function kf(t,a){for(var o=0;o<a.length;o++){const r=a[o];if(typeof r!="string"&&!Array.isArray(r)){for(const p in r)if(p!=="default"&&!(p in t)){const c=Object.getOwnPropertyDescriptor(r,p);c&&Object.defineProperty(t,p,c.get?c:{enumerable:!0,get:()=>r[p]})}}}return Object.freeze(Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}))}(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const p of document.querySelectorAll('link[rel="modulepreload"]'))r(p);new MutationObserver(p=>{for(const c of p)if(c.type==="childList")for(const g of c.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&r(g)}).observe(document,{childList:!0,subtree:!0});function o(p){const c={};return p.integrity&&(c.integrity=p.integrity),p.referrerPolicy&&(c.referrerPolicy=p.referrerPolicy),p.crossOrigin==="use-credentials"?c.credentials="include":p.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(p){if(p.ep)return;p.ep=!0;const c=o(p);fetch(p.href,c)}})();function bf(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var vu={exports:{}},Zt={},wu={exports:{}},Ie={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Sp;function Lf(){if(Sp)return Zt;Sp=1;var t=Uu(),a=Symbol.for("react.element"),o=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,p=t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,c={key:!0,ref:!0,__self:!0,__source:!0};function g(f,m,_){var E,w={},J=null,z=null;_!==void 0&&(J=""+_),m.key!==void 0&&(J=""+m.key),m.ref!==void 0&&(z=m.ref);for(E in m)r.call(m,E)&&!c.hasOwnProperty(E)&&(w[E]=m[E]);if(f&&f.defaultProps)for(E in m=f.defaultProps,m)w[E]===void 0&&(w[E]=m[E]);return{$$typeof:a,type:f,key:J,ref:z,props:w,_owner:p.current}}return Zt.Fragment=o,Zt.jsx=g,Zt.jsxs=g,Zt}var vp;function If(){return vp||(vp=1,vu.exports=Lf()),vu.exports}var b=If(),C=Uu();const Gf=bf(C),Pf=kf({__proto__:null,default:Gf},[C]);/**
 ...
 *
 * @license MIT
 */var ud=t=>{throw TypeError(t)},rd=(t,a,o)=>a.has(t)||ud("Cannot "+o),Fl=(t,a,o)=>(rd(t,a,"read from private field"),o?o.call(t):a.get(t)),an=(t,a,o)=>a.has(t)?ud("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(t):a.set(t,o),hs=(t,a,o,r)=>(rd(t,a,"write to private field"),a.set(t,o),o),wp="popstate";function xp(t){return typeof t=="object"&&t!=null&&"pathname"in t&&"search"in t&&"hash"in t&&"state"in t&&"key"in t}function Jf(t={}){function a(p,c){let{pathname:g="/",search:f="",hash:m=""}=as(p.location.hash.substring(1));return!g.startsWith("/")&&!g.startsWith(".")&&(g="/"+g),cn("",{pathname:g,search:f,hash:m},c.state&&c.state.usr||null,c.state&&c.state.key||"default")}function o(p,c){let g=p.document.querySelector("base"),f="";if(g&&g.getAttribute("href")){let m=p.location.href,_=m.indexOf("#");f=_===-1?m:m.slice(0,_)}return f+"#"+(typeof c=="string"?c:vs(c))}function r(p,c){Xe(p.pathname.charAt(0)==="/",`relative pathnames are not supported in hash history.push(${JSON.stringify(c)})`)}return Uf(a,o,r,t)}function Ce(t,a){if(t===!1||t===null||typeof t>"u")throw new Error(a)}function Xe(t,a){if(!t){typeof console<"u"&&console.warn(a);try{throw new Error(a)}catch{}}}function zf(){return Math.random().toString(36).substring(2,10)}function yp(t,a){return{usr:t.state,key:t.key,idx:a,masked:t.mask?{pathname:t.pathname,search:t.search,hash:t.hash}:void 0}}function cn(t,a,o=null,r,p){return{pathname:typeof t=="string"?t:t.pathname,search:"",hash:"",...typeof a=="string"?as(a):a,state:o,key:a&&a.key||r||zf(),mask:p}}function vs({pathname:t="/",search:a="",hash:o=""}){return a&&a!=="?"&&(t+=a.charAt(0)==="?"?a:"?"+a),o&&o!=="#"&&(t+=o.charAt(0)==="#"?o:"#"+o),t}function as(t){let a={};if(t){let o=t.indexOf("#");o>=0&&(a.hash=t.substring(o),t=t.substring(0,o));let r=t.indexOf("?");r>=0&&(a.search=t.substring(r),t=t.substring(0,r)),t&&(a.pathname=t)}return a}function Uf(t,a,o,r={}){let{window:p=document.defaultView,v5Compat:c=!1}=r,g=p.history,f="POP",m=null,_=E();_==null&&(_=0,g.replaceState({...g.state,idx:_},""));function E(){return(g.state||{idx:null}).idx}function w(){f="POP";let B=E(),Q=B==null?null:B-_;_=B,m&&m({action:f,location:q.location,delta:Q})}function J(B,Q){f="PUSH";let V=xp(B)?B:cn(q.location,B,Q);o&&o(V,B),_=E()+1;let ie=yp(V,_),de=q.createHref(V.mask||V);try{g.pushState(ie,"",de)}catch(ce){if(ce instanceof DOMException&&ce.name==="DataCloneError")throw ce;p.location.assign(de)}c&&m&&m({action:f,location:q.location,delta:1})}function z(B,Q){f="REPLACE";let V=xp(B)?B:cn(q.location,B,Q);o&&o(V,B),_=E();let ie=yp(V,_),de=q.createHref(V.mask||V);g.replaceState(ie,"",de),c&&m&&m({action:f,location:q.location,delta:0})}function H(B){return cd(p,B)}let q={get action(){return f},get location(){return t(p,g)},listen(B){if(m)throw new Error("A history only accepts one active listener");return p.addEventListener(wp,w),m=B,()=>{p.removeEventListener(wp,w),m=null}},createHref(B){return a(p,B)},createURL:H,encodeLocation(B){let Q=H(B);return{pathname:Q.pathname,search:Q.search,hash:Q.hash}},push:J,replace:z,go(B){return g.go(B)}};return q}function cd(t,a,o=!1){let r="http://localhost";t&&(r=t.location.origin!=="null"?t.location.origin:t.location.href),Ce(r,"No window.location.(origin|href) available to create URL");let p=typeof a=="string"?a:vs(a);return p=p.replace(/ $/,"%20"),!o&&p.startsWith("//")&&(p=r+p),new URL(p,r)}var on,Ep=class{constructor(t){if(an(this,on,new Map),t)for(let[a,o]of t)this.set(a,o)}get(t){if(Fl(this,on).has(t))return Fl(this,on).get(t);if(t.defaultValue!==void 0)return t.defaultValue;throw new Error("No value found for context")}set(t,a){Fl(this,on).set(t,a)}};on=new WeakMap;var qf=new Set(["lazy","caseSensitive","path","id","index","children"]);function Bf(t){return qf.has(t)}var Af=new Set(["lazy","caseSensitive","path","id","index","middleware","children"]);function Mf(t){return Af.has(t)}function Hf(t){return t.index===!0}function pn(t,a,o=[],r={},p=!1){return t.map((c,g)=>{let f=[...o,String(g)],m=typeof c.id=="string"?c.id:f.join("-");if(Ce(c.index!==!0||!c.children,"Cannot specify children on an index route"),Ce(p||!r[m],`Found a route id collision on id "${m}".  Route id's must be globally unique within Data Router usages`),Hf(c)){let _={...c,id:m};return r[m]=kp(_,a(_)),_}else{let _={...c,id:m,children:void 0};return r[m]=kp(_,a(_)),c.children&&(_.children=pn(c.children,a,f,r,p)),_}})}function kp(t,a){return Object.assign(t,{...a,...typeof a.lazy=="object"&&a.lazy!=null?{lazy:{...t.lazy,...a.lazy}}:{}})}function pd(t,a,o="/"){return ns(t,a,o,!1)}function ns(t,a,o,r,p){let c=typeof a=="string"?as(a):a,g=$l(c.pathname||"/",o);if(g==null)return null;let f=p??Pa(t),m=null,_=Xf(g);for(let E=0;m==null&&E<f.length;++E)m=Qf(f[E],_,r);return m}function Tf(t,a){let{route:o,pathname:r,params:p}=t;return{id:o.id,pathname:r,params:p,data:a[o.id],loaderData:a[o.id],handle:o.handle}}function Pa(t){let a=dd(t);return Rf(a),a}function dd(t,a=[],o=[],r="",p=!1){let c=(g,f,m=p,_)=>{let E={relativePath:_===void 0?g.path||"":_,caseSensitive:g.caseSensitive===!0,childrenIndex:f,route:g};if(E.relativePath.startsWith("/")){if(!E.relativePath.startsWith(r)&&m)return;Ce(E.relativePath.startsWith(r),`Absolute route path "${E.relativePath}" nested under path "${r}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),E.relativePath=E.relativePath.slice(r.length)}let w=Wl([r,E.relativePath]),J=o.concat(E);g.children&&g.children.length>0&&(Ce(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${w}".`),dd(g.children,a,J,w,m)),!(g.path==null&&!g.index)&&a.push({path:w,score:Vf(w,g.index),routesMeta:J})};return t.forEach((g,f)=>{var m;if(g.path===""||!((m=g.path)!=null&&m.includes("?")))c(g,f);else for(let _ of gd(g.path))c(g,f,!0,_)}),a}function gd(t){let a=t.split("/");if(a.length===0)return[];let[o,...r]=a,p=o.endsWith("?"),c=o.replace(/\?$/,"");if(r.length===0)return p?[c,""]:[c];let g=gd(r.join("/")),f=[];return f.push(...g.map(m=>m===""?c:[c,m].join("/"))),p&&f.push(...g),f.map(m=>t.startsWith("/")&&m===""?"/":m)}function Rf(t){t.sort((a,o)=>a.score!==o.score?o.score-a.score:Kf(a.routesMeta.map(r=>r.childrenIndex),o.routesMeta.map(r=>r.childrenIndex)))}var Of=/^:[\w-]+$/,Nf=3,Ff=2,Df=1,Wf=10,$f=-2,bp=t=>t==="*";function Vf(t,a){let o=t.split("/"),r=o.length;return o.some(bp)&&(r+=$f),a&&(r+=Ff),o.filter(p=>!bp(p)).reduce((p,c)=>p+(Of.test(c)?Nf:c===""?Df:Wf),r)}function Kf(t,a){return t.length===a.length&&t.slice(0,-1).every((r,p)=>r===a[p])?t[t.length-1]-a[a.length-1]:0}function Qf(t,a,o=!1){let{routesMeta:r}=t,p={},c="/",g=[];for(let f=0;f<r.length;++f){let m=r[f],_=f===r.length-1,E=c==="/"?a:a.slice(c.length)||"/",w=qa({path:m.relativePath,caseSensitive:m.caseSensitive,end:_},E),J=m.route;if(!w&&_&&o&&!r[r.length-1].route.index&&(w=qa({path:m.relativePath,caseSensitive:m.caseSensitive,end:!1},E)),!w)return null;Object.assign(p,w.params),g.push({params:p,pathname:Wl([c,w.pathname]),pathnameBase:lm(Wl([c,w.pathnameBase])),route:J}),w.pathnameBase!=="/"&&(c=Wl([c,w.pathnameBase]))}return g}function qa(t,a){typeof t=="string"&&(t={path:t,caseSensitive:!1,end:!0});let[o,r]=Yf(t.path,t.caseSensitive,t.end),p=a.match(o);if(!p)return null;let c=p[0],g=c.replace(/(.)\/+$/,"$1"),f=p.slice(1);return{params:r.reduce((_,{paramName:E,isOptional:w},J)=>{if(E==="*"){let H=f[J]||"";g=c.slice(0,c.length-H.length).replace(/(.)\/+$/,"$1")}const z=f[J];return w&&!z?_[E]=void 0:_[E]=(z||"").replace(/%2F/g,"/"),_},{}),pathname:c,pathnameBase:g,pattern:t}}function Yf(t,a=!1,o=!0){Xe(t==="*"||!t.endsWith("*")||t.endsWith("/*"),`Route path "${t}" will be treated as if it were "${t.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${t.replace(/\*$/,"/*")}".`);let r=[],p="^"+t.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(g,f,m,_,E)=>{if(r.push({paramName:f,isOptional:m!=null}),m){let w=E.charAt(_+g.length);return w&&w!=="/"?"/([^\\/]*)":"(?:/([^\\/]*))?"}return"/([^\\/]+)"}).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return t.endsWith("*")?(r.push({paramName:"*"}),p+=t==="*"||t==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):o?p+="\\/*$":t!==""&&t!=="/"&&(p+="(?:(?=\\/|$))"),[new RegExp(p,a?void 0:"i"),r]}function Xf(t){try{return t.split("/").map(a=>decodeURIComponent(a).replace(/\//g,"%2F")).join("/")}catch(a){return Xe(!1,`The URL path "${t}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${a}).`),t}}function $l(t,a){if(a==="/")return t;if(!t.toLowerCase().startsWith(a.toLowerCase()))return null;let o=a.endsWith("/")?a.length-1:a.length,r=t.charAt(o);return r&&r!=="/"?null:t.slice(o)||"/"}function Zf({basename:t,pathname:a}){return a==="/"?t:Wl([t,a])}var fd=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,qu=t=>fd.test(t);function em(t,a="/"){let{pathname:o,search:r="",hash:p=""}=typeof t=="string"?as(t):t,c;return o?(o=Bu(o),o.startsWith("/")?c=Cp(o.substring(1),"/"):c=Cp(o,a)):c=a,{pathname:c,search:sm(r),hash:im(p)}}function Cp(t,a){let o=Ba(a).split("/");return t.split("/").forEach(p=>{p===".."?o.length>1&&o.pop():p!=="."&&o.push(p)}),o.length>1?o.join("/"):"/"}function xu(t,a,o,r){return`Cannot include a '${t}' character in a manually specified \`to.${a}\` field [${JSON.stringify(r)}].  Please separate it out to the \`to.${o}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function md(t){return t.filter((a,o)=>o===0||a.route.path&&a.route.path.length>0)}function Aa(t){let a=md(t);return a.map((o,r)=>r===a.length-1?o.pathname:o.pathnameBase)}function gn(t,a,o,r=!1){let p;typeof t=="string"?p=as(t):(p={...t},Ce(!p.pathname||!p.pathname.includes("?"),xu("?","pathname","search",p)),Ce(!p.pathname||!p.pathname.includes("#"),xu("#","pathname","hash",p)),Ce(!p.search||!p.search.includes("#"),xu("#","search","hash",p)));let c=t===""||p.pathname==="",g=c?"/":p.pathname,f;if(g==null)f=o;else{let w=a.length-1;if(!r&&g.startsWith("..")){let J=g.split("/");for(;J[0]==="..";)J.shift(),w-=1;p.pathname=J.join("/")}f=w>=0?a[w]:"/"}let m=em(p,f),_=g&&g!=="/"&&g.endsWith("/"),E=(c||g===".")&&o.endsWith("/");return!m.pathname.endsWith("/")&&(_||E)&&(m.pathname+="/"),m}var Bu=t=>t.replace(/\/\/+/g,"/"),Wl=t=>Bu(t.join("/")),Ba=t=>t.replace(/\/+$/,""),lm=t=>Ba(t).replace(/^\/*/,"/"),sm=t=>!t||t==="?"?"":t.startsWith("?")?t:"?"+t,im=t=>!t||t==="#"?"":t.startsWith("#")?t:"#"+t,fn=class{constructor(t,a,o,r=!1){this.status=t,this.statusText=a||"",this.internal=r,o instanceof Error?(this.data=o.toString(),this.error=o):this.data=o}};function dn(t){return t!=null&&typeof t.status=="number"&&typeof t.statusText=="string"&&typeof t.internal=="boolean"&&"data"in t}function mn(t){let a=t.map(o=>o.route.path).filter(Boolean);return Wl(a)||"/"}var hd=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function _d(t,a){let o=t;if(typeof o!="string"||!fd.test(o))return{absoluteURL:void 0,isExternal:!1,to:o};let r=o,p=!1;if(hd)try{let c=new URL(window.location.href),g=o.startsWith("//")?new URL(c.protocol+o):new URL(o),f=$l(g.pathname,a);g.origin===c.origin&&f!=null?o=f+g.search+g.hash:p=!0}catch{Xe(!1,`<Link to="${o}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}return{absoluteURL:r,isExternal:p,to:o}}var ci=Symbol("Uninstrumented");function tm(t,a){let o={lazy:[],"lazy.loader":[],"lazy.action":[],"lazy.middleware":[],middleware:[],loader:[],action:[]};t.forEach(p=>p({id:a.id,index:a.index,path:a.path,instrument(c){let g=Object.keys(o);for(let f of g)c[f]&&o[f].push(c[f])}}));let r={};if(typeof a.lazy=="function"&&o.lazy.length>0){let p=pt(o.lazy,a.lazy,()=>{});p&&(r.lazy=p)}if(typeof a.lazy=="object"){let p=a.lazy;["middleware","loader","action"].forEach(c=>{let g=p[c],f=o[`lazy.${c}`];if(typeof g=="function"&&f.length>0){let m=pt(f,g,()=>{});m&&(r.lazy=Object.assign(r.lazy||{},{[c]:m}))}})}return["loader","action"].forEach(p=>{let c=a[p];if(typeof c=="function"&&o[p].length>0){let g=c[ci]??c,f=pt(o[p],g,(...m)=>Lp(m[0]));f&&(p==="loader"&&g.hydrate===!0&&(f.hydrate=!0),f[ci]=g,r[p]=f)}}),a.middleware&&a.middleware.length>0&&o.middleware.length>0&&(r.middleware=a.middleware.map(p=>{let c=p[ci]??p,g=pt(o.middleware,c,(...f)=>Lp(f[0]));return g?(g[ci]=c,g):p})),r}function nm(t,a){let o={navigate:[],fetch:[]};if(a.forEach(r=>r({instrument(p){let c=Object.keys(p);for(let g of c)p[g]&&o[g].push(p[g])}})),o.navigate.length>0){let r=t.navigate[ci]??t.navigate,p=pt(o.navigate,r,(...c)=>{let[g,f]=c;return{to:typeof g=="number"||typeof g=="string"?g:g?vs(g):".",...Ip(t,f??{})}});p&&(p[ci]=r,t.navigate=p)}if(o.fetch.length>0){let r=t.fetch[ci]??t.fetch,p=pt(o.fetch,r,(...c)=>{let[g,,f,m]=c;return{href:f??".",fetcherKey:g,...Ip(t,m??{})}});p&&(p[ci]=r,t.fetch=p)}return t}function pt(t,a,o){return t.length===0?null:async(...r)=>{let p=await jd(t,o(...r),()=>a(...r),t.length-1);if(p.type==="error")throw p.value;return p.value}}async function jd(t,a,o,r){let p=t[r],c;if(p){let g,f=async()=>(g?console.error("You cannot call instrumented handlers more than once"):g=jd(t,a,o,r-1),c=await g,Ce(c,"Expected a result"),c.type==="error"&&c.value instanceof Error?{status:"error",error:c.value}:{status:"success",error:void 0});try{await p(f,a)}catch(m){console.error("An instrumentation function threw an error:",m)}g||await f(),await g}else try{c={type:"success",value:await o()}}catch(g){c={type:"error",value:g}}return c||{type:"error",value:new Error("No result assigned in instrumentation chain.")}}function Lp(t){let{request:a,context:o,params:r,pattern:p}=t;return{request:am(a),params:{...r},pattern:p,context:om(o)}}function Ip(t,a){return{currentUrl:vs(t.state.location),..."formMethod"in a?{formMethod:a.formMethod}:{},..."formEncType"in a?{formEncType:a.formEncType}:{},..."formData"in a?{formData:a.formData}:{},..."body"in a?{body:a.body}:{}}}function am(t){return{method:t.method,url:t.url,headers:{get:(...a)=>t.headers.get(...a)}}}function om(t){if(rm(t)){let a={...t};return Object.freeze(a),a}else return{get:a=>t.get(a)}}var um=Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function rm(t){if(t===null||typeof t!="object")return!1;const a=Object.getPrototypeOf(t);return a===Object.prototype||a===null||Object.getOwnPropertyNames(a).sort().join("\0")===um}var Sd=["POST","PUT","PATCH","DELETE"],cm=new Set(Sd),pm=["GET",...Sd],dm=new Set(pm),vd=new Set([301,302,303,307,308]),gm=new Set([307,308]),yu={state:"idle",location:void 0,matches:void 0,historyAction:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},fm={state:"idle",data:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},en={state:"unblocked",proceed:void 0,reset:void 0,location:void 0},mm=t=>({hasErrorBoundary:!!t.hasErrorBoundary}),wd="remix-router-transitions",xd=Symbol("ResetLoaderData"),Ci,ut,ui,rt,hm=class{constructor(t){an(this,Ci),an(this,ut),an(this,ui),an(this,rt),hs(this,Ci,t),hs(this,ut,Pa(t))}get stableRoutes(){return Fl(this,Ci)}get activeRoutes(){return Fl(this,ui)??Fl(this,Ci)}get branches(){return Fl(this,rt)??Fl(this,ut)}get hasHMRRoutes(){return Fl(this,ui)!=null}setRoutes(t){hs(this,Ci,t),hs(this,ut,Pa(t))}setHmrRoutes(t){hs(this,ui,t),hs(this,rt,Pa(t))}commitHmrRoutes(){Fl(this,ui)&&(hs(this,Ci,Fl(this,ui)),hs(this,ut,Fl(this,rt)),hs(this,ui,void 0),hs(this,rt,void 0))}};Ci=new WeakMap;ut=new WeakMap;ui=new WeakMap;rt=new WeakMap;function _m(t){const a=t.window?t.window:typeof window<"u"?window:void 0,o=typeof a<"u"&&typeof a.document<"u"&&typeof a.document.createElement<"u";Ce(t.routes.length>0,"You must provide a non-empty routes array to createRouter");let r=t.hydrationRouteProperties||[],p=t.mapRouteProperties||mm,c=p;if(t.instrumentations){let j=t.instrumentations;c=v=>({...p(v),...tm(j.map(G=>G.route).filter(Boolean),v)})}let g={},f=new hm(pn(t.routes,c,void 0,g)),m=t.basename||"/";m.startsWith("/")||(m=`/${m}`);let _=t.dataStrategy||xm,E={...t.future},w=null,J=new Set,z=null,H=null,q=null,B=null,Q=t.hydrationData!=null,V=ns(f.activeRoutes,t.history.location,m,!1,f.branches),ie=!1,de=null,ce,ve;if(V==null&&!t.patchRoutesOnNavigation){let j=Dl(404,{pathname:t.history.location.pathname}),{matches:v,route:G}=ba(f.activeRoutes);ce=!0,ve=!ce,V=v,de={[G.id]:j}}else if(V&&!t.hydrationData&&Ms(V,f.activeRoutes,t.history.location.pathname).active&&(V=null),V)if(V.some(j=>j.route.lazy))ce=!1,ve=!ce;else if(!V.some(j=>Au(j.route)))ce=!0,ve=!ce;else{let j=t.hydrationData?t.hydrationData.loaderData:null,v=t.hydrationData?t.hydrationData.errors:null,G=V;if(v){let T=V.findIndex(R=>v[R.route.id]!==void 0);G=G.slice(0,T+1)}ve=!1,ce=!0,G.forEach(T=>{let R=yd(T.route,j,v);ve=ve||R.renderFallback,ce=ce&&!R.shouldLoad})}else{ce=!1,ve=!ce,V=[];let j=Ms(null,f.activeRoutes,t.history.location.pathname);j.active&&j.matches&&(ie=!0,V=j.matches)}let Ee,L={historyAction:t.history.action,location:t.history.location,matches:V,initialized:ce,renderFallback:ve,navigation:yu,restoreScrollPosition:t.hydrationData!=null?!1:null,preventScrollReset:!1,revalidation:"idle",loaderData:t.hydrationData&&t.hydrationData.loaderData||{},actionData:t.hydrationData&&t.hydrationData.actionData||null,errors:t.hydrationData&&t.hydrationData.errors||de,fetchers:new Map,blockers:new Map},ye="POP",ne=null,Te=!1,ke,qe=!1,Le=new Map,ze=null,Ne=!1,me=!1,F=new Set,Y=new Map,K=0,x=-1,M=new Map,ge=new Set,he=new Map,k=new Map,A=new Set,$=new Map,ee,fe=null;function $e(){if(w=t.history.listen(({action:j,location:v,delta:G})=>{if(ee){ee(),ee=void 0;return}Xe($.size===0||G!=null,"You are trying to use a blocker on a POP navigation to a location that was not created by @remix-run/router. This will fail silently in production. This can happen if you are navigating outside the router via `window.history.pushState`/`window.location.hash` instead of using router navigation APIs.  This can also happen if you are using createHashRouter and the user manually changes the URL.");let T=xs({currentLocation:L.location,nextLocation:v,historyAction:j});if(T&&G!=null){let R=new Promise(oe=>{ee=oe});t.history.go(G*-1),Ql(T,{state:"blocked",location:v,proceed(){Ql(T,{state:"proceeding",proceed:void 0,reset:void 0,location:v}),R.then(()=>t.history.go(G))},reset(){let oe=new Map(L.blockers);oe.set(T,en),Ze({blockers:oe})}}),ne==null||ne.resolve(),ne=null;return}return Vl(j,v)}),o){Tm(a,Le);let j=()=>Rm(a,Le);a.addEventListener("pagehide",j),ze=()=>a.removeEventListener("pagehide",j)}return L.initialized||Vl("POP",L.location,{initialHydration:!0}),Ee}function ws(){w&&w(),ze&&ze(),J.clear(),ke&&ke.abort(),L.fetchers.forEach((j,v)=>Pi(L.fetchers,v)),L.blockers.forEach((j,v)=>qi(v))}function zs(j){if(J.add(j),z){let{newErrors:v}=z;z=null,j(L,{deletedFetchers:[],newErrors:v,viewTransitionOpts:void 0,flushSync:!1})}return()=>J.delete(j)}function Ze(j,v={}){j.matches&&(j.matches=j.matches.map(R=>{let oe=g[R.route.id],ue=R.route;return ue.element!==oe.element||ue.errorElement!==oe.errorElement||ue.hydrateFallbackElement!==oe.hydrateFallbackElement?{...R,route:oe}:R})),L={...L,...j};let G=[],T=[];L.fetchers.forEach((R,oe)=>{R.state==="idle"&&(A.has(oe)?G.push(oe):T.push(oe))}),A.forEach(R=>{!L.fetchers.has(R)&&!Y.has(R)&&G.push(R)}),J.size===0&&(z={newErrors:j.errors??null}),[...J].forEach(R=>R(L,{deletedFetchers:G,newErrors:j.errors??null,viewTransitionOpts:v.viewTransitionOpts,flushSync:v.flushSync===!0})),G.forEach(R=>Pi(L.fetchers,R)),T.forEach(R=>L.fetchers.delete(R))}function rs(j,v,{flushSync:G}={}){var Se,be;let T=L.actionData!=null&&L.navigation.formMethod!=null&&jl(L.navigation.formMethod)&&L.navigation.state==="loading"&&((Se=j.state)==null?void 0:Se._isRedirect)!==!0,R;v.actionData?Object.keys(v.actionData).length>0?R=v.actionData:R=null:T?R=L.actionData:R=null;let oe=v.loaderData?Tp(L.loaderData,v.loaderData,v.matches||[],v.errors):L.loaderData,ue=L.blockers;ue.size>0&&(ue=new Map(ue),ue.forEach((pe,Ge)=>ue.set(Ge,en)));let xe=Ne?!1:St(j,v.matches||L.matches),X=Te===!0||L.navigation.formMethod!=null&&jl(L.navigation.formMethod)&&((be=j.state)==null?void 0:be._isRedirect)!==!0;f.commitHmrRoutes(),Ne||ye==="POP"||(ye==="PUSH"?t.history.push(j,j.state):ye==="REPLACE"&&t.history.replace(j,j.state));let re;if(ye==="POP"){let pe=Le.get(L.location.pathname);pe&&pe.has(j.pathname)?re={currentLocation:L.location,nextLocation:j}:Le.has(j.pathname)&&(re={currentLocation:j,nextLocation:L.location})}else if(qe){let pe=Le.get(L.location.pathname);pe?pe.add(j.pathname):(pe=new Set([j.pathname]),Le.set(L.location.pathname,pe)),re={currentLocation:L.location,nextLocation:j}}Ze({...v,actionData:R,loaderData:oe,historyAction:ye,location:j,initialized:!0,renderFallback:!1,navigation:yu,revalidation:"idle",restoreScrollPosition:xe,preventScrollReset:X,blockers:ue},{viewTransitionOpts:re,flushSync:G===!0}),ye="POP",Te=!1,qe=!1,Ne=!1,me=!1,ne==null||ne.resolve(),ne=null,fe==null||fe.resolve(),fe=null}async function ft(j,v){if(ne==null||ne.resolve(),ne=null,typeof j=="number"){ne||(ne=Fp());let Ae=ne.promise;return t.history.go(j),Ae}let G=Pu(L.location,L.matches,m,j,v==null?void 0:v.fromRouteId,v==null?void 0:v.relative),{path:T,submission:R,error:oe}=Gp(!1,G,v),ue;v!=null&&v.mask&&(ue={pathname:"",search:"",hash:"",...typeof v.mask=="string"?as(v.mask):{...L.location.mask,...v.mask}});let xe=L.location,X=cn(xe,T,v&&v.state,void 0,ue);X={...X,...t.history.encodeLocation(X)};let re=v&&v.replace!=null?v.replace:void 0,Se="PUSH";re===!0?Se="REPLACE":re===!1||R!=null&&jl(R.formMethod)&&R.formAction===L.location.pathname+L.location.search&&(Se="REPLACE");let be=v&&"preventScrollReset"in v?v.preventScrollReset===!0:void 0,pe=(v&&v.flushSync)===!0,Ge=xs({currentLocation:xe,nextLocation:X,historyAction:Se});if(Ge){Ql(Ge,{state:"blocked",location:X,proceed(){Ql(Ge,{state:"proceeding",proceed:void 0,reset:void 0,location:X}),ft(j,v)},reset(){let Ae=new Map(L.blockers);Ae.set(Ge,en),Ze({blockers:Ae})}});return}await Vl(Se,X,{submission:R,pendingError:oe,preventScrollReset:be,replace:v&&v.replace,enableViewTransition:v&&v.viewTransition,flushSync:pe,callSiteDefaultShouldRevalidate:v&&v.defaultShouldRevalidate})}function jn(){fe||(fe=Fp()),As(),Ze({revalidation:"loading"});let j=fe.promise;return L.navigation.state==="submitting"?j:L.navigation.state==="idle"?(Vl(L.historyAction,L.location,{startUninterruptedRevalidation:!0}),j):(Vl(ye||L.historyAction,L.navigation.location,{overrideNavigation:L.navigation,enableViewTransition:qe===!0}),j)}async function Vl(j,v,G){ke&&ke.abort(),ke=null,ye=j,Ne=(G&&G.startUninterruptedRevalidation)===!0,En(L.location,L.matches),Te=(G&&G.preventScrollReset)===!0,qe=(G&&G.enableViewTransition)===!0;let T=f.activeRoutes,R=G!=null&&G.initialHydration&&L.matches&&L.matches.length>0&&!ie?L.matches:ns(T,v,m,!1,f.branches),oe=(G&&G.flushSync)===!0;if(R&&L.initialized&&!me&&Gm(L.location,v)&&!(G&&G.submission&&jl(G.submission.formMethod))){rs(v,{matches:R},{flushSync:oe});return}let ue=Ms(R,T,v.pathname);if(ue.active&&ue.matches&&(R=ue.matches),!R){let{error:Fe,notFoundMatches:Me,route:Pe}=Bi(v.pathname);rs(v,{matches:Me,loaderData:{},errors:{[Pe.id]:Fe}},{flushSync:oe});return}let xe=G&&G.overrideNavigation?{...G.overrideNavigation,matches:R,historyAction:j}:void 0;ke=new AbortController;let X=ct(t.history,v,ke.signal,G&&G.submission),re=t.getContext?await t.getContext():new Ep,Se;if(G&&G.pendingError)Se=[ri(R).route.id,{type:"error",error:G.pendingError}];else if(G&&G.submission&&jl(G.submission.formMethod)){let Fe=await Sn(X,v,G.submission,R,j,re,ue.active,G&&G.initialHydration===!0,{replace:G.replace,flushSync:oe});if(Fe.shortCircuited)return;if(Fe.pendingActionResult){let[Me,Pe]=Fe.pendingActionResult;if(ql(Pe)&&dn(Pe.error)&&Pe.error.status===404){ke=null,rs(v,{matches:Fe.matches,loaderData:{},errors:{[Me]:Pe.error}});return}}R=Fe.matches||R,Se=Fe.pendingActionResult,xe=Eu(v,R,j,G.submission),oe=!1,ue.active=!1,X=ct(t.history,X.url,X.signal)}let{shortCircuited:be,matches:pe,loaderData:Ge,errors:Ae,workingFetchers:el}=await mt(X,v,R,j,re,ue.active,xe,G&&G.submission,G&&G.fetcherSubmission,G&&G.replace,G&&G.initialHydration===!0,oe,Se,G&&G.callSiteDefaultShouldRevalidate);be||(ke=null,rs(v,{matches:pe||R,...Rp(Se),loaderData:Ge,errors:Ae,...el?{fetchers:el}:{}}))}async function Sn(j,v,G,T,R,oe,ue,xe,X={}){As();let re=Mm(v,T,R,G);if(Ze({navigation:re},{flushSync:X.flushSync===!0}),ue){let pe=await gi(T,v.pathname,j.signal);if(pe.type==="aborted")return{shortCircuited:!0};if(pe.type==="error"){if(pe.partialMatches.length===0){let{matches:Ae,route:el}=ba(f.activeRoutes);return{matches:Ae,pendingActionResult:[el.id,{type:"error",error:pe.error}]}}let Ge=ri(pe.partialMatches).route.id;return{matches:pe.partialMatches,pendingActionResult:[Ge,{type:"error",error:pe.error}]}}else if(pe.matches)T=pe.matches;else{let{notFoundMatches:Ge,error:Ae,route:el}=Bi(v.pathname);return{matches:Ge,pendingActionResult:[el.id,{type:"error",error:Ae}]}}}let Se,be=Ja(T,v);if(!be.route.action&&!be.route.lazy)Se={type:"error",error:Dl(405,{method:j.method,pathname:v.pathname,routeId:be.route.id})};else{let pe=dt(c,g,j,v,T,be,xe?[]:r,oe),Ge=await Bs(j,v,pe,oe,null);if(Se=Ge[be.route.id],!Se){for(let Ae of T)if(Ge[Ae.route.id]){Se=Ge[Ae.route.id];break}}if(j.signal.aborted)return{shortCircuited:!0}}if(Li(Se)){let pe;return X&&X.replace!=null?pe=X.replace:pe=Ap(Se.response.headers.get("Location"),new URL(j.url),m,t.history)===L.location.pathname+L.location.search,await cs(j,Se,!0,{submission:G,replace:pe}),{shortCircuited:!0}}if(ql(Se)){let pe=ri(T,be.route.id);return(X&&X.replace)!==!0&&(ye="PUSH"),{matches:T,pendingActionResult:[pe.route.id,Se,be.route.id]}}return{matches:T,pendingActionResult:[be.route.id,Se]}}async function mt(j,v,G,T,R,oe,ue,xe,X,re,Se,be,pe,Ge){let Ae=ue||Eu(v,G,T,xe),el=xe||X||Np(Ae),Fe=!Ne&&!Se;if(oe){if(Fe){let gl=Us(pe);Ze({navigation:Ae,...gl!==void 0?{actionData:gl}:{}},{flushSync:be})}let Je=await gi(G,v.pathname,j.signal);if(Je.type==="aborted")return{shortCircuited:!0};if(Je.type==="error"){if(Je.partialMatches.length===0){let{matches:vl,route:yl}=ba(f.activeRoutes);return{matches:vl,loaderData:{},errors:{[yl.id]:Je.error}}}let gl=ri(Je.partialMatches).route.id;return{matches:Je.partialMatches,loaderData:{},errors:{[gl]:Je.error}}}else if(Je.matches)G=Je.matches;else{let{error:gl,notFoundMatches:vl,route:yl}=Bi(v.pathname);return{matches:vl,loaderData:{},errors:{[yl.id]:gl}}}}let Me=f.activeRoutes,{dsMatches:Pe,revalidatingFetchers:pl}=Pp(j,R,c,g,t.history,L,G,el,v,Se?[]:r,Se===!0,me,F,A,he,ge,Me,m,t.patchRoutesOnNavigation!=null,f.branches,pe,Ge);if(x=++K,!t.dataStrategy&&!Pe.some(Je=>Je.shouldLoad)&&!Pe.some(Je=>Je.route.middleware&&Je.route.middleware.length>0)&&pl.length===0){let Je=new Map(L.fetchers),gl=zi(Je);return rs(v,{matches:G,loaderData:{},errors:pe&&ql(pe[1])?{[pe[0]]:pe[1].error}:null,...Rp(pe),...gl?{fetchers:Je}:{}},{flushSync:be}),{shortCircuited:!0}}if(Fe){let Je={};if(!oe){Je.navigation=Ae;let gl=Us(pe);gl!==void 0&&(Je.actionData=gl)}pl.length>0&&(Je.fetchers=qs(pl)),Ze(Je,{flushSync:be})}pl.forEach(Je=>{Kl(Je.key),Je.controller&&Y.set(Je.key,Je.controller)});let ys=()=>pl.forEach(Je=>Kl(Je.key));ke&&ke.signal.addEventListener("abort",ys);let{loaderResults:Yl,fetcherResults:Xl}=await Gi(Pe,pl,j,v,R);if(j.signal.aborted)return{shortCircuited:!0};ke&&ke.signal.removeEventListener("abort",ys),pl.forEach(Je=>Y.delete(Je.key));let ps=Ca(Yl);if(ps)return await cs(j,ps.result,!0,{replace:re}),{shortCircuited:!0};if(ps=Ca(Xl),ps)return ge.add(ps.key),await cs(j,ps.result,!0,{replace:re}),{shortCircuited:!0};let Gl=new Map(L.fetchers),{loaderData:Ts,errors:il}=Hp(L,G,Yl,pe,pl,Xl,Gl);Se&&L.errors&&(il={...L.errors,...il});let Ai=zi(Gl),dl=Ui(x,Gl),Mi=Ai||dl||pl.length>0;return{matches:G,loaderData:Ts,errors:il,...Mi?{workingFetchers:Gl}:{}}}function Us(j){if(j&&!ql(j[1]))return{[j[0]]:j[1].data};if(L.actionData)return Object.keys(L.actionData).length===0?null:L.actionData}function qs(j){let v=new Map(L.fetchers);return j.forEach(G=>{let T=v.get(G.key),R=ln(void 0,T?T.data:void 0);v.set(G.key,R)}),v}async function ht(j,v,G,T){Kl(j);let R=(T&&T.flushSync)===!0,oe=f.activeRoutes,ue=Pu(L.location,L.matches,m,G,v,T==null?void 0:T.relative),xe=ns(oe,ue,m,!1,f.branches),X=Ms(xe,oe,ue);if(X.active&&X.matches&&(xe=X.matches),!xe){Sl(j,v,Dl(404,{pathname:ue}),{flushSync:R});return}let{path:re,submission:Se,error:be}=Gp(!0,ue,T);if(be){Sl(j,v,be,{flushSync:R});return}let pe=t.getContext?await t.getContext():new Ep,Ge=(T&&T.preventScrollReset)===!0;if(Se&&jl(Se.formMethod)){await vn(j,v,re,xe,pe,X.active,R,Ge,Se,T&&T.defaultShouldRevalidate);return}he.set(j,{routeId:v,path:re}),await wn(j,v,re,xe,pe,X.active,R,Ge,Se)}async function vn(j,v,G,T,R,oe,ue,xe,X,re){As(),he.delete(j);let Se=L.fetchers.get(j);Al(j,Hm(X,Se),{flushSync:ue});let be=new AbortController,pe=ct(t.history,G,be.signal,X);if(oe){let Re=await gi(T,new URL(pe.url).pathname,pe.signal,j);if(Re.type==="aborted")return;if(Re.type==="error"){Sl(j,v,Re.error,{flushSync:ue});return}else if(Re.matches)T=Re.matches;else{Sl(j,v,Dl(404,{pathname:G}),{flushSync:ue});return}}let Ge=Ja(T,G);if(!Ge.route.action&&!Ge.route.lazy){let Re=Dl(405,{method:X.formMethod,pathname:G,routeId:v});Sl(j,v,Re,{flushSync:ue});return}Y.set(j,be);let Ae=K,el=dt(c,g,pe,G,T,Ge,r,R),Fe=await Bs(pe,G,el,R,j),Me=Fe[Ge.route.id];if(!Me){for(let Re of el)if(Fe[Re.route.id]){Me=Fe[Re.route.id];break}}if(pe.signal.aborted){Y.get(j)===be&&Y.delete(j);return}if(A.has(j)){if(Li(Me)||ql(Me)){Al(j,Ss(void 0));return}}else{if(Li(Me))if(Y.delete(j),x>Ae){Al(j,Ss(void 0));return}else return ge.add(j),Al(j,ln(X)),cs(pe,Me,!1,{fetcherSubmission:X,preventScrollReset:xe});if(ql(Me)){Sl(j,v,Me.error);return}}let Pe=L.navigation.location||L.location,pl=ct(t.history,Pe,be.signal),ys=f.activeRoutes,Yl=L.navigation.state!=="idle"?ns(ys,L.navigation.location,m,!1,f.branches):L.matches;Ce(Yl,"Didn't find any matches after fetcher action");let Xl=++K;M.set(j,Xl);let{dsMatches:ps,revalidatingFetchers:Gl}=Pp(pl,R,c,g,t.history,L,Yl,X,Pe,r,!1,me,F,A,he,ge,ys,m,t.patchRoutesOnNavigation!=null,f.branches,[Ge.route.id,Me],re),Ts=ln(X,Me.data),il=new Map(L.fetchers);il.set(j,Ts),Gl.filter(Re=>Re.key!==j).forEach(Re=>{let Es=Re.key,Hi=il.get(Es),kn=ln(void 0,Hi?Hi.data:void 0);il.set(Es,kn),Kl(Es),Re.controller&&Y.set(Es,Re.controller)}),Ze({fetchers:il});let Ai=()=>Gl.forEach(Re=>Kl(Re.key));be.signal.addEventListener("abort",Ai);let{loaderResults:dl,fetcherResults:Mi}=await Gi(ps,Gl,pl,Pe,R);if(be.signal.aborted)return;be.signal.removeEventListener("abort",Ai),M.delete(j),Y.delete(j),Gl.forEach(Re=>Y.delete(Re.key));let Je=L.fetchers.has(j),gl=Re=>{if(!Je)return Re;let Es=new Map(Re.fetchers);return Es.set(j,Ss(Me.data)),{...Re,fetchers:Es}},vl=Ca(dl);if(vl)return L=gl(L),cs(pl,vl.result,!1,{preventScrollReset:xe});if(vl=Ca(Mi),vl)return ge.add(vl.key),L=gl(L),cs(pl,vl.result,!1,{preventScrollReset:xe});let yl=new Map(L.fetchers);Je&&yl.set(j,Ss(Me.data));let{loaderData:Rs,errors:Os}=Hp(L,Yl,dl,void 0,Gl,Mi,yl);Ui(Xl,yl),L.navigation.state==="loading"&&Xl>x?(Ce(ye,"Expected pending action"),ke&&ke.abort(),rs(L.navigation.location,{matches:Yl,loaderData:Rs,errors:Os,fetchers:yl})):(Ze({errors:Os,loaderData:Tp(L.loaderData,Rs,Yl,Os),fetchers:yl}),me=!1)}async function wn(j,v,G,T,R,oe,ue,xe,X){let re=L.fetchers.get(j);Al(j,ln(X,re?re.data:void 0),{flushSync:ue});let Se=new AbortController,be=ct(t.history,G,Se.signal);if(oe){let Me=await gi(T,new URL(be.url).pathname,be.signal,j);if(Me.type==="aborted")return;if(Me.type==="error"){Sl(j,v,Me.error,{flushSync:ue});return}else if(Me.matches)T=Me.matches;else{Sl(j,v,Dl(404,{pathname:G}),{flushSync:ue});return}}let pe=Ja(T,G);Y.set(j,Se);let Ge=K,Ae=dt(c,g,be,G,T,pe,r,R),el=await Bs(be,G,Ae,R,j),Fe=el[pe.route.id];if(!Fe){for(let Me of T)if(el[Me.route.id]){Fe=el[Me.route.id];break}}if(Y.get(j)===Se&&Y.delete(j),!be.signal.aborted){if(A.has(j)){Al(j,Ss(void 0));return}if(Li(Fe))if(x>Ge){Al(j,Ss(void 0));return}else{ge.add(j),await cs(be,Fe,!1,{preventScrollReset:xe});return}if(ql(Fe)){Sl(j,v,Fe.error);return}Al(j,Ss(Fe.data))}}async function cs(j,v,G,{submission:T,fetcherSubmission:R,preventScrollReset:oe,replace:ue}={}){G||(ne==null||ne.resolve(),ne=null),v.response.headers.has("X-Remix-Revalidate")&&(me=!0);let xe=v.response.headers.get("Location");Ce(xe,"Expected a Location header on the redirect Response"),xe=Ap(xe,new URL(j.url),m,t.history);let X=cn(L.location,xe,{_isRedirect:!0});if(o){let Ae=!1;if(v.response.headers.has("X-Remix-Reload-Document"))Ae=!0;else if(qu(xe)){const el=cd(a,xe,!0);Ae=el.origin!==a.location.origin||$l(el.pathname,m)==null}if(Ae){ue?a.location.replace(xe):a.location.assign(xe);return}}ke=null;let re=ue===!0||v.response.headers.has("X-Remix-Replace")?"REPLACE":"PUSH",{formMethod:Se,formAction:be,formEncType:pe}=L.navigation;!T&&!R&&Se&&be&&pe&&(T=Np(L.navigation));let Ge=T||R;if(gm.has(v.response.status)&&Ge&&jl(Ge.formMethod))await Vl(re,X,{submission:{...Ge,formAction:xe},preventScrollReset:oe||Te,enableViewTransition:G?qe:void 0});else{let Ae=Eu(X,[],re,T);await Vl(re,X,{overrideNavigation:Ae,fetcherSubmission:R,preventScrollReset:oe||Te,enableViewTransition:G?qe:void 0})}}async function Bs(j,v,G,T,R){var xe;let oe,ue={};try{oe=await Em(_,j,v,G,R,T,!1)}catch(X){return G.filter(re=>re.shouldLoad).forEach(re=>{ue[re.route.id]={type:"error",error:X}}),ue}if(j.signal.aborted)return ue;if(!jl(j.method))for(let X of G){if(((xe=oe[X.route.id])==null?void 0:xe.type)==="error")break;!oe.hasOwnProperty(X.route.id)&&!L.loaderData.hasOwnProperty(X.route.id)&&(!L.errors||!L.errors.hasOwnProperty(X.route.id))&&X.shouldCallHandler()&&(oe[X.route.id]={type:"error",result:new Error(`No result returned from dataStrategy for route ${X.route.id}`)})}for(let[X,re]of Object.entries(oe))if(Um(re)){let Se=re.result;ue[X]={type:"redirect",response:Lm(Se,j,X,G,m)}}else ue[X]=await Cm(re);return ue}async function Gi(j,v,G,T,R){let oe=Bs(G,T,j,R,null),ue=Promise.all(v.map(async re=>{if(re.matches&&re.match&&re.request&&re.controller){let be=(await Bs(re.request,re.path,re.matches,R,re.key))[re.match.route.id];return{[re.key]:be}}else return Promise.resolve({[re.key]:{type:"error",error:Dl(404,{pathname:re.path})}})})),xe=await oe,X=(await ue).reduce((re,Se)=>Object.assign(re,Se),{});return{loaderResults:xe,fetcherResults:X}}function As(){me=!0,he.forEach((j,v)=>{Y.has(v)&&F.add(v),Kl(v)})}function Al(j,v,G={}){let T=new Map(L.fetchers);T.set(j,v),Ze({fetchers:T},{flushSync:(G&&G.flushSync)===!0})}function Sl(j,v,G,T={}){let R=ri(L.matches,v),oe=new Map(L.fetchers);Pi(oe,j),Ze({errors:{[R.route.id]:G},fetchers:oe},{flushSync:(T&&T.flushSync)===!0})}function di(j){return k.set(j,(k.get(j)||0)+1),A.has(j)&&A.delete(j),L.fetchers.get(j)||fm}function Ta(j,v){Kl(j,v==null?void 0:v.reason),Al(j,Ss(null))}function Pi(j,v){let G=L.fetchers.get(v);Y.has(v)&&!(G&&G.state==="loading"&&M.has(v))&&Kl(v),he.delete(v),M.delete(v),ge.delete(v),A.delete(v),F.delete(v),j.delete(v)}function xn(j){let v=(k.get(j)||0)-1;v<=0?(k.delete(j),A.add(j)):k.set(j,v),Ze({fetchers:new Map(L.fetchers)})}function Kl(j,v){let G=Y.get(j);G&&(G.abort(v),Y.delete(j))}function Ji(j,v){for(let G of j){let T=v.get(G);Ce(T,`Expected fetcher: ${G}`);let R=Ss(T.data);v.set(G,R)}}function zi(j){let v=[],G=!1;for(let T of ge){let R=j.get(T);Ce(R,`Expected fetcher: ${T}`),R.state==="loading"&&(ge.delete(T),v.push(T),G=!0)}return Ji(v,j),G}function Ui(j,v){let G=[];for(let[T,R]of M)if(R<j){let oe=v.get(T);Ce(oe,`Expected fetcher: ${T}`),oe.state==="loading"&&(Kl(T),M.delete(T),G.push(T))}return Ji(G,v),G.length>0}function _t(j,v){let G=L.blockers.get(j)||en;return $.get(j)!==v&&$.set(j,v),G}function qi(j){L.blockers.delete(j),$.delete(j)}function Ql(j,v){let G=L.blockers.get(j)||en;Ce(G.state==="unblocked"&&v.state==="blocked"||G.state==="blocked"&&v.state==="blocked"||G.state==="blocked"&&v.state==="proceeding"||G.state==="blocked"&&v.state==="unblocked"||G.state==="proceeding"&&v.state==="unblocked",`Invalid blocker state transition: ${G.state} -> ${v.state}`);let T=new Map(L.blockers);T.set(j,v),Ze({blockers:T})}function xs({currentLocation:j,nextLocation:v,historyAction:G}){if($.size===0)return;$.size>1&&Xe(!1,"A router only supports one blocker at a time");let T=Array.from($.entries()),[R,oe]=T[T.length-1],ue=L.blockers.get(R);if(!(ue&&ue.state==="proceeding")&&oe({currentLocation:j,nextLocation:v,historyAction:G}))return R}function Bi(j){let v=Dl(404,{pathname:j}),G=f.activeRoutes,{matches:T,route:R}=ba(G);return{notFoundMatches:T,route:R,error:v}}function yn(j,v,G){if(H=j,B=v,q=G||null,!Q&&L.navigation===yu){Q=!0;let T=St(L.location,L.matches);T!=null&&Ze({restoreScrollPosition:T})}return()=>{H=null,B=null,q=null}}function jt(j,v){return q&&q(j,v.map(T=>Tf(T,L.loaderData)))||j.key}function En(j,v){if(H&&B){let G=jt(j,v);H[G]=B()}}function St(j,v){if(H){let G=jt(j,v),T=H[G];if(typeof T=="number")return T}return null}function Ms(j,v,G){if(t.patchRoutesOnNavigation){let T=f.branches;if(j){if(Object.keys(j[0].params).length>0)return{active:!0,matches:ns(v,G,m,!0,T)}}else return{active:!0,matches:ns(v,G,m,!0,T)||[]}}return{active:!1,matches:null}}async function gi(j,v,G,T){if(!t.patchRoutesOnNavigation)return{type:"success",matches:j};let R=j;for(;;){let oe=g;try{await t.patchRoutesOnNavigation({signal:G,path:v,matches:R,fetcherKey:T,patch:(re,Se)=>{G.aborted||Jp(re,Se,f,oe,c,!1)}})}catch(re){return{type:"error",error:re,partialMatches:R}}if(G.aborted)return{type:"aborted"};let ue=f.branches,xe=ns(f.activeRoutes,v,m,!1,ue),X=null;if(xe){if(Object.keys(xe[0].params).length===0)return{type:"success",matches:xe};if(X=ns(f.activeRoutes,v,m,!0,ue),!(X&&R.length<X.length&&Hs(R,X.slice(0,R.length))))return{type:"success",matches:xe}}if(X||(X=ns(f.activeRoutes,v,m,!0,ue)),!X||Hs(R,X))return{type:"success",matches:null};R=X}}function Hs(j,v){return j.length===v.length&&j.every((G,T)=>G.route.id===v[T].route.id)}function vt(j){g={},f.setHmrRoutes(pn(j,c,void 0,g))}function fi(j,v,G=!1){Jp(j,v,f,g,c,G),f.hasHMRRoutes||Ze({})}return Ee={get basename(){return m},get future(){return E},get state(){return L},get routes(){return f.stableRoutes},get branches(){return f.branches},get manifest(){return g},get window(){return a},initialize:$e,subscribe:zs,enableScrollRestoration:yn,navigate:ft,fetch:ht,revalidate:jn,createHref:j=>t.history.createHref(j),encodeLocation:j=>t.history.encodeLocation(j),getFetcher:di,resetFetcher:Ta,deleteFetcher:xn,dispose:ws,getBlocker:_t,deleteBlocker:qi,patchRoutes:fi,_internalFetchControllers:Y,_internalSetRoutes:vt,_internalSetStateDoNotUseOrYouWillBreakYourApp(j){Ze(j)}},t.instrumentations&&(Ee=nm(Ee,t.instrumentations.map(j=>j.router).filter(Boolean))),Ee}function jm(t){return t!=null&&("formData"in t&&t.formData!=null||"body"in t&&t.body!==void 0)}function Pu(t,a,o,r,p,c){let g,f;if(p){g=[];for(let _ of a)if(g.push(_),_.route.id===p){f=_;break}}else g=a,f=a[a.length-1];let m=gn(r||".",Aa(g),$l(t.pathname,o)||t.pathname,c==="path");if(r==null&&(m.search=t.search,m.hash=t.hash),(r==null||r===""||r===".")&&f){let _=Hu(m.search);if(f.route.index&&!_)m.search=m.search?m.search.replace(/^\?/,"?index&"):"?index";else if(!f.route.index&&_){let E=new URLSearchParams(m.search),w=E.getAll("index");E.delete("index"),w.filter(z=>z).forEach(z=>E.append("index",z));let J=E.toString();m.search=J?`?${J}`:""}}return o!=="/"&&(m.pathname=Zf({basename:o,pathname:m.pathname})),vs(m)}function Gp(t,a,o){if(!o||!jm(o))return{path:a};if(o.formMethod&&!Am(o.formMethod))return{path:a,error:Dl(405,{method:o.formMethod})};let r=()=>({path:a,error:Dl(400,{type:"invalid-body"})}),c=(o.formMethod||"get").toUpperCase(),g=Gd(a);if(o.body!==void 0){if(o.formEncType==="text/plain"){if(!jl(c))return r();let w=typeof o.body=="string"?o.body:o.body instanceof FormData||o.body instanceof URLSearchParams?Array.from(o.body.entries()).reduce((J,[z,H])=>`${J}${z}=${H}
`,""):String(o.body);return{path:a,submission:{formMethod:c,formAction:g,formEncType:o.formEncType,formData:void 0,json:void 0,text:w}}}else if(o.formEncType==="application/json"){if(!jl(c))return r();try{let w=typeof o.body=="string"?JSON.parse(o.body):o.body;return{path:a,submission:{formMethod:c,formAction:g,formEncType:o.formEncType,formData:void 0,json:w,text:void 0}}}catch{return r()}}}Ce(typeof FormData=="function","FormData is not available in this environment");let f,m;if(o.formData)f=zu(o.formData),m=o.formData;else if(o.body instanceof FormData)f=zu(o.body),m=o.body;else if(o.body instanceof URLSearchParams)f=o.body,m=Mp(f);else if(o.body==null)f=new URLSearchParams,m=new FormData;else try{f=new URLSearchParams(o.body),m=Mp(f)}catch{return r()}let _={formMethod:c,formAction:g,formEncType:o&&o.formEncType||"application/x-www-form-urlencoded",formData:m,json:void 0,text:void 0};if(jl(_.formMethod))return{path:a,submission:_};let E=as(a);return t&&E.search&&Hu(E.search)&&f.append("index",""),E.search=`?${f}`,{path:vs(E),submission:_}}function Pp(t,a,o,r,p,c,g,f,m,_,E,w,J,z,H,q,B,Q,V,ie,de,ce){var Ne;let ve=de?ql(de[1])?de[1].error:de[1].data:void 0,Ee=p.createURL(c.location),L=p.createURL(m),ye;if(E&&c.errors){let me=Object.keys(c.errors)[0];ye=g.findIndex(F=>F.route.id===me)}else if(de&&ql(de[1])){let me=de[0];ye=g.findIndex(F=>F.route.id===me)-1}let ne=de?de[1].statusCode:void 0,Te=ne&&ne>=400,ke={currentUrl:Ee,currentParams:((Ne=c.matches[0])==null?void 0:Ne.params)||{},nextUrl:L,nextParams:g[0].params,...f,actionResult:ve,actionStatus:ne},qe=mn(g),Le=g.map((me,F)=>{let{route:Y}=me,K=null;if(ye!=null&&F>ye)K=!1;else if(Y.lazy)K=!0;else if(!Au(Y))K=!1;else if(E){let{shouldLoad:he}=yd(Y,c.loaderData,c.errors);K=he}else Sm(c.loaderData,c.matches[F],me)&&(K=!0);if(K!==null)return Ju(o,r,t,m,qe,me,_,a,K);let x=!1;typeof ce=="boolean"?x=ce:Te?x=!1:(w||Ee.pathname+Ee.search===L.pathname+L.search||Ee.search!==L.search||vm(c.matches[F],me))&&(x=!0);let M={...ke,defaultShouldRevalidate:x},ge=rn(me,M);return Ju(o,r,t,m,qe,me,_,a,ge,M,ce)}),ze=[];return H.forEach((me,F)=>{if(E||!g.some(A=>A.route.id===me.routeId)||z.has(F))return;let Y=c.fetchers.get(F),K=Y&&Y.state!=="idle"&&Y.data===void 0,x=ns(B,me.path,Q??"/",!1,ie);if(!x){if(V&&K)return;ze.push({key:F,routeId:me.routeId,path:me.path,matches:null,match:null,request:null,controller:null});return}if(q.has(F))return;let M=Ja(x,me.path),ge=new AbortController,he=ct(p,me.path,ge.signal),k=null;if(J.has(F))J.delete(F),k=dt(o,r,he,me.path,x,M,_,a);else if(K)w&&(k=dt(o,r,he,me.path,x,M,_,a));else{let A;typeof ce=="boolean"?A=ce:Te?A=!1:A=w;let $={...ke,defaultShouldRevalidate:A};rn(M,$)&&(k=dt(o,r,he,me.path,x,M,_,a,$))}k&&ze.push({key:F,routeId:me.routeId,path:me.path,matches:k,match:M,request:he,controller:ge})}),{dsMatches:Le,revalidatingFetchers:ze}}function Au(t){return t.loader!=null||t.middleware!=null&&t.middleware.length>0}function yd(t,a,o){if(t.lazy)return{shouldLoad:!0,renderFallback:!0};if(!Au(t))return{shouldLoad:!1,renderFallback:!1};let r=a!=null&&t.id in a,p=o!=null&&o[t.id]!==void 0;if(!r&&p)return{shouldLoad:!1,renderFallback:!1};if(typeof t.loader=="function"&&t.loader.hydrate===!0)return{shouldLoad:!0,renderFallback:!r};let c=!r&&!p;return{shouldLoad:c,renderFallback:c}}function Sm(t,a,o){let r=!a||o.route.id!==a.route.id,p=!t.hasOwnProperty(o.route.id);return r||p}function vm(t,a){let o=t.route.path;return t.pathname!==a.pathname||o!=null&&o.endsWith("*")&&t.params["*"]!==a.params["*"]}function rn(t,a){if(t.route.shouldRevalidate){let o=t.route.shouldRevalidate(a);if(typeof o=="boolean")return o}return a.defaultShouldRevalidate}function Jp(t,a,o,r,p,c){let g;if(t){let _=r[t];Ce(_,`No route found to patch children into: routeId = ${t}`),_.children||(_.children=[]),g=_.children}else g=o.activeRoutes;let f=[],m=[];if(a.forEach(_=>{let E=g.find(w=>Ed(_,w));E?m.push({existingRoute:E,newRoute:_}):f.push(_)}),f.length>0){let _=pn(f,p,[t||"_","patch",String((g==null?void 0:g.length)||"0")],r);g.push(..._)}if(c&&m.length>0)for(let _=0;_<m.length;_++){let{existingRoute:E,newRoute:w}=m[_],J=E,[z]=pn([w],p,[],{},!0);Object.assign(J,{element:z.element?z.element:J.element,errorElement:z.errorElement?z.errorElement:J.errorElement,hydrateFallbackElement:z.hydrateFallbackElement?z.hydrateFallbackElement:J.hydrateFallbackElement})}o.hasHMRRoutes||o.setRoutes([...o.activeRoutes])}function Ed(t,a){var o;return"id"in t&&"id"in a&&t.id===a.id?!0:t.index===a.index&&t.path===a.path&&t.caseSensitive===a.caseSensitive?(!t.children||t.children.length===0)&&(!a.children||a.children.length===0)?!0:((o=t.children)==null?void 0:o.every((r,p)=>{var c;return(c=a.children)==null?void 0:c.some(g=>Ed(r,g))}))??!1:!1}var zp=new WeakMap,kd=({key:t,route:a,manifest:o,mapRouteProperties:r})=>{let p=o[a.id];if(Ce(p,"No route found in manifest"),!p.lazy||typeof p.lazy!="object")return;let c=p.lazy[t];if(!c)return;let g=zp.get(p);g||(g={},zp.set(p,g));let f=g[t];if(f)return f;let m=(async()=>{let _=Bf(t),w=p[t]!==void 0&&t!=="hasErrorBoundary";if(_)Xe(!_,"Route property "+t+" is not a supported lazy route property. This property will be ignored."),g[t]=Promise.resolve();else if(w)Xe(!1,`Route "${p.id}" has a static property "${t}" defined. The lazy property will be ignored.`);else{let J=await c();J!=null&&(Object.assign(p,{[t]:J}),Object.assign(p,r(p)))}typeof p.lazy=="object"&&(p.lazy[t]=void 0,Object.values(p.lazy).every(J=>J===void 0)&&(p.lazy=void 0))})();return g[t]=m,m},Up=new WeakMap;function wm(t,a,o,r,p){let c=o[t.id];if(Ce(c,"No route found in manifest"),!t.lazy)return{lazyRoutePromise:void 0,lazyHandlerPromise:void 0};if(typeof t.lazy=="function"){let E=Up.get(c);if(E)return{lazyRoutePromise:E,lazyHandlerPromise:E};let w=(async()=>{Ce(typeof t.lazy=="function","No lazy route function found");let J=await t.lazy(),z={};for(let H in J){let q=J[H];if(q===void 0)continue;let B=Mf(H),V=c[H]!==void 0&&H!=="hasErrorBoundary";B?Xe(!B,"Route property "+H+" is not a supported property to be returned from a lazy route function. This property will be ignored."):V?Xe(!V,`Route "${c.id}" has a static property "${H}" defined but its lazy function is also returning a value for this property. The lazy route property "${H}" will be ignored.`):z[H]=q}Object.assign(c,z),Object.assign(c,{...r(c),lazy:void 0})})();return Up.set(c,w),w.catch(()=>{}),{lazyRoutePromise:w,lazyHandlerPromise:w}}let g=Object.keys(t.lazy),f=[],m;for(let E of g){if(p&&p.includes(E))continue;let w=kd({key:E,route:t,manifest:o,mapRouteProperties:r});w&&(f.push(w),E===a&&(m=w))}let _=f.length>0?Promise.all(f).then(()=>{}):void 0;return _==null||_.catch(()=>{}),m==null||m.catch(()=>{}),{lazyRoutePromise:_,lazyHandlerPromise:m}}async function qp(t){let a=t.matches.filter(p=>p.shouldLoad),o={};return(await Promise.all(a.map(p=>p.resolve()))).forEach((p,c)=>{o[a[c].route.id]=p}),o}async function xm(t){return t.matches.some(a=>a.route.middleware)?bd(t,()=>qp(t)):qp(t)}function bd(t,a){return ym(t,a,r=>{if(Bm(r))throw r;return r},Jm,o);function o(r,p,c){if(c)return Promise.resolve(Object.assign(c.value,{[p]:{type:"error",result:r}}));{let{matches:g}=t,f=Math.min(Math.max(g.findIndex(_=>_.route.id===p),0),Math.max(g.findIndex(_=>_.shouldCallHandler()),0)),m=ri(g,g[f].route.id).route.id;return Promise.resolve({[m]:{type:"error",result:r}})}}}async function ym(t,a,o,r,p){let{matches:c,...g}=t,f=c.flatMap(_=>_.route.middleware?_.route.middleware.map(E=>[_.route.id,E]):[]);return await Cd(g,f,a,o,r,p)}async function Cd(t,a,o,r,p,c,g=0){let{request:f}=t;if(f.signal.aborted)throw f.signal.reason??new Error(`Request aborted: ${f.method} ${f.url}`);let m=a[g];if(!m)return await o();let[_,E]=m,w,J=async()=>{if(w)throw new Error("You may only call `next()` once per middleware");try{return w={value:await Cd(t,a,o,r,p,c,g+1)},w.value}catch(z){return w={value:await c(z,_,w)},w.value}};try{let z=await E(t,J),H=z!=null?r(z):void 0;return p(H)?H:w?H??w.value:(w={value:await J()},w.value)}catch(z){return await c(z,_,w)}}function Ld(t,a,o,r,p){let c=kd({key:"middleware",route:r.route,manifest:a,mapRouteProperties:t}),g=wm(r.route,jl(o.method)?"action":"loader",a,t,p);return{middleware:c,route:g.lazyRoutePromise,handler:g.lazyHandlerPromise}}function Ju(t,a,o,r,p,c,g,f,m,_=null,E){let w=!1,J=Ld(t,a,o,c,g);return{...c,_lazyPromises:J,shouldLoad:m,shouldRevalidateArgs:_,shouldCallHandler(z){return w=!0,_?typeof E=="boolean"?rn(c,{..._,defaultShouldRevalidate:E}):typeof z=="boolean"?rn(c,{..._,defaultShouldRevalidate:z}):rn(c,_):m},resolve(z){let{lazy:H,loader:q,middleware:B}=c.route,Q=w||m||z&&!jl(o.method)&&(H||q),V=B&&B.length>0&&!q&&!H;return Q&&(jl(o.method)||!V)?km({request:o,path:r,pattern:p,match:c,lazyHandlerPromise:J==null?void 0:J.handler,lazyRoutePromise:J==null?void 0:J.route,handlerOverride:z,scopedContext:f}):Promise.resolve({type:"data",result:void 0})}}}function dt(t,a,o,r,p,c,g,f,m=null){return p.map(_=>_.route.id!==c.route.id?{..._,shouldLoad:!1,shouldRevalidateArgs:m,shouldCallHandler:()=>!1,_lazyPromises:Ld(t,a,o,_,g),resolve:()=>Promise.resolve({type:"data",result:void 0})}:Ju(t,a,o,r,mn(p),_,g,f,!0,m))}async function Em(t,a,o,r,p,c,g){r.some(E=>{var w;return(w=E._lazyPromises)==null?void 0:w.middleware})&&await Promise.all(r.map(E=>{var w;return(w=E._lazyPromises)==null?void 0:w.middleware}));let f={request:a,url:Id(a,o),pattern:mn(r),params:r[0].params,context:c,matches:r},_=await t({...f,fetcherKey:p,runClientMiddleware:E=>{let w=f;return bd(w,()=>E({...w,fetcherKey:p,runClientMiddleware:()=>{throw new Error("Cannot call `runClientMiddleware()` from within an `runClientMiddleware` handler")}}))}});try{await Promise.all(r.flatMap(E=>{var w,J;return[(w=E._lazyPromises)==null?void 0:w.handler,(J=E._lazyPromises)==null?void 0:J.route]}))}catch{}return _}async function km({request:t,path:a,pattern:o,match:r,lazyHandlerPromise:p,lazyRoutePromise:c,handlerOverride:g,scopedContext:f}){let m,_,E=jl(t.method),w=E?"action":"loader",J=z=>{let H,q=new Promise((V,ie)=>H=ie);_=()=>H(),t.signal.addEventListener("abort",_);let B=V=>typeof z!="function"?Promise.reject(new Error(`You cannot call the handler for a route which defines a boolean "${w}" [routeId: ${r.route.id}]`)):z({request:t,url:Id(t,a),pattern:o,params:r.params,context:f},...V!==void 0?[V]:[]),Q=(async()=>{try{return{type:"data",result:await(g?g(ie=>B(ie)):B())}}catch(V){return{type:"error",result:V}}})();return Promise.race([Q,q])};try{let z=E?r.route.action:r.route.loader;if(p||c)if(z){let H,[q]=await Promise.all([J(z).catch(B=>{H=B}),p,c]);if(H!==void 0)throw H;m=q}else{await p;let H=E?r.route.action:r.route.loader;if(H)[m]=await Promise.all([J(H),c]);else if(w==="action"){let q=new URL(t.url),B=q.pathname+q.search;throw Dl(405,{method:t.method,pathname:B,routeId:r.route.id})}else return{type:"data",result:void 0}}else if(z)m=await J(z);else{let H=new URL(t.url),q=H.pathname+H.search;throw Dl(404,{pathname:q})}}catch(z){return{type:"error",result:z}}finally{_&&t.signal.removeEventListener("abort",_)}return m}async function bm(t){let a=t.headers.get("Content-Type");return a&&/\bapplication\/json\b/.test(a)?t.body==null?null:t.json():t.text()}async function Cm(t){var r,p,c,g,f;let{result:a,type:o}=t;if(Mu(a)){let m;try{m=await bm(a)}catch(_){return{type:"error",error:_}}return o==="error"?{type:"error",error:new fn(a.status,a.statusText,m),statusCode:a.status,headers:a.headers}:{type:"data",data:m,statusCode:a.status,headers:a.headers}}return o==="error"?Op(a)?a.data instanceof Error?{type:"error",error:a.data,statusCode:(r=a.init)==null?void 0:r.status,headers:(p=a.init)!=null&&p.headers?new Headers(a.init.headers):void 0}:{type:"error",error:Pm(a),statusCode:dn(a)?a.status:void 0,headers:(c=a.init)!=null&&c.headers?new Headers(a.init.headers):void 0}:{type:"error",error:a,statusCode:dn(a)?a.status:void 0}:Op(a)?{type:"data",data:a.data,statusCode:(g=a.init)==null?void 0:g.status,headers:(f=a.init)!=null&&f.headers?new Headers(a.init.headers):void 0}:{type:"data",data:a}}function Lm(t,a,o,r,p){let c=t.headers.get("Location");if(Ce(c,"Redirects returned/thrown from loaders/actions must have a Location header"),!qu(c)){let g=r.slice(0,r.findIndex(f=>f.route.id===o)+1);c=Pu(new URL(a.url),g,p,c),t.headers.set("Location",c)}return t}var Bp=["about:","blob:","chrome:","chrome-untrusted:","content:","data:","devtools:","file:","filesystem:","javascript:"];function Ap(t,a,o,r){if(qu(t)){let p=t,c=p.startsWith("//")?new URL(a.protocol+p):new URL(p);if(Bp.includes(c.protocol))throw new Error("Invalid redirect location");let g=$l(c.pathname,o)!=null;if(c.origin===a.origin&&g)return Bu(c.pathname)+c.search+c.hash}try{let p=r.createURL(t);if(Bp.includes(p.protocol))throw new Error("Invalid redirect location")}catch{}return t}function ct(t,a,o,r){let p=t.createURL(Gd(a)).toString(),c={signal:o};if(r&&jl(r.formMethod)){let{formMethod:g,formEncType:f}=r;c.method=g.toUpperCase(),f==="application/json"?(c.headers=new Headers({"Content-Type":f}),c.body=JSON.stringify(r.json)):f==="text/plain"?c.body=r.text:f==="application/x-www-form-urlencoded"&&r.formData?c.body=zu(r.formData):c.body=r.formData}return new Request(p,c)}function Id(t,a){let o=new URL(t.url),r=typeof a=="string"?as(a):a;if(o.pathname=r.pathname||"/",r.search){let p=new URLSearchParams(r.search),c=p.getAll("index");p.delete("index");for(let g of c.filter(Boolean))p.append("index",g);o.search=p.size?`?${p.toString()}`:""}else o.search="";return o.hash=r.hash||"",o}function zu(t){let a=new URLSearchParams;for(let[o,r]of t.entries())a.append(o,typeof r=="string"?r:r.name);return a}function Mp(t){let a=new FormData;for(let[o,r]of t.entries())a.append(o,r);return a}function Im(t,a,o,r=!1,p=!1){let c={},g=null,f,m=!1,_={},E=o&&ql(o[1])?o[1].error:void 0;return t.forEach(w=>{if(!(w.route.id in a))return;let J=w.route.id,z=a[J];if(Ce(!Li(z),"Cannot handle redirect results in processLoaderData"),ql(z)){let H=z.error;if(E!==void 0&&(H=E,E=void 0),g=g||{},p)g[J]=H;else{let q=ri(t,J);g[q.route.id]==null&&(g[q.route.id]=H)}r||(c[J]=xd),m||(m=!0,f=dn(z.error)?z.error.status:500),z.headers&&(_[J]=z.headers)}else c[J]=z.data,z.statusCode&&z.statusCode!==200&&!m&&(f=z.statusCode),z.headers&&(_[J]=z.headers)}),E!==void 0&&o&&(g={[o[0]]:E},o[2]&&(c[o[2]]=void 0)),{loaderData:c,errors:g,statusCode:f||200,loaderHeaders:_}}function Hp(t,a,o,r,p,c,g){let{loaderData:f,errors:m}=Im(a,o,r);return p.filter(_=>!_.matches||_.matches.some(E=>E.shouldLoad)).forEach(_=>{let{key:E,match:w,controller:J}=_;if(J&&J.signal.aborted)return;let z=c[E];if(Ce(z,"Did not find corresponding fetcher result"),ql(z)){let H=ri(t.matches,w==null?void 0:w.route.id);m&&m[H.route.id]||(m={...m,[H.route.id]:z.error}),g.delete(E)}else if(Li(z))Ce(!1,"Unhandled fetcher revalidation redirect");else{let H=Ss(z.data);g.set(E,H)}}),{loaderData:f,errors:m}}function Tp(t,a,o,r){let p=Object.entries(a).filter(([,c])=>c!==xd).reduce((c,[g,f])=>(c[g]=f,c),{});for(let c of o){let g=c.route.id;if(!a.hasOwnProperty(g)&&t.hasOwnProperty(g)&&c.route.loader&&(p[g]=t[g]),r&&r.hasOwnProperty(g))break}return p}function Rp(t){return t?ql(t[1])?{actionData:{}}:{actionData:{[t[0]]:t[1].data}}:{}}function ri(t,a){return(a?t.slice(0,t.findIndex(r=>r.route.id===a)+1):[...t]).reverse().find(r=>r.route.hasErrorBoundary===!0)||t[0]}function ba(t){let a=t.length===1?t[0]:t.find(o=>o.index||!o.path||o.path==="/")||{id:"__shim-error-route__"};return{matches:[{params:{},pathname:"",pathnameBase:"",route:a}],route:a}}function Dl(t,{pathname:a,routeId:o,method:r,type:p,message:c}={}){let g="Unknown Server Error",f="Unknown @remix-run/router error";return t===400?(g="Bad Request",r&&a&&o?f=`You made a ${r} request to "${a}" but did not provide a \`loader\` for route "${o}", so there is no way to handle the request.`:p==="invalid-body"&&(f="Unable to encode submission body")):t===403?(g="Forbidden",f=`Route "${o}" does not match URL "${a}"`):t===404?(g="Not Found",f=`No route matches URL "${a}"`):t===405&&(g="Method Not Allowed",r&&a&&o?f=`You made a ${r.toUpperCase()} request to "${a}" but did not provide an \`action\` for route "${o}", so there is no way to handle the request.`:r&&(f=`Invalid request method "${r.toUpperCase()}"`)),new fn(t||500,g,new Error(f),!0)}function Ca(t){let a=Object.entries(t);for(let o=a.length-1;o>=0;o--){let[r,p]=a[o];if(Li(p))return{key:r,result:p}}}function Gd(t){let a=typeof t=="string"?as(t):t;return vs({...a,hash:""})}function Gm(t,a){return t.pathname!==a.pathname||t.search!==a.search?!1:t.hash===""?a.hash!=="":t.hash===a.hash?!0:a.hash!==""}function Pm(t){var a,o;return new fn(((a=t.init)==null?void 0:a.status)??500,((o=t.init)==null?void 0:o.statusText)??"Internal Server Error",t.data)}function Jm(t){return t!=null&&typeof t=="object"&&Object.entries(t).every(([a,o])=>typeof a=="string"&&zm(o))}function zm(t){return t!=null&&typeof t=="object"&&"type"in t&&"result"in t&&(t.type==="data"||t.type==="error")}function Um(t){return Mu(t.result)&&vd.has(t.result.status)}function ql(t){return t.type==="error"}function Li(t){return(t&&t.type)==="redirect"}function Op(t){return typeof t=="object"&&t!=null&&"type"in t&&"data"in t&&"init"in t&&t.type==="DataWithResponseInit"}function Mu(t){return t!=null&&typeof t.status=="number"&&typeof t.statusText=="string"&&typeof t.headers=="object"&&typeof t.body<"u"}function qm(t){return vd.has(t)}function Bm(t){return Mu(t)&&qm(t.status)&&t.headers.has("Location")}function Am(t){return dm.has(t.toUpperCase())}function jl(t){return cm.has(t.toUpperCase())}function Hu(t){return new URLSearchParams(t).getAll("index").some(a=>a==="")}function Ja(t,a){let o=typeof a=="string"?as(a).search:a.search;if(t[t.length-1].route.index&&Hu(o||""))return t[t.length-1];let r=md(t);return r[r.length-1]}function Np(t){let{formMethod:a,formAction:o,formEncType:r,text:p,formData:c,json:g}=t;if(!(!a||!o||!r)){if(p!=null)return{formMethod:a,formAction:o,formEncType:r,formData:void 0,json:void 0,text:p};if(c!=null)return{formMethod:a,formAction:o,formEncType:r,formData:c,json:void 0,text:void 0};if(g!==void 0)return{formMethod:a,formAction:o,formEncType:r,formData:void 0,json:g,text:void 0}}}function Eu(t,a,o,r){return r?{state:"loading",location:t,matches:a,historyAction:o,formMethod:r.formMethod,formAction:r.formAction,formEncType:r.formEncType,formData:r.formData,json:r.json,text:r.text}:{state:"loading",location:t,matches:a,historyAction:o,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0}}function Mm(t,a,o,r){return{state:"submitting",location:t,matches:a,historyAction:o,formMethod:r.formMethod,formAction:r.formAction,formEncType:r.formEncType,formData:r.formData,json:r.json,text:r.text}}function ln(t,a){return t?{state:"loading",formMethod:t.formMethod,formAction:t.formAction,formEncType:t.formEncType,formData:t.formData,json:t.json,text:t.text,data:a}:{state:"loading",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0,data:a}}function Hm(t,a){return{state:"submitting",formMethod:t.formMethod,formAction:t.formAction,formEncType:t.formEncType,formData:t.formData,json:t.json,text:t.text,data:a?a.data:void 0}}function Ss(t){return{state:"idle",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0,data:t}}function Tm(t,a){try{let o=t.sessionStorage.getItem(wd);if(o){let r=JSON.parse(o);for(let[p,c]of Object.entries(r||{}))c&&Array.isArray(c)&&a.set(p,new Set(c||[]))}}catch{}}function Rm(t,a){if(a.size>0){let o={};for(let[r,p]of a)o[r]=[...p];try{t.sessionStorage.setItem(wd,JSON.stringify(o))}catch(r){Xe(!1,`Failed to save applied view transitions in sessionStorage (${r}).`)}}}function Fp(){let t,a,o=new Promise((r,p)=>{t=async c=>{r(c);try{await o}catch{}},a=async c=>{p(c);try{await o}catch{}}});return{promise:o,resolve:t,reject:a}}var Ii=C.createContext(null);Ii.displayName="DataRouter";var hn=C.createContext(null);hn.displayName="DataRouterState";var Pd=C.createContext(!1);function Jd(){return C.useContext(Pd)}var Tu=C.createContext({isTransitioning:!1});Tu.displayName="ViewTransition";var zd=C.createContext(new Map);zd.displayName="Fetchers";var Om=C.createContext(null);Om.displayName="Await";var Bl=C.createContext(null);Bl.displayName="Navigation";var Ma=C.createContext(null);Ma.displayName="Location";var os=C.createContext({outlet:null,matches:[],isDataRoute:!1});os.displayName="Route";var Ru=C.createContext(null);Ru.displayName="RouteError";var Ud="REACT_ROUTER_ERROR",Nm="REDIRECT",Fm="ROUTE_ERROR_RESPONSE";function Dm(t){if(t.startsWith(`${Ud}:${Nm}:{`))try{let a=JSON.parse(t.slice(28));if(typeof a=="object"&&a&&typeof a.status=="number"&&typeof a.statusText=="string"&&typeof a.location=="string"&&typeof a.reloadDocument=="boolean"&&typeof a.replace=="boolean")return a}catch{}}function Wm(t){if(t.startsWith(`${Ud}:${Fm}:{`))try{let a=JSON.parse(t.slice(40));if(typeof a=="object"&&a&&typeof a.status=="number"&&typeof a.statusText=="string")return new fn(a.status,a.statusText,a.data)}catch{}}function $m(t,{relative:a}={}){Ce(gt(),"useHref() may be used only in the context of a <Router> component.");let{basename:o,navigator:r}=C.useContext(Bl),{hash:p,pathname:c,search:g}=_n(t,{relative:a}),f=c;return o!=="/"&&(f=c==="/"?o:Wl([o,c])),r.createHref({pathname:f,search:g,hash:p})}function gt(){return C.useContext(Ma)!=null}function us(){return Ce(gt(),"useLocation() may be used only in the context of a <Router> component."),C.useContext(Ma).location}var qd="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Bd(t){C.useContext(Bl).static||C.useLayoutEffect(t)}function Ou(){let{isDataRoute:t}=C.useContext(os);return t?oh():Vm()}function Vm(){Ce(gt(),"useNavigate() may be used only in the context of a <Router> component.");let t=C.useContext(Ii),{basename:a,navigator:o}=C.useContext(Bl),{matches:r}=C.useContext(os),{pathname:p}=us(),c=JSON.stringify(Aa(r)),g=C.useRef(!1);return Bd(()=>{g.current=!0}),C.useCallback((m,_={})=>{if(Xe(g.current,qd),!g.current)return;if(typeof m=="number"){o.go(m);return}let E=gn(m,JSON.parse(c),p,_.relative==="path");t==null&&a!=="/"&&(E.pathname=E.pathname==="/"?a:Wl([a,E.pathname])),(_.replace?o.replace:o.push)(E,_.state,_)},[a,o,c,p,t])}C.createContext(null);function Km(){let{matches:t}=C.useContext(os),a=t[t.length-1];return(a==null?void 0:a.params)??{}}function _n(t,{relative:a}={}){let{matches:o}=C.useContext(os),{pathname:r}=us(),p=JSON.stringify(Aa(o));return C.useMemo(()=>gn(t,JSON.parse(p),r,a==="path"),[t,p,r,a])}function Qm(t,a,o){Ce(gt(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:r}=C.useContext(Bl),{matches:p}=C.useContext(os),c=p[p.length-1],g=c?c.params:{},f=c?c.pathname:"/",m=c?c.pathnameBase:"/",_=c&&c.route;{let B=_&&_.path||"";Md(f,!_||B.endsWith("*")||B.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${f}" (under <Route path="${B}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${B}"> to <Route path="${B==="/"?"*":`${B}/*`}">.`)}let E=us(),w;w=E;let J=w.pathname||"/",z=J;if(m!=="/"){let B=m.replace(/^\//,"").split("/");z="/"+J.replace(/^\//,"").split("/").slice(B.length).join("/")}let H=o&&o.state.matches.length?o.state.matches.map(B=>Object.assign(B,{route:o.manifest[B.route.id]||B.route})):pd(t,{pathname:z});return Xe(_||H!=null,`No routes matched location "${w.pathname}${w.search}${w.hash}" `),Xe(H==null||H[H.length-1].route.element!==void 0||H[H.length-1].route.Component!==void 0||H[H.length-1].route.lazy!==void 0,`Matched leaf route at location "${w.pathname}${w.search}${w.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`),lh(H&&H.map(B=>Object.assign({},B,{params:Object.assign({},g,B.params),pathname:Wl([m,r.encodeLocation?r.encodeLocation(B.pathname.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:B.pathname]),pathnameBase:B.pathnameBase==="/"?m:Wl([m,r.encodeLocation?r.encodeLocation(B.pathnameBase.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:B.pathnameBase])})),p,o)}function Ym(){let t=ah(),a=dn(t)?`${t.status} ${t.statusText}`:t instanceof Error?t.message:JSON.stringify(t),o=t instanceof Error?t.stack:null,r="rgba(200,200,200, 0.5)",p={padding:"0.5rem",backgroundColor:r},c={padding:"2px 4px",backgroundColor:r},g=null;return console.error("Error handled by React Router default ErrorBoundary:",t),g=C.createElement(C.Fragment,null,C.createElement("p",null,"💿 Hey developer 👋"),C.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",C.createElement("code",{style:c},"ErrorBoundary")," or"," ",C.createElement("code",{style:c},"errorElement")," prop on your route.")),C.createElement(C.Fragment,null,C.createElement("h2",null,"Unexpected Application Error!"),C.createElement("h3",{style:{fontStyle:"italic"}},a),o?C.createElement("pre",{style:p},o):null,g)}var Xm=C.createElement(Ym,null),Ad=class extends C.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,a){return a.location!==t.location||a.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:a.error,location:a.location,revalidation:t.revalidation||a.revalidation}}componentDidCatch(t,a){this.props.onError?this.props.onError(t,a):console.error("React Router caught the following error during render",t)}render(){let t=this.state.error;if(this.context&&typeof t=="object"&&t&&"digest"in t&&typeof t.digest=="string"){const o=Wm(t.digest);o&&(t=o)}let a=t!==void 0?C.createElement(os.Provider,{value:this.props.routeContext},C.createElement(Ru.Provider,{value:t,children:this.props.component})):this.props.children;return this.context?C.createElement(Zm,{error:t},a):a}};Ad.contextType=Pd;var ku=new WeakMap;function Zm({children:t,error:a}){let{basename:o}=C.useContext(Bl);if(typeof a=="object"&&a&&"digest"in a&&typeof a.digest=="string"){let r=Dm(a.digest);if(r){let p=ku.get(a);if(p)throw p;let c=_d(r.location,o);if(hd&&!ku.get(a))if(c.isExternal||r.reloadDocument)window.location.href=c.absoluteURL||c.to;else{const g=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(c.to,{replace:r.replace}));throw ku.set(a,g),g}return C.createElement("meta",{httpEquiv:"refresh",content:`0;url=${c.absoluteURL||c.to}`})}}return t}function eh({routeContext:t,match:a,children:o}){let r=C.useContext(Ii);return r&&r.static&&r.staticContext&&(a.route.errorElement||a.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=a.route.id),C.createElement(os.Provider,{value:t},o)}function lh(t,a=[],o){let r=o==null?void 0:o.state;if(t==null){if(!r)return null;if(r.errors)t=r.matches;else if(a.length===0&&!r.initialized&&r.matches.length>0)t=r.matches;else return null}let p=t,c=r==null?void 0:r.errors;if(c!=null){let E=p.findIndex(w=>w.route.id&&(c==null?void 0:c[w.route.id])!==void 0);Ce(E>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(c).join(",")}`),p=p.slice(0,Math.min(p.length,E+1))}let g=!1,f=-1;if(o&&r){g=r.renderFallback;for(let E=0;E<p.length;E++){let w=p[E];if((w.route.HydrateFallback||w.route.hydrateFallbackElement)&&(f=E),w.route.id){let{loaderData:J,errors:z}=r,H=w.route.loader&&!J.hasOwnProperty(w.route.id)&&(!z||z[w.route.id]===void 0);if(w.route.lazy||H){o.isStatic&&(g=!0),f>=0?p=p.slice(0,f+1):p=[p[0]];break}}}}let m=o==null?void 0:o.onError,_=r&&m?(E,w)=>{var J,z;m(E,{location:r.location,params:((z=(J=r.matches)==null?void 0:J[0])==null?void 0:z.params)??{},pattern:mn(r.matches),errorInfo:w})}:void 0;return p.reduceRight((E,w,J)=>{let z,H=!1,q=null,B=null;r&&(z=c&&w.route.id?c[w.route.id]:void 0,q=w.route.errorElement||Xm,g&&(f<0&&J===0?(Md("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),H=!0,B=null):f===J&&(H=!0,B=w.route.hydrateFallbackElement||null)));let Q=a.concat(p.slice(0,J+1)),V=()=>{let ie;return z?ie=q:H?ie=B:w.route.Component?ie=C.createElement(w.route.Component,null):w.route.element?ie=w.route.element:ie=E,C.createElement(eh,{match:w,routeContext:{outlet:E,matches:Q,isDataRoute:r!=null},children:ie})};return r&&(w.route.ErrorBoundary||w.route.errorElement||J===0)?C.createElement(Ad,{location:r.location,revalidation:r.revalidation,component:q,error:z,children:V(),routeContext:{outlet:null,matches:Q,isDataRoute:!0},onError:_}):V()},null)}function Nu(t){return`${t} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function sh(t){let a=C.useContext(Ii);return Ce(a,Nu(t)),a}function ih(t){let a=C.useContext(hn);return Ce(a,Nu(t)),a}function th(t){let a=C.useContext(os);return Ce(a,Nu(t)),a}function Fu(t){let a=th(t),o=a.matches[a.matches.length-1];return Ce(o.route.id,`${t} can only be used on routes that contain a unique "id"`),o.route.id}function nh(){return Fu("useRouteId")}function ah(){var r;let t=C.useContext(Ru),a=ih("useRouteError"),o=Fu("useRouteError");return t!==void 0?t:(r=a.errors)==null?void 0:r[o]}function oh(){let{router:t}=sh("useNavigate"),a=Fu("useNavigate"),o=C.useRef(!1);return Bd(()=>{o.current=!0}),C.useCallback(async(p,c={})=>{Xe(o.current,qd),o.current&&(typeof p=="number"?await t.navigate(p):await t.navigate(p,{fromRouteId:a,...c}))},[t,a])}var Dp={};function Md(t,a,o){!a&&!Dp[t]&&(Dp[t]=!0,Xe(!1,o))}var Wp={};function $p(t,a){!t&&!Wp[a]&&(Wp[a]=!0,console.warn(a))}var uh="useOptimistic",Vp=Pf[uh],rh=()=>{};function ch(t){return Vp?Vp(t):[t,rh]}function ph(t){let a={hasErrorBoundary:t.hasErrorBoundary||t.ErrorBoundary!=null||t.errorElement!=null};return t.Component&&(t.element&&Xe(!1,"You should not include both `Component` and `element` on your route - `Component` will be used."),Object.assign(a,{element:C.createElement(t.Component),Component:void 0})),t.HydrateFallback&&(t.hydrateFallbackElement&&Xe(!1,"You should not include both `HydrateFallback` and `hydrateFallbackElement` on your route - `HydrateFallback` will be used."),Object.assign(a,{hydrateFallbackElement:C.createElement(t.HydrateFallback),HydrateFallback:void 0})),t.ErrorBoundary&&(t.errorElement&&Xe(!1,"You should not include both `ErrorBoundary` and `errorElement` on your route - `ErrorBoundary` will be used."),Object.assign(a,{errorElement:C.createElement(t.ErrorBoundary),ErrorBoundary:void 0})),a}var dh=["HydrateFallback","hydrateFallbackElement"],gh=class{constructor(){this.status="pending",this.promise=new Promise((t,a)=>{this.resolve=o=>{this.status==="pending"&&(this.status="resolved",t(o))},this.reject=o=>{this.status==="pending"&&(this.status="rejected",a(o))}})}};function fh({router:t,flushSync:a,onError:o,useTransitions:r}){r=Jd()||r;let[c,g]=C.useState(t.state),[f,m]=ch(c),[_,E]=C.useState(),[w,J]=C.useState({isTransitioning:!1}),[z,H]=C.useState(),[q,B]=C.useState(),[Q,V]=C.useState(),ie=C.useRef(new Map),de=C.useCallback((L,{deletedFetchers:ye,newErrors:ne,flushSync:Te,viewTransitionOpts:ke})=>{ne&&o&&Object.values(ne).forEach(Le=>{var ze;return o(Le,{location:L.location,params:((ze=L.matches[0])==null?void 0:ze.params)??{},pattern:mn(L.matches)})}),L.fetchers.forEach((Le,ze)=>{Le.data!==void 0&&ie.current.set(ze,Le.data)}),ye.forEach(Le=>ie.current.delete(Le)),$p(Te===!1||a!=null,'You provided the `flushSync` option to a router update, but you are not using the `<RouterProvider>` from `react-router/dom` so `ReactDOM.flushSync()` is unavailable.  Please update your app to `import { RouterProvider } from "react-router/dom"` and ensure you have `react-dom` installed as a dependency to use the `flushSync` option.');let qe=t.window!=null&&t.window.document!=null&&typeof t.window.document.startViewTransition=="function";if($p(ke==null||qe,"You provided the `viewTransition` option to a router update, but you do not appear to be running in a DOM environment as `window.startViewTransition` is not available."),!ke||!qe){a&&Te?a(()=>g(L)):r===!1?g(L):C.startTransition(()=>{r===!0&&m(Le=>Kp(Le,L)),g(L)});return}if(a&&Te){a(()=>{q&&(z==null||z.resolve(),q.skipTransition()),J({isTransitioning:!0,flushSync:!0,currentLocation:ke.currentLocation,nextLocation:ke.nextLocation})});let Le=t.window.document.startViewTransition(()=>{a(()=>g(L))});Le.finished.finally(()=>{a(()=>{H(void 0),B(void 0),E(void 0),J({isTransitioning:!1})})}),a(()=>B(Le));return}q?(z==null||z.resolve(),q.skipTransition(),V({state:L,currentLocation:ke.currentLocation,nextLocation:ke.nextLocation})):(E(L),J({isTransitioning:!0,flushSync:!1,currentLocation:ke.currentLocation,nextLocation:ke.nextLocation}))},[t.window,a,q,z,r,m,o]);C.useLayoutEffect(()=>t.subscribe(de),[t,de]),C.useEffect(()=>{w.isTransitioning&&!w.flushSync&&H(new gh)},[w]),C.useEffect(()=>{if(z&&_&&t.window){let L=_,ye=z.promise,ne=t.window.document.startViewTransition(async()=>{r===!1?g(L):C.startTransition(()=>{r===!0&&m(Te=>Kp(Te,L)),g(L)}),await ye});ne.finished.finally(()=>{H(void 0),B(void 0),E(void 0),J({isTransitioning:!1})}),B(ne)}},[_,z,t.window,r,m]),C.useEffect(()=>{z&&_&&f.location.key===_.location.key&&z.resolve()},[z,q,f.location,_]),C.useEffect(()=>{!w.isTransitioning&&Q&&(E(Q.state),J({isTransitioning:!0,flushSync:!1,currentLocation:Q.currentLocation,nextLocation:Q.nextLocation}),V(void 0))},[w.isTransitioning,Q]);let ce=C.useMemo(()=>({createHref:t.createHref,encodeLocation:t.encodeLocation,go:L=>t.navigate(L),push:(L,ye,ne)=>t.navigate(L,{state:ye,preventScrollReset:ne==null?void 0:ne.preventScrollReset}),replace:(L,ye,ne)=>t.navigate(L,{replace:!0,state:ye,preventScrollReset:ne==null?void 0:ne.preventScrollReset})}),[t]),ve=t.basename||"/",Ee=C.useMemo(()=>({router:t,navigator:ce,static:!1,basename:ve,onError:o}),[t,ce,ve,o]);return C.createElement(C.Fragment,null,C.createElement(Ii.Provider,{value:Ee},C.createElement(hn.Provider,{value:f},C.createElement(zd.Provider,{value:ie.current},C.createElement(Tu.Provider,{value:w},C.createElement(jh,{basename:ve,location:f.location,navigationType:f.historyAction,navigator:ce,useTransitions:r},C.createElement(mh,{routes:t.routes,manifest:t.manifest,future:t.future,state:f,isStatic:!1,onError:o})))))),null)}function Kp(t,a){return{...t,navigation:a.navigation.state!=="idle"?a.navigation:t.navigation,revalidation:a.revalidation!=="idle"?a.revalidation:t.revalidation,actionData:a.navigation.state!=="submitting"?a.actionData:t.actionData,fetchers:a.fetchers}}var mh=C.memo(hh);function hh({routes:t,manifest:a,future:o,state:r,isStatic:p,onError:c}){return Qm(t,void 0,{manifest:a,state:r,isStatic:p,onError:c})}function _h({to:t,replace:a,state:o,relative:r}){Ce(gt(),"<Navigate> may be used only in the context of a <Router> component.");let{static:p}=C.useContext(Bl);Xe(!p,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:c}=C.useContext(os),{pathname:g}=us(),f=Ou(),m=gn(t,Aa(c),g,r==="path"),_=JSON.stringify(m);return C.useEffect(()=>{f(JSON.parse(_),{replace:a,state:o,relative:r})},[f,_,r,a,o]),null}function jh({basename:t="/",children:a=null,location:o,navigationType:r="POP",navigator:p,static:c=!1,useTransitions:g}){Ce(!gt(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let f=t.replace(/^\/*/,"/"),m=C.useMemo(()=>({basename:f,navigator:p,static:c,useTransitions:g,future:{}}),[f,p,c,g]);typeof o=="string"&&(o=as(o));let{pathname:_="/",search:E="",hash:w="",state:J=null,key:z="default",mask:H}=o,q=C.useMemo(()=>{let B=$l(_,f);return B==null?null:{location:{pathname:B,search:E,hash:w,state:J,key:z,mask:H},navigationType:r}},[f,_,E,w,J,z,r,H]);return Xe(q!=null,`<Router basename="${f}"> is not able to match the URL "${_}${E}${w}" because it does not start with the basename, so the <Router> won't render anything.`),q==null?null:C.createElement(Bl.Provider,{value:m},C.createElement(Ma.Provider,{children:a,value:q}))}var za="get",Ua="application/x-www-form-urlencoded";function Ha(t){return typeof HTMLElement<"u"&&t instanceof HTMLElement}function Sh(t){return Ha(t)&&t.tagName.toLowerCase()==="button"}function vh(t){return Ha(t)&&t.tagName.toLowerCase()==="form"}function wh(t){return Ha(t)&&t.tagName.toLowerCase()==="input"}function xh(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}function yh(t,a){return t.button===0&&(!a||a==="_self")&&!xh(t)}var La=null;function Eh(){if(La===null)try{new FormData(document.createElement("form"),0),La=!1}catch{La=!0}return La}var kh=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function bu(t){return t!=null&&!kh.has(t)?(Xe(!1,`"${t}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Ua}"`),null):t}function bh(t,a){let o,r,p,c,g;if(vh(t)){let f=t.getAttribute("action");r=f?$l(f,a):null,o=t.getAttribute("method")||za,p=bu(t.getAttribute("enctype"))||Ua,c=new FormData(t)}else if(Sh(t)||wh(t)&&(t.type==="submit"||t.type==="image")){let f=t.form;if(f==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let m=t.getAttribute("formaction")||f.getAttribute("action");if(r=m?$l(m,a):null,o=t.getAttribute("formmethod")||f.getAttribute("method")||za,p=bu(t.getAttribute("formenctype"))||bu(f.getAttribute("enctype"))||Ua,c=new FormData(f,t),!Eh()){let{name:_,type:E,value:w}=t;if(E==="image"){let J=_?`${_}.`:"";c.append(`${J}x`,"0"),c.append(`${J}y`,"0")}else _&&c.append(_,w)}}else{if(Ha(t))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');o=za,r=null,p=Ua,g=t}return c&&p==="text/plain"&&(g=c,c=void 0),{action:r,method:o.toLowerCase(),encType:p,formData:c,body:g}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Du(t,a){if(t===!1||t===null||typeof t>"u")throw new Error(a)}function Hd(t,a,o,r){let p=typeof t=="string"?new URL(t,typeof window>"u"?"server://singlefetch/":window.location.origin):t;return o?p.pathname.endsWith("/")?p.pathname=`${p.pathname}_.${r}`:p.pathname=`${p.pathname}.${r}`:p.pathname==="/"?p.pathname=`_root.${r}`:a&&$l(p.pathname,a)==="/"?p.pathname=`${Ba(a)}/_root.${r}`:p.pathname=`${Ba(p.pathname)}.${r}`,p}async function Ch(t,a){if(t.id in a)return a[t.id];try{let o=await import(t.module);return a[t.id]=o,o}catch(o){return console.error(`Error loading route module \`${t.module}\`, reloading page...`),console.error(o),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Lh(t){return t==null?!1:t.href==null?t.rel==="preload"&&typeof t.imageSrcSet=="string"&&typeof t.imageSizes=="string":typeof t.rel=="string"&&typeof t.href=="string"}async function Ih(t,a,o){let r=await Promise.all(t.map(async p=>{let c=a.routes[p.route.id];if(c){let g=await Ch(c,o);return g.links?g.links():[]}return[]}));return zh(r.flat(1).filter(Lh).filter(p=>p.rel==="stylesheet"||p.rel==="preload").map(p=>p.rel==="stylesheet"?{...p,rel:"prefetch",as:"style"}:{...p,rel:"prefetch"}))}function Qp(t,a,o,r,p,c){let g=(m,_)=>o[_]?m.route.id!==o[_].route.id:!0,f=(m,_)=>{var E;return o[_].pathname!==m.pathname||((E=o[_].route.path)==null?void 0:E.endsWith("*"))&&o[_].params["*"]!==m.params["*"]};return c==="assets"?a.filter((m,_)=>g(m,_)||f(m,_)):c==="data"?a.filter((m,_)=>{var w;let E=r.routes[m.route.id];if(!E||!E.hasLoader)return!1;if(g(m,_)||f(m,_))return!0;if(m.route.shouldRevalidate){let J=m.route.shouldRevalidate({currentUrl:new URL(p.pathname+p.search+p.hash,window.origin),currentParams:((w=o[0])==null?void 0:w.params)||{},nextUrl:new URL(t,window.origin),nextParams:m.params,defaultShouldRevalidate:!0});if(typeof J=="boolean")return J}return!0}):[]}function Gh(t,a,{includeHydrateFallback:o}={}){return Ph(t.map(r=>{let p=a.routes[r.route.id];if(!p)return[];let c=[p.module];return p.clientActionModule&&(c=c.concat(p.clientActionModule)),p.clientLoaderModule&&(c=c.concat(p.clientLoaderModule)),o&&p.hydrateFallbackModule&&(c=c.concat(p.hydrateFallbackModule)),p.imports&&(c=c.concat(p.imports)),c}).flat(1))}function Ph(t){return[...new Set(t)]}function Jh(t){let a={},o=Object.keys(t).sort();for(let r of o)a[r]=t[r];return a}function zh(t,a){let o=new Set;return new Set(a),t.reduce((r,p)=>{let c=JSON.stringify(Jh(p));return o.has(c)||(o.add(c),r.push({key:c,link:p})),r},[])}function Wu(){let t=C.useContext(Ii);return Du(t,"You must render this element inside a <DataRouterContext.Provider> element"),t}function Uh(){let t=C.useContext(hn);return Du(t,"You must render this element inside a <DataRouterStateContext.Provider> element"),t}var $u=C.createContext(void 0);$u.displayName="FrameworkContext";function Vu(){let t=C.useContext($u);return Du(t,"You must render this element inside a <HydratedRouter> element"),t}function qh(t,a){let o=C.useContext($u),[r,p]=C.useState(!1),[c,g]=C.useState(!1),{onFocus:f,onBlur:m,onMouseEnter:_,onMouseLeave:E,onTouchStart:w}=a,J=C.useRef(null);C.useEffect(()=>{if(t==="render"&&g(!0),t==="viewport"){let q=Q=>{Q.forEach(V=>{g(V.isIntersecting)})},B=new IntersectionObserver(q,{threshold:.5});return J.current&&B.observe(J.current),()=>{B.disconnect()}}},[t]),C.useEffect(()=>{if(r){let q=setTimeout(()=>{g(!0)},100);return()=>{clearTimeout(q)}}},[r]);let z=()=>{p(!0)},H=()=>{p(!1),g(!1)};return o?t!=="intent"?[c,J,{}]:[c,J,{onFocus:sn(f,z),onBlur:sn(m,H),onMouseEnter:sn(_,z),onMouseLeave:sn(E,H),onTouchStart:sn(w,z)}]:[!1,J,{}]}function sn(t,a){return o=>{t&&t(o),o.defaultPrevented||a(o)}}function Bh({page:t,...a}){let o=Jd(),{router:r}=Wu(),p=C.useMemo(()=>pd(r.routes,t,r.basename),[r.routes,t,r.basename]);return p?o?C.createElement(Mh,{page:t,matches:p,...a}):C.createElement(Hh,{page:t,matches:p,...a}):null}function Ah(t){let{manifest:a,routeModules:o}=Vu(),[r,p]=C.useState([]);return C.useEffect(()=>{let c=!1;return Ih(t,a,o).then(g=>{c||p(g)}),()=>{c=!0}},[t,a,o]),r}function Mh({page:t,matches:a,...o}){let r=us(),{future:p}=Vu(),{basename:c}=Wu(),g=C.useMemo(()=>{if(t===r.pathname+r.search+r.hash)return[];let f=Hd(t,c,p.v8_trailingSlashAwareDataRequests,"rsc"),m=!1,_=[];for(let E of a)typeof E.route.shouldRevalidate=="function"?m=!0:_.push(E.route.id);return m&&_.length>0&&f.searchParams.set("_routes",_.join(",")),[f.pathname+f.search]},[c,p.v8_trailingSlashAwareDataRequests,t,r,a]);return C.createElement(C.Fragment,null,g.map(f=>C.createElement("link",{key:f,rel:"prefetch",as:"fetch",href:f,...o})))}function Hh({page:t,matches:a,...o}){let r=us(),{future:p,manifest:c,routeModules:g}=Vu(),{basename:f}=Wu(),{loaderData:m,matches:_}=Uh(),E=C.useMemo(()=>Qp(t,a,_,c,r,"data"),[t,a,_,c,r]),w=C.useMemo(()=>Qp(t,a,_,c,r,"assets"),[t,a,_,c,r]),J=C.useMemo(()=>{if(t===r.pathname+r.search+r.hash)return[];let q=new Set,B=!1;if(a.forEach(V=>{var de;let ie=c.routes[V.route.id];!ie||!ie.hasLoader||(!E.some(ce=>ce.route.id===V.route.id)&&V.route.id in m&&((de=g[V.route.id])!=null&&de.shouldRevalidate)||ie.hasClientLoader?B=!0:q.add(V.route.id))}),q.size===0)return[];let Q=Hd(t,f,p.v8_trailingSlashAwareDataRequests,"data");return B&&q.size>0&&Q.searchParams.set("_routes",a.filter(V=>q.has(V.route.id)).map(V=>V.route.id).join(",")),[Q.pathname+Q.search]},[f,p.v8_trailingSlashAwareDataRequests,m,r,c,E,a,t,g]),z=C.useMemo(()=>Gh(w,c),[w,c]),H=Ah(w);return C.createElement(C.Fragment,null,J.map(q=>C.createElement("link",{key:q,rel:"prefetch",as:"fetch",href:q,...o})),z.map(q=>C.createElement("link",{key:q,rel:"modulepreload",href:q,...o})),H.map(({key:q,link:B})=>C.createElement("link",{key:q,nonce:o.nonce,...B,crossOrigin:B.crossOrigin??o.crossOrigin})))}function Th(...t){return a=>{t.forEach(o=>{typeof o=="function"?o(a):o!=null&&(o.current=a)})}}var Rh=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Rh&&(window.__reactRouterVersion="7.17.0")}catch{}function Oh(t,a){return _m({basename:a==null?void 0:a.basename,getContext:a==null?void 0:a.getContext,future:a==null?void 0:a.future,history:Jf({window:a==null?void 0:a.window}),hydrationData:Nh(),routes:t,mapRouteProperties:ph,hydrationRouteProperties:dh,dataStrategy:a==null?void 0:a.dataStrategy,patchRoutesOnNavigation:a==null?void 0:a.patchRoutesOnNavigation,window:a==null?void 0:a.window,instrumentations:a==null?void 0:a.instrumentations}).initialize()}function Nh(){let t=window==null?void 0:window.__staticRouterHydrationData;return t&&t.errors&&(t={...t,errors:Fh(t.errors)}),t}function Fh(t){if(!t)return null;let a=Object.entries(t),o={};for(let[r,p]of a)if(p&&p.__type==="RouteErrorResponse")o[r]=new fn(p.status,p.statusText,p.data,p.internal===!0);else if(p&&p.__type==="Error"){if(p.__subType){let c=window[p.__subType];if(typeof c=="function")try{let g=new c(p.message);g.stack="",o[r]=g}catch{}}if(o[r]==null){let c=new Error(p.message);c.stack="",o[r]=c}}else o[r]=p;return o}var Td=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Rd=C.forwardRef(function({onClick:a,discover:o="render",prefetch:r="none",relative:p,reloadDocument:c,replace:g,mask:f,state:m,target:_,to:E,preventScrollReset:w,viewTransition:J,defaultShouldRevalidate:z,...H},q){let{basename:B,navigator:Q,useTransitions:V}=C.useContext(Bl),ie=typeof E=="string"&&Td.test(E),de=_d(E,B);E=de.to;let ce=$m(E,{relative:p}),ve=us(),Ee=null;if(f){let ze=gn(f,[],ve.mask?ve.mask.pathname:"/",!0);B!=="/"&&(ze.pathname=ze.pathname==="/"?B:Wl([B,ze.pathname])),Ee=Q.createHref(ze)}let[L,ye,ne]=qh(r,H),Te=Vh(E,{replace:g,mask:f,state:m,target:_,preventScrollReset:w,relative:p,viewTransition:J,defaultShouldRevalidate:z,useTransitions:V});function ke(ze){a&&a(ze),ze.defaultPrevented||Te(ze)}let qe=!(de.isExternal||c),Le=C.createElement("a",{...H,...ne,href:(qe?Ee:void 0)||de.absoluteURL||ce,onClick:qe?ke:a,ref:Th(q,ye),target:_,"data-discover":!ie&&o==="render"?"true":void 0});return L&&!ie?C.createElement(C.Fragment,null,Le,C.createElement(Bh,{page:ce})):Le});Rd.displayName="Link";var Dh=C.forwardRef(function({"aria-current":a="page",caseSensitive:o=!1,className:r="",end:p=!1,style:c,to:g,viewTransition:f,children:m,..._},E){let w=_n(g,{relative:_.relative}),J=us(),z=C.useContext(hn),{navigator:H,basename:q}=C.useContext(Bl),B=z!=null&&Zh(w)&&f===!0,Q=H.encodeLocation?H.encodeLocation(w).pathname:w.pathname,V=J.pathname,ie=z&&z.navigation&&z.navigation.location?z.navigation.location.pathname:null;o||(V=V.toLowerCase(),ie=ie?ie.toLowerCase():null,Q=Q.toLowerCase()),ie&&q&&(ie=$l(ie,q)||ie);const de=Q!=="/"&&Q.endsWith("/")?Q.length-1:Q.length;let ce=V===Q||!p&&V.startsWith(Q)&&V.charAt(de)==="/",ve=ie!=null&&(ie===Q||!p&&ie.startsWith(Q)&&ie.charAt(Q.length)==="/"),Ee={isActive:ce,isPending:ve,isTransitioning:B},L=ce?a:void 0,ye;typeof r=="function"?ye=r(Ee):ye=[r,ce?"active":null,ve?"pending":null,B?"transitioning":null].filter(Boolean).join(" ");let ne=typeof c=="function"?c(Ee):c;return C.createElement(Rd,{..._,"aria-current":L,className:ye,ref:E,style:ne,to:g,viewTransition:f},typeof m=="function"?m(Ee):m)});Dh.displayName="NavLink";var Wh=C.forwardRef(({discover:t="render",fetcherKey:a,navigate:o,reloadDocument:r,replace:p,state:c,method:g=za,action:f,onSubmit:m,relative:_,preventScrollReset:E,viewTransition:w,defaultShouldRevalidate:J,...z},H)=>{let{useTransitions:q}=C.useContext(Bl),B=Yh(),Q=Xh(f,{relative:_}),V=g.toLowerCase()==="get"?"get":"post",ie=typeof f=="string"&&Td.test(f),de=ce=>{if(m&&m(ce),ce.defaultPrevented)return;ce.preventDefault();let ve=ce.nativeEvent.submitter,Ee=(ve==null?void 0:ve.getAttribute("formmethod"))||g,L=()=>B(ve||ce.currentTarget,{fetcherKey:a,method:Ee,navigate:o,replace:p,state:c,relative:_,preventScrollReset:E,viewTransition:w,defaultShouldRevalidate:J});q&&o!==!1?C.startTransition(()=>L()):L()};return C.createElement("form",{ref:H,method:V,action:Q,onSubmit:r?m:de,...z,"data-discover":!ie&&t==="render"?"true":void 0})});Wh.displayName="Form";function $h(t){return`${t} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Od(t){let a=C.useContext(Ii);return Ce(a,$h(t)),a}function Vh(t,{target:a,replace:o,mask:r,state:p,preventScrollReset:c,relative:g,viewTransition:f,defaultShouldRevalidate:m,useTransitions:_}={}){let E=Ou(),w=us(),J=_n(t,{relative:g});return C.useCallback(z=>{if(yh(z,a)){z.preventDefault();let H=o!==void 0?o:vs(w)===vs(J),q=()=>E(t,{replace:H,mask:r,state:p,preventScrollReset:c,relative:g,viewTransition:f,defaultShouldRevalidate:m});_?C.startTransition(()=>q()):q()}},[w,E,J,o,r,p,a,t,c,g,f,m,_])}var Kh=0,Qh=()=>`__${String(++Kh)}__`;function Yh(){let{router:t}=Od("useSubmit"),{basename:a}=C.useContext(Bl),o=nh(),r=t.fetch,p=t.navigate;return C.useCallback(async(c,g={})=>{let{action:f,method:m,encType:_,formData:E,body:w}=bh(c,a);if(g.navigate===!1){let J=g.fetcherKey||Qh();await r(J,o,g.action||f,{defaultShouldRevalidate:g.defaultShouldRevalidate,preventScrollReset:g.preventScrollReset,formData:E,body:w,formMethod:g.method||m,formEncType:g.encType||_,flushSync:g.flushSync})}else await p(g.action||f,{defaultShouldRevalidate:g.defaultShouldRevalidate,preventScrollReset:g.preventScrollReset,formData:E,body:w,formMethod:g.method||m,formEncType:g.encType||_,replace:g.replace,state:g.state,fromRouteId:o,flushSync:g.flushSync,viewTransition:g.viewTransition})},[r,p,a,o])}function Xh(t,{relative:a}={}){let{basename:o}=C.useContext(Bl),r=C.useContext(os);Ce(r,"useFormAction must be used inside a RouteContext");let[p]=r.matches.slice(-1),c={..._n(t||".",{relative:a})},g=us();if(t==null){c.search=g.search;let f=new URLSearchParams(c.search),m=f.getAll("index");if(m.some(E=>E==="")){f.delete("index"),m.filter(w=>w).forEach(w=>f.append("index",w));let E=f.toString();c.search=E?`?${E}`:""}}return(!t||t===".")&&p.route.index&&(c.search=c.search?c.search.replace(/^\?/,"?index&"):"?index"),o!=="/"&&(c.pathname=c.pathname==="/"?o:Wl([o,c.pathname])),vs(c)}function Zh(t,{relative:a}={}){let o=C.useContext(Tu);Ce(o!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Od("useViewTransitionState"),p=_n(t,{relative:a});if(!o.isTransitioning)return!1;let c=$l(o.currentLocation.pathname,r)||o.currentLocation.pathname,g=$l(o.nextLocation.pathname,r)||o.nextLocation.pathname;return qa(p.pathname,g)!=null||qa(p.pathname,c)!=null}var Cu={exports:{}},Il={},Lu={exports:{}},Iu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Yp;function e_(){return Yp||(Yp=1,(function(t){function a(F,Y){var K=F.length;F.push(Y);e:for(;0<K;){var x=K-1>>>1,M=F[x];if(0<p(M,Y))F[x]=Y,F[K]=M,K=x;else break e}}function o(F){return F.length===0?null:F[0]}function r(F){if(F.length===0)return null;var Y=F[0],K=F.pop();if(K!==Y){F[0]=K;e:for(var x=0,M=F.length,ge=M>>>1;x<ge;){var he=2*(x+1)-1,k=F[he],A=he+1,$=F[A];if(0>p(k,K))A<M&&0>p($,k)?(F[x]=$,F[A]=K,x=A):(F[x]=k,F[he]=K,x=he);else if(A<M&&0>p($,K))F[x]=$,F[A]=K,x=A;else break e}}return Y}function p(F,Y){var K=F.sortIndex-Y.sortIndex;return K!==0?K:F.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var c=performance;t.unstable_now=function(){return c.now()}}else{var g=Date,f=g.now();t.unstable_now=function(){return g.now()-f}}var m=[],_=[],E=1,w=null,J=3,z=!1,H=!1,q=!1,B=typeof setTimeout=="function"?setTimeout:null,Q=typeof clearTimeout=="function"?clearTimeout:null,V=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ie(F){for(var Y=o(_);Y!==null;){if(Y.callback===null)r(_);else if(Y.startTime<=F)r(_),Y.sortIndex=Y.expirationTime,a(m,Y);else break;Y=o(_)}}function de(F){if(q=!1,ie(F),!H)if(o(m)!==null)H=!0,Ne(ce);else{var Y=o(_);Y!==null&&me(de,Y.startTime-F)}}function ce(F,Y){H=!1,q&&(q=!1,Q(L),L=-1),z=!0;var K=J;try{for(ie(Y),w=o(m);w!==null&&(!(w.expirationTime>Y)||F&&!Te());){var x=w.callback;if(typeof x=="function"){w.callback=null,J=w.priorityLevel;var M=x(w.expirationTime<=Y);Y=t.unstable_now(),typeof M=="function"?w.callback=M:w===o(m)&&r(m),ie(Y)}else r(m);w=o(m)}if(w!==null)var ge=!0;else{var he=o(_);he!==null&&me(de,he.startTime-Y),ge=!1}return ge}finally{w=null,J=K,z=!1}}var ve=!1,Ee=null,L=-1,ye=5,ne=-1;function Te(){return!(t.unstable_now()-ne<ye)}function ke(){if(Ee!==null){var F=t.unstable_now();ne=F;var Y=!0;try{Y=Ee(!0,F)}finally{Y?qe():(ve=!1,Ee=null)}}else ve=!1}var qe;if(typeof V=="function")qe=function(){V(ke)};else if(typeof MessageChannel<"u"){var Le=new MessageChannel,ze=Le.port2;Le.port1.onmessage=ke,qe=function(){ze.postMessage(null)}}else qe=function(){B(ke,0)};function Ne(F){Ee=F,ve||(ve=!0,qe())}function me(F,Y){L=B(function(){F(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(F){F.callback=null},t.unstable_continueExecution=function(){H||z||(H=!0,Ne(ce))},t.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ye=0<F?Math.floor(1e3/F):5},t.unstable_getCurrentPriorityLevel=function(){return J},t.unstable_getFirstCallbackNode=function(){return o(m)},t.unstable_next=function(F){switch(J){case 1:case 2:case 3:var Y=3;break;default:Y=J}var K=J;J=Y;try{return F()}finally{J=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(F,Y){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var K=J;J=F;try{return Y()}finally{J=K}},t.unstable_scheduleCallback=function(F,Y,K){var x=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?x+K:x):K=x,F){case 1:var M=-1;break;case 2:M=250;break;case 5:M=1073741823;break;case 4:M=1e4;break;default:M=5e3}return M=K+M,F={id:E++,callback:Y,priorityLevel:F,startTime:K,expirationTime:M,sortIndex:-1},K>x?(F.sortIndex=K,a(_,F),o(m)===null&&F===o(_)&&(q?(Q(L),L=-1):q=!0,me(de,K-x))):(F.sortIndex=M,a(m,F),H||z||(H=!0,Ne(ce))),F},t.unstable_shouldYield=Te,t.unstable_wrapCallback=function(F){var Y=J;return function(){var K=J;J=Y;try{return F.apply(this,arguments)}finally{J=K}}}})(Iu)),Iu}var Xp;function l_(){return Xp||(Xp=1,Lu.exports=e_()),Lu.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const c_=C.forwardRef(({color:t="currentColor",size:a=24,strokeWidth:o=2,absoluteStrokeWidth:r,className:p="",children:c,iconNode:g,...f},m)=>C.createElement("svg",{ref:m,...r_,width:a,height:a,stroke:t,strokeWidth:r?Number(o)*24/Number(a):o,className:Fd("lucide",p),...f},[...g.map(([_,E])=>C.createElement(_,E)),...Array.isArray(c)?c:[c]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pi=(t,a)=>{const o=C.forwardRef(({className:r,...p},c)=>C.createElement(c_,{ref:c,iconNode:a,className:Fd(`lucide-${o_(sd(t))}`,`lucide-${t}`,r),...p}));return o.displayName=sd(t),o};/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const x_=[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]],y_=pi("trash-2",x_),E_="data:image/svg+xml;base64,";function tn(t){const[a,o]=C.useState(!1),r=()=>{o(!0)},{src:p,alt:c,style:g,className:f,...m}=t;return a?b.jsx("div",{className:`inline-block bg-gray-100 text-center align-middle ${f??""}`,style:g,children:b.jsx("div",{className:"flex items-center justify-center w-full h-full",children:b.jsx("img",{src:E_,alt:"Error loading image",...m,"data-original-url":p})})}):b.jsx("img",{src:p,alt:c,className:f,style:g,...m,onError:r})}const k_=`id,TITLE,DESCRIPTION,PRICE,CURRENCY_CODE,QUANTITY,TAGS,MATERIALS,IMAGE1,IMAGE2,IMAGE3,IMAGE4,IMAGE5,IMAGE6,IMAGE7,IMAGE8,IMAGE9,IMAGE10,condition,availability,root links,item_group_id,shape,length\r
