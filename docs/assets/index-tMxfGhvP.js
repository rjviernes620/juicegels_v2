 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _p;function Lf(){if(_p)return sn;_p=1;var t=Ju(),a=Symbol.for("react.element"),o=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,c=t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};function g(f,m,_){var E,S={},J=null,U=null;_!==void 0&&(J=""+_),m.key!==void 0&&(J=""+m.key),m.ref!==void 0&&(U=m.ref);for(E in m)r.call(m,E)&&!p.hasOwnProperty(E)&&(S[E]=m[E]);if(f&&f.defaultProps)for(E in m=f.defaultProps,m)S[E]===void 0&&(S[E]=m[E]);return{$$typeof:a,type:f,key:J,ref:U,props:S,_owner:c.current}}return sn.Fragment=o,sn.jsx=g,sn.jsxs=g,sn}var jp;function If(){return jp||(jp=1,Su.exports=Lf()),Su.exports}var b=If(),C=Ju();const Gf=bf(C),Pf=kf({__proto__:null,default:Gf},[C]);/**
 ...
 *
 * @license MIT
 */var od=t=>{throw TypeError(t)},ud=(t,a,o)=>a.has(t)||od("Cannot "+o),$l=(t,a,o)=>(ud(t,a,"read from private field"),o?o.call(t):a.get(t)),rn=(t,a,o)=>a.has(t)?od("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(t):a.set(t,o),ms=(t,a,o,r)=>(ud(t,a,"write to private field"),a.set(t,o),o),Sp="popstate";function vp(t){return typeof t=="object"&&t!=null&&"pathname"in t&&"search"in t&&"hash"in t&&"state"in t&&"key"in t}function Jf(t={}){function a(r,c){var _;let p=(_=c.state)==null?void 0:_.masked,{pathname:g,search:f,hash:m}=p||r.location;return dn("",{pathname:g,search:f,hash:m},c.state&&c.state.usr||null,c.state&&c.state.key||"default",p?{pathname:r.location.pathname,search:r.location.search,hash:r.location.hash}:void 0)}function o(r,c){return typeof c=="string"?c:Ss(c)}return Uf(a,o,null,t)}function Ge(t,a){if(t===!1||t===null||typeof t>"u")throw new Error(a)}function nl(t,a){if(!t){typeof console<"u"&&console.warn(a);try{throw new Error(a)}catch{}}}function zf(){return Math.random().toString(36).substring(2,10)}function wp(t,a){return{usr:t.state,key:t.key,idx:a,masked:t.mask?{pathname:t.pathname,search:t.search,hash:t.hash}:void 0}}function dn(t,a,o=null,r,c){return{pathname:typeof t=="string"?t:t.pathname,search:"",hash:"",...typeof a=="string"?vs(a):a,state:o,key:a&&a.key||r||zf(),mask:c}}function Ss({pathname:t="/",search:a="",hash:o=""}){return a&&a!=="?"&&(t+=a.charAt(0)==="?"?a:"?"+a),o&&o!=="#"&&(t+=o.charAt(0)==="#"?o:"#"+o),t}function vs(t){let a={};if(t){let o=t.indexOf("#");o>=0&&(a.hash=t.substring(o),t=t.substring(0,o));let r=t.indexOf("?");r>=0&&(a.search=t.substring(r),t=t.substring(0,r)),t&&(a.pathname=t)}return a}function Uf(t,a,o,r={}){let{window:c=document.defaultView,v5Compat:p=!1}=r,g=c.history,f="POP",m=null,_=E();_==null&&(_=0,g.replaceState({...g.state,idx:_},""));function E(){return(g.state||{idx:null}).idx}function S(){f="POP";let q=E(),D=q==null?null:q-_;_=q,m&&m({action:f,location:A.location,delta:D})}function J(q,D){f="PUSH";let K=vp(q)?q:dn(A.location,q,D);_=E()+1;let X=wp(K,_),pe=A.createHref(K.mask||K);try{g.pushState(X,"",pe)}catch(ue){if(ue instanceof DOMException&&ue.name==="DataCloneError")throw ue;c.location.assign(pe)}p&&m&&m({action:f,location:A.location,delta:1})}function U(q,D){f="REPLACE";let K=vp(q)?q:dn(A.location,q,D);_=E();let X=wp(K,_),pe=A.createHref(K.mask||K);g.replaceState(X,"",pe),p&&m&&m({action:f,location:A.location,delta:0})}function H(q){return rd(c,q)}let A={get action(){return f},get location(){return t(c,g)},listen(q){if(m)throw new Error("A history only accepts one active listener");return c.addEventListener(Sp,S),m=q,()=>{c.removeEventListener(Sp,S),m=null}},createHref(q){return a(c,q)},createURL:H,encodeLocation(q){let D=H(q);return{pathname:D.pathname,search:D.search,hash:D.hash}},push:J,replace:U,go(q){return g.go(q)}};return A}function rd(t,a,o=!1){let r="http://localhost";t&&(r=t.location.origin!=="null"?t.location.origin:t.location.href),Ge(r,"No window.location.(origin|href) available to create URL");let c=typeof a=="string"?a:Ss(a);return c=c.replace(/ $/,"%20"),!o&&c.startsWith("//")&&(c=r+c),new URL(c,r)}var cn,xp=class{constructor(t){if(rn(this,cn,new Map),t)for(let[a,o]of t)this.set(a,o)}get(t){if($l(this,cn).has(t))return $l(this,cn).get(t);if(t.defaultValue!==void 0)return t.defaultValue;throw new Error("No value found for context")}set(t,a){$l(this,cn).set(t,a)}};cn=new WeakMap;var qf=new Set(["lazy","caseSensitive","path","id","index","children"]);function Bf(t){return qf.has(t)}var Af=new Set(["lazy","caseSensitive","path","id","index","middleware","children"]);function Mf(t){return Af.has(t)}function Hf(t){return t.index===!0}function gn(t,a,o=[],r={},c=!1){return t.map((p,g)=>{let f=[...o,String(g)],m=typeof p.id=="string"?p.id:f.join("-");if(Ge(p.index!==!0||!p.children,"Cannot specify children on an index route"),Ge(c||!r[m],`Found a route id collision on id "${m}".  Route id's must be globally unique within Data Router usages`),Hf(p)){let _={...p,id:m};return r[m]=yp(_,a(_)),_}else{let _={...p,id:m,children:void 0};return r[m]=yp(_,a(_)),p.children&&(_.children=gn(p.children,a,f,r,c)),_}})}function yp(t,a){return Object.assign(t,{...a,...typeof a.lazy=="object"&&a.lazy!=null?{lazy:{...t.lazy,...a.lazy}}:{}})}function cd(t,a,o="/"){return us(t,a,o,!1)}function us(t,a,o,r,c){let p=typeof a=="string"?vs(a):a,g=Ql(p.pathname||"/",o);if(g==null)return null;let f=c??Ga(t),m=null,_=Xf(g);for(let E=0;m==null&&E<f.length;++E)m=Qf(f[E],_,r);return m}function Tf(t,a){let{route:o,pathname:r,params:c}=t;return{id:o.id,pathname:r,params:c,data:a[o.id],loaderData:a[o.id],handle:o.handle}}function Ga(t){let a=pd(t);return Rf(a),a}function pd(t,a=[],o=[],r="",c=!1){let p=(g,f,m=c,_)=>{let E={relativePath:_===void 0?g.path||"":_,caseSensitive:g.caseSensitive===!0,childrenIndex:f,route:g};if(E.relativePath.startsWith("/")){if(!E.relativePath.startsWith(r)&&m)return;Ge(E.relativePath.startsWith(r),`Absolute route path "${E.relativePath}" nested under path "${r}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),E.relativePath=E.relativePath.slice(r.length)}let S=Kl([r,E.relativePath]),J=o.concat(E);g.children&&g.children.length>0&&(Ge(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${S}".`),pd(g.children,a,J,S,m)),!(g.path==null&&!g.index)&&a.push({path:S,score:Vf(S,g.index),routesMeta:J})};return t.forEach((g,f)=>{var m;if(g.path===""||!((m=g.path)!=null&&m.includes("?")))p(g,f);else for(let _ of dd(g.path))p(g,f,!0,_)}),a}function dd(t){let a=t.split("/");if(a.length===0)return[];let[o,...r]=a,c=o.endsWith("?"),p=o.replace(/\?$/,"");if(r.length===0)return c?[p,""]:[p];let g=dd(r.join("/")),f=[];return f.push(...g.map(m=>m===""?p:[p,m].join("/"))),c&&f.push(...g),f.map(m=>t.startsWith("/")&&m===""?"/":m)}function Rf(t){t.sort((a,o)=>a.score!==o.score?o.score-a.score:Kf(a.routesMeta.map(r=>r.childrenIndex),o.routesMeta.map(r=>r.childrenIndex)))}var Of=/^:[\w-]+$/,Nf=3,Ff=2,Df=1,Wf=10,$f=-2,Ep=t=>t==="*";function Vf(t,a){let o=t.split("/"),r=o.length;return o.some(Ep)&&(r+=$f),a&&(r+=Ff),o.filter(c=>!Ep(c)).reduce((c,p)=>c+(Of.test(p)?Nf:p===""?Df:Wf),r)}function Kf(t,a){return t.length===a.length&&t.slice(0,-1).every((r,c)=>r===a[c])?t[t.length-1]-a[a.length-1]:0}function Qf(t,a,o=!1){let{routesMeta:r}=t,c={},p="/",g=[];for(let f=0;f<r.length;++f){let m=r[f],_=f===r.length-1,E=p==="/"?a:a.slice(p.length)||"/",S=Ua({path:m.relativePath,caseSensitive:m.caseSensitive,end:_},E),J=m.route;if(!S&&_&&o&&!r[r.length-1].route.index&&(S=Ua({path:m.relativePath,caseSensitive:m.caseSensitive,end:!1},E)),!S)return null;Object.assign(c,S.params),g.push({params:c,pathname:Kl([p,S.pathname]),pathnameBase:lm(Kl([p,S.pathnameBase])),route:J}),S.pathnameBase!=="/"&&(p=Kl([p,S.pathnameBase]))}return g}function Ua(t,a){typeof t=="string"&&(t={path:t,caseSensitive:!1,end:!0});let[o,r]=Yf(t.path,t.caseSensitive,t.end),c=a.match(o);if(!c)return null;let p=c[0],g=p.replace(/(.)\/+$/,"$1"),f=c.slice(1);return{params:r.reduce((_,{paramName:E,isOptional:S},J)=>{if(E==="*"){let H=f[J]||"";g=p.slice(0,p.length-H.length).replace(/(.)\/+$/,"$1")}const U=f[J];return S&&!U?_[E]=void 0:_[E]=(U||"").replace(/%2F/g,"/"),_},{}),pathname:p,pathnameBase:g,pattern:t}}function Yf(t,a=!1,o=!0){nl(t==="*"||!t.endsWith("*")||t.endsWith("/*"),`Route path "${t}" will be treated as if it were "${t.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${t.replace(/\*$/,"/*")}".`);let r=[],c="^"+t.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(g,f,m,_,E)=>{if(r.push({paramName:f,isOptional:m!=null}),m){let S=E.charAt(_+g.length);return S&&S!=="/"?"/([^\\/]*)":"(?:/([^\\/]*))?"}return"/([^\\/]+)"}).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return t.endsWith("*")?(r.push({paramName:"*"}),c+=t==="*"||t==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):o?c+="\\/*$":t!==""&&t!=="/"&&(c+="(?:(?=\\/|$))"),[new RegExp(c,a?void 0:"i"),r]}function Xf(t){try{return t.split("/").map(a=>decodeURIComponent(a).replace(/\//g,"%2F")).join("/")}catch(a){return nl(!1,`The URL path "${t}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${a}).`),t}}function Ql(t,a){if(a==="/")return t;if(!t.toLowerCase().startsWith(a.toLowerCase()))return null;let o=a.endsWith("/")?a.length-1:a.length,r=t.charAt(o);return r&&r!=="/"?null:t.slice(o)||"/"}function Zf({basename:t,pathname:a}){return a==="/"?t:Kl([t,a])}var gd=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,zu=t=>gd.test(t);function em(t,a="/"){let{pathname:o,search:r="",hash:c=""}=typeof t=="string"?vs(t):t,p;return o?(o=qu(o),o.startsWith("/")?p=kp(o.substring(1),"/"):p=kp(o,a)):p=a,{pathname:p,search:sm(r),hash:im(c)}}function kp(t,a){let o=qa(a).split("/");return t.split("/").forEach(c=>{c===".."?o.length>1&&o.pop():c!=="."&&o.push(c)}),o.length>1?o.join("/"):"/"}function wu(t,a,o,r){return`Cannot include a '${t}' character in a manually specified \`to.${a}\` field [${JSON.stringify(r)}].  Please separate it out to the \`to.${o}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function fd(t){return t.filter((a,o)=>o===0||a.route.path&&a.route.path.length>0)}function Uu(t){let a=fd(t);return a.map((o,r)=>r===a.length-1?o.pathname:o.pathnameBase)}function Ba(t,a,o,r=!1){let c;typeof t=="string"?c=vs(t):(c={...t},Ge(!c.pathname||!c.pathname.includes("?"),wu("?","pathname","search",c)),Ge(!c.pathname||!c.pathname.includes("#"),wu("#","pathname","hash",c)),Ge(!c.search||!c.search.includes("#"),wu("#","search","hash",c)));let p=t===""||c.pathname==="",g=p?"/":c.pathname,f;if(g==null)f=o;else{let S=a.length-1;if(!r&&g.startsWith("..")){let J=g.split("/");for(;J[0]==="..";)J.shift(),S-=1;c.pathname=J.join("/")}f=S>=0?a[S]:"/"}let m=em(c,f),_=g&&g!=="/"&&g.endsWith("/"),E=(p||g===".")&&o.endsWith("/");return!m.pathname.endsWith("/")&&(_||E)&&(m.pathname+="/"),m}var qu=t=>t.replace(/\/\/+/g,"/"),Kl=t=>qu(t.join("/")),qa=t=>t.replace(/\/+$/,""),lm=t=>qa(t).replace(/^\/*/,"/"),sm=t=>!t||t==="?"?"":t.startsWith("?")?t:"?"+t,im=t=>!t||t==="#"?"":t.startsWith("#")?t:"#"+t,mn=class{constructor(t,a,o,r=!1){this.status=t,this.statusText=a||"",this.internal=r,o instanceof Error?(this.data=o.toString(),this.error=o):this.data=o}};function fn(t){return t!=null&&typeof t.status=="number"&&typeof t.statusText=="string"&&typeof t.internal=="boolean"&&"data"in t}function hn(t){let a=t.map(o=>o.route.path).filter(Boolean);return Kl(a)||"/"}var md=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function hd(t,a){let o=t;if(typeof o!="string"||!gd.test(o))return{absoluteURL:void 0,isExternal:!1,to:o};let r=o,c=!1;if(md)try{let p=new URL(window.location.href),g=o.startsWith("//")?new URL(p.protocol+o):new URL(o),f=Ql(g.pathname,a);g.origin===p.origin&&f!=null?o=f+g.search+g.hash:c=!0}catch{nl(!1,`<Link to="${o}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}return{absoluteURL:r,isExternal:c,to:o}}var di=Symbol("Uninstrumented");function tm(t,a){let o={lazy:[],"lazy.loader":[],"lazy.action":[],"lazy.middleware":[],middleware:[],loader:[],action:[]};t.forEach(c=>c({id:a.id,index:a.index,path:a.path,instrument(p){let g=Object.keys(o);for(let f of g)p[f]&&o[f].push(p[f])}}));let r={};if(typeof a.lazy=="function"&&o.lazy.length>0){let c=ht(o.lazy,a.lazy,()=>{});c&&(r.lazy=c)}if(typeof a.lazy=="object"){let c=a.lazy;["middleware","loader","action"].forEach(p=>{let g=c[p],f=o[`lazy.${p}`];if(typeof g=="function"&&f.length>0){let m=ht(f,g,()=>{});m&&(r.lazy=Object.assign(r.lazy||{},{[p]:m}))}})}return["loader","action"].forEach(c=>{let p=a[c];if(typeof p=="function"&&o[c].length>0){let g=p[di]??p,f=ht(o[c],g,(...m)=>bp(m[0]));f&&(c==="loader"&&g.hydrate===!0&&(f.hydrate=!0),f[di]=g,r[c]=f)}}),a.middleware&&a.middleware.length>0&&o.middleware.length>0&&(r.middleware=a.middleware.map(c=>{let p=c[di]??c,g=ht(o.middleware,p,(...f)=>bp(f[0]));return g?(g[di]=p,g):c})),r}function nm(t,a){let o={navigate:[],fetch:[]};if(a.forEach(r=>r({instrument(c){let p=Object.keys(c);for(let g of p)c[g]&&o[g].push(c[g])}})),o.navigate.length>0){let r=t.navigate[di]??t.navigate,c=ht(o.navigate,r,(...p)=>{let[g,f]=p;return{to:typeof g=="number"||typeof g=="string"?g:g?Ss(g):".",...Cp(t,f??{})}});c&&(c[di]=r,t.navigate=c)}if(o.fetch.length>0){let r=t.fetch[di]??t.fetch,c=ht(o.fetch,r,(...p)=>{let[g,,f,m]=p;return{href:f??".",fetcherKey:g,...Cp(t,m??{})}});c&&(c[di]=r,t.fetch=c)}return t}function ht(t,a,o){return t.length===0?null:async(...r)=>{let c=await _d(t,o(...r),()=>a(...r),t.length-1);if(c.type==="error")throw c.value;return c.value}}async function _d(t,a,o,r){let c=t[r],p;if(c){let g,f=async()=>(g?console.error("You cannot call instrumented handlers more than once"):g=_d(t,a,o,r-1),p=await g,Ge(p,"Expected a result"),p.type==="error"&&p.value instanceof Error?{status:"error",error:p.value}:{status:"success",error:void 0});try{await c(f,a)}catch(m){console.error("An instrumentation function threw an error:",m)}g||await f(),await g}else try{p={type:"success",value:await o()}}catch(g){p={type:"error",value:g}}return p||{type:"error",value:new Error("No result assigned in instrumentation chain.")}}function bp(t){let{request:a,context:o,params:r,pattern:c}=t;return{request:am(a),params:{...r},pattern:c,context:om(o)}}function Cp(t,a){return{currentUrl:Ss(t.state.location),..."formMethod"in a?{formMethod:a.formMethod}:{},..."formEncType"in a?{formEncType:a.formEncType}:{},..."formData"in a?{formData:a.formData}:{},..."body"in a?{body:a.body}:{}}}function am(t){return{method:t.method,url:t.url,headers:{get:(...a)=>t.headers.get(...a)}}}function om(t){if(rm(t)){let a={...t};return Object.freeze(a),a}else return{get:a=>t.get(a)}}var um=Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function rm(t){if(t===null||typeof t!="object")return!1;const a=Object.getPrototypeOf(t);return a===Object.prototype||a===null||Object.getOwnPropertyNames(a).sort().join("\0")===um}var jd=["POST","PUT","PATCH","DELETE"],cm=new Set(jd),pm=["GET",...jd],dm=new Set(pm),Sd=new Set([301,302,303,307,308]),gm=new Set([307,308]),xu={state:"idle",location:void 0,matches:void 0,historyAction:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},fm={state:"idle",data:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},tn={state:"unblocked",proceed:void 0,reset:void 0,location:void 0},mm=t=>({hasErrorBoundary:!!t.hasErrorBoundary}),vd="remix-router-transitions",wd=Symbol("ResetLoaderData"),Ii,dt,ci,gt,hm=class{constructor(t){rn(this,Ii),rn(this,dt),rn(this,ci),rn(this,gt),ms(this,Ii,t),ms(this,dt,Ga(t))}get stableRoutes(){return $l(this,Ii)}get activeRoutes(){return $l(this,ci)??$l(this,Ii)}get branches(){return $l(this,gt)??$l(this,dt)}get hasHMRRoutes(){return $l(this,ci)!=null}setRoutes(t){ms(this,Ii,t),ms(this,dt,Ga(t))}setHmrRoutes(t){ms(this,ci,t),ms(this,gt,Ga(t))}commitHmrRoutes(){$l(this,ci)&&(ms(this,Ii,$l(this,ci)),ms(this,dt,$l(this,gt)),ms(this,ci,void 0),ms(this,gt,void 0))}};Ii=new WeakMap;dt=new WeakMap;ci=new WeakMap;gt=new WeakMap;function _m(t){const a=t.window?t.window:typeof window<"u"?window:void 0,o=typeof a<"u"&&typeof a.document<"u"&&typeof a.document.createElement<"u";Ge(t.routes.length>0,"You must provide a non-empty routes array to createRouter");let r=t.hydrationRouteProperties||[],c=t.mapRouteProperties||mm,p=c;if(t.instrumentations){let j=t.instrumentations;p=w=>({...c(w),...tm(j.map(G=>G.route).filter(Boolean),w)})}let g={},f=new hm(gn(t.routes,p,void 0,g)),m=t.basename||"/";m.startsWith("/")||(m=`/${m}`);let _=t.dataStrategy||xm,E={...t.future},S=null,J=new Set,U=null,H=null,A=null,q=null,D=t.hydrationData!=null,K=us(f.activeRoutes,t.history.location,m,!1,f.branches),X=!1,pe=null,ue,ve;if(K==null&&!t.patchRoutesOnNavigation){let j=Vl(404,{pathname:t.history.location.pathname}),{matches:w,route:G}=ba(f.activeRoutes);ue=!0,ve=!ue,K=w,pe={[G.id]:j}}else if(K&&!t.hydrationData&&Ts(K,f.activeRoutes,t.history.location.pathname).active&&(K=null),K)if(K.some(j=>j.route.lazy))ue=!1,ve=!ue;else if(!K.some(j=>Bu(j.route)))ue=!0,ve=!ue;else{let j=t.hydrationData?t.hydrationData.loaderData:null,w=t.hydrationData?t.hydrationData.errors:null,G=K;if(w){let M=K.findIndex(T=>w[T.route.id]!==void 0);G=G.slice(0,M+1)}ve=!1,ue=!0,G.forEach(M=>{let T=xd(M.route,j,w);ve=ve||T.renderFallback,ue=ue&&!T.shouldLoad})}else{ue=!1,ve=!ue,K=[];let j=Ts(null,f.activeRoutes,t.history.location.pathname);j.active&&j.matches&&(X=!0,K=j.matches)}let Le,L={historyAction:t.history.action,location:t.history.location,matches:K,initialized:ue,renderFallback:ve,navigation:xu,restoreScrollPosition:t.hydrationData!=null?!1:null,preventScrollReset:!1,revalidation:"idle",loaderData:t.hydrationData&&t.hydrationData.loaderData||{},actionData:t.hydrationData&&t.hydrationData.actionData||null,errors:t.hydrationData&&t.hydrationData.errors||pe,fetchers:new Map,blockers:new Map},ke="POP",fe=null,Ne=!1,we,Pe=!1,Je=new Map,Me=null,Oe=!1,de=!1,N=new Set,Q=new Map,V=0,y=-1,B=new Map,ce=new Set,me=new Map,ge=new Map,he=new Set,Ie=new Map,qe,k=null;function $(){if(S=t.history.listen(({action:j,location:w,delta:G})=>{if(qe){qe(),qe=void 0;return}nl(Ie.size===0||G!=null,"You are trying to use a blocker on a POP navigation to a location that was not created by @remix-run/router. This will fail silently in production. This can happen if you are navigating outside the router via `window.history.pushState`/`window.location.hash` instead of using router navigation APIs.  This can also happen if you are using createHashRouter and the user manually changes the URL.");let M=ks({currentLocation:L.location,nextLocation:w,historyAction:j});if(M&&G!=null){let T=new Promise(ne=>{qe=ne});t.history.go(G*-1),Zl(M,{state:"blocked",location:w,proceed(){Zl(M,{state:"proceeding",proceed:void 0,reset:void 0,location:w}),T.then(()=>t.history.go(G))},reset(){let ne=new Map(L.blockers);ne.set(M,tn),Ee({blockers:ne})}}),fe==null||fe.resolve(),fe=null;return}return zl(j,w)}),o){Tm(a,Je);let j=()=>Rm(a,Je);a.addEventListener("pagehide",j),Me=()=>a.removeEventListener("pagehide",j)}return L.initialized||zl("POP",L.location,{initialHydration:!0}),Le}function se(){S&&S(),Me&&Me(),J.clear(),we&&we.abort(),L.fetchers.forEach((j,w)=>Ui(L.fetchers,w)),L.blockers.forEach((j,w)=>Mi(w))}function be(j){if(J.add(j),U){let{newErrors:w}=U;U=null,j(L,{deletedFetchers:[],newErrors:w,viewTransitionOpts:void 0,flushSync:!1})}return()=>J.delete(j)}function Ee(j,w={}){j.matches&&(j.matches=j.matches.map(T=>{let ne=g[T.route.id],ae=T.route;return ae.element!==ne.element||ae.errorElement!==ne.errorElement||ae.hydrateFallbackElement!==ne.hydrateFallbackElement?{...T,route:ne}:T})),L={...L,...j};let G=[],M=[];L.fetchers.forEach((T,ne)=>{T.state==="idle"&&(he.has(ne)?G.push(ne):M.push(ne))}),he.forEach(T=>{!L.fetchers.has(T)&&!Q.has(T)&&G.push(T)}),J.size===0&&(U={newErrors:j.errors??null}),[...J].forEach(T=>T(L,{deletedFetchers:G,newErrors:j.errors??null,viewTransitionOpts:w.viewTransitionOpts,flushSync:w.flushSync===!0})),G.forEach(T=>Ui(L.fetchers,T)),M.forEach(T=>L.fetchers.delete(T))}function ll(j,w,{flushSync:G}={}){var Se,Ce;let M=L.actionData!=null&&L.navigation.formMethod!=null&&wl(L.navigation.formMethod)&&L.navigation.state==="loading"&&((Se=j.state)==null?void 0:Se._isRedirect)!==!0,T;w.actionData?Object.keys(w.actionData).length>0?T=w.actionData:T=null:M?T=L.actionData:T=null;let ne=w.loaderData?Mp(L.loaderData,w.loaderData,w.matches||[],w.errors):L.loaderData,ae=L.blockers;ae.size>0&&(ae=new Map(ae),ae.forEach((re,Ue)=>ae.set(Ue,tn)));let ye=Oe?!1:xt(j,w.matches||L.matches),Y=Ne===!0||L.navigation.formMethod!=null&&wl(L.navigation.formMethod)&&((Ce=j.state)==null?void 0:Ce._isRedirect)!==!0;f.commitHmrRoutes(),Oe||ke==="POP"||(ke==="PUSH"?t.history.push(j,j.state):ke==="REPLACE"&&t.history.replace(j,j.state));let oe;if(ke==="POP"){let re=Je.get(L.location.pathname);re&&re.has(j.pathname)?oe={currentLocation:L.location,nextLocation:j}:Je.has(j.pathname)&&(oe={currentLocation:j,nextLocation:L.location})}else if(Pe){let re=Je.get(L.location.pathname);re?re.add(j.pathname):(re=new Set([j.pathname]),Je.set(L.location.pathname,re)),oe={currentLocation:L.location,nextLocation:j}}Ee({...w,actionData:T,loaderData:ne,historyAction:ke,location:j,initialized:!0,renderFallback:!1,navigation:xu,revalidation:"idle",restoreScrollPosition:ye,preventScrollReset:Y,blockers:ae},{viewTransitionOpts:oe,flushSync:G===!0}),ke="POP",Ne=!1,Pe=!1,Oe=!1,de=!1,fe==null||fe.resolve(),fe=null,k==null||k.resolve(),k=null}async function ys(j,w){if(fe==null||fe.resolve(),fe=null,typeof j=="number"){fe||(fe=Op());let Re=fe.promise;return t.history.go(j),Re}let G=Iu(L.location,L.matches,m,j,w==null?void 0:w.fromRouteId,w==null?void 0:w.relative),{path:M,submission:T,error:ne}=Lp(!1,G,w),ae;w!=null&&w.mask&&(ae={pathname:"",search:"",hash:"",...typeof w.mask=="string"?vs(w.mask):{...L.location.mask,...w.mask}});let ye=L.location,Y=dn(ye,M,w&&w.state,void 0,ae);Y={...Y,...t.history.encodeLocation(Y)};let oe=w&&w.replace!=null?w.replace:void 0,Se="PUSH";oe===!0?Se="REPLACE":oe===!1||T!=null&&wl(T.formMethod)&&T.formAction===L.location.pathname+L.location.search&&(Se="REPLACE");let Ce=w&&"preventScrollReset"in w?w.preventScrollReset===!0:void 0,re=(w&&w.flushSync)===!0,Ue=ks({currentLocation:ye,nextLocation:Y,historyAction:Se});if(Ue){Zl(Ue,{state:"blocked",location:Y,proceed(){Zl(Ue,{state:"proceeding",proceed:void 0,reset:void 0,location:Y}),ys(j,w)},reset(){let Re=new Map(L.blockers);Re.set(Ue,tn),Ee({blockers:Re})}});return}await zl(Se,Y,{submission:T,pendingError:ne,preventScrollReset:Ce,replace:w&&w.replace,enableViewTransition:w&&w.viewTransition,flushSync:re,callSiteDefaultShouldRevalidate:w&&w.defaultShouldRevalidate})}function Es(){k||(k=Op()),Hs(),Ee({revalidation:"loading"});let j=k.promise;return L.navigation.state==="submitting"?j:L.navigation.state==="idle"?(zl(L.historyAction,L.location,{startUninterruptedRevalidation:!0}),j):(zl(ke||L.historyAction,L.navigation.location,{overrideNavigation:L.navigation,enableViewTransition:Pe===!0}),j)}async function zl(j,w,G){we&&we.abort(),we=null,ke=j,Oe=(G&&G.startUninterruptedRevalidation)===!0,En(L.location,L.matches),Ne=(G&&G.preventScrollReset)===!0,Pe=(G&&G.enableViewTransition)===!0;let M=f.activeRoutes,T=G!=null&&G.initialHydration&&L.matches&&L.matches.length>0&&!X?L.matches:us(M,w,m,!1,f.branches),ne=(G&&G.flushSync)===!0;if(T&&L.initialized&&!de&&Gm(L.location,w)&&!(G&&G.submission&&wl(G.submission.formMethod))){ll(w,{matches:T},{flushSync:ne});return}let ae=Ts(T,M,w.pathname);if(ae.active&&ae.matches&&(T=ae.matches),!T){let{error:Ve,notFoundMatches:Fe,route:Be}=Hi(w.pathname);ll(w,{matches:Fe,loaderData:{},errors:{[Be.id]:Ve}},{flushSync:ne});return}let ye=G&&G.overrideNavigation?{...G.overrideNavigation,matches:T,historyAction:j}:void 0;we=new AbortController;let Y=ft(t.history,w,we.signal,G&&G.submission),oe=t.getContext?await t.getContext():new xp,Se;if(G&&G.pendingError)Se=[pi(T).route.id,{type:"error",error:G.pendingError}];else if(G&&G.submission&&wl(G.submission.formMethod)){let Ve=await Ji(Y,w,G.submission,T,j,oe,ae.active,G&&G.initialHydration===!0,{replace:G.replace,flushSync:ne});if(Ve.shortCircuited)return;if(Ve.pendingActionResult){let[Fe,Be]=Ve.pendingActionResult;if(Hl(Be)&&fn(Be.error)&&Be.error.status===404){we=null,ll(w,{matches:Ve.matches,loaderData:{},errors:{[Fe]:Be.error}});return}}T=Ve.matches||T,Se=Ve.pendingActionResult,ye=yu(w,T,j,G.submission),ne=!1,ae.active=!1,Y=ft(t.history,Y.url,Y.signal)}let{shortCircuited:Ce,matches:re,loaderData:Ue,errors:Re,workingFetchers:sl}=await jt(Y,w,T,j,oe,ae.active,ye,G&&G.submission,G&&G.fetcherSubmission,G&&G.replace,G&&G.initialHydration===!0,ne,Se,G&&G.callSiteDefaultShouldRevalidate);Ce||(we=null,ll(w,{matches:re||T,...Hp(Se),loaderData:Ue,errors:Re,...sl?{fetchers:sl}:{}}))}async function Ji(j,w,G,M,T,ne,ae,ye,Y={}){Hs();let oe=Mm(w,M,T,G);if(Ee({navigation:oe},{flushSync:Y.flushSync===!0}),ae){let re=await mi(M,w.pathname,j.signal);if(re.type==="aborted")return{shortCircuited:!0};if(re.type==="error"){if(re.partialMatches.length===0){let{matches:Re,route:sl}=ba(f.activeRoutes);return{matches:Re,pendingActionResult:[sl.id,{type:"error",error:re.error}]}}let Ue=pi(re.partialMatches).route.id;return{matches:re.partialMatches,pendingActionResult:[Ue,{type:"error",error:re.error}]}}else if(re.matches)M=re.matches;else{let{notFoundMatches:Ue,error:Re,route:sl}=Hi(w.pathname);return{matches:Ue,pendingActionResult:[sl.id,{type:"error",error:Re}]}}}let Se,Ce=Pa(M,w);if(!Ce.route.action&&!Ce.route.lazy)Se={type:"error",error:Vl(405,{method:j.method,pathname:w.pathname,routeId:Ce.route.id})};else{let re=_t(p,g,j,w,M,Ce,ye?[]:r,ne),Ue=await Ms(j,w,re,ne,null);if(Se=Ue[Ce.route.id],!Se){for(let Re of M)if(Ue[Re.route.id]){Se=Ue[Re.route.id];break}}if(j.signal.aborted)return{shortCircuited:!0}}if(Gi(Se)){let re;return Y&&Y.replace!=null?re=Y.replace:re=qp(Se.response.headers.get("Location"),new URL(j.url),m,t.history)===L.location.pathname+L.location.search,await rs(j,Se,!0,{submission:G,replace:re}),{shortCircuited:!0}}if(Hl(Se)){let re=pi(M,Ce.route.id);return(Y&&Y.replace)!==!0&&(ke="PUSH"),{matches:M,pendingActionResult:[re.route.id,Se,Ce.route.id]}}return{matches:M,pendingActionResult:[Ce.route.id,Se]}}async function jt(j,w,G,M,T,ne,ae,ye,Y,oe,Se,Ce,re,Ue){let Re=ae||yu(w,G,M,ye),sl=ye||Y||Rp(Re),Ve=!Oe&&!Se;if(ne){if(Ve){let hl=Bs(re);Ee({navigation:Re,...hl!==void 0?{actionData:hl}:{}},{flushSync:Ce})}let Ae=await mi(G,w.pathname,j.signal);if(Ae.type==="aborted")return{shortCircuited:!0};if(Ae.type==="error"){if(Ae.partialMatches.length===0){let{matches:yl,route:bl}=ba(f.activeRoutes);return{matches:yl,loaderData:{},errors:{[bl.id]:Ae.error}}}let hl=pi(Ae.partialMatches).route.id;return{matches:Ae.partialMatches,loaderData:{},errors:{[hl]:Ae.error}}}else if(Ae.matches)G=Ae.matches;else{let{error:hl,notFoundMatches:yl,route:bl}=Hi(w.pathname);return{matches:yl,loaderData:{},errors:{[bl.id]:hl}}}}let Fe=f.activeRoutes,{dsMatches:Be,revalidatingFetchers:fl}=Ip(j,T,p,g,t.history,L,G,sl,w,Se?[]:r,Se===!0,de,N,he,me,ce,Fe,m,t.patchRoutesOnNavigation!=null,f.branches,re,Ue);if(y=++V,!t.dataStrategy&&!Be.some(Ae=>Ae.shouldLoad)&&!Be.some(Ae=>Ae.route.middleware&&Ae.route.middleware.length>0)&&fl.length===0){let Ae=new Map(L.fetchers),hl=Bi(Ae);return ll(w,{matches:G,loaderData:{},errors:re&&Hl(re[1])?{[re[0]]:re[1].error}:null,...Hp(re),...hl?{fetchers:Ae}:{}},{flushSync:Ce}),{shortCircuited:!0}}if(Ve){let Ae={};if(!ne){Ae.navigation=Re;let hl=Bs(re);hl!==void 0&&(Ae.actionData=hl)}fl.length>0&&(Ae.fetchers=As(fl)),Ee(Ae,{flushSync:Ce})}fl.forEach(Ae=>{Xl(Ae.key),Ae.controller&&Q.set(Ae.key,Ae.controller)});let bs=()=>fl.forEach(Ae=>Xl(Ae.key));we&&we.signal.addEventListener("abort",bs);let{loaderResults:es,fetcherResults:ls}=await zi(Be,fl,j,w,T);if(j.signal.aborted)return{shortCircuited:!0};we&&we.signal.removeEventListener("abort",bs),fl.forEach(Ae=>Q.delete(Ae.key));let cs=Ca(es);if(cs)return await rs(j,cs.result,!0,{replace:oe}),{shortCircuited:!0};if(cs=Ca(ls),cs)return ce.add(cs.key),await rs(j,cs.result,!0,{replace:oe}),{shortCircuited:!0};let Ul=new Map(L.fetchers),{loaderData:Os,errors:al}=Ap(L,G,es,re,fl,ls,Ul);Se&&L.errors&&(al={...L.errors,...al});let Ti=Bi(Ul),ml=Ai(y,Ul),Ri=Ti||ml||fl.length>0;return{matches:G,loaderData:Os,errors:al,...Ri?{workingFetchers:Ul}:{}}}function Bs(j){if(j&&!Hl(j[1]))return{[j[0]]:j[1].data};if(L.actionData)return Object.keys(L.actionData).length===0?null:L.actionData}function As(j){let w=new Map(L.fetchers);return j.forEach(G=>{let M=w.get(G.key),T=nn(void 0,M?M.data:void 0);w.set(G.key,T)}),w}async function St(j,w,G,M){Xl(j);let T=(M&&M.flushSync)===!0,ne=f.activeRoutes,ae=Iu(L.location,L.matches,m,G,w,M==null?void 0:M.relative),ye=us(ne,ae,m,!1,f.branches),Y=Ts(ye,ne,ae);if(Y.active&&Y.matches&&(ye=Y.matches),!ye){xl(j,w,Vl(404,{pathname:ae}),{flushSync:T});return}let{path:oe,submission:Se,error:Ce}=Lp(!0,ae,M);if(Ce){xl(j,w,Ce,{flushSync:T});return}let re=t.getContext?await t.getContext():new xp,Ue=(M&&M.preventScrollReset)===!0;if(Se&&wl(Se.formMethod)){await vn(j,w,oe,ye,re,Y.active,T,Ue,Se,M&&M.defaultShouldRevalidate);return}me.set(j,{routeId:w,path:oe}),await wn(j,w,oe,ye,re,Y.active,T,Ue,Se)}async function vn(j,w,G,M,T,ne,ae,ye,Y,oe){Hs(),me.delete(j);let Se=L.fetchers.get(j);Tl(j,Hm(Y,Se),{flushSync:ae});let Ce=new AbortController,re=ft(t.history,G,Ce.signal,Y);if(ne){let We=await mi(M,new URL(re.url).pathname,re.signal,j);if(We.type==="aborted")return;if(We.type==="error"){xl(j,w,We.error,{flushSync:ae});return}else if(We.matches)M=We.matches;else{xl(j,w,Vl(404,{pathname:G}),{flushSync:ae});return}}let Ue=Pa(M,G);if(!Ue.route.action&&!Ue.route.lazy){let We=Vl(405,{method:Y.formMethod,pathname:G,routeId:w});xl(j,w,We,{flushSync:ae});return}Q.set(j,Ce);let Re=V,sl=_t(p,g,re,G,M,Ue,r,T),Ve=await Ms(re,G,sl,T,j),Fe=Ve[Ue.route.id];if(!Fe){for(let We of sl)if(Ve[We.route.id]){Fe=Ve[We.route.id];break}}if(re.signal.aborted){Q.get(j)===Ce&&Q.delete(j);return}if(he.has(j)){if(Gi(Fe)||Hl(Fe)){Tl(j,js(void 0));return}}else{if(Gi(Fe))if(Q.delete(j),y>Re){Tl(j,js(void 0));return}else return ce.add(j),Tl(j,nn(Y)),rs(re,Fe,!1,{fetcherSubmission:Y,preventScrollReset:ye});if(Hl(Fe)){xl(j,w,Fe.error);return}}let Be=L.navigation.location||L.location,fl=ft(t.history,Be,Ce.signal),bs=f.activeRoutes,es=L.navigation.state!=="idle"?us(bs,L.navigation.location,m,!1,f.branches):L.matches;Ge(es,"Didn't find any matches after fetcher action");let ls=++V;B.set(j,ls);let{dsMatches:cs,revalidatingFetchers:Ul}=Ip(fl,T,p,g,t.history,L,es,Y,Be,r,!1,de,N,he,me,ce,bs,m,t.patchRoutesOnNavigation!=null,f.branches,[Ue.route.id,Fe],oe),Os=nn(Y,Fe.data),al=new Map(L.fetchers);al.set(j,Os),Ul.filter(We=>We.key!==j).forEach(We=>{let Cs=We.key,Oi=al.get(Cs),kn=nn(void 0,Oi?Oi.data:void 0);al.set(Cs,kn),Xl(Cs),We.controller&&Q.set(Cs,We.controller)}),Ee({fetchers:al});let Ti=()=>Ul.forEach(We=>Xl(We.key));Ce.signal.addEventListener("abort",Ti);let{loaderResults:ml,fetcherResults:Ri}=await zi(cs,Ul,fl,Be,T);if(Ce.signal.aborted)return;Ce.signal.removeEventListener("abort",Ti),B.delete(j),Q.delete(j),Ul.forEach(We=>Q.delete(We.key));let Ae=L.fetchers.has(j),hl=We=>{if(!Ae)return We;let Cs=new Map(We.fetchers);return Cs.set(j,js(Fe.data)),{...We,fetchers:Cs}},yl=Ca(ml);if(yl)return L=hl(L),rs(fl,yl.result,!1,{preventScrollReset:ye});if(yl=Ca(Ri),yl)return ce.add(yl.key),L=hl(L),rs(fl,yl.result,!1,{preventScrollReset:ye});let bl=new Map(L.fetchers);Ae&&bl.set(j,js(Fe.data));let{loaderData:Ns,errors:Fs}=Ap(L,es,ml,void 0,Ul,Ri,bl);Ai(ls,bl),L.navigation.state==="loading"&&ls>y?(Ge(ke,"Expected pending action"),we&&we.abort(),ll(L.navigation.location,{matches:es,loaderData:Ns,errors:Fs,fetchers:bl})):(Ee({errors:Fs,loaderData:Mp(L.loaderData,Ns,es,Fs),fetchers:bl}),de=!1)}async function wn(j,w,G,M,T,ne,ae,ye,Y){let oe=L.fetchers.get(j);Tl(j,nn(Y,oe?oe.data:void 0),{flushSync:ae});let Se=new AbortController,Ce=ft(t.history,G,Se.signal);if(ne){let Fe=await mi(M,new URL(Ce.url).pathname,Ce.signal,j);if(Fe.type==="aborted")return;if(Fe.type==="error"){xl(j,w,Fe.error,{flushSync:ae});return}else if(Fe.matches)M=Fe.matches;else{xl(j,w,Vl(404,{pathname:G}),{flushSync:ae});return}}let re=Pa(M,G);Q.set(j,Se);let Ue=V,Re=_t(p,g,Ce,G,M,re,r,T),sl=await Ms(Ce,G,Re,T,j),Ve=sl[re.route.id];if(!Ve){for(let Fe of M)if(sl[Fe.route.id]){Ve=sl[Fe.route.id];break}}if(Q.get(j)===Se&&Q.delete(j),!Ce.signal.aborted){if(he.has(j)){Tl(j,js(void 0));return}if(Gi(Ve))if(y>Ue){Tl(j,js(void 0));return}else{ce.add(j),await rs(Ce,Ve,!1,{preventScrollReset:ye});return}if(Hl(Ve)){xl(j,w,Ve.error);return}Tl(j,js(Ve.data))}}async function rs(j,w,G,{submission:M,fetcherSubmission:T,preventScrollReset:ne,replace:ae}={}){G||(fe==null||fe.resolve(),fe=null),w.response.headers.has("X-Remix-Revalidate")&&(de=!0);let ye=w.response.headers.get("Location");Ge(ye,"Expected a Location header on the redirect Response"),ye=qp(ye,new URL(j.url),m,t.history);let Y=dn(L.location,ye,{_isRedirect:!0});if(o){let Re=!1;if(w.response.headers.has("X-Remix-Reload-Document"))Re=!0;else if(zu(ye)){const sl=rd(a,ye,!0);Re=sl.origin!==a.location.origin||Ql(sl.pathname,m)==null}if(Re){ae?a.location.replace(ye):a.location.assign(ye);return}}we=null;let oe=ae===!0||w.response.headers.has("X-Remix-Replace")?"REPLACE":"PUSH",{formMethod:Se,formAction:Ce,formEncType:re}=L.navigation;!M&&!T&&Se&&Ce&&re&&(M=Rp(L.navigation));let Ue=M||T;if(gm.has(w.response.status)&&Ue&&wl(Ue.formMethod))await zl(oe,Y,{submission:{...Ue,formAction:ye},preventScrollReset:ne||Ne,enableViewTransition:G?Pe:void 0});else{let Re=yu(Y,[],oe,M);await zl(oe,Y,{overrideNavigation:Re,fetcherSubmission:T,preventScrollReset:ne||Ne,enableViewTransition:G?Pe:void 0})}}async function Ms(j,w,G,M,T){var ye;let ne,ae={};try{ne=await Em(_,j,w,G,T,M,!1)}catch(Y){return G.filter(oe=>oe.shouldLoad).forEach(oe=>{ae[oe.route.id]={type:"error",error:Y}}),ae}if(j.signal.aborted)return ae;if(!wl(j.method))for(let Y of G){if(((ye=ne[Y.route.id])==null?void 0:ye.type)==="error")break;!ne.hasOwnProperty(Y.route.id)&&!L.loaderData.hasOwnProperty(Y.route.id)&&(!L.errors||!L.errors.hasOwnProperty(Y.route.id))&&Y.shouldCallHandler()&&(ne[Y.route.id]={type:"error",result:new Error(`No result returned from dataStrategy for route ${Y.route.id}`)})}for(let[Y,oe]of Object.entries(ne))if(Um(oe)){let Se=oe.result;ae[Y]={type:"redirect",response:Lm(Se,j,Y,G,m)}}else ae[Y]=await Cm(oe);return ae}async function zi(j,w,G,M,T){let ne=Ms(G,M,j,T,null),ae=Promise.all(w.map(async oe=>{if(oe.matches&&oe.match&&oe.request&&oe.controller){let Ce=(await Ms(oe.request,oe.path,oe.matches,T,oe.key))[oe.match.route.id];return{[oe.key]:Ce}}else return Promise.resolve({[oe.key]:{type:"error",error:Vl(404,{pathname:oe.path})}})})),ye=await ne,Y=(await ae).reduce((oe,Se)=>Object.assign(oe,Se),{});return{loaderResults:ye,fetcherResults:Y}}function Hs(){de=!0,me.forEach((j,w)=>{Q.has(w)&&N.add(w),Xl(w)})}function Tl(j,w,G={}){let M=new Map(L.fetchers);M.set(j,w),Ee({fetchers:M},{flushSync:(G&&G.flushSync)===!0})}function xl(j,w,G,M={}){let T=pi(L.matches,w),ne=new Map(L.fetchers);Ui(ne,j),Ee({errors:{[T.route.id]:G},fetchers:ne},{flushSync:(M&&M.flushSync)===!0})}function fi(j){return ge.set(j,(ge.get(j)||0)+1),he.has(j)&&he.delete(j),L.fetchers.get(j)||fm}function Ha(j,w){Xl(j,w==null?void 0:w.reason),Tl(j,js(null))}function Ui(j,w){let G=L.fetchers.get(w);Q.has(w)&&!(G&&G.state==="loading"&&B.has(w))&&Xl(w),me.delete(w),B.delete(w),ce.delete(w),he.delete(w),N.delete(w),j.delete(w)}function xn(j){let w=(ge.get(j)||0)-1;w<=0?(ge.delete(j),he.add(j)):ge.set(j,w),Ee({fetchers:new Map(L.fetchers)})}function Xl(j,w){let G=Q.get(j);G&&(G.abort(w),Q.delete(j))}function qi(j,w){for(let G of j){let M=w.get(G);Ge(M,`Expected fetcher: ${G}`);let T=js(M.data);w.set(G,T)}}function Bi(j){let w=[],G=!1;for(let M of ce){let T=j.get(M);Ge(T,`Expected fetcher: ${M}`),T.state==="loading"&&(ce.delete(M),w.push(M),G=!0)}return qi(w,j),G}function Ai(j,w){let G=[];for(let[M,T]of B)if(T<j){let ne=w.get(M);Ge(ne,`Expected fetcher: ${M}`),ne.state==="loading"&&(Xl(M),B.delete(M),G.push(M))}return qi(G,w),G.length>0}function vt(j,w){let G=L.blockers.get(j)||tn;return Ie.get(j)!==w&&Ie.set(j,w),G}function Mi(j){L.blockers.delete(j),Ie.delete(j)}function Zl(j,w){let G=L.blockers.get(j)||tn;Ge(G.state==="unblocked"&&w.state==="blocked"||G.state==="blocked"&&w.state==="blocked"||G.state==="blocked"&&w.state==="proceeding"||G.state==="blocked"&&w.state==="unblocked"||G.state==="proceeding"&&w.state==="unblocked",`Invalid blocker state transition: ${G.state} -> ${w.state}`);let M=new Map(L.blockers);M.set(j,w),Ee({blockers:M})}function ks({currentLocation:j,nextLocation:w,historyAction:G}){if(Ie.size===0)return;Ie.size>1&&nl(!1,"A router only supports one blocker at a time");let M=Array.from(Ie.entries()),[T,ne]=M[M.length-1],ae=L.blockers.get(T);if(!(ae&&ae.state==="proceeding")&&ne({currentLocation:j,nextLocation:w,historyAction:G}))return T}function Hi(j){let w=Vl(404,{pathname:j}),G=f.activeRoutes,{matches:M,route:T}=ba(G);return{notFoundMatches:M,route:T,error:w}}function yn(j,w,G){if(H=j,q=w,A=G||null,!D&&L.navigation===xu){D=!0;let M=xt(L.location,L.matches);M!=null&&Ee({restoreScrollPosition:M})}return()=>{H=null,q=null,A=null}}function wt(j,w){return A&&A(j,w.map(M=>Tf(M,L.loaderData)))||j.key}function En(j,w){if(H&&q){let G=wt(j,w);H[G]=q()}}function xt(j,w){if(H){let G=wt(j,w),M=H[G];if(typeof M=="number")return M}return null}function Ts(j,w,G){if(t.patchRoutesOnNavigation){let M=f.branches;if(j){if(Object.keys(j[0].params).length>0)return{active:!0,matches:us(w,G,m,!0,M)}}else return{active:!0,matches:us(w,G,m,!0,M)||[]}}return{active:!1,matches:null}}async function mi(j,w,G,M){if(!t.patchRoutesOnNavigation)return{type:"success",matches:j};let T=j;for(;;){let ne=g;try{await t.patchRoutesOnNavigation({signal:G,path:w,matches:T,fetcherKey:M,patch:(oe,Se)=>{G.aborted||Gp(oe,Se,f,ne,p,!1)}})}catch(oe){return{type:"error",error:oe,partialMatches:T}}if(G.aborted)return{type:"aborted"};let ae=f.branches,ye=us(f.activeRoutes,w,m,!1,ae),Y=null;if(ye){if(Object.keys(ye[0].params).length===0)return{type:"success",matches:ye};if(Y=us(f.activeRoutes,w,m,!0,ae),!(Y&&T.length<Y.length&&Rs(T,Y.slice(0,T.length))))return{type:"success",matches:ye}}if(Y||(Y=us(f.activeRoutes,w,m,!0,ae)),!Y||Rs(T,Y))return{type:"success",matches:null};T=Y}}function Rs(j,w){return j.length===w.length&&j.every((G,M)=>G.route.id===w[M].route.id)}function yt(j){g={},f.setHmrRoutes(gn(j,p,void 0,g))}function hi(j,w,G=!1){Gp(j,w,f,g,p,G),f.hasHMRRoutes||Ee({})}return Le={get basename(){return m},get future(){return E},get state(){return L},get routes(){return f.stableRoutes},get branches(){return f.branches},get manifest(){return g},get window(){return a},initialize:$,subscribe:be,enableScrollRestoration:yn,navigate:ys,fetch:St,revalidate:Es,createHref:j=>t.history.createHref(j),encodeLocation:j=>t.history.encodeLocation(j),getFetcher:fi,resetFetcher:Ha,deleteFetcher:xn,dispose:se,getBlocker:vt,deleteBlocker:Mi,patchRoutes:hi,_internalFetchControllers:Q,_internalSetRoutes:yt,_internalSetStateDoNotUseOrYouWillBreakYourApp(j){Ee(j)}},t.instrumentations&&(Le=nm(Le,t.instrumentations.map(j=>j.router).filter(Boolean))),Le}function jm(t){return t!=null&&("formData"in t&&t.formData!=null||"body"in t&&t.body!==void 0)}function Iu(t,a,o,r,c,p){let g,f;if(c){g=[];for(let _ of a)if(g.push(_),_.route.id===c){f=_;break}}else g=a,f=a[a.length-1];let m=Ba(r||".",Uu(g),Ql(t.pathname,o)||t.pathname,p==="path");if(r==null&&(m.search=t.search,m.hash=t.hash),(r==null||r===""||r===".")&&f){let _=Mu(m.search);if(f.route.index&&!_)m.search=m.search?m.search.replace(/^\?/,"?index&"):"?index";else if(!f.route.index&&_){let E=new URLSearchParams(m.search),S=E.getAll("index");E.delete("index"),S.filter(U=>U).forEach(U=>E.append("index",U));let J=E.toString();m.search=J?`?${J}`:""}}return o!=="/"&&(m.pathname=Zf({basename:o,pathname:m.pathname})),Ss(m)}function Lp(t,a,o){if(!o||!jm(o))return{path:a};if(o.formMethod&&!Am(o.formMethod))return{path:a,error:Vl(405,{method:o.formMethod})};let r=()=>({path:a,error:Vl(400,{type:"invalid-body"})}),p=(o.formMethod||"get").toUpperCase(),g=Id(a);if(o.body!==void 0){if(o.formEncType==="text/plain"){if(!wl(p))return r();let S=typeof o.body=="string"?o.body:o.body instanceof FormData||o.body instanceof URLSearchParams?Array.from(o.body.entries()).reduce((J,[U,H])=>`${J}${U}=${H}
`,""):String(o.body);return{path:a,submission:{formMethod:p,formAction:g,formEncType:o.formEncType,formData:void 0,json:void 0,text:S}}}else if(o.formEncType==="application/json"){if(!wl(p))return r();try{let S=typeof o.body=="string"?JSON.parse(o.body):o.body;return{path:a,submission:{formMethod:p,formAction:g,formEncType:o.formEncType,formData:void 0,json:S,text:void 0}}}catch{return r()}}}Ge(typeof FormData=="function","FormData is not available in this environment");let f,m;if(o.formData)f=Pu(o.formData),m=o.formData;else if(o.body instanceof FormData)f=Pu(o.body),m=o.body;else if(o.body instanceof URLSearchParams)f=o.body,m=Bp(f);else if(o.body==null)f=new URLSearchParams,m=new FormData;else try{f=new URLSearchParams(o.body),m=Bp(f)}catch{return r()}let _={formMethod:p,formAction:g,formEncType:o&&o.formEncType||"application/x-www-form-urlencoded",formData:m,json:void 0,text:void 0};if(wl(_.formMethod))return{path:a,submission:_};let E=vs(a);return t&&E.search&&Mu(E.search)&&f.append("index",""),E.search=`?${f}`,{path:Ss(E),submission:_}}function Ip(t,a,o,r,c,p,g,f,m,_,E,S,J,U,H,A,q,D,K,X,pe,ue){var Oe;let ve=pe?Hl(pe[1])?pe[1].error:pe[1].data:void 0,Le=c.createURL(p.location),L=c.createURL(m),ke;if(E&&p.errors){let de=Object.keys(p.errors)[0];ke=g.findIndex(N=>N.route.id===de)}else if(pe&&Hl(pe[1])){let de=pe[0];ke=g.findIndex(N=>N.route.id===de)-1}let fe=pe?pe[1].statusCode:void 0,Ne=fe&&fe>=400,we={currentUrl:Le,currentParams:((Oe=p.matches[0])==null?void 0:Oe.params)||{},nextUrl:L,nextParams:g[0].params,...f,actionResult:ve,actionStatus:fe},Pe=hn(g),Je=g.map((de,N)=>{let{route:Q}=de,V=null;if(ke!=null&&N>ke)V=!1;else if(Q.lazy)V=!0;else if(!Bu(Q))V=!1;else if(E){let{shouldLoad:me}=xd(Q,p.loaderData,p.errors);V=me}else Sm(p.loaderData,p.matches[N],de)&&(V=!0);if(V!==null)return Gu(o,r,t,m,Pe,de,_,a,V);let y=!1;typeof ue=="boolean"?y=ue:Ne?y=!1:(S||Le.pathname+Le.search===L.pathname+L.search||Le.search!==L.search||vm(p.matches[N],de))&&(y=!0);let B={...we,defaultShouldRevalidate:y},ce=pn(de,B);return Gu(o,r,t,m,Pe,de,_,a,ce,B,ue)}),Me=[];return H.forEach((de,N)=>{if(E||!g.some(he=>he.route.id===de.routeId)||U.has(N))return;let Q=p.fetchers.get(N),V=Q&&Q.state!=="idle"&&Q.data===void 0,y=us(q,de.path,D??"/",!1,X);if(!y){if(K&&V)return;Me.push({key:N,routeId:de.routeId,path:de.path,matches:null,match:null,request:null,controller:null});return}if(A.has(N))return;let B=Pa(y,de.path),ce=new AbortController,me=ft(c,de.path,ce.signal),ge=null;if(J.has(N))J.delete(N),ge=_t(o,r,me,de.path,y,B,_,a);else if(V)S&&(ge=_t(o,r,me,de.path,y,B,_,a));else{let he;typeof ue=="boolean"?he=ue:Ne?he=!1:he=S;let Ie={...we,defaultShouldRevalidate:he};pn(B,Ie)&&(ge=_t(o,r,me,de.path,y,B,_,a,Ie))}ge&&Me.push({key:N,routeId:de.routeId,path:de.path,matches:ge,match:B,request:me,controller:ce})}),{dsMatches:Je,revalidatingFetchers:Me}}function Bu(t){return t.loader!=null||t.middleware!=null&&t.middleware.length>0}function xd(t,a,o){if(t.lazy)return{shouldLoad:!0,renderFallback:!0};if(!Bu(t))return{shouldLoad:!1,renderFallback:!1};let r=a!=null&&t.id in a,c=o!=null&&o[t.id]!==void 0;if(!r&&c)return{shouldLoad:!1,renderFallback:!1};if(typeof t.loader=="function"&&t.loader.hydrate===!0)return{shouldLoad:!0,renderFallback:!r};let p=!r&&!c;return{shouldLoad:p,renderFallback:p}}function Sm(t,a,o){let r=!a||o.route.id!==a.route.id,c=!t.hasOwnProperty(o.route.id);return r||c}function vm(t,a){let o=t.route.path;return t.pathname!==a.pathname||o!=null&&o.endsWith("*")&&t.params["*"]!==a.params["*"]}function pn(t,a){if(t.route.shouldRevalidate){let o=t.route.shouldRevalidate(a);if(typeof o=="boolean")return o}return a.defaultShouldRevalidate}function Gp(t,a,o,r,c,p){let g;if(t){let _=r[t];Ge(_,`No route found to patch children into: routeId = ${t}`),_.children||(_.children=[]),g=_.children}else g=o.activeRoutes;let f=[],m=[];if(a.forEach(_=>{let E=g.find(S=>yd(_,S));E?m.push({existingRoute:E,newRoute:_}):f.push(_)}),f.length>0){let _=gn(f,c,[t||"_","patch",String((g==null?void 0:g.length)||"0")],r);g.push(..._)}if(p&&m.length>0)for(let _=0;_<m.length;_++){let{existingRoute:E,newRoute:S}=m[_],J=E,[U]=gn([S],c,[],{},!0);Object.assign(J,{element:U.element?U.element:J.element,errorElement:U.errorElement?U.errorElement:J.errorElement,hydrateFallbackElement:U.hydrateFallbackElement?U.hydrateFallbackElement:J.hydrateFallbackElement})}o.hasHMRRoutes||o.setRoutes([...o.activeRoutes])}function yd(t,a){var o;return"id"in t&&"id"in a&&t.id===a.id?!0:t.index===a.index&&t.path===a.path&&t.caseSensitive===a.caseSensitive?(!t.children||t.children.length===0)&&(!a.children||a.children.length===0)?!0:((o=t.children)==null?void 0:o.every((r,c)=>{var p;return(p=a.children)==null?void 0:p.some(g=>yd(r,g))}))??!1:!1}var Pp=new WeakMap,Ed=({key:t,route:a,manifest:o,mapRouteProperties:r})=>{let c=o[a.id];if(Ge(c,"No route found in manifest"),!c.lazy||typeof c.lazy!="object")return;let p=c.lazy[t];if(!p)return;let g=Pp.get(c);g||(g={},Pp.set(c,g));let f=g[t];if(f)return f;let m=(async()=>{let _=Bf(t),S=c[t]!==void 0&&t!=="hasErrorBoundary";if(_)nl(!_,"Route property "+t+" is not a supported lazy route property. This property will be ignored."),g[t]=Promise.resolve();else if(S)nl(!1,`Route "${c.id}" has a static property "${t}" defined. The lazy property will be ignored.`);else{let J=await p();J!=null&&(Object.assign(c,{[t]:J}),Object.assign(c,r(c)))}typeof c.lazy=="object"&&(c.lazy[t]=void 0,Object.values(c.lazy).every(J=>J===void 0)&&(c.lazy=void 0))})();return g[t]=m,m},Jp=new WeakMap;function wm(t,a,o,r,c){let p=o[t.id];if(Ge(p,"No route found in manifest"),!t.lazy)return{lazyRoutePromise:void 0,lazyHandlerPromise:void 0};if(typeof t.lazy=="function"){let E=Jp.get(p);if(E)return{lazyRoutePromise:E,lazyHandlerPromise:E};let S=(async()=>{Ge(typeof t.lazy=="function","No lazy route function found");let J=await t.lazy(),U={};for(let H in J){let A=J[H];if(A===void 0)continue;let q=Mf(H),K=p[H]!==void 0&&H!=="hasErrorBoundary";q?nl(!q,"Route property "+H+" is not a supported property to be returned from a lazy route function. This property will be ignored."):K?nl(!K,`Route "${p.id}" has a static property "${H}" defined but its lazy function is also returning a value for this property. The lazy route property "${H}" will be ignored.`):U[H]=A}Object.assign(p,U),Object.assign(p,{...r(p),lazy:void 0})})();return Jp.set(p,S),S.catch(()=>{}),{lazyRoutePromise:S,lazyHandlerPromise:S}}let g=Object.keys(t.lazy),f=[],m;for(let E of g){if(c&&c.includes(E))continue;let S=Ed({key:E,route:t,manifest:o,mapRouteProperties:r});S&&(f.push(S),E===a&&(m=S))}let _=f.length>0?Promise.all(f).then(()=>{}):void 0;return _==null||_.catch(()=>{}),m==null||m.catch(()=>{}),{lazyRoutePromise:_,lazyHandlerPromise:m}}async function zp(t){let a=t.matches.filter(c=>c.shouldLoad),o={};return(await Promise.all(a.map(c=>c.resolve()))).forEach((c,p)=>{o[a[p].route.id]=c}),o}async function xm(t){return t.matches.some(a=>a.route.middleware)?kd(t,()=>zp(t)):zp(t)}function kd(t,a){return ym(t,a,r=>{if(Bm(r))throw r;return r},Jm,o);function o(r,c,p){if(p)return Promise.resolve(Object.assign(p.value,{[c]:{type:"error",result:r}}));{let{matches:g}=t,f=Math.min(Math.max(g.findIndex(_=>_.route.id===c),0),Math.max(g.findIndex(_=>_.shouldCallHandler()),0)),m=pi(g,g[f].route.id).route.id;return Promise.resolve({[m]:{type:"error",result:r}})}}}async function ym(t,a,o,r,c){let{matches:p,...g}=t,f=p.flatMap(_=>_.route.middleware?_.route.middleware.map(E=>[_.route.id,E]):[]);return await bd(g,f,a,o,r,c)}async function bd(t,a,o,r,c,p,g=0){let{request:f}=t;if(f.signal.aborted)throw f.signal.reason??new Error(`Request aborted: ${f.method} ${f.url}`);let m=a[g];if(!m)return await o();let[_,E]=m,S,J=async()=>{if(S)throw new Error("You may only call `next()` once per middleware");try{return S={value:await bd(t,a,o,r,c,p,g+1)},S.value}catch(U){return S={value:await p(U,_,S)},S.value}};try{let U=await E(t,J),H=U!=null?r(U):void 0;return c(H)?H:S?H??S.value:(S={value:await J()},S.value)}catch(U){return await p(U,_,S)}}function Cd(t,a,o,r,c){let p=Ed({key:"middleware",route:r.route,manifest:a,mapRouteProperties:t}),g=wm(r.route,wl(o.method)?"action":"loader",a,t,c);return{middleware:p,route:g.lazyRoutePromise,handler:g.lazyHandlerPromise}}function Gu(t,a,o,r,c,p,g,f,m,_=null,E){let S=!1,J=Cd(t,a,o,p,g);return{...p,_lazyPromises:J,shouldLoad:m,shouldRevalidateArgs:_,shouldCallHandler(U){return S=!0,_?typeof E=="boolean"?pn(p,{..._,defaultShouldRevalidate:E}):typeof U=="boolean"?pn(p,{..._,defaultShouldRevalidate:U}):pn(p,_):m},resolve(U){let{lazy:H,loader:A,middleware:q}=p.route,D=S||m||U&&!wl(o.method)&&(H||A),K=q&&q.length>0&&!A&&!H;return D&&(wl(o.method)||!K)?km({request:o,path:r,pattern:c,match:p,lazyHandlerPromise:J==null?void 0:J.handler,lazyRoutePromise:J==null?void 0:J.route,handlerOverride:U,scopedContext:f}):Promise.resolve({type:"data",result:void 0})}}}function _t(t,a,o,r,c,p,g,f,m=null){return c.map(_=>_.route.id!==p.route.id?{..._,shouldLoad:!1,shouldRevalidateArgs:m,shouldCallHandler:()=>!1,_lazyPromises:Cd(t,a,o,_,g),resolve:()=>Promise.resolve({type:"data",result:void 0})}:Gu(t,a,o,r,hn(c),_,g,f,!0,m))}async function Em(t,a,o,r,c,p,g){r.some(E=>{var S;return(S=E._lazyPromises)==null?void 0:S.middleware})&&await Promise.all(r.map(E=>{var S;return(S=E._lazyPromises)==null?void 0:S.middleware}));let f={request:a,url:Ld(a,o),pattern:hn(r),params:r[0].params,context:p,matches:r},_=await t({...f,fetcherKey:c,runClientMiddleware:E=>{let S=f;return kd(S,()=>E({...S,fetcherKey:c,runClientMiddleware:()=>{throw new Error("Cannot call `runClientMiddleware()` from within an `runClientMiddleware` handler")}}))}});try{await Promise.all(r.flatMap(E=>{var S,J;return[(S=E._lazyPromises)==null?void 0:S.handler,(J=E._lazyPromises)==null?void 0:J.route]}))}catch{}return _}async function km({request:t,path:a,pattern:o,match:r,lazyHandlerPromise:c,lazyRoutePromise:p,handlerOverride:g,scopedContext:f}){let m,_,E=wl(t.method),S=E?"action":"loader",J=U=>{let H,A=new Promise((K,X)=>H=X);_=()=>H(),t.signal.addEventListener("abort",_);let q=K=>typeof U!="function"?Promise.reject(new Error(`You cannot call the handler for a route which defines a boolean "${S}" [routeId: ${r.route.id}]`)):U({request:t,url:Ld(t,a),pattern:o,params:r.params,context:f},...K!==void 0?[K]:[]),D=(async()=>{try{return{type:"data",result:await(g?g(X=>q(X)):q())}}catch(K){return{type:"error",result:K}}})();return Promise.race([D,A])};try{let U=E?r.route.action:r.route.loader;if(c||p)if(U){let H,[A]=await Promise.all([J(U).catch(q=>{H=q}),c,p]);if(H!==void 0)throw H;m=A}else{await c;let H=E?r.route.action:r.route.loader;if(H)[m]=await Promise.all([J(H),p]);else if(S==="action"){let A=new URL(t.url),q=A.pathname+A.search;throw Vl(405,{method:t.method,pathname:q,routeId:r.route.id})}else return{type:"data",result:void 0}}else if(U)m=await J(U);else{let H=new URL(t.url),A=H.pathname+H.search;throw Vl(404,{pathname:A})}}catch(U){return{type:"error",result:U}}finally{_&&t.signal.removeEventListener("abort",_)}return m}async function bm(t){let a=t.headers.get("Content-Type");return a&&/\bapplication\/json\b/.test(a)?t.body==null?null:t.json():t.text()}async function Cm(t){var r,c,p,g,f;let{result:a,type:o}=t;if(Au(a)){let m;try{m=await bm(a)}catch(_){return{type:"error",error:_}}return o==="error"?{type:"error",error:new mn(a.status,a.statusText,m),statusCode:a.status,headers:a.headers}:{type:"data",data:m,statusCode:a.status,headers:a.headers}}return o==="error"?Tp(a)?a.data instanceof Error?{type:"error",error:a.data,statusCode:(r=a.init)==null?void 0:r.status,headers:(c=a.init)!=null&&c.headers?new Headers(a.init.headers):void 0}:{type:"error",error:Pm(a),statusCode:fn(a)?a.status:void 0,headers:(p=a.init)!=null&&p.headers?new Headers(a.init.headers):void 0}:{type:"error",error:a,statusCode:fn(a)?a.status:void 0}:Tp(a)?{type:"data",data:a.data,statusCode:(g=a.init)==null?void 0:g.status,headers:(f=a.init)!=null&&f.headers?new Headers(a.init.headers):void 0}:{type:"data",data:a}}function Lm(t,a,o,r,c){let p=t.headers.get("Location");if(Ge(p,"Redirects returned/thrown from loaders/actions must have a Location header"),!zu(p)){let g=r.slice(0,r.findIndex(f=>f.route.id===o)+1);p=Iu(new URL(a.url),g,c,p),t.headers.set("Location",p)}return t}var Up=["about:","blob:","chrome:","chrome-untrusted:","content:","data:","devtools:","file:","filesystem:","javascript:"];function qp(t,a,o,r){if(zu(t)){let c=t,p=c.startsWith("//")?new URL(a.protocol+c):new URL(c);if(Up.includes(p.protocol))throw new Error("Invalid redirect location");let g=Ql(p.pathname,o)!=null;if(p.origin===a.origin&&g)return qu(p.pathname)+p.search+p.hash}try{let c=r.createURL(t);if(Up.includes(c.protocol))throw new Error("Invalid redirect location")}catch{}return t}function ft(t,a,o,r){let c=t.createURL(Id(a)).toString(),p={signal:o};if(r&&wl(r.formMethod)){let{formMethod:g,formEncType:f}=r;p.method=g.toUpperCase(),f==="application/json"?(p.headers=new Headers({"Content-Type":f}),p.body=JSON.stringify(r.json)):f==="text/plain"?p.body=r.text:f==="application/x-www-form-urlencoded"&&r.formData?p.body=Pu(r.formData):p.body=r.formData}return new Request(c,p)}function Ld(t,a){let o=new URL(t.url),r=typeof a=="string"?vs(a):a;if(o.pathname=r.pathname||"/",r.search){let c=new URLSearchParams(r.search),p=c.getAll("index");c.delete("index");for(let g of p.filter(Boolean))c.append("index",g);o.search=c.size?`?${c.toString()}`:""}else o.search="";return o.hash=r.hash||"",o}function Pu(t){let a=new URLSearchParams;for(let[o,r]of t.entries())a.append(o,typeof r=="string"?r:r.name);return a}function Bp(t){let a=new FormData;for(let[o,r]of t.entries())a.append(o,r);return a}function Im(t,a,o,r=!1,c=!1){let p={},g=null,f,m=!1,_={},E=o&&Hl(o[1])?o[1].error:void 0;return t.forEach(S=>{if(!(S.route.id in a))return;let J=S.route.id,U=a[J];if(Ge(!Gi(U),"Cannot handle redirect results in processLoaderData"),Hl(U)){let H=U.error;if(E!==void 0&&(H=E,E=void 0),g=g||{},c)g[J]=H;else{let A=pi(t,J);g[A.route.id]==null&&(g[A.route.id]=H)}r||(p[J]=wd),m||(m=!0,f=fn(U.error)?U.error.status:500),U.headers&&(_[J]=U.headers)}else p[J]=U.data,U.statusCode&&U.statusCode!==200&&!m&&(f=U.statusCode),U.headers&&(_[J]=U.headers)}),E!==void 0&&o&&(g={[o[0]]:E},o[2]&&(p[o[2]]=void 0)),{loaderData:p,errors:g,statusCode:f||200,loaderHeaders:_}}function Ap(t,a,o,r,c,p,g){let{loaderData:f,errors:m}=Im(a,o,r);return c.filter(_=>!_.matches||_.matches.some(E=>E.shouldLoad)).forEach(_=>{let{key:E,match:S,controller:J}=_;if(J&&J.signal.aborted)return;let U=p[E];if(Ge(U,"Did not find corresponding fetcher result"),Hl(U)){let H=pi(t.matches,S==null?void 0:S.route.id);m&&m[H.route.id]||(m={...m,[H.route.id]:U.error}),g.delete(E)}else if(Gi(U))Ge(!1,"Unhandled fetcher revalidation redirect");else{let H=js(U.data);g.set(E,H)}}),{loaderData:f,errors:m}}function Mp(t,a,o,r){let c=Object.entries(a).filter(([,p])=>p!==wd).reduce((p,[g,f])=>(p[g]=f,p),{});for(let p of o){let g=p.route.id;if(!a.hasOwnProperty(g)&&t.hasOwnProperty(g)&&p.route.loader&&(c[g]=t[g]),r&&r.hasOwnProperty(g))break}return c}function Hp(t){return t?Hl(t[1])?{actionData:{}}:{actionData:{[t[0]]:t[1].data}}:{}}function pi(t,a){return(a?t.slice(0,t.findIndex(r=>r.route.id===a)+1):[...t]).reverse().find(r=>r.route.hasErrorBoundary===!0)||t[0]}function ba(t){let a=t.length===1?t[0]:t.find(o=>o.index||!o.path||o.path==="/")||{id:"__shim-error-route__"};return{matches:[{params:{},pathname:"",pathnameBase:"",route:a}],route:a}}function Vl(t,{pathname:a,routeId:o,method:r,type:c,message:p}={}){let g="Unknown Server Error",f="Unknown @remix-run/router error";return t===400?(g="Bad Request",r&&a&&o?f=`You made a ${r} request to "${a}" but did not provide a \`loader\` for route "${o}", so there is no way to handle the request.`:c==="invalid-body"&&(f="Unable to encode submission body")):t===403?(g="Forbidden",f=`Route "${o}" does not match URL "${a}"`):t===404?(g="Not Found",f=`No route matches URL "${a}"`):t===405&&(g="Method Not Allowed",r&&a&&o?f=`You made a ${r.toUpperCase()} request to "${a}" but did not provide an \`action\` for route "${o}", so there is no way to handle the request.`:r&&(f=`Invalid request method "${r.toUpperCase()}"`)),new mn(t||500,g,new Error(f),!0)}function Ca(t){let a=Object.entries(t);for(let o=a.length-1;o>=0;o--){let[r,c]=a[o];if(Gi(c))return{key:r,result:c}}}function Id(t){let a=typeof t=="string"?vs(t):t;return Ss({...a,hash:""})}function Gm(t,a){return t.pathname!==a.pathname||t.search!==a.search?!1:t.hash===""?a.hash!=="":t.hash===a.hash?!0:a.hash!==""}function Pm(t){var a,o;return new mn(((a=t.init)==null?void 0:a.status)??500,((o=t.init)==null?void 0:o.statusText)??"Internal Server Error",t.data)}function Jm(t){return t!=null&&typeof t=="object"&&Object.entries(t).every(([a,o])=>typeof a=="string"&&zm(o))}function zm(t){return t!=null&&typeof t=="object"&&"type"in t&&"result"in t&&(t.type==="data"||t.type==="error")}function Um(t){return Au(t.result)&&Sd.has(t.result.status)}function Hl(t){return t.type==="error"}function Gi(t){return(t&&t.type)==="redirect"}function Tp(t){return typeof t=="object"&&t!=null&&"type"in t&&"data"in t&&"init"in t&&t.type==="DataWithResponseInit"}function Au(t){return t!=null&&typeof t.status=="number"&&typeof t.statusText=="string"&&typeof t.headers=="object"&&typeof t.body<"u"}function qm(t){return Sd.has(t)}function Bm(t){return Au(t)&&qm(t.status)&&t.headers.has("Location")}function Am(t){return dm.has(t.toUpperCase())}function wl(t){return cm.has(t.toUpperCase())}function Mu(t){return new URLSearchParams(t).getAll("index").some(a=>a==="")}function Pa(t,a){let o=typeof a=="string"?vs(a).search:a.search;if(t[t.length-1].route.index&&Mu(o||""))return t[t.length-1];let r=fd(t);return r[r.length-1]}function Rp(t){let{formMethod:a,formAction:o,formEncType:r,text:c,formData:p,json:g}=t;if(!(!a||!o||!r)){if(c!=null)return{formMethod:a,formAction:o,formEncType:r,formData:void 0,json:void 0,text:c};if(p!=null)return{formMethod:a,formAction:o,formEncType:r,formData:p,json:void 0,text:void 0};if(g!==void 0)return{formMethod:a,formAction:o,formEncType:r,formData:void 0,json:g,text:void 0}}}function yu(t,a,o,r){return r?{state:"loading",location:t,matches:a,historyAction:o,formMethod:r.formMethod,formAction:r.formAction,formEncType:r.formEncType,formData:r.formData,json:r.json,text:r.text}:{state:"loading",location:t,matches:a,historyAction:o,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0}}function Mm(t,a,o,r){return{state:"submitting",location:t,matches:a,historyAction:o,formMethod:r.formMethod,formAction:r.formAction,formEncType:r.formEncType,formData:r.formData,json:r.json,text:r.text}}function nn(t,a){return t?{state:"loading",formMethod:t.formMethod,formAction:t.formAction,formEncType:t.formEncType,formData:t.formData,json:t.json,text:t.text,data:a}:{state:"loading",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0,data:a}}function Hm(t,a){return{state:"submitting",formMethod:t.formMethod,formAction:t.formAction,formEncType:t.formEncType,formData:t.formData,json:t.json,text:t.text,data:a?a.data:void 0}}function js(t){return{state:"idle",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0,data:t}}function Tm(t,a){try{let o=t.sessionStorage.getItem(vd);if(o){let r=JSON.parse(o);for(let[c,p]of Object.entries(r||{}))p&&Array.isArray(p)&&a.set(c,new Set(p||[]))}}catch{}}function Rm(t,a){if(a.size>0){let o={};for(let[r,c]of a)o[r]=[...c];try{t.sessionStorage.setItem(vd,JSON.stringify(o))}catch(r){nl(!1,`Failed to save applied view transitions in sessionStorage (${r}).`)}}}function Op(){let t,a,o=new Promise((r,c)=>{t=async p=>{r(p);try{await o}catch{}},a=async p=>{c(p);try{await o}catch{}}});return{promise:o,resolve:t,reject:a}}var Pi=C.createContext(null);Pi.displayName="DataRouter";var _n=C.createContext(null);_n.displayName="DataRouterState";var Gd=C.createContext(!1);function Pd(){return C.useContext(Gd)}var Hu=C.createContext({isTransitioning:!1});Hu.displayName="ViewTransition";var Jd=C.createContext(new Map);Jd.displayName="Fetchers";var Om=C.createContext(null);Om.displayName="Await";var Yl=C.createContext(null);Yl.displayName="Navigation";var Aa=C.createContext(null);Aa.displayName="Location";var ws=C.createContext({outlet:null,matches:[],isDataRoute:!1});ws.displayName="Route";var Tu=C.createContext(null);Tu.displayName="RouteError";var zd="REACT_ROUTER_ERROR",Nm="REDIRECT",Fm="ROUTE_ERROR_RESPONSE";function Dm(t){if(t.startsWith(`${zd}:${Nm}:{`))try{let a=JSON.parse(t.slice(28));if(typeof a=="object"&&a&&typeof a.status=="number"&&typeof a.statusText=="string"&&typeof a.location=="string"&&typeof a.reloadDocument=="boolean"&&typeof a.replace=="boolean")return a}catch{}}function Wm(t){if(t.startsWith(`${zd}:${Fm}:{`))try{let a=JSON.parse(t.slice(40));if(typeof a=="object"&&a&&typeof a.status=="number"&&typeof a.statusText=="string")return new mn(a.status,a.statusText,a.data)}catch{}}function $m(t,{relative:a}={}){Ge(jn(),"useHref() may be used only in the context of a <Router> component.");let{basename:o,navigator:r}=C.useContext(Yl),{hash:c,pathname:p,search:g}=Sn(t,{relative:a}),f=p;return o!=="/"&&(f=p==="/"?o:Kl([o,p])),r.createHref({pathname:f,search:g,hash:c})}function jn(){return C.useContext(Aa)!=null}function xs(){return Ge(jn(),"useLocation() may be used only in the context of a <Router> component."),C.useContext(Aa).location}var Ud="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function qd(t){C.useContext(Yl).static||C.useLayoutEffect(t)}function Bd(){let{isDataRoute:t}=C.useContext(ws);return t?oh():Vm()}function Vm(){Ge(jn(),"useNavigate() may be used only in the context of a <Router> component.");let t=C.useContext(Pi),{basename:a,navigator:o}=C.useContext(Yl),{matches:r}=C.useContext(ws),{pathname:c}=xs(),p=JSON.stringify(Uu(r)),g=C.useRef(!1);return qd(()=>{g.current=!0}),C.useCallback((m,_={})=>{if(nl(g.current,Ud),!g.current)return;if(typeof m=="number"){o.go(m);return}let E=Ba(m,JSON.parse(p),c,_.relative==="path");t==null&&a!=="/"&&(E.pathname=E.pathname==="/"?a:Kl([a,E.pathname])),(_.replace?o.replace:o.push)(E,_.state,_)},[a,o,p,c,t])}C.createContext(null);function Km(){let{matches:t}=C.useContext(ws),a=t[t.length-1];return(a==null?void 0:a.params)??{}}function Sn(t,{relative:a}={}){let{matches:o}=C.useContext(ws),{pathname:r}=xs(),c=JSON.stringify(Uu(o));return C.useMemo(()=>Ba(t,JSON.parse(c),r,a==="path"),[t,c,r,a])}function Qm(t,a,o){Ge(jn(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:r}=C.useContext(Yl),{matches:c}=C.useContext(ws),p=c[c.length-1],g=p?p.params:{},f=p?p.pathname:"/",m=p?p.pathnameBase:"/",_=p&&p.route;{let q=_&&_.path||"";Md(f,!_||q.endsWith("*")||q.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${f}" (under <Route path="${q}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${q}"> to <Route path="${q==="/"?"*":`${q}/*`}">.`)}let E=xs(),S;S=E;let J=S.pathname||"/",U=J;if(m!=="/"){let q=m.replace(/^\//,"").split("/");U="/"+J.replace(/^\//,"").split("/").slice(q.length).join("/")}let H=o&&o.state.matches.length?o.state.matches.map(q=>Object.assign(q,{route:o.manifest[q.route.id]||q.route})):cd(t,{pathname:U});return nl(_||H!=null,`No routes matched location "${S.pathname}${S.search}${S.hash}" `),nl(H==null||H[H.length-1].route.element!==void 0||H[H.length-1].route.Component!==void 0||H[H.length-1].route.lazy!==void 0,`Matched leaf route at location "${S.pathname}${S.search}${S.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`),lh(H&&H.map(q=>Object.assign({},q,{params:Object.assign({},g,q.params),pathname:Kl([m,r.encodeLocation?r.encodeLocation(q.pathname.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:q.pathname]),pathnameBase:q.pathnameBase==="/"?m:Kl([m,r.encodeLocation?r.encodeLocation(q.pathnameBase.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:q.pathnameBase])})),c,o)}function Ym(){let t=ah(),a=fn(t)?`${t.status} ${t.statusText}`:t instanceof Error?t.message:JSON.stringify(t),o=t instanceof Error?t.stack:null,r="rgba(200,200,200, 0.5)",c={padding:"0.5rem",backgroundColor:r},p={padding:"2px 4px",backgroundColor:r},g=null;return console.error("Error handled by React Router default ErrorBoundary:",t),g=C.createElement(C.Fragment,null,C.createElement("p",null,"💿 Hey developer 👋"),C.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",C.createElement("code",{style:p},"ErrorBoundary")," or"," ",C.createElement("code",{style:p},"errorElement")," prop on your route.")),C.createElement(C.Fragment,null,C.createElement("h2",null,"Unexpected Application Error!"),C.createElement("h3",{style:{fontStyle:"italic"}},a),o?C.createElement("pre",{style:c},o):null,g)}var Xm=C.createElement(Ym,null),Ad=class extends C.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,a){return a.location!==t.location||a.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:a.error,location:a.location,revalidation:t.revalidation||a.revalidation}}componentDidCatch(t,a){this.props.onError?this.props.onError(t,a):console.error("React Router caught the following error during render",t)}render(){let t=this.state.error;if(this.context&&typeof t=="object"&&t&&"digest"in t&&typeof t.digest=="string"){const o=Wm(t.digest);o&&(t=o)}let a=t!==void 0?C.createElement(ws.Provider,{value:this.props.routeContext},C.createElement(Tu.Provider,{value:t,children:this.props.component})):this.props.children;return this.context?C.createElement(Zm,{error:t},a):a}};Ad.contextType=Gd;var Eu=new WeakMap;function Zm({children:t,error:a}){let{basename:o}=C.useContext(Yl);if(typeof a=="object"&&a&&"digest"in a&&typeof a.digest=="string"){let r=Dm(a.digest);if(r){let c=Eu.get(a);if(c)throw c;let p=hd(r.location,o);if(md&&!Eu.get(a))if(p.isExternal||r.reloadDocument)window.location.href=p.absoluteURL||p.to;else{const g=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(p.to,{replace:r.replace}));throw Eu.set(a,g),g}return C.createElement("meta",{httpEquiv:"refresh",content:`0;url=${p.absoluteURL||p.to}`})}}return t}function eh({routeContext:t,match:a,children:o}){let r=C.useContext(Pi);return r&&r.static&&r.staticContext&&(a.route.errorElement||a.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=a.route.id),C.createElement(ws.Provider,{value:t},o)}function lh(t,a=[],o){let r=o==null?void 0:o.state;if(t==null){if(!r)return null;if(r.errors)t=r.matches;else if(a.length===0&&!r.initialized&&r.matches.length>0)t=r.matches;else return null}let c=t,p=r==null?void 0:r.errors;if(p!=null){let E=c.findIndex(S=>S.route.id&&(p==null?void 0:p[S.route.id])!==void 0);Ge(E>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),c=c.slice(0,Math.min(c.length,E+1))}let g=!1,f=-1;if(o&&r){g=r.renderFallback;for(let E=0;E<c.length;E++){let S=c[E];if((S.route.HydrateFallback||S.route.hydrateFallbackElement)&&(f=E),S.route.id){let{loaderData:J,errors:U}=r,H=S.route.loader&&!J.hasOwnProperty(S.route.id)&&(!U||U[S.route.id]===void 0);if(S.route.lazy||H){o.isStatic&&(g=!0),f>=0?c=c.slice(0,f+1):c=[c[0]];break}}}}let m=o==null?void 0:o.onError,_=r&&m?(E,S)=>{var J,U;m(E,{location:r.location,params:((U=(J=r.matches)==null?void 0:J[0])==null?void 0:U.params)??{},pattern:hn(r.matches),errorInfo:S})}:void 0;return c.reduceRight((E,S,J)=>{let U,H=!1,A=null,q=null;r&&(U=p&&S.route.id?p[S.route.id]:void 0,A=S.route.errorElement||Xm,g&&(f<0&&J===0?(Md("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),H=!0,q=null):f===J&&(H=!0,q=S.route.hydrateFallbackElement||null)));let D=a.concat(c.slice(0,J+1)),K=()=>{let X;return U?X=A:H?X=q:S.route.Component?X=C.createElement(S.route.Component,null):S.route.element?X=S.route.element:X=E,C.createElement(eh,{match:S,routeContext:{outlet:E,matches:D,isDataRoute:r!=null},children:X})};return r&&(S.route.ErrorBoundary||S.route.errorElement||J===0)?C.createElement(Ad,{location:r.location,revalidation:r.revalidation,component:A,error:U,children:K(),routeContext:{outlet:null,matches:D,isDataRoute:!0},onError:_}):K()},null)}function Ru(t){return`${t} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function sh(t){let a=C.useContext(Pi);return Ge(a,Ru(t)),a}function ih(t){let a=C.useContext(_n);return Ge(a,Ru(t)),a}function th(t){let a=C.useContext(ws);return Ge(a,Ru(t)),a}function Ou(t){let a=th(t),o=a.matches[a.matches.length-1];return Ge(o.route.id,`${t} can only be used on routes that contain a unique "id"`),o.route.id}function nh(){return Ou("useRouteId")}function ah(){var r;let t=C.useContext(Tu),a=ih("useRouteError"),o=Ou("useRouteError");return t!==void 0?t:(r=a.errors)==null?void 0:r[o]}function oh(){let{router:t}=sh("useNavigate"),a=Ou("useNavigate"),o=C.useRef(!1);return qd(()=>{o.current=!0}),C.useCallback(async(c,p={})=>{nl(o.current,Ud),o.current&&(typeof c=="number"?await t.navigate(c):await t.navigate(c,{fromRouteId:a,...p}))},[t,a])}var Np={};function Md(t,a,o){!a&&!Np[t]&&(Np[t]=!0,nl(!1,o))}var Fp={};function Dp(t,a){!t&&!Fp[a]&&(Fp[a]=!0,console.warn(a))}var uh="useOptimistic",Wp=Pf[uh],rh=()=>{};function ch(t){return Wp?Wp(t):[t,rh]}function ph(t){let a={hasErrorBoundary:t.hasErrorBoundary||t.ErrorBoundary!=null||t.errorElement!=null};return t.Component&&(t.element&&nl(!1,"You should not include both `Component` and `element` on your route - `Component` will be used."),Object.assign(a,{element:C.createElement(t.Component),Component:void 0})),t.HydrateFallback&&(t.hydrateFallbackElement&&nl(!1,"You should not include both `HydrateFallback` and `hydrateFallbackElement` on your route - `HydrateFallback` will be used."),Object.assign(a,{hydrateFallbackElement:C.createElement(t.HydrateFallback),HydrateFallback:void 0})),t.ErrorBoundary&&(t.errorElement&&nl(!1,"You should not include both `ErrorBoundary` and `errorElement` on your route - `ErrorBoundary` will be used."),Object.assign(a,{errorElement:C.createElement(t.ErrorBoundary),ErrorBoundary:void 0})),a}var dh=["HydrateFallback","hydrateFallbackElement"],gh=class{constructor(){this.status="pending",this.promise=new Promise((t,a)=>{this.resolve=o=>{this.status==="pending"&&(this.status="resolved",t(o))},this.reject=o=>{this.status==="pending"&&(this.status="rejected",a(o))}})}};function fh({router:t,flushSync:a,onError:o,useTransitions:r}){r=Pd()||r;let[p,g]=C.useState(t.state),[f,m]=ch(p),[_,E]=C.useState(),[S,J]=C.useState({isTransitioning:!1}),[U,H]=C.useState(),[A,q]=C.useState(),[D,K]=C.useState(),X=C.useRef(new Map),pe=C.useCallback((L,{deletedFetchers:ke,newErrors:fe,flushSync:Ne,viewTransitionOpts:we})=>{fe&&o&&Object.values(fe).forEach(Je=>{var Me;return o(Je,{location:L.location,params:((Me=L.matches[0])==null?void 0:Me.params)??{},pattern:hn(L.matches)})}),L.fetchers.forEach((Je,Me)=>{Je.data!==void 0&&X.current.set(Me,Je.data)}),ke.forEach(Je=>X.current.delete(Je)),Dp(Ne===!1||a!=null,'You provided the `flushSync` option to a router update, but you are not using the `<RouterProvider>` from `react-router/dom` so `ReactDOM.flushSync()` is unavailable.  Please update your app to `import { RouterProvider } from "react-router/dom"` and ensure you have `react-dom` installed as a dependency to use the `flushSync` option.');let Pe=t.window!=null&&t.window.document!=null&&typeof t.window.document.startViewTransition=="function";if(Dp(we==null||Pe,"You provided the `viewTransition` option to a router update, but you do not appear to be running in a DOM environment as `window.startViewTransition` is not available."),!we||!Pe){a&&Ne?a(()=>g(L)):r===!1?g(L):C.startTransition(()=>{r===!0&&m(Je=>$p(Je,L)),g(L)});return}if(a&&Ne){a(()=>{A&&(U==null||U.resolve(),A.skipTransition()),J({isTransitioning:!0,flushSync:!0,currentLocation:we.currentLocation,nextLocation:we.nextLocation})});let Je=t.window.document.startViewTransition(()=>{a(()=>g(L))});Je.finished.finally(()=>{a(()=>{H(void 0),q(void 0),E(void 0),J({isTransitioning:!1})})}),a(()=>q(Je));return}A?(U==null||U.resolve(),A.skipTransition(),K({state:L,currentLocation:we.currentLocation,nextLocation:we.nextLocation})):(E(L),J({isTransitioning:!0,flushSync:!1,currentLocation:we.currentLocation,nextLocation:we.nextLocation}))},[t.window,a,A,U,r,m,o]);C.useLayoutEffect(()=>t.subscribe(pe),[t,pe]),C.useEffect(()=>{S.isTransitioning&&!S.flushSync&&H(new gh)},[S]),C.useEffect(()=>{if(U&&_&&t.window){let L=_,ke=U.promise,fe=t.window.document.startViewTransition(async()=>{r===!1?g(L):C.startTransition(()=>{r===!0&&m(Ne=>$p(Ne,L)),g(L)}),await ke});fe.finished.finally(()=>{H(void 0),q(void 0),E(void 0),J({isTransitioning:!1})}),q(fe)}},[_,U,t.window,r,m]),C.useEffect(()=>{U&&_&&f.location.key===_.location.key&&U.resolve()},[U,A,f.location,_]),C.useEffect(()=>{!S.isTransitioning&&D&&(E(D.state),J({isTransitioning:!0,flushSync:!1,currentLocation:D.currentLocation,nextLocation:D.nextLocation}),K(void 0))},[S.isTransitioning,D]);let ue=C.useMemo(()=>({createHref:t.createHref,encodeLocation:t.encodeLocation,go:L=>t.navigate(L),push:(L,ke,fe)=>t.navigate(L,{state:ke,preventScrollReset:fe==null?void 0:fe.preventScrollReset}),replace:(L,ke,fe)=>t.navigate(L,{replace:!0,state:ke,preventScrollReset:fe==null?void 0:fe.preventScrollReset})}),[t]),ve=t.basename||"/",Le=C.useMemo(()=>({router:t,navigator:ue,static:!1,basename:ve,onError:o}),[t,ue,ve,o]);return C.createElement(C.Fragment,null,C.createElement(Pi.Provider,{value:Le},C.createElement(_n.Provider,{value:f},C.createElement(Jd.Provider,{value:X.current},C.createElement(Hu.Provider,{value:S},C.createElement(_h,{basename:ve,location:f.location,navigationType:f.historyAction,navigator:ue,useTransitions:r},C.createElement(mh,{routes:t.routes,manifest:t.manifest,future:t.future,state:f,isStatic:!1,onError:o})))))),null)}function $p(t,a){return{...t,navigation:a.navigation.state!=="idle"?a.navigation:t.navigation,revalidation:a.revalidation!=="idle"?a.revalidation:t.revalidation,actionData:a.navigation.state!=="submitting"?a.actionData:t.actionData,fetchers:a.fetchers}}var mh=C.memo(hh);function hh({routes:t,manifest:a,future:o,state:r,isStatic:c,onError:p}){return Qm(t,void 0,{manifest:a,state:r,isStatic:c,onError:p})}function _h({basename:t="/",children:a=null,location:o,navigationType:r="POP",navigator:c,static:p=!1,useTransitions:g}){Ge(!jn(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let f=t.replace(/^\/*/,"/"),m=C.useMemo(()=>({basename:f,navigator:c,static:p,useTransitions:g,future:{}}),[f,c,p,g]);typeof o=="string"&&(o=vs(o));let{pathname:_="/",search:E="",hash:S="",state:J=null,key:U="default",mask:H}=o,A=C.useMemo(()=>{let q=Ql(_,f);return q==null?null:{location:{pathname:q,search:E,hash:S,state:J,key:U,mask:H},navigationType:r}},[f,_,E,S,J,U,r,H]);return nl(A!=null,`<Router basename="${f}"> is not able to match the URL "${_}${E}${S}" because it does not start with the basename, so the <Router> won't render anything.`),A==null?null:C.createElement(Yl.Provider,{value:m},C.createElement(Aa.Provider,{children:a,value:A}))}var Ja="get",za="application/x-www-form-urlencoded";function Ma(t){return typeof HTMLElement<"u"&&t instanceof HTMLElement}function jh(t){return Ma(t)&&t.tagName.toLowerCase()==="button"}function Sh(t){return Ma(t)&&t.tagName.toLowerCase()==="form"}function vh(t){return Ma(t)&&t.tagName.toLowerCase()==="input"}function wh(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}function xh(t,a){return t.button===0&&(!a||a==="_self")&&!wh(t)}var La=null;function yh(){if(La===null)try{new FormData(document.createElement("form"),0),La=!1}catch{La=!0}return La}var Eh=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function ku(t){return t!=null&&!Eh.has(t)?(nl(!1,`"${t}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${za}"`),null):t}function kh(t,a){let o,r,c,p,g;if(Sh(t)){let f=t.getAttribute("action");r=f?Ql(f,a):null,o=t.getAttribute("method")||Ja,c=ku(t.getAttribute("enctype"))||za,p=new FormData(t)}else if(jh(t)||vh(t)&&(t.type==="submit"||t.type==="image")){let f=t.form;if(f==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let m=t.getAttribute("formaction")||f.getAttribute("action");if(r=m?Ql(m,a):null,o=t.getAttribute("formmethod")||f.getAttribute("method")||Ja,c=ku(t.getAttribute("formenctype"))||ku(f.getAttribute("enctype"))||za,p=new FormData(f,t),!yh()){let{name:_,type:E,value:S}=t;if(E==="image"){let J=_?`${_}.`:"";p.append(`${J}x`,"0"),p.append(`${J}y`,"0")}else _&&p.append(_,S)}}else{if(Ma(t))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');o=Ja,r=null,c=za,g=t}return p&&c==="text/plain"&&(g=p,p=void 0),{action:r,method:o.toLowerCase(),encType:c,formData:p,body:g}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Nu(t,a){if(t===!1||t===null||typeof t>"u")throw new Error(a)}function Hd(t,a,o,r){let c=typeof t=="string"?new URL(t,typeof window>"u"?"server://singlefetch/":window.location.origin):t;return o?c.pathname.endsWith("/")?c.pathname=`${c.pathname}_.${r}`:c.pathname=`${c.pathname}.${r}`:c.pathname==="/"?c.pathname=`_root.${r}`:a&&Ql(c.pathname,a)==="/"?c.pathname=`${qa(a)}/_root.${r}`:c.pathname=`${qa(c.pathname)}.${r}`,c}async function bh(t,a){if(t.id in a)return a[t.id];try{let o=await import(t.module);return a[t.id]=o,o}catch(o){return console.error(`Error loading route module \`${t.module}\`, reloading page...`),console.error(o),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Ch(t){return t==null?!1:t.href==null?t.rel==="preload"&&typeof t.imageSrcSet=="string"&&typeof t.imageSizes=="string":typeof t.rel=="string"&&typeof t.href=="string"}async function Lh(t,a,o){let r=await Promise.all(t.map(async c=>{let p=a.routes[c.route.id];if(p){let g=await bh(p,o);return g.links?g.links():[]}return[]}));return Jh(r.flat(1).filter(Ch).filter(c=>c.rel==="stylesheet"||c.rel==="preload").map(c=>c.rel==="stylesheet"?{...c,rel:"prefetch",as:"style"}:{...c,rel:"prefetch"}))}function Vp(t,a,o,r,c,p){let g=(m,_)=>o[_]?m.route.id!==o[_].route.id:!0,f=(m,_)=>{var E;return o[_].pathname!==m.pathname||((E=o[_].route.path)==null?void 0:E.endsWith("*"))&&o[_].params["*"]!==m.params["*"]};return p==="assets"?a.filter((m,_)=>g(m,_)||f(m,_)):p==="data"?a.filter((m,_)=>{var S;let E=r.routes[m.route.id];if(!E||!E.hasLoader)return!1;if(g(m,_)||f(m,_))return!0;if(m.route.shouldRevalidate){let J=m.route.shouldRevalidate({currentUrl:new URL(c.pathname+c.search+c.hash,window.origin),currentParams:((S=o[0])==null?void 0:S.params)||{},nextUrl:new URL(t,window.origin),nextParams:m.params,defaultShouldRevalidate:!0});if(typeof J=="boolean")return J}return!0}):[]}function Ih(t,a,{includeHydrateFallback:o}={}){return Gh(t.map(r=>{let c=a.routes[r.route.id];if(!c)return[];let p=[c.module];return c.clientActionModule&&(p=p.concat(c.clientActionModule)),c.clientLoaderModule&&(p=p.concat(c.clientLoaderModule)),o&&c.hydrateFallbackModule&&(p=p.concat(c.hydrateFallbackModule)),c.imports&&(p=p.concat(c.imports)),p}).flat(1))}function Gh(t){return[...new Set(t)]}function Ph(t){let a={},o=Object.keys(t).sort();for(let r of o)a[r]=t[r];return a}function Jh(t,a){let o=new Set;return new Set(a),t.reduce((r,c)=>{let p=JSON.stringify(Ph(c));return o.has(p)||(o.add(p),r.push({key:p,link:c})),r},[])}function Fu(){let t=C.useContext(Pi);return Nu(t,"You must render this element inside a <DataRouterContext.Provider> element"),t}function zh(){let t=C.useContext(_n);return Nu(t,"You must render this element inside a <DataRouterStateContext.Provider> element"),t}var Du=C.createContext(void 0);Du.displayName="FrameworkContext";function Wu(){let t=C.useContext(Du);return Nu(t,"You must render this element inside a <HydratedRouter> element"),t}function Uh(t,a){let o=C.useContext(Du),[r,c]=C.useState(!1),[p,g]=C.useState(!1),{onFocus:f,onBlur:m,onMouseEnter:_,onMouseLeave:E,onTouchStart:S}=a,J=C.useRef(null);C.useEffect(()=>{if(t==="render"&&g(!0),t==="viewport"){let A=D=>{D.forEach(K=>{g(K.isIntersecting)})},q=new IntersectionObserver(A,{threshold:.5});return J.current&&q.observe(J.current),()=>{q.disconnect()}}},[t]),C.useEffect(()=>{if(r){let A=setTimeout(()=>{g(!0)},100);return()=>{clearTimeout(A)}}},[r]);let U=()=>{c(!0)},H=()=>{c(!1),g(!1)};return o?t!=="intent"?[p,J,{}]:[p,J,{onFocus:an(f,U),onBlur:an(m,H),onMouseEnter:an(_,U),onMouseLeave:an(E,H),onTouchStart:an(S,U)}]:[!1,J,{}]}function an(t,a){return o=>{t&&t(o),o.defaultPrevented||a(o)}}function qh({page:t,...a}){let o=Pd(),{router:r}=Fu(),c=C.useMemo(()=>cd(r.routes,t,r.basename),[r.routes,t,r.basename]);return c?o?C.createElement(Ah,{page:t,matches:c,...a}):C.createElement(Mh,{page:t,matches:c,...a}):null}function Bh(t){let{manifest:a,routeModules:o}=Wu(),[r,c]=C.useState([]);return C.useEffect(()=>{let p=!1;return Lh(t,a,o).then(g=>{p||c(g)}),()=>{p=!0}},[t,a,o]),r}function Ah({page:t,matches:a,...o}){let r=xs(),{future:c}=Wu(),{basename:p}=Fu(),g=C.useMemo(()=>{if(t===r.pathname+r.search+r.hash)return[];let f=Hd(t,p,c.v8_trailingSlashAwareDataRequests,"rsc"),m=!1,_=[];for(let E of a)typeof E.route.shouldRevalidate=="function"?m=!0:_.push(E.route.id);return m&&_.length>0&&f.searchParams.set("_routes",_.join(",")),[f.pathname+f.search]},[p,c.v8_trailingSlashAwareDataRequests,t,r,a]);return C.createElement(C.Fragment,null,g.map(f=>C.createElement("link",{key:f,rel:"prefetch",as:"fetch",href:f,...o})))}function Mh({page:t,matches:a,...o}){let r=xs(),{future:c,manifest:p,routeModules:g}=Wu(),{basename:f}=Fu(),{loaderData:m,matches:_}=zh(),E=C.useMemo(()=>Vp(t,a,_,p,r,"data"),[t,a,_,p,r]),S=C.useMemo(()=>Vp(t,a,_,p,r,"assets"),[t,a,_,p,r]),J=C.useMemo(()=>{if(t===r.pathname+r.search+r.hash)return[];let A=new Set,q=!1;if(a.forEach(K=>{var pe;let X=p.routes[K.route.id];!X||!X.hasLoader||(!E.some(ue=>ue.route.id===K.route.id)&&K.route.id in m&&((pe=g[K.route.id])!=null&&pe.shouldRevalidate)||X.hasClientLoader?q=!0:A.add(K.route.id))}),A.size===0)return[];let D=Hd(t,f,c.v8_trailingSlashAwareDataRequests,"data");return q&&A.size>0&&D.searchParams.set("_routes",a.filter(K=>A.has(K.route.id)).map(K=>K.route.id).join(",")),[D.pathname+D.search]},[f,c.v8_trailingSlashAwareDataRequests,m,r,p,E,a,t,g]),U=C.useMemo(()=>Ih(S,p),[S,p]),H=Bh(S);return C.createElement(C.Fragment,null,J.map(A=>C.createElement("link",{key:A,rel:"prefetch",as:"fetch",href:A,...o})),U.map(A=>C.createElement("link",{key:A,rel:"modulepreload",href:A,...o})),H.map(({key:A,link:q})=>C.createElement("link",{key:A,nonce:o.nonce,...q,crossOrigin:q.crossOrigin??o.crossOrigin})))}function Hh(...t){return a=>{t.forEach(o=>{typeof o=="function"?o(a):o!=null&&(o.current=a)})}}var Th=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Th&&(window.__reactRouterVersion="7.17.0")}catch{}function Rh(t,a){return _m({basename:a==null?void 0:a.basename,getContext:a==null?void 0:a.getContext,future:a==null?void 0:a.future,history:Jf({window:a==null?void 0:a.window}),hydrationData:Oh(),routes:t,mapRouteProperties:ph,hydrationRouteProperties:dh,dataStrategy:a==null?void 0:a.dataStrategy,patchRoutesOnNavigation:a==null?void 0:a.patchRoutesOnNavigation,window:a==null?void 0:a.window,instrumentations:a==null?void 0:a.instrumentations}).initialize()}function Oh(){let t=window==null?void 0:window.__staticRouterHydrationData;return t&&t.errors&&(t={...t,errors:Nh(t.errors)}),t}function Nh(t){if(!t)return null;let a=Object.entries(t),o={};for(let[r,c]of a)if(c&&c.__type==="RouteErrorResponse")o[r]=new mn(c.status,c.statusText,c.data,c.internal===!0);else if(c&&c.__type==="Error"){if(c.__subType){let p=window[c.__subType];if(typeof p=="function")try{let g=new p(c.message);g.stack="",o[r]=g}catch{}}if(o[r]==null){let p=new Error(c.message);p.stack="",o[r]=p}}else o[r]=c;return o}var Td=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Rd=C.forwardRef(function({onClick:a,discover:o="render",prefetch:r="none",relative:c,reloadDocument:p,replace:g,mask:f,state:m,target:_,to:E,preventScrollReset:S,viewTransition:J,defaultShouldRevalidate:U,...H},A){let{basename:q,navigator:D,useTransitions:K}=C.useContext(Yl),X=typeof E=="string"&&Td.test(E),pe=hd(E,q);E=pe.to;let ue=$m(E,{relative:c}),ve=xs(),Le=null;if(f){let Me=Ba(f,[],ve.mask?ve.mask.pathname:"/",!0);q!=="/"&&(Me.pathname=Me.pathname==="/"?q:Kl([q,Me.pathname])),Le=D.createHref(Me)}let[L,ke,fe]=Uh(r,H),Ne=$h(E,{replace:g,mask:f,state:m,target:_,preventScrollReset:S,relative:c,viewTransition:J,defaultShouldRevalidate:U,useTransitions:K});function we(Me){a&&a(Me),Me.defaultPrevented||Ne(Me)}let Pe=!(pe.isExternal||p),Je=C.createElement("a",{...H,...fe,href:(Pe?Le:void 0)||pe.absoluteURL||ue,onClick:Pe?we:a,ref:Hh(A,ke),target:_,"data-discover":!X&&o==="render"?"true":void 0});return L&&!X?C.createElement(C.Fragment,null,Je,C.createElement(qh,{page:ue})):Je});Rd.displayName="Link";var Fh=C.forwardRef(function({"aria-current":a="page",caseSensitive:o=!1,className:r="",end:c=!1,style:p,to:g,viewTransition:f,children:m,..._},E){let S=Sn(g,{relative:_.relative}),J=xs(),U=C.useContext(_n),{navigator:H,basename:A}=C.useContext(Yl),q=U!=null&&Xh(S)&&f===!0,D=H.encodeLocation?H.encodeLocation(S).pathname:S.pathname,K=J.pathname,X=U&&U.navigation&&U.navigation.location?U.navigation.location.pathname:null;o||(K=K.toLowerCase(),X=X?X.toLowerCase():null,D=D.toLowerCase()),X&&A&&(X=Ql(X,A)||X);const pe=D!=="/"&&D.endsWith("/")?D.length-1:D.length;let ue=K===D||!c&&K.startsWith(D)&&K.charAt(pe)==="/",ve=X!=null&&(X===D||!c&&X.startsWith(D)&&X.charAt(D.length)==="/"),Le={isActive:ue,isPending:ve,isTransitioning:q},L=ue?a:void 0,ke;typeof r=="function"?ke=r(Le):ke=[r,ue?"active":null,ve?"pending":null,q?"transitioning":null].filter(Boolean).join(" ");let fe=typeof p=="function"?p(Le):p;return C.createElement(Rd,{..._,"aria-current":L,className:ke,ref:E,style:fe,to:g,viewTransition:f},typeof m=="function"?m(Le):m)});Fh.displayName="NavLink";var Dh=C.forwardRef(({discover:t="render",fetcherKey:a,navigate:o,reloadDocument:r,replace:c,state:p,method:g=Ja,action:f,onSubmit:m,relative:_,preventScrollReset:E,viewTransition:S,defaultShouldRevalidate:J,...U},H)=>{let{useTransitions:A}=C.useContext(Yl),q=Qh(),D=Yh(f,{relative:_}),K=g.toLowerCase()==="get"?"get":"post",X=typeof f=="string"&&Td.test(f),pe=ue=>{if(m&&m(ue),ue.defaultPrevented)return;ue.preventDefault();let ve=ue.nativeEvent.submitter,Le=(ve==null?void 0:ve.getAttribute("formmethod"))||g,L=()=>q(ve||ue.currentTarget,{fetcherKey:a,method:Le,navigate:o,replace:c,state:p,relative:_,preventScrollReset:E,viewTransition:S,defaultShouldRevalidate:J});A&&o!==!1?C.startTransition(()=>L()):L()};return C.createElement("form",{ref:H,method:K,action:D,onSubmit:r?m:pe,...U,"data-discover":!X&&t==="render"?"true":void 0})});Dh.displayName="Form";function Wh(t){return`${t} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Od(t){let a=C.useContext(Pi);return Ge(a,Wh(t)),a}function $h(t,{target:a,replace:o,mask:r,state:c,preventScrollReset:p,relative:g,viewTransition:f,defaultShouldRevalidate:m,useTransitions:_}={}){let E=Bd(),S=xs(),J=Sn(t,{relative:g});return C.useCallback(U=>{if(xh(U,a)){U.preventDefault();let H=o!==void 0?o:Ss(S)===Ss(J),A=()=>E(t,{replace:H,mask:r,state:c,preventScrollReset:p,relative:g,viewTransition:f,defaultShouldRevalidate:m});_?C.startTransition(()=>A()):A()}},[S,E,J,o,r,c,a,t,p,g,f,m,_])}var Vh=0,Kh=()=>`__${String(++Vh)}__`;function Qh(){let{router:t}=Od("useSubmit"),{basename:a}=C.useContext(Yl),o=nh(),r=t.fetch,c=t.navigate;return C.useCallback(async(p,g={})=>{let{action:f,method:m,encType:_,formData:E,body:S}=kh(p,a);if(g.navigate===!1){let J=g.fetcherKey||Kh();await r(J,o,g.action||f,{defaultShouldRevalidate:g.defaultShouldRevalidate,preventScrollReset:g.preventScrollReset,formData:E,body:S,formMethod:g.method||m,formEncType:g.encType||_,flushSync:g.flushSync})}else await c(g.action||f,{defaultShouldRevalidate:g.defaultShouldRevalidate,preventScrollReset:g.preventScrollReset,formData:E,body:S,formMethod:g.method||m,formEncType:g.encType||_,replace:g.replace,state:g.state,fromRouteId:o,flushSync:g.flushSync,viewTransition:g.viewTransition})},[r,c,a,o])}function Yh(t,{relative:a}={}){let{basename:o}=C.useContext(Yl),r=C.useContext(ws);Ge(r,"useFormAction must be used inside a RouteContext");let[c]=r.matches.slice(-1),p={...Sn(t||".",{relative:a})},g=xs();if(t==null){p.search=g.search;let f=new URLSearchParams(p.search),m=f.getAll("index");if(m.some(E=>E==="")){f.delete("index"),m.filter(S=>S).forEach(S=>f.append("index",S));let E=f.toString();p.search=E?`?${E}`:""}}return(!t||t===".")&&c.route.index&&(p.search=p.search?p.search.replace(/^\?/,"?index&"):"?index"),o!=="/"&&(p.pathname=p.pathname==="/"?o:Kl([o,p.pathname])),Ss(p)}function Xh(t,{relative:a}={}){let o=C.useContext(Hu);Ge(o!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Od("useViewTransitionState"),c=Sn(t,{relative:a});if(!o.isTransitioning)return!1;let p=Ql(o.currentLocation.pathname,r)||o.currentLocation.pathname,g=Ql(o.nextLocation.pathname,r)||o.nextLocation.pathname;return Ua(c.pathname,g)!=null||Ua(c.pathname,p)!=null}var bu={exports:{}},Jl={},Cu={exports:{}},Lu={};/**
 * @license React
...
`+n[d].replace(" at new "," at ");return e.displayName&&v.includes("<anonymous>")&&(v=v.replace("<anonymous>",e.displayName)),v}while(1<=d&&0<=h);break}}}finally{ce=!1,Error.prepareStackTrace=s}return(e=e?e.displayName||e.name:"")?B(e):""}function ge(e){switch(e.tag){case 5:return B(e.type);case 16:return B("Lazy");case 13:return B("Suspense");case 19:return B("SuspenseList");case 0:case 2:case 15:return e=me(e.type,!1),e;case 11:return e=me(e.type.render,!1),e;case 1:return e=me(e.type,!0),e;default:return""}}function he(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Le:return"Fragment";case ve:return"Portal";case ke:return"Profiler";case L:return"StrictMode";case Pe:return"Suspense";case Je:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Ne:return(e.displayName||"Context")+".Consumer";case fe:return(e._context.displayName||"Context")+".Provider";case we:var l=e.render;return e=e.displayName,e||(e=l.displayName||l.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case Me:return l=e.displayName||null,l!==null?l:he(e.type)||"Memo";case Oe:l=e._payload,e=e._init;try{return he(e(l))}catch{}}return null}function Ie(e){var l=e.type;switch(e.tag){case 24:return"Cache";case 9:return(l.displayName||"Context")+".Consumer";case 10:return(l._context.displayName||"Context")+".Provider";case 18:return"DehydratedFragment";case 11:return e=l.render,e=e.displayName||e.name||"",l.displayName||(e!==""?"ForwardRef("+e+")":"ForwardRef");case 7:return"Fragment";case 5:return l;case 4:return"Portal";case 3:return"Root";case 6:return"Text";case 16:return he(l);case 8:return l===L?"StrictMode":"Mode";case 22:return"Offscreen";case 12:return"Profiler";case 21:return"Scope";case 13:return"Suspense";case 19:return"SuspenseList";case 25:return"TracingMarker";case 1:case 0:case 17:case 2:case 14:case 15:if(typeof l=="function")return l.displayName||l.name||null;if(typeof l=="string")return l}return null}function qe(e){switch(typeof e){case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function k(e){var l=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(l==="checkbox"||l==="radio")}function $(e){var l=k(e)?"checked":"value",s=Object.getOwnPropertyDescriptor(e.constructor.prototype,l),i=""+e[l];if(!e.hasOwnProperty(l)&&typeof s<"u"&&typeof s.get=="function"&&typeof s.set=="function"){var n=s.get,u=s.set;return Object.defineProperty(e,l,{configurable:!0,get:function(){return n.call(this)},set:function(d){i=""+d,u.call(this,d)}}),Object.defineProperty(e,l,{enumerable:s.enumerable}),{getValue:function(){return i},setValue:function(d){i=""+d},stopTracking:function(){e._valueTracker=null,delete e[l]}}}}function se(e){e._valueTracker||(e._valueTracker=$(e))}function be(e){if(!e)return!1;var l=e._valueTracker;if(!l)return!0;var s=l.getValue(),i="";return e&&(i=k(e)?e.checked?"true":"false":e.value),e=i,e!==s?(l.setValue(e),!0):!1}function Ee(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}function ll(e,l){var s=l.checked;return V({},l,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:s??e._wrapperState.initialChecked})}function ys(e,l){var s=l.defaultValue==null?"":l.defaultValue,i=l.checked!=null?l.checked:l.defaultChecked;s=qe(l.value!=null?l.value:s),e._wrapperState={initialChecked:i,initialValue:s,controlled:l.type==="checkbox"||l.type==="radio"?l.checked!=null:l.value!=null}}function Es(e,l){l=l.checked,l!=null&&X(e,"checked",l,!1)}function zl(e,l){Es(e,l);var s=qe(l.value),i=l.type;if(s!=null)i==="number"?(s===0&&e.value===""||e.value!=s)&&(e.value=""+s):e.value!==""+s&&(e.value=""+s);else if(i==="submit"||i==="reset"){e.removeAttribute("value");return}l.hasOwnProperty("value")?jt(e,l.type,s):l.hasOwnProperty("defaultValue")&&jt(e,l.type,qe(l.defaultValue)),l.checked==null&&l.defaultChecked!=null&&(e.defaultChecked=!!l.defaultChecked)}function Ji(e,l,s){if(l.hasOwnProperty("value")||l.hasOwnProperty("defaultValue")){var i=l.type;if(!(i!=="submit"&&i!=="reset"||l.value!==void 0&&l.value!==null))return;l=""+e._wrapperState.initialValue,s||l===e.value||(e.value=l),e.defaultValue=l}s=e.name,s!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,s!==""&&(e.name=s)}function jt(e,l,s){(l!=="number"||Ee(e.ownerDocument)!==e)&&(s==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+s&&(e.defaultValue=""+s))}var Bs=Array.isArray;function As(e,l,s,i){if(e=e.options,l){l={};for(var n=0;n<s.length;n++)l["$"+s[n]]=!0;for(s=0;s<e.length;s++)n=l.hasOwnProperty("$"+e[s].value),e[s].selected!==n&&(e[s].selected=n),n&&i&&(e[s].defaultSelected=!0)}else{for(s=""+qe(s),l=null,n=0;n<e.length;n++){if(e[n].value===s){e[n].selected=!0,i&&(e[n].defaultSelected=!0);return}l!==null||e[n].disabled||(l=e[n])}l!==null&&(l.selected=!0)}}function St(e,l){if(l.dangerouslySetInnerHTML!=null)throw Error(o(91));return V({},l,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function vn(e,l){var s=l.value;if(s==null){if(s=l.children,l=l.defaultValue,s!=null){if(l!=null)throw Error(o(92));if(Bs(s)){if(1<s.length)throw Error(o(93));s=s[0]}l=s}l==null&&(l=""),s=l}e._wrapperState={initialValue:qe(s)}}function wn(e,l){var s=qe(l.value),i=qe(l.defaultValue);s!=null&&(s=""+s,s!==e.value&&(e.value=s),l.defaultValue==null&&e.defaultValue!==s&&(e.defaultValue=s)),i!=null&&(e.defaultValue=""+i)}function rs(e){var l=e.textContent;l===e._wrapperState.initialValue&&l!==""&&l!==null&&(e.value=l)}function Ms(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function zi(e,l){return e==null||e==="http://www.w3.org/1999/xhtml"?Ms(l):e==="http://www.w3.org/2000/svg"&&l==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Hs,Tl=(function(e){return typeof MSApp<"u"&&MSApp.execUnsafeLocalFunction?function(l,s,i,n){MSApp.execUnsafeLocalFunction(function(){return e(l,s,i,n)})}:e})(function(e,l){if(e.namespaceURI!=="http://www.w3.org/2000/svg"||"innerHTML"in e)e.innerHTML=l;else{for(Hs=Hs||document.createElement("div"),Hs.innerHTML="<svg>"+l.valueOf().toString()+"</svg>",l=Hs.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;l.firstChild;)e.appendChild(l.firstChild)}});function xl(e,l){if(l){var s=e.firstChild;if(s&&s===e.lastChild&&s.nodeType===3){s.nodeValue=l;return}}e.textContent=l}var fi={animationIterationCount:!0,aspectRatio:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Ha=["Webkit","ms","Moz","O"];Object.keys(fi).forEach(function(e){Ha.forEach(function(l){l=l+e.charAt(0).toUpperCase()+e.substring(1),fi[l]=fi[e]})});function Ui(e,l,s){return l==null||typeof l=="boolean"||l===""?"":s||typeof l!="number"||l===0||fi.hasOwnProperty(e)&&fi[e]?(""+l).trim():l+"px"}function xn(e,l){e=e.style;for(var s in l)if(l.hasOwnProperty(s)){var i=s.indexOf("--")===0,n=Ui(s,l[s],i);s==="float"&&(s="cssFloat"),i?e.setProperty(s,n):e[s]=n}}var Xl=V({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function qi(e,l){if(l){if(Xl[e]&&(l.children!=null||l.dangerouslySetInnerHTML!=null))throw Error(o(137,e));if(l.dangerouslySetInnerHTML!=null){if(l.children!=null)throw Error(o(60));if(typeof l.dangerouslySetInnerHTML!="object"||!("__html"in l.dangerouslySetInnerHTML))throw Error(o(61))}if(l.style!=null&&typeof l.style!="object")throw Error(o(62))}}function Bi(e,l){if(e.indexOf("-")===-1)return typeof l.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var Ai=null;function vt(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var Mi=null,Zl=null,ks=null;function Hi(e){if(e=Rt(e)){if(typeof Mi!="function")throw Error(o(280));var l=e.stateNode;l&&(l=Rn(l),Mi(e.stateNode,e.type,l))}}function yn(e){Zl?ks?ks.push(e):ks=[e]:Zl=e}function wt(){if(Zl){var e=Zl,l=ks;if(ks=Zl=null,Hi(e),l)for(e=0;e<l.length;e++)Hi(l[e])}}function En(e,l){return e(l)}function xt(){}var Ts=!1;function mi(e,l,s){if(Ts)return e(l,s);Ts=!0;try{return En(e,l,s)}finally{Ts=!1,(Zl!==null||ks!==null)&&(xt(),wt())}}function Rs(e,l){var s=e.stateNode;if(s===null)return null;var i=Rn(s);if(i===null)return null;s=i[l];e:switch(l){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(i=!i.disabled)||(e=e.type,i=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!i;break e;default:e=!1}if(e)return null;if(s&&typeof s!="function")throw Error(o(231,l,typeof s));return s}var yt=!1;if(f)try{var hi={};Object.defineProperty(hi,"passive",{get:function(){yt=!0}}),window.addEventListener("test",hi,hi),window.removeEventListener("test",hi,hi)}catch{yt=!1}function j(e,l,s,i,n,u,d,h,v){var z=Array.prototype.slice.call(arguments,3);try{l.apply(s,z)}catch(O){this.onError(O)}}var w=!1,G=null,M=!1,T=null,ne={onError:function(e){w=!0,G=e}};function ae(e,l,s,i,n,u,d,h,v){w=!1,G=null,j.apply(ne,arguments)}function ye(e,l,s,i,n,u,d,h,v){if(ae.apply(this,arguments),w){if(w){var z=G;w=!1,G=null}else throw Error(o(198));M||(M=!0,T=z)}}function Y(e){var l=e,s=e;if(e.alternate)for(;l.return;)l=l.return;else{e=l;do l=e,(l.flags&4098)!==0&&(s=l.return),e=l.return;while(e)}return l.tag===3?s:null}function oe(e){if(e.tag===13){var l=e.memoizedState;if(l===null&&(e=e.alternate,e!==null&&(l=e.memoizedState)),l!==null)return l.dehydrated}return null}function Se(e){if(Y(e)!==e)throw Error(o(188))}function Ce(e){var l=e.alternate;if(!l){if(l=Y(e),l===null)throw Error(o(188));return l!==e?null:e}for(var s=e,i=l;;){var n=s.return;if(n===null)break;var u=n.alternate;if(u===null){if(i=n.return,i!==null){s=i;continue}break}if(n.child===u.child){for(u=n.child;u;){if(u===s)return Se(n),e;if(u===i)return Se(n),l;u=u.sibling}throw Error(o(188))}if(s.return!==i.return)s=n,i=u;else{for(var d=!1,h=n.child;h;){if(h===s){d=!0,s=n,i=u;break}if(h===i){d=!0,i=n,s=u;break}h=h.sibling}if(!d){for(h=u.child;h;){if(h===s){d=!0,s=u,i=n;break}if(h===i){d=!0,i=u,s=n;break}h=h.sibling}if(!d)throw Error(o(189))}}if(s.alternate!==i)throw Error(o(190))}if(s.tag!==3)throw Error(o(188));return s.stateNode.current===s?e:l}function re(e){return e=Ce(e),e!==null?Ue(e):null}function Ue(e){if(e.tag===5||e.tag===6)return e;for(e=e.child;e!==null;){var l=Ue(e);if(l!==null)return l;e=e.sibling}return null}var Re=a.unstable_scheduleCallback,sl=a.unstable_cancelCallback,Ve=a.unstable_shouldYield,Fe=a.unstable_requestPaint,Be=a.unstable_now,fl=a.unstable_getCurrentPriorityLevel,bs=a.unstable_ImmediatePriority,es=a.unstable_UserBlockingPriority,ls=a.unstable_NormalPriority,cs=a.unstable_LowPriority,Ul=a.unstable_IdlePriority,Os=null,al=null;function Ti(e){if(al&&typeof al.onCommitFiberRoot=="function")try{al.onCommitFiberRoot(Os,e,void 0,(e.current.flags&128)===128)}catch{}}var ml=Math.clz32?Math.clz32:hl,Ri=Math.log,Ae=Math.LN2;function hl(e){return e>>>=0,e===0?32:31-(Ri(e)/Ae|0)|0}var yl=64,bl=4194304;function Ns(e){switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194240;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return e&130023424;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 1073741824;default:return e}}function Fs(e,l){var s=e.pendingLanes;if(s===0)return 0;var i=0,n=e.suspendedLanes,u=e.pingedLanes,d=s&268435455;if(d!==0){var h=d&~n;h!==0?i=Ns(h):(u&=d,u!==0&&(i=Ns(u)))}else d=s&~n,d!==0?i=Ns(d):u!==0&&(i=Ns(u));if(i===0)return 0;if(l!==0&&l!==i&&(l&n)===0&&(n=i&-i,u=l&-l,n>=u||n===16&&(u&4194240)!==0))return l;if((i&4)!==0&&(i|=s&16),l=e.entangledLanes,l!==0)for(e=e.entanglements,l&=i;0<l;)s=31-ml(l),n=1<<s,i|=e[s],l&=~n;return i}function We(e,l){switch(e){case 1:case 2:case 4:return l+250;case 8:case 16:case 32:case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return l+5e3;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return-1;case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function Cs(e,l){for(var s=e.suspendedLanes,i=e.pingedLanes,n=e.expirationTimes,u=e.pendingLanes;0<u;){var d=31-ml(u),h=1<<d,v=n[d];v===-1?((h&s)===0||(h&i)!==0)&&(n[d]=We(h,l)):v<=l&&(e.expiredLanes|=h),u&=~h}}function Oi(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function kn(){var e=yl;return yl<<=1,(yl&4194240)===0&&(yl=64),e}function Ta(e){for(var l=[],s=0;31>s;s++)l.push(e);return l}function Et(e,l,s){e.pendingLanes|=l,l!==536870912&&(e.suspendedLanes=0,e.pingedLanes=0),e=e.eventTimes,l=31-ml(l),e[l]=s}function Dd(e,l){var s=e.pendingLanes&~l;e.pendingLanes=l,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=l,e.mutableReadLanes&=l,e.entangledLanes&=l,l=e.entanglements;var i=e.eventTimes;for(e=e.expirationTimes;0<s;){var n=31-ml(s),u=1<<n;l[n]=0,i[n]=-1,e[n]=-1,s&=~u}}function Ra(e,l){var s=e.entangledLanes|=l;for(e=e.entanglements;s;){var i=31-ml(s),n=1<<i;n&l|e[i]&l&&(e[i]|=l),s&=~n}}var De=0;function $u(e){return e&=-e,1<e?4<e?(e&268435455)!==0?16:536870912:4:1}var Vu,Oa,Ku,Qu,Yu,Na=!1,bn=[],Ds=null,Ws=null,$s=null,kt=new Map,bt=new Map,Vs=[],Wd="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function Xu(e,l){switch(e){case"focusin":case"focusout":Ds=null;break;case"dragenter":case"dragleave":Ws=null;break;case"mouseover":case"mouseout":$s=null;break;case"pointerover":case"pointerout":kt.delete(l.pointerId);break;case"gotpointercapture":case"lostpointercapture":bt.delete(l.pointerId)}}function Ct(e,l,s,i,n,u){return e===null||e.nativeEvent!==u?(e={blockedOn:l,domEventName:s,eventSystemFlags:i,nativeEvent:u,targetContainers:[n]},l!==null&&(l=Rt(l),l!==null&&Oa(l)),e):(e.eventSystemFlags|=i,l=e.targetContainers,n!==null&&l.indexOf(n)===-1&&l.push(n),e)}function $d(e,l,s,i,n){switch(l){case"focusin":return Ds=Ct(Ds,e,l,s,i,n),!0;case"dragenter":return Ws=Ct(Ws,e,l,s,i,n),!0;case"mouseover":return $s=Ct($s,e,l,s,i,n),!0;case"pointerover":var u=n.pointerId;return kt.set(u,Ct(kt.get(u)||null,e,l,s,i,n)),!0;case"gotpointercapture":return u=n.pointerId,bt.set(u,Ct(bt.get(u)||null,e,l,s,i,n)),!0}return!1}function Zu(e){var l=_i(e.target);if(l!==null){var s=Y(l);if(s!==null){if(l=s.tag,l===13){if(l=oe(s),l!==null){e.blockedOn=l,Yu(e.priority,function(){Ku(s)});return}}else if(l===3&&s.stateNode.current.memoizedState.isDehydrated){e.blockedOn=s.tag===3?s.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Cn(e){if(e.blockedOn!==null)return!1;for(var l=e.targetContainers;0<l.length;){var s=Da(e.domEventName,e.eventSystemFlags,l[0],e.nativeEvent);if(s===null){s=e.nativeEvent;var i=new s.constructor(s.type,s);Ai=i,s.target.dispatchEvent(i),Ai=null}else return l=Rt(s),l!==null&&Oa(l),e.blockedOn=s,!1;l.shift()}return!0}function er(e,l,s){Cn(e)&&s.delete(l)}function Vd(){Na=!1,Ds!==null&&Cn(Ds)&&(Ds=null),Ws!==null&&Cn(Ws)&&(Ws=null),$s!==null&&Cn($s)&&($s=null),kt.forEach(er),bt.forEach(er)}function Lt(e,l){e.blockedOn===l&&(e.blockedOn=null,Na||(Na=!0,a.unstable_scheduleCallback(a.unstable_NormalPriority,Vd)))}function It(e){function l(n){return Lt(n,e)}if(0<bn.length){Lt(bn[0],e);for(var s=1;s<bn.length;s++){var i=bn[s];i.blockedOn===e&&(i.blockedOn=null)}}for(Ds!==null&&Lt(Ds,e),Ws!==null&&Lt(Ws,e),$s!==null&&Lt($s,e),kt.forEach(l),bt.forEach(l),s=0;s<Vs.length;s++)i=Vs[s],i.blockedOn===e&&(i.blockedOn=null);for(;0<Vs.length&&(s=Vs[0],s.blockedOn===null);)Zu(s),s.blockedOn===null&&Vs.shift()}var Ni=pe.ReactCurrentBatchConfig,Ln=!0;function Kd(e,l,s,i){var n=De,u=Ni.transition;Ni.transition=null;try{De=1,Fa(e,l,s,i)}finally{De=n,Ni.transition=u}}function Qd(e,l,s,i){var n=De,u=Ni.transition;Ni.transition=null;try{De=4,Fa(e,l,s,i)}finally{De=n,Ni.transition=u}}function Fa(e,l,s,i){if(Ln){var n=Da(e,l,s,i);if(n===null)uo(e,l,i,In,s),Xu(e,i);else if($d(n,e,l,s,i))i.stopPropagation();else if(Xu(e,i),l&4&&-1<Wd.indexOf(e)){for(;n!==null;){var u=Rt(n);if(u!==null&&Vu(u),u=Da(e,l,s,i),u===null&&uo(e,l,i,In,s),u===n)break;n=u}n!==null&&i.stopPropagation()}else uo(e,l,i,null,s)}}var In=null;function Da(e,l,s,i){if(In=null,e=vt(i),e=_i(e),e!==null)if(l=Y(e),l===null)e=null;else if(s=l.tag,s===13){if(e=oe(l),e!==null)return e;e=null}else if(s===3){if(l.stateNode.current.memoizedState.isDehydrated)return l.tag===3?l.stateNode.containerInfo:null;e=null}else l!==e&&(e=null);return In=e,null}function lr(e){switch(e){case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 1;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"toggle":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 4;case"message":switch(fl()){case bs:return 1;case es:return 4;case ls:case cs:return 16;case Ul:return 536870912;default:return 16}default:return 16}}var Ks=null,Wa=null,Gn=null;function sr(){if(Gn)return Gn;var e,l=Wa,s=l.length,i,n="value"in Ks?Ks.value:Ks.textContent,u=n.length;for(e=0;e<s&&l[e]===n[e];e++);var d=s-e;for(i=1;i<=d&&l[s-i]===n[u-i];i++);return Gn=n.slice(e,1<i?1-i:void 0)}function Pn(e){var l=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&l===13&&(e=13)):e=l,e===10&&(e=13),32<=e||e===13?e:0}function Jn(){return!0}function ir(){return!1}function ql(e){function l(s,i,n,u,d){this._reactName=s,this._targetInst=n,this.type=i,this.nativeEvent=u,this.target=d,this.currentTarget=null;for(var h in e)e.hasOwnProperty(h)&&(s=e[h],this[h]=s?s(u):u[h]);return this.isDefaultPrevented=(u.defaultPrevented!=null?u.defaultPrevented:u.returnValue===!1)?Jn:ir,this.isPropagationStopped=ir,this}return V(l.prototype,{preventDefault:function(){this.defaultPrevented=!0;var s=this.nativeEvent;s&&(s.preventDefault?s.preventDefault():typeof s.returnValue!="unknown"&&(s.returnValue=!1),this.isDefaultPrevented=Jn)},stopPropagation:function(){var s=this.nativeEvent;s&&(s.stopPropagation?s.stopPropagation():typeof s.cancelBubble!="unknown"&&(s.cancelBubble=!0),this.isPropagationStopped=Jn)},persist:function(){},isPersistent:Jn}),l}var Fi={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},$a=ql(Fi),Gt=V({},Fi,{view:0,detail:0}),Yd=ql(Gt),Va,Ka,Pt,zn=V({},Gt,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Ya,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Pt&&(Pt&&e.type==="mousemove"?(Va=e.screenX-Pt.screenX,Ka=e.screenY-Pt.screenY):Ka=Va=0,Pt=e),Va)},movementY:function(e){return"movementY"in e?e.movementY:Ka}}),tr=ql(zn),Xd=V({},zn,{dataTransfer:0}),Zd=ql(Xd),eg=V({},Gt,{relatedTarget:0}),Qa=ql(eg),lg=V({},Fi,{animationName:0,elapsedTime:0,pseudoElement:0}),sg=ql(lg),ig=V({},Fi,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),tg=ql(ig),ng=V({},Fi,{data:0}),nr=ql(ng),ag={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},og={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},ug={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function rg(e){var l=this.nativeEvent;return l.getModifierState?l.getModifierState(e):(e=ug[e])?!!l[e]:!1}function Ya(){return rg}var cg=V({},Gt,{key:function(e){if(e.key){var l=ag[e.key]||e.key;if(l!=="Unidentified")return l}return e.type==="keypress"?(e=Pn(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?og[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Ya,charCode:function(e){return e.type==="keypress"?Pn(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Pn(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),pg=ql(cg),dg=V({},zn,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),ar=ql(dg),gg=V({},Gt,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Ya}),fg=ql(gg),mg=V({},Fi,{propertyName:0,elapsedTime:0,pseudoElement:0}),hg=ql(mg),_g=V({},zn,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),jg=ql(_g),Sg=[9,13,27,32],Xa=f&&"CompositionEvent"in window,Jt=null;f&&"documentMode"in document&&(Jt=document.documentMode);var vg=f&&"TextEvent"in window&&!Jt,or=f&&(!Xa||Jt&&8<Jt&&11>=Jt),ur=" ",rr=!1;function cr(e,l){switch(e){case"keyup":return Sg.indexOf(l.keyCode)!==-1;case"keydown":return l.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function pr(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var Di=!1;function wg(e,l){switch(e){case"compositionend":return pr(l);case"keypress":return l.which!==32?null:(rr=!0,ur);case"textInput":return e=l.data,e===ur&&rr?null:e;default:return null}}function xg(e,l){if(Di)return e==="compositionend"||!Xa&&cr(e,l)?(e=sr(),Gn=Wa=Ks=null,Di=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(l.ctrlKey||l.altKey||l.metaKey)||l.ctrlKey&&l.altKey){if(l.char&&1<l.char.length)return l.char;if(l.which)return String.fromCharCode(l.which)}return null;case"compositionend":return or&&l.locale!=="ko"?null:l.data;default:return null}}var yg={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function dr(e){var l=e&&e.nodeName&&e.nodeName.toLowerCase();return l==="input"?!!yg[e.type]:l==="textarea"}function gr(e,l,s,i){yn(i),l=Mn(l,"onChange"),0<l.length&&(s=new $a("onChange","change",null,s,i),e.push({event:s,listeners:l}))}var zt=null,Ut=null;function Eg(e){Pr(e,0)}function Un(e){var l=Qi(e);if(be(l))return e}function kg(e,l){if(e==="change")return l}var fr=!1;if(f){var Za;if(f){var eo="oninput"in document;if(!eo){var mr=document.createElement("div");mr.setAttribute("oninput","return;"),eo=typeof mr.oninput=="function"}Za=eo}else Za=!1;fr=Za&&(!document.documentMode||9<document.documentMode)}function hr(){zt&&(zt.detachEvent("onpropertychange",_r),Ut=zt=null)}function _r(e){if(e.propertyName==="value"&&Un(Ut)){var l=[];gr(l,Ut,e,vt(e)),mi(Eg,l)}}function bg(e,l,s){e==="focusin"?(hr(),zt=l,Ut=s,zt.attachEvent("onpropertychange",_r)):e==="focusout"&&hr()}function Cg(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Un(Ut)}function Lg(e,l){if(e==="click")return Un(l)}function Ig(e,l){if(e==="input"||e==="change")return Un(l)}function Gg(e,l){return e===l&&(e!==0||1/e===1/l)||e!==e&&l!==l}var ss=typeof Object.is=="function"?Object.is:Gg;function qt(e,l){if(ss(e,l))return!0;if(typeof e!="object"||e===null||typeof l!="object"||l===null)return!1;var s=Object.keys(e),i=Object.keys(l);if(s.length!==i.length)return!1;for(i=0;i<s.length;i++){var n=s[i];if(!m.call(l,n)||!ss(e[n],l[n]))return!1}return!0}function jr(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function Sr(e,l){var s=jr(e);e=0;for(var i;s;){if(s.nodeType===3){if(i=e+s.textContent.length,e<=l&&i>=l)return{node:s,offset:l-e};e=i}e:{for(;s;){if(s.nextSibling){s=s.nextSibling;break e}s=s.parentNode}s=void 0}s=jr(s)}}function vr(e,l){return e&&l?e===l?!0:e&&e.nodeType===3?!1:l&&l.nodeType===3?vr(e,l.parentNode):"contains"in e?e.contains(l):e.compareDocumentPosition?!!(e.compareDocumentPosition(l)&16):!1:!1}function wr(){for(var e=window,l=Ee();l instanceof e.HTMLIFrameElement;){try{var s=typeof l.contentWindow.location.href=="string"}catch{s=!1}if(s)e=l.contentWindow;else break;l=Ee(e.document)}return l}function lo(e){var l=e&&e.nodeName&&e.nodeName.toLowerCase();return l&&(l==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||l==="textarea"||e.contentEditable==="true")}function Pg(e){var l=wr(),s=e.focusedElem,i=e.selectionRange;if(l!==s&&s&&s.ownerDocument&&vr(s.ownerDocument.documentElement,s)){if(i!==null&&lo(s)){if(l=i.start,e=i.end,e===void 0&&(e=l),"selectionStart"in s)s.selectionStart=l,s.selectionEnd=Math.min(e,s.value.length);else if(e=(l=s.ownerDocument||document)&&l.defaultView||window,e.getSelection){e=e.getSelection();var n=s.textContent.length,u=Math.min(i.start,n);i=i.end===void 0?u:Math.min(i.end,n),!e.extend&&u>i&&(n=i,i=u,u=n),n=Sr(s,u);var d=Sr(s,i);n&&d&&(e.rangeCount!==1||e.anchorNode!==n.node||e.anchorOffset!==n.offset||e.focusNode!==d.node||e.focusOffset!==d.offset)&&(l=l.createRange(),l.setStart(n.node,n.offset),e.removeAllRanges(),u>i?(e.addRange(l),e.extend(d.node,d.offset)):(l.setEnd(d.node,d.offset),e.addRange(l)))}}for(l=[],e=s;e=e.parentNode;)e.nodeType===1&&l.push({element:e,left:e.scrollLeft,top:e.scrollTop});for(typeof s.focus=="function"&&s.focus(),s=0;s<l.length;s++)e=l[s],e.element.scrollLeft=e.left,e.element.scrollTop=e.top}}var Jg=f&&"documentMode"in document&&11>=document.documentMode,Wi=null,so=null,Bt=null,io=!1;function xr(e,l,s){var i=s.window===s?s.document:s.nodeType===9?s:s.ownerDocument;io||Wi==null||Wi!==Ee(i)||(i=Wi,"selectionStart"in i&&lo(i)?i={start:i.selectionStart,end:i.selectionEnd}:(i=(i.ownerDocument&&i.ownerDocument.defaultView||window).getSelection(),i={anchorNode:i.anchorNode,anchorOffset:i.anchorOffset,focusNode:i.focusNode,focusOffset:i.focusOffset}),Bt&&qt(Bt,i)||(Bt=i,i=Mn(so,"onSelect"),0<i.length&&(l=new $a("onSelect","select",null,l,s),e.push({event:l,listeners:i}),l.target=Wi)))}function qn(e,l){var s={};return s[e.toLowerCase()]=l.toLowerCase(),s["Webkit"+e]="webkit"+l,s["Moz"+e]="moz"+l,s}var $i={animationend:qn("Animation","AnimationEnd"),animationiteration:qn("Animation","AnimationIteration"),animationstart:qn("Animation","AnimationStart"),transitionend:qn("Transition","TransitionEnd")},to={},yr={};f&&(yr=document.createElement("div").style,"AnimationEvent"in window||(delete $i.animationend.animation,delete $i.animationiteration.animation,delete $i.animationstart.animation),"TransitionEvent"in window||delete $i.transitionend.transition);function Bn(e){if(to[e])return to[e];if(!$i[e])return e;var l=$i[e],s;for(s in l)if(l.hasOwnProperty(s)&&s in yr)return to[e]=l[s];return e}var Er=Bn("animationend"),kr=Bn("animationiteration"),br=Bn("animationstart"),Cr=Bn("transitionend"),Lr=new Map,Ir="abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");function Qs(e,l){Lr.set(e,l),p(l,[e])}for(var no=0;no<Ir.length;no++){var ao=Ir[no],zg=ao.toLowerCase(),Ug=ao[0].toUpperCase()+ao.slice(1);Qs(zg,"on"+Ug)}Qs(Er,"onAnimationEnd"),Qs(kr,"onAnimationIteration"),Qs(br,"onAnimationStart"),Qs("dblclick","onDoubleClick"),Qs("focusin","onFocus"),Qs("focusout","onBlur"),Qs(Cr,"onTransitionEnd"),g("onMouseEnter",["mouseout","mouseover"]),g("onMouseLeave",["mouseout","mouseover"]),g("onPointerEnter",["pointerout","pointerover"]),g("onPointerLeave",["pointerout","pointerover"]),p("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),p("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),p("onBeforeInput",["compositionend","keypress","textInput","paste"]),p("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),p("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),p("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var At="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),qg=new Set("cancel close invalid load scroll toggle".split(" ").concat(At));function Gr(e,l,s){var i=e.type||"unknown-event";e.currentTarget=s,ye(i,l,void 0,e),e.currentTarget=null}function Pr(e,l){l=(l&4)!==0;for(var s=0;s<e.length;s++){var i=e[s],n=i.event;i=i.listeners;e:{var u=void 0;if(l)for(var d=i.length-1;0<=d;d--){var h=i[d],v=h.instance,z=h.currentTarget;if(h=h.listener,v!==u&&n.isPropagationStopped())break e;Gr(n,h,z),u=v}else for(d=0;d<i.length;d++){if(h=i[d],v=h.instance,z=h.currentTarget,h=h.listener,v!==u&&n.isPropagationStopped())break e;Gr(n,h,z),u=v}}}if(M)throw e=T,M=!1,T=null,e}function Ke(e,l){var s=l[mo];s===void 0&&(s=l[mo]=new Set);var i=e+"__bubble";s.has(i)||(Jr(l,e,2,!1),s.add(i))}function oo(e,l,s){var i=0;l&&(i|=4),Jr(s,e,i,l)}var An="_reactListening"+Math.random().toString(36).slice(2);function Mt(e){if(!e[An]){e[An]=!0,r.forEach(function(s){s!=="selectionchange"&&(qg.has(s)||oo(s,!1,e),oo(s,!0,e))});var l=e.nodeType===9?e:e.ownerDocument;l===null||l[An]||(l[An]=!0,oo("selectionchange",!1,l))}}function Jr(e,l,s,i){switch(lr(l)){case 1:var n=Kd;break;case 4:n=Qd;break;default:n=Fa}s=n.bind(null,l,s,e),n=void 0,!yt||l!=="touchstart"&&l!=="touchmove"&&l!=="wheel"||(n=!0),i?n!==void 0?e.addEventListener(l,s,{capture:!0,passive:n}):e.addEventListener(l,s,!0):n!==void 0?e.addEventListener(l,s,{passive:n}):e.addEventListener(l,s,!1)}function uo(e,l,s,i,n){var u=i;if((l&1)===0&&(l&2)===0&&i!==null)e:for(;;){if(i===null)return;var d=i.tag;if(d===3||d===4){var h=i.stateNode.containerInfo;if(h===n||h.nodeType===8&&h.parentNode===n)break;if(d===4)for(d=i.return;d!==null;){var v=d.tag;if((v===3||v===4)&&(v=d.stateNode.containerInfo,v===n||v.nodeType===8&&v.parentNode===n))return;d=d.return}for(;h!==null;){if(d=_i(h),d===null)return;if(v=d.tag,v===5||v===6){i=u=d;continue e}h=h.parentNode}}i=i.return}mi(function(){var z=u,O=vt(s),F=[];e:{var R=Lr.get(e);if(R!==void 0){var Z=$a,le=e;switch(e){case"keypress":if(Pn(s)===0)break e;case"keydown":case"keyup":Z=pg;break;case"focusin":le="focus",Z=Qa;break;case"focusout":le="blur",Z=Qa;break;case"beforeblur":case"afterblur":Z=Qa;break;case"click":if(s.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":Z=tr;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":Z=Zd;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":Z=fg;break;case Er:case kr:case br:Z=sg;break;case Cr:Z=hg;break;case"scroll":Z=Yd;break;case"wheel":Z=jg;break;case"copy":case"cut":case"paste":Z=tg;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":Z=ar}var ie=(l&4)!==0,il=!ie&&e==="scroll",I=ie?R!==null?R+"Capture":null:R;ie=[];for(var x=z,P;x!==null;){P=x;var W=P.stateNode;if(P.tag===5&&W!==null&&(P=W,I!==null&&(W=Rs(x,I),W!=null&&ie.push(Ht(x,W,P)))),il)break;x=x.return}0<ie.length&&(R=new Z(R,le,null,s,O),F.push({event:R,listeners:ie}))}}if((l&7)===0){e:{if(R=e==="mouseover"||e==="pointerover",Z=e==="mouseout"||e==="pointerout",R&&s!==Ai&&(le=s.relatedTarget||s.fromElement)&&(_i(le)||le[Ls]))break e;if((Z||R)&&(R=O.window===O?O:(R=O.ownerDocument)?R.defaultView||R.parentWindow:window,Z?(le=s.relatedTarget||s.toElement,Z=z,le=le?_i(le):null,le!==null&&(il=Y(le),le!==il||le.tag!==5&&le.tag!==6)&&(le=null)):(Z=null,le=z),Z!==le)){if(ie=tr,W="onMouseLeave",I="onMouseEnter",x="mouse",(e==="pointerout"||e==="pointerover")&&(ie=ar,W="onPointerLeave",I="onPointerEnter",x="pointer"),il=Z==null?R:Qi(Z),P=le==null?R:Qi(le),R=new ie(W,x+"leave",Z,s,O),R.target=il,R.relatedTarget=P,W=null,_i(O)===z&&(ie=new ie(I,x+"enter",le,s,O),ie.target=P,ie.relatedTarget=il,W=ie),il=W,Z&&le)l:{for(ie=Z,I=le,x=0,P=ie;P;P=Vi(P))x++;for(P=0,W=I;W;W=Vi(W))P++;for(;0<x-P;)ie=Vi(ie),x--;for(;0<P-x;)I=Vi(I),P--;for(;x--;){if(ie===I||I!==null&&ie===I.alternate)break l;ie=Vi(ie),I=Vi(I)}ie=null}else ie=null;Z!==null&&zr(F,R,Z,ie,!1),le!==null&&il!==null&&zr(F,il,le,ie,!0)}}e:{if(R=z?Qi(z):window,Z=R.nodeName&&R.nodeName.toLowerCase(),Z==="select"||Z==="input"&&R.type==="file")var te=kg;else if(dr(R))if(fr)te=Ig;else{te=Cg;var _e=bg}else(Z=R.nodeName)&&Z.toLowerCase()==="input"&&(R.type==="checkbox"||R.type==="radio")&&(te=Lg);if(te&&(te=te(e,z))){gr(F,te,s,O);break e}_e&&_e(e,R,z),e==="focusout"&&(_e=R._wrapperState)&&_e.controlled&&R.type==="number"&&jt(R,"number",R.value)}switch(_e=z?Qi(z):window,e){case"focusin":(dr(_e)||_e.contentEditable==="true")&&(Wi=_e,so=z,Bt=null);break;case"focusout":Bt=so=Wi=null;break;case"mousedown":io=!0;break;case"contextmenu":case"mouseup":case"dragend":io=!1,xr(F,s,O);break;case"selectionchange":if(Jg)break;case"keydown":case"keyup":xr(F,s,O)}var je;if(Xa)e:{switch(e){case"compositionstart":var xe="onCompositionStart";break e;case"compositionend":xe="onCompositionEnd";break e;case"compositionupdate":xe="onCompositionUpdate";break e}xe=void 0}else Di?cr(e,s)&&(xe="onCompositionEnd"):e==="keydown"&&s.keyCode===229&&(xe="onCompositionStart");xe&&(or&&s.locale!=="ko"&&(Di||xe!=="onCompositionStart"?xe==="onCompositionEnd"&&Di&&(je=sr()):(Ks=O,Wa="value"in Ks?Ks.value:Ks.textContent,Di=!0)),_e=Mn(z,xe),0<_e.length&&(xe=new nr(xe,e,null,s,O),F.push({event:xe,listeners:_e}),je?xe.data=je:(je=pr(s),je!==null&&(xe.data=je)))),(je=vg?wg(e,s):xg(e,s))&&(z=Mn(z,"onBeforeInput"),0<z.length&&(O=new nr("onBeforeInput","beforeinput",null,s,O),F.push({event:O,listeners:z}),O.data=je))}Pr(F,l)})}function Ht(e,l,s){return{instance:e,listener:l,currentTarget:s}}function Mn(e,l){for(var s=l+"Capture",i=[];e!==null;){var n=e,u=n.stateNode;n.tag===5&&u!==null&&(n=u,u=Rs(e,s),u!=null&&i.unshift(Ht(e,u,n)),u=Rs(e,l),u!=null&&i.push(Ht(e,u,n))),e=e.return}return i}function Vi(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function zr(e,l,s,i,n){for(var u=l._reactName,d=[];s!==null&&s!==i;){var h=s,v=h.alternate,z=h.stateNode;if(v!==null&&v===i)break;h.tag===5&&z!==null&&(h=z,n?(v=Rs(s,u),v!=null&&d.unshift(Ht(s,v,h))):n||(v=Rs(s,u),v!=null&&d.push(Ht(s,v,h)))),s=s.return}d.length!==0&&e.push({event:l,listeners:d})}var Bg=/\r\n?/g,Ag=/\u0000|\uFFFD/g;function Ur(e){return(typeof e=="string"?e:""+e).replace(Bg,`
`).replace(Ag,"")}function Hn(e,l,s){if(l=Ur(l),Ur(e)!==l&&s)throw Error(o(425))}function Tn(){}var ro=null,co=null;function po(e,l){return e==="textarea"||e==="noscript"||typeof l.children=="string"||typeof l.children=="number"||typeof l.dangerouslySetInnerHTML=="object"&&l.dangerouslySetInnerHTML!==null&&l.dangerouslySetInnerHTML.__html!=null}var go=typeof setTimeout=="function"?setTimeout:void 0,Mg=typeof clearTimeout=="function"?clearTimeout:void 0,qr=typeof Promise=="function"?Promise:void 0,Hg=typeof queueMicrotask=="function"?queueMicrotask:typeof qr<"u"?function(e){return qr.resolve(null).then(e).catch(Tg)}:go;function Tg(e){setTimeout(function(){throw e})}function fo(e,l){var s=l,i=0;do{var n=s.nextSibling;if(e.removeChild(s),n&&n.nodeType===8)if(s=n.data,s==="/$"){if(i===0){e.removeChild(n),It(l);return}i--}else s!=="$"&&s!=="$?"&&s!=="$!"||i++;s=n}while(s);It(l)}function Ys(e){for(;e!=null;e=e.nextSibling){var l=e.nodeType;if(l===1||l===3)break;if(l===8){if(l=e.data,l==="$"||l==="$!"||l==="$?")break;if(l==="/$")return null}}return e}function Br(e){e=e.previousSibling;for(var l=0;e;){if(e.nodeType===8){var s=e.data;if(s==="$"||s==="$!"||s==="$?"){if(l===0)return e;l--}else s==="/$"&&l++}e=e.previousSibling}return null}var Ki=Math.random().toString(36).slice(2),ps="__reactFiber$"+Ki,Tt="__reactProps$"+Ki,Ls="__reactContainer$"+Ki,mo="__reactEvents$"+Ki,Rg="__reactListeners$"+Ki,Og="__reactHandles$"+Ki;function _i(e){var l=e[ps];if(l)return l;for(var s=e.parentNode;s;){if(l=s[Ls]||s[ps]){if(s=l.alternate,l.child!==null||s!==null&&s.child!==null)for(e=Br(e);e!==null;){if(s=e[ps])return s;e=Br(e)}return l}e=s,s=e.parentNode}return null}function Rt(e){return e=e[ps]||e[Ls],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function Qi(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(o(33))}function Rn(e){return e[Tt]||null}var ho=[],Yi=-1;function Xs(e){return{current:e}}function Qe(e){0>Yi||(e.current=ho[Yi],ho[Yi]=null,Yi--)}function $e(e,l){Yi++,ho[Yi]=e.current,e.current=l}var Zs={},_l=Xs(Zs),Cl=Xs(!1),ji=Zs;function Xi(e,l){var s=e.type.contextTypes;if(!s)return Zs;var i=e.stateNode;if(i&&i.__reactInternalMemoizedUnmaskedChildContext===l)return i.__reactInternalMemoizedMaskedChildContext;var n={},u;for(u in s)n[u]=l[u];return i&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=l,e.__reactInternalMemoizedMaskedChildContext=n),n}function Ll(e){return e=e.childContextTypes,e!=null}function On(){Qe(Cl),Qe(_l)}function Ar(e,l,s){if(_l.current!==Zs)throw Error(o(168));$e(_l,l),$e(Cl,s)}function Mr(e,l,s){var i=e.stateNode;if(l=l.childContextTypes,typeof i.getChildContext!="function")return s;i=i.getChildContext();for(var n in i)if(!(n in l))throw Error(o(108,Ie(e)||"Unknown",n));return V({},s,i)}function Nn(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||Zs,ji=_l.current,$e(_l,e),$e(Cl,Cl.current),!0}function Hr(e,l,s){var i=e.stateNode;if(!i)throw Error(o(169));s?(e=Mr(e,l,ji),i.__reactInternalMemoizedMergedChildContext=e,Qe(Cl),Qe(_l),$e(_l,e)):Qe(Cl),$e(Cl,s)}var Is=null,Fn=!1,_o=!1;function Tr(e){Is===null?Is=[e]:Is.push(e)}function Ng(e){Fn=!0,Tr(e)}function ei(){if(!_o&&Is!==null){_o=!0;var e=0,l=De;try{var s=Is;for(De=1;e<s.length;e++){var i=s[e];do i=i(!0);while(i!==null)}Is=null,Fn=!1}catch(n){throw Is!==null&&(Is=Is.slice(e+1)),Re(bs,ei),n}finally{De=l,_o=!1}}return null}var Zi=[],et=0,Dn=null,Wn=0,Rl=[],Ol=0,Si=null,Gs=1,Ps="";function vi(e,l){Zi[et++]=Wn,Zi[et++]=Dn,Dn=e,Wn=l}function Rr(e,l,s){Rl[Ol++]=Gs,Rl[Ol++]=Ps,Rl[Ol++]=Si,Si=e;var i=Gs;e=Ps;var n=32-ml(i)-1;i&=~(1<<n),s+=1;var u=32-ml(l)+n;if(30<u){var d=n-n%5;u=(i&(1<<d)-1).toString(32),i>>=d,n-=d,Gs=1<<32-ml(l)+n|s<<n|i,Ps=u+e}else Gs=1<<u|s<<n|i,Ps=e}function jo(e){e.return!==null&&(vi(e,1),Rr(e,1,0))}function So(e){for(;e===Dn;)Dn=Zi[--et],Zi[et]=null,Wn=Zi[--et],Zi[et]=null;for(;e===Si;)Si=Rl[--Ol],Rl[Ol]=null,Ps=Rl[--Ol],Rl[Ol]=null,Gs=Rl[--Ol],Rl[Ol]=null}var Bl=null,Al=null,Ye=!1,is=null;function Or(e,l){var s=Wl(5,null,null,0);s.elementType="DELETED",s.stateNode=l,s.return=e,l=e.deletions,l===null?(e.deletions=[s],e.flags|=16):l.push(s)}function Nr(e,l){switch(e.tag){case 5:var s=e.type;return l=l.nodeType!==1||s.toLowerCase()!==l.nodeName.toLowerCase()?null:l,l!==null?(e.stateNode=l,Bl=e,Al=Ys(l.firstChild),!0):!1;case 6:return l=e.pendingProps===""||l.nodeType!==3?null:l,l!==null?(e.stateNode=l,Bl=e,Al=null,!0):!1;case 13:return l=l.nodeType!==8?null:l,l!==null?(s=Si!==null?{id:Gs,overflow:Ps}:null,e.memoizedState={dehydrated:l,treeContext:s,retryLane:1073741824},s=Wl(18,null,null,0),s.stateNode=l,s.return=e,e.child=s,Bl=e,Al=null,!0):!1;default:return!1}}function vo(e){return(e.mode&1)!==0&&(e.flags&128)===0}function wo(e){if(Ye){var l=Al;if(l){var s=l;if(!Nr(e,l)){if(vo(e))throw Error(o(418));l=Ys(s.nextSibling);var i=Bl;l&&Nr(e,l)?Or(i,s):(e.flags=e.flags&-4097|2,Ye=!1,Bl=e)}}else{if(vo(e))throw Error(o(418));e.flags=e.flags&-4097|2,Ye=!1,Bl=e}}}function Fr(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;Bl=e}function $n(e){if(e!==Bl)return!1;if(!Ye)return Fr(e),Ye=!0,!1;var l;if((l=e.tag!==3)&&!(l=e.tag!==5)&&(l=e.type,l=l!=="head"&&l!=="body"&&!po(e.type,e.memoizedProps)),l&&(l=Al)){if(vo(e))throw Dr(),Error(o(418));for(;l;)Or(e,l),l=Ys(l.nextSibling)}if(Fr(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(o(317));e:{for(e=e.nextSibling,l=0;e;){if(e.nodeType===8){var s=e.data;if(s==="/$"){if(l===0){Al=Ys(e.nextSibling);break e}l--}else s!=="$"&&s!=="$!"&&s!=="$?"||l++}e=e.nextSibling}Al=null}}else Al=Bl?Ys(e.stateNode.nextSibling):null;return!0}function Dr(){for(var e=Al;e;)e=Ys(e.nextSibling)}function lt(){Al=Bl=null,Ye=!1}function xo(e){is===null?is=[e]:is.push(e)}var Fg=pe.ReactCurrentBatchConfig;function Ot(e,l,s){if(e=s.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(s._owner){if(s=s._owner,s){if(s.tag!==1)throw Error(o(309));var i=s.stateNode}if(!i)throw Error(o(147,e));var n=i,u=""+e;return l!==null&&l.ref!==null&&typeof l.ref=="function"&&l.ref._stringRef===u?l.ref:(l=function(d){var h=n.refs;d===null?delete h[u]:h[u]=d},l._stringRef=u,l)}if(typeof e!="string")throw Error(o(284));if(!s._owner)throw Error(o(290,e))}return e}function Vn(e,l){throw e=Object.prototype.toString.call(l),Error(o(31,e==="[object Object]"?"object with keys {"+Object.keys(l).join(", ")+"}":e))}function Wr(e){var l=e._init;return l(e._payload)}function $r(e){function l(I,x){if(e){var P=I.deletions;P===null?(I.deletions=[x],I.flags|=16):P.push(x)}}function s(I,x){if(!e)return null;for(;x!==null;)l(I,x),x=x.sibling;return null}function i(I,x){for(I=new Map;x!==null;)x.key!==null?I.set(x.key,x):I.set(x.index,x),x=x.sibling;return I}function n(I,x){return I=ui(I,x),I.index=0,I.sibling=null,I}function u(I,x,P){return I.index=P,e?(P=I.alternate,P!==null?(P=P.index,P<x?(I.flags|=2,x):P):(I.flags|=2,x)):(I.flags|=1048576,x)}function d(I){return e&&I.alternate===null&&(I.flags|=2),I}function h(I,x,P,W){return x===null||x.tag!==6?(x=gu(P,I.mode,W),x.return=I,x):(x=n(x,P),x.return=I,x)}function v(I,x,P,W){var te=P.type;return te===Le?O(I,x,P.props.children,W,P.key):x!==null&&(x.elementType===te||typeof te=="object"&&te!==null&&te.$$typeof===Oe&&Wr(te)===x.type)?(W=n(x,P.props),W.ref=Ot(I,x,P),W.return=I,W):(W=ja(P.type,P.key,P.props,null,I.mode,W),W.ref=Ot(I,x,P),W.return=I,W)}function z(I,x,P,W){return x===null||x.tag!==4||x.stateNode.containerInfo!==P.containerInfo||x.stateNode.implementation!==P.implementation?(x=fu(P,I.mode,W),x.return=I,x):(x=n(x,P.children||[]),x.return=I,x)}function O(I,x,P,W,te){return x===null||x.tag!==7?(x=Li(P,I.mode,W,te),x.return=I,x):(x=n(x,P),x.return=I,x)}function F(I,x,P){if(typeof x=="string"&&x!==""||typeof x=="number")return x=gu(""+x,I.mode,P),x.return=I,x;if(typeof x=="object"&&x!==null){switch(x.$$typeof){case ue:return P=ja(x.type,x.key,x.props,null,I.mode,P),P.ref=Ot(I,null,x),P.return=I,P;case ve:return x=fu(x,I.mode,P),x.return=I,x;case Oe:var W=x._init;return F(I,W(x._payload),P)}if(Bs(x)||Q(x))return x=Li(x,I.mode,P,null),x.return=I,x;Vn(I,x)}return null}function R(I,x,P,W){var te=x!==null?x.key:null;if(typeof P=="string"&&P!==""||typeof P=="number")return te!==null?null:h(I,x,""+P,W);if(typeof P=="object"&&P!==null){switch(P.$$typeof){case ue:return P.key===te?v(I,x,P,W):null;case ve:return P.key===te?z(I,x,P,W):null;case Oe:return te=P._init,R(I,x,te(P._payload),W)}if(Bs(P)||Q(P))return te!==null?null:O(I,x,P,W,null);Vn(I,P)}return null}function Z(I,x,P,W,te){if(typeof W=="string"&&W!==""||typeof W=="number")return I=I.get(P)||null,h(x,I,""+W,te);if(typeof W=="object"&&W!==null){switch(W.$$typeof){case ue:return I=I.get(W.key===null?P:W.key)||null,v(x,I,W,te);case ve:return I=I.get(W.key===null?P:W.key)||null,z(x,I,W,te);case Oe:var _e=W._init;return Z(I,x,P,_e(W._payload),te)}if(Bs(W)||Q(W))return I=I.get(P)||null,O(x,I,W,te,null);Vn(x,W)}return null}function le(I,x,P,W){for(var te=null,_e=null,je=x,xe=x=0,pl=null;je!==null&&xe<P.length;xe++){je.index>xe?(pl=je,je=null):pl=je.sibling;var Te=R(I,je,P[xe],W);if(Te===null){je===null&&(je=pl);break}e&&je&&Te.alternate===null&&l(I,je),x=u(Te,x,xe),_e===null?te=Te:_e.sibling=Te,_e=Te,je=pl}if(xe===P.length)return s(I,je),Ye&&vi(I,xe),te;if(je===null){for(;xe<P.length;xe++)je=F(I,P[xe],W),je!==null&&(x=u(je,x,xe),_e===null?te=je:_e.sibling=je,_e=je);return Ye&&vi(I,xe),te}for(je=i(I,je);xe<P.length;xe++)pl=Z(je,I,xe,P[xe],W),pl!==null&&(e&&pl.alternate!==null&&je.delete(pl.key===null?xe:pl.key),x=u(pl,x,xe),_e===null?te=pl:_e.sibling=pl,_e=pl);return e&&je.forEach(function(ri){return l(I,ri)}),Ye&&vi(I,xe),te}function ie(I,x,P,W){var te=Q(P);if(typeof te!="function")throw Error(o(150));if(P=te.call(P),P==null)throw Error(o(151));for(var _e=te=null,je=x,xe=x=0,pl=null,Te=P.next();je!==null&&!Te.done;xe++,Te=P.next()){je.index>xe?(pl=je,je=null):pl=je.sibling;var ri=R(I,je,Te.value,W);if(ri===null){je===null&&(je=pl);break}e&&je&&ri.alternate===null&&l(I,je),x=u(ri,x,xe),_e===null?te=ri:_e.sibling=ri,_e=ri,je=pl}if(Te.done)return s(I,je),Ye&&vi(I,xe),te;if(je===null){for(;!Te.done;xe++,Te=P.next())Te=F(I,Te.value,W),Te!==null&&(x=u(Te,x,xe),_e===null?te=Te:_e.sibling=Te,_e=Te);return Ye&&vi(I,xe),te}for(je=i(I,je);!Te.done;xe++,Te=P.next())Te=Z(je,I,xe,Te.value,W),Te!==null&&(e&&Te.alternate!==null&&je.delete(Te.key===null?xe:Te.key),x=u(Te,x,xe),_e===null?te=Te:_e.sibling=Te,_e=Te);return e&&je.forEach(function(Ef){return l(I,Ef)}),Ye&&vi(I,xe),te}function il(I,x,P,W){if(typeof P=="object"&&P!==null&&P.type===Le&&P.key===null&&(P=P.props.children),typeof P=="object"&&P!==null){switch(P.$$typeof){case ue:e:{for(var te=P.key,_e=x;_e!==null;){if(_e.key===te){if(te=P.type,te===Le){if(_e.tag===7){s(I,_e.sibling),x=n(_e,P.props.children),x.return=I,I=x;break e}}else if(_e.elementType===te||typeof te=="object"&&te!==null&&te.$$typeof===Oe&&Wr(te)===_e.type){s(I,_e.sibling),x=n(_e,P.props),x.ref=Ot(I,_e,P),x.return=I,I=x;break e}s(I,_e);break}else l(I,_e);_e=_e.sibling}P.type===Le?(x=Li(P.props.children,I.mode,W,P.key),x.return=I,I=x):(W=ja(P.type,P.key,P.props,null,I.mode,W),W.ref=Ot(I,x,P),W.return=I,I=W)}return d(I);case ve:e:{for(_e=P.key;x!==null;){if(x.key===_e)if(x.tag===4&&x.stateNode.containerInfo===P.containerInfo&&x.stateNode.implementation===P.implementation){s(I,x.sibling),x=n(x,P.children||[]),x.return=I,I=x;break e}else{s(I,x);break}else l(I,x);x=x.sibling}x=fu(P,I.mode,W),x.return=I,I=x}return d(I);case Oe:return _e=P._init,il(I,x,_e(P._payload),W)}if(Bs(P))return le(I,x,P,W);if(Q(P))return ie(I,x,P,W);Vn(I,P)}return typeof P=="string"&&P!==""||typeof P=="number"?(P=""+P,x!==null&&x.tag===6?(s(I,x.sibling),x=n(x,P),x.return=I,I=x):(s(I,x),x=gu(P,I.mode,W),x.return=I,I=x),d(I)):s(I,x)}return il}var st=$r(!0),Vr=$r(!1),Kn=Xs(null),Qn=null,it=null,yo=null;function Eo(){yo=it=Qn=null}function ko(e){var l=Kn.current;Qe(Kn),e._currentValue=l}function bo(e,l,s){for(;e!==null;){var i=e.alternate;if((e.childLanes&l)!==l?(e.childLanes|=l,i!==null&&(i.childLanes|=l)):i!==null&&(i.childLanes&l)!==l&&(i.childLanes|=l),e===s)break;e=e.return}}function tt(e,l){Qn=e,yo=it=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&l)!==0&&(Il=!0),e.firstContext=null)}function Nl(e){var l=e._currentValue;if(yo!==e)if(e={context:e,memoizedValue:l,next:null},it===null){if(Qn===null)throw Error(o(308));it=e,Qn.dependencies={lanes:0,firstContext:e}}else it=it.next=e;return l}var wi=null;function Co(e){wi===null?wi=[e]:wi.push(e)}function Kr(e,l,s,i){var n=l.interleaved;return n===null?(s.next=s,Co(l)):(s.next=n.next,n.next=s),l.interleaved=s,Js(e,i)}function Js(e,l){e.lanes|=l;var s=e.alternate;for(s!==null&&(s.lanes|=l),s=e,e=e.return;e!==null;)e.childLanes|=l,s=e.alternate,s!==null&&(s.childLanes|=l),s=e,e=e.return;return s.tag===3?s.stateNode:null}var li=!1;function Lo(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,interleaved:null,lanes:0},effects:null}}function Qr(e,l){e=e.updateQueue,l.updateQueue===e&&(l.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function zs(e,l){return{eventTime:e,lane:l,tag:0,payload:null,callback:null,next:null}}function si(e,l,s){var i=e.updateQueue;if(i===null)return null;if(i=i.shared,(He&2)!==0){var n=i.pending;return n===null?l.next=l:(l.next=n.next,n.next=l),i.pending=l,Js(e,s)}return n=i.interleaved,n===null?(l.next=l,Co(i)):(l.next=n.next,n.next=l),i.interleaved=l,Js(e,s)}function Yn(e,l,s){if(l=l.updateQueue,l!==null&&(l=l.shared,(s&4194240)!==0)){var i=l.lanes;i&=e.pendingLanes,s|=i,l.lanes=s,Ra(e,s)}}function Yr(e,l){var s=e.updateQueue,i=e.alternate;if(i!==null&&(i=i.updateQueue,s===i)){var n=null,u=null;if(s=s.firstBaseUpdate,s!==null){do{var d={eventTime:s.eventTime,lane:s.lane,tag:s.tag,payload:s.payload,callback:s.callback,next:null};u===null?n=u=d:u=u.next=d,s=s.next}while(s!==null);u===null?n=u=l:u=u.next=l}else n=u=l;s={baseState:i.baseState,firstBaseUpdate:n,lastBaseUpdate:u,shared:i.shared,effects:i.effects},e.updateQueue=s;return}e=s.lastBaseUpdate,e===null?s.firstBaseUpdate=l:e.next=l,s.lastBaseUpdate=l}function Xn(e,l,s,i){var n=e.updateQueue;li=!1;var u=n.firstBaseUpdate,d=n.lastBaseUpdate,h=n.shared.pending;if(h!==null){n.shared.pending=null;var v=h,z=v.next;v.next=null,d===null?u=z:d.next=z,d=v;var O=e.alternate;O!==null&&(O=O.updateQueue,h=O.lastBaseUpdate,h!==d&&(h===null?O.firstBaseUpdate=z:h.next=z,O.lastBaseUpdate=v))}if(u!==null){var F=n.baseState;d=0,O=z=v=null,h=u;do{var R=h.lane,Z=h.eventTime;if((i&R)===R){O!==null&&(O=O.next={eventTime:Z,lane:0,tag:h.tag,payload:h.payload,callback:h.callback,next:null});e:{var le=e,ie=h;switch(R=l,Z=s,ie.tag){case 1:if(le=ie.payload,typeof le=="function"){F=le.call(Z,F,R);break e}F=le;break e;case 3:le.flags=le.flags&-65537|128;case 0:if(le=ie.payload,R=typeof le=="function"?le.call(Z,F,R):le,R==null)break e;F=V({},F,R);break e;case 2:li=!0}}h.callback!==null&&h.lane!==0&&(e.flags|=64,R=n.effects,R===null?n.effects=[h]:R.push(h))}else Z={eventTime:Z,lane:R,tag:h.tag,payload:h.payload,callback:h.callback,next:null},O===null?(z=O=Z,v=F):O=O.next=Z,d|=R;if(h=h.next,h===null){if(h=n.shared.pending,h===null)break;R=h,h=R.next,R.next=null,n.lastBaseUpdate=R,n.shared.pending=null}}while(!0);if(O===null&&(v=F),n.baseState=v,n.firstBaseUpdate=z,n.lastBaseUpdate=O,l=n.shared.interleaved,l!==null){n=l;do d|=n.lane,n=n.next;while(n!==l)}else u===null&&(n.shared.lanes=0);Ei|=d,e.lanes=d,e.memoizedState=F}}function Xr(e,l,s){if(e=l.effects,l.effects=null,e!==null)for(l=0;l<e.length;l++){var i=e[l],n=i.callback;if(n!==null){if(i.callback=null,i=s,typeof n!="function")throw Error(o(191,n));n.call(i)}}}var Nt={},ds=Xs(Nt),Ft=Xs(Nt),Dt=Xs(Nt);function xi(e){if(e===Nt)throw Error(o(174));return e}function Io(e,l){switch($e(Dt,l),$e(Ft,e),$e(ds,Nt),e=l.nodeType,e){case 9:case 11:l=(l=l.documentElement)?l.namespaceURI:zi(null,"");break;default:e=e===8?l.parentNode:l,l=e.namespaceURI||null,e=e.tagName,l=zi(l,e)}Qe(ds),$e(ds,l)}function nt(){Qe(ds),Qe(Ft),Qe(Dt)}function Zr(e){xi(Dt.current);var l=xi(ds.current),s=zi(l,e.type);l!==s&&($e(Ft,e),$e(ds,s))}function Go(e){Ft.current===e&&(Qe(ds),Qe(Ft))}var Xe=Xs(0);function Zn(e){for(var l=e;l!==null;){if(l.tag===13){var s=l.memoizedState;if(s!==null&&(s=s.dehydrated,s===null||s.data==="$?"||s.data==="$!"))return l}else if(l.tag===19&&l.memoizedProps.revealOrder!==void 0){if((l.flags&128)!==0)return l}else if(l.child!==null){l.child.return=l,l=l.child;continue}if(l===e)break;for(;l.sibling===null;){if(l.return===null||l.return===e)return null;l=l.return}l.sibling.return=l.return,l=l.sibling}return null}var Po=[];function Jo(){for(var e=0;e<Po.length;e++)Po[e]._workInProgressVersionPrimary=null;Po.length=0}var ea=pe.ReactCurrentDispatcher,zo=pe.ReactCurrentBatchConfig,yi=0,Ze=null,ol=null,rl=null,la=!1,Wt=!1,$t=0,Dg=0;function jl(){throw Error(o(321))}function Uo(e,l){if(l===null)return!1;for(var s=0;s<l.length&&s<e.length;s++)if(!ss(e[s],l[s]))return!1;return!0}function qo(e,l,s,i,n,u){if(yi=u,Ze=l,l.memoizedState=null,l.updateQueue=null,l.lanes=0,ea.current=e===null||e.memoizedState===null?Kg:Qg,e=s(i,n),Wt){u=0;do{if(Wt=!1,$t=0,25<=u)throw Error(o(301));u+=1,rl=ol=null,l.updateQueue=null,ea.current=Yg,e=s(i,n)}while(Wt)}if(ea.current=ta,l=ol!==null&&ol.next!==null,yi=0,rl=ol=Ze=null,la=!1,l)throw Error(o(300));return e}function Bo(){var e=$t!==0;return $t=0,e}function gs(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return rl===null?Ze.memoizedState=rl=e:rl=rl.next=e,rl}function Fl(){if(ol===null){var e=Ze.alternate;e=e!==null?e.memoizedState:null}else e=ol.next;var l=rl===null?Ze.memoizedState:rl.next;if(l!==null)rl=l,ol=e;else{if(e===null)throw Error(o(310));ol=e,e={memoizedState:ol.memoizedState,baseState:ol.baseState,baseQueue:ol.baseQueue,queue:ol.queue,next:null},rl===null?Ze.memoizedState=rl=e:rl=rl.next=e}return rl}function Vt(e,l){return typeof l=="function"?l(e):l}function Ao(e){var l=Fl(),s=l.queue;if(s===null)throw Error(o(311));s.lastRenderedReducer=e;var i=ol,n=i.baseQueue,u=s.pending;if(u!==null){if(n!==null){var d=n.next;n.next=u.next,u.next=d}i.baseQueue=n=u,s.pending=null}if(n!==null){u=n.next,i=i.baseState;var h=d=null,v=null,z=u;do{var O=z.lane;if((yi&O)===O)v!==null&&(v=v.next={lane:0,action:z.action,hasEagerState:z.hasEagerState,eagerState:z.eagerState,next:null}),i=z.hasEagerState?z.eagerState:e(i,z.action);else{var F={lane:O,action:z.action,hasEagerState:z.hasEagerState,eagerState:z.eagerState,next:null};v===null?(h=v=F,d=i):v=v.next=F,Ze.lanes|=O,Ei|=O}z=z.next}while(z!==null&&z!==u);v===null?d=i:v.next=h,ss(i,l.memoizedState)||(Il=!0),l.memoizedState=i,l.baseState=d,l.baseQueue=v,s.lastRenderedState=i}if(e=s.interleaved,e!==null){n=e;do u=n.lane,Ze.lanes|=u,Ei|=u,n=n.next;while(n!==e)}else n===null&&(s.lanes=0);return[l.memoizedState,s.dispatch]}function Mo(e){var l=Fl(),s=l.queue;if(s===null)throw Error(o(311));s.lastRenderedReducer=e;var i=s.dispatch,n=s.pending,u=l.memoizedState;if(n!==null){s.pending=null;var d=n=n.next;do u=e(u,d.action),d=d.next;while(d!==n);ss(u,l.memoizedState)||(Il=!0),l.memoizedState=u,l.baseQueue===null&&(l.baseState=u),s.lastRenderedState=u}return[u,i]}function ec(){}function lc(e,l){var s=Ze,i=Fl(),n=l(),u=!ss(i.memoizedState,n);if(u&&(i.memoizedState=n,Il=!0),i=i.queue,Ho(tc.bind(null,s,i,e),[e]),i.getSnapshot!==l||u||rl!==null&&rl.memoizedState.tag&1){if(s.flags|=2048,Kt(9,ic.bind(null,s,i,n,l),void 0,null),cl===null)throw Error(o(349));(yi&30)!==0||sc(s,l,n)}return n}function sc(e,l,s){e.flags|=16384,e={getSnapshot:l,value:s},l=Ze.updateQueue,l===null?(l={lastEffect:null,stores:null},Ze.updateQueue=l,l.stores=[e]):(s=l.stores,s===null?l.stores=[e]:s.push(e))}function ic(e,l,s,i){l.value=s,l.getSnapshot=i,nc(l)&&ac(e)}function tc(e,l,s){return s(function(){nc(l)&&ac(e)})}function nc(e){var l=e.getSnapshot;e=e.value;try{var s=l();return!ss(e,s)}catch{return!0}}function ac(e){var l=Js(e,1);l!==null&&os(l,e,1,-1)}function oc(e){var l=gs();return typeof e=="function"&&(e=e()),l.memoizedState=l.baseState=e,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:Vt,lastRenderedState:e},l.queue=e,e=e.dispatch=Vg.bind(null,Ze,e),[l.memoizedState,e]}function Kt(e,l,s,i){return e={tag:e,create:l,destroy:s,deps:i,next:null},l=Ze.updateQueue,l===null?(l={lastEffect:null,stores:null},Ze.updateQueue=l,l.lastEffect=e.next=e):(s=l.lastEffect,s===null?l.lastEffect=e.next=e:(i=s.next,s.next=e,e.next=i,l.lastEffect=e)),e}function uc(){return Fl().memoizedState}function sa(e,l,s,i){var n=gs();Ze.flags|=e,n.memoizedState=Kt(1|l,s,void 0,i===void 0?null:i)}function ia(e,l,s,i){var n=Fl();i=i===void 0?null:i;var u=void 0;if(ol!==null){var d=ol.memoizedState;if(u=d.destroy,i!==null&&Uo(i,d.deps)){n.memoizedState=Kt(l,s,u,i);return}}Ze.flags|=e,n.memoizedState=Kt(1|l,s,u,i)}function rc(e,l){return sa(8390656,8,e,l)}function Ho(e,l){return ia(2048,8,e,l)}function cc(e,l){return ia(4,2,e,l)}function pc(e,l){return ia(4,4,e,l)}function dc(e,l){if(typeof l=="function")return e=e(),l(e),function(){l(null)};if(l!=null)return e=e(),l.current=e,function(){l.current=null}}function gc(e,l,s){return s=s!=null?s.concat([e]):null,ia(4,4,dc.bind(null,l,e),s)}function To(){}function fc(e,l){var s=Fl();l=l===void 0?null:l;var i=s.memoizedState;return i!==null&&l!==null&&Uo(l,i[1])?i[0]:(s.memoizedState=[e,l],e)}function mc(e,l){var s=Fl();l=l===void 0?null:l;var i=s.memoizedState;return i!==null&&l!==null&&Uo(l,i[1])?i[0]:(e=e(),s.memoizedState=[e,l],e)}function hc(e,l,s){return(yi&21)===0?(e.baseState&&(e.baseState=!1,Il=!0),e.memoizedState=s):(ss(s,l)||(s=kn(),Ze.lanes|=s,Ei|=s,e.baseState=!0),l)}function Wg(e,l){var s=De;De=s!==0&&4>s?s:4,e(!0);var i=zo.transition;zo.transition={};try{e(!1),l()}finally{De=s,zo.transition=i}}function _c(){return Fl().memoizedState}function $g(e,l,s){var i=ai(e);if(s={lane:i,action:s,hasEagerState:!1,eagerState:null,next:null},jc(e))Sc(l,s);else if(s=Kr(e,l,s,i),s!==null){var n=kl();os(s,e,i,n),vc(s,l,i)}}function Vg(e,l,s){var i=ai(e),n={lane:i,action:s,hasEagerState:!1,eagerState:null,next:null};if(jc(e))Sc(l,n);else{var u=e.alternate;if(e.lanes===0&&(u===null||u.lanes===0)&&(u=l.lastRenderedReducer,u!==null))try{var d=l.lastRenderedState,h=u(d,s);if(n.hasEagerState=!0,n.eagerState=h,ss(h,d)){var v=l.interleaved;v===null?(n.next=n,Co(l)):(n.next=v.next,v.next=n),l.interleaved=n;return}}catch{}finally{}s=Kr(e,l,n,i),s!==null&&(n=kl(),os(s,e,i,n),vc(s,l,i))}}function jc(e){var l=e.alternate;return e===Ze||l!==null&&l===Ze}function Sc(e,l){Wt=la=!0;var s=e.pending;s===null?l.next=l:(l.next=s.next,s.next=l),e.pending=l}function vc(e,l,s){if((s&4194240)!==0){var i=l.lanes;i&=e.pendingLanes,s|=i,l.lanes=s,Ra(e,s)}}var ta={readContext:Nl,useCallback:jl,useContext:jl,useEffect:jl,useImperativeHandle:jl,useInsertionEffect:jl,useLayoutEffect:jl,useMemo:jl,useReducer:jl,useRef:jl,useState:jl,useDebugValue:jl,useDeferredValue:jl,useTransition:jl,useMutableSource:jl,useSyncExternalStore:jl,useId:jl,unstable_isNewReconciler:!1},Kg={readContext:Nl,useCallback:function(e,l){return gs().memoizedState=[e,l===void 0?null:l],e},useContext:Nl,useEffect:rc,useImperativeHandle:function(e,l,s){return s=s!=null?s.concat([e]):null,sa(4194308,4,dc.bind(null,l,e),s)},useLayoutEffect:function(e,l){return sa(4194308,4,e,l)},useInsertionEffect:function(e,l){return sa(4,2,e,l)},useMemo:function(e,l){var s=gs();return l=l===void 0?null:l,e=e(),s.memoizedState=[e,l],e},useReducer:function(e,l,s){var i=gs();return l=s!==void 0?s(l):l,i.memoizedState=i.baseState=l,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:l},i.queue=e,e=e.dispatch=$g.bind(null,Ze,e),[i.memoizedState,e]},useRef:function(e){var l=gs();return e={current:e},l.memoizedState=e},useState:oc,useDebugValue:To,useDeferredValue:function(e){return gs().memoizedState=e},useTransition:function(){var e=oc(!1),l=e[0];return e=Wg.bind(null,e[1]),gs().memoizedState=e,[l,e]},useMutableSource:function(){},useSyncExternalStore:function(e,l,s){var i=Ze,n=gs();if(Ye){if(s===void 0)throw Error(o(407));s=s()}else{if(s=l(),cl===null)throw Error(o(349));(yi&30)!==0||sc(i,l,s)}n.memoizedState=s;var u={value:s,getSnapshot:l};return n.queue=u,rc(tc.bind(null,i,u,e),[e]),i.flags|=2048,Kt(9,ic.bind(null,i,u,s,l),void 0,null),s},useId:function(){var e=gs(),l=cl.identifierPrefix;if(Ye){var s=Ps,i=Gs;s=(i&~(1<<32-ml(i)-1)).toString(32)+s,l=":"+l+"R"+s,s=$t++,0<s&&(l+="H"+s.toString(32)),l+=":"}else s=Dg++,l=":"+l+"r"+s.toString(32)+":";return e.memoizedState=l},unstable_isNewReconciler:!1},Qg={readContext:Nl,useCallback:fc,useContext:Nl,useEffect:Ho,useImperativeHandle:gc,useInsertionEffect:cc,useLayoutEffect:pc,useMemo:mc,useReducer:Ao,useRef:uc,useState:function(){return Ao(Vt)},useDebugValue:To,useDeferredValue:function(e){var l=Fl();return hc(l,ol.memoizedState,e)},useTransition:function(){var e=Ao(Vt)[0],l=Fl().memoizedState;return[e,l]},useMutableSource:ec,useSyncExternalStore:lc,useId:_c,unstable_isNewReconciler:!1},Yg={readContext:Nl,useCallback:fc,useContext:Nl,useEffect:Ho,useImperativeHandle:gc,useInsertionEffect:cc,useLayoutEffect:pc,useMemo:mc,useReducer:Mo,useRef:uc,useState:function(){return Mo(Vt)},useDebugValue:To,useDeferredValue:function(e){var l=Fl();return ol===null?l.memoizedState=e:hc(l,ol.memoizedState,e)},useTransition:function(){var e=Mo(Vt)[0],l=Fl().memoizedState;return[e,l]},useMutableSource:ec,useSyncExternalStore:lc,useId:_c,unstable_isNewReconciler:!1};function ts(e,l){if(e&&e.defaultProps){l=V({},l),e=e.defaultProps;for(var s in e)l[s]===void 0&&(l[s]=e[s]);return l}return l}function Ro(e,l,s,i){l=e.memoizedState,s=s(i,l),s=s==null?l:V({},l,s),e.memoizedState=s,e.lanes===0&&(e.updateQueue.baseState=s)}var na={isMounted:function(e){return(e=e._reactInternals)?Y(e)===e:!1},enqueueSetState:function(e,l,s){e=e._reactInternals;var i=kl(),n=ai(e),u=zs(i,n);u.payload=l,s!=null&&(u.callback=s),l=si(e,u,n),l!==null&&(os(l,e,n,i),Yn(l,e,n))},enqueueReplaceState:function(e,l,s){e=e._reactInternals;var i=kl(),n=ai(e),u=zs(i,n);u.tag=1,u.payload=l,s!=null&&(u.callback=s),l=si(e,u,n),l!==null&&(os(l,e,n,i),Yn(l,e,n))},enqueueForceUpdate:function(e,l){e=e._reactInternals;var s=kl(),i=ai(e),n=zs(s,i);n.tag=2,l!=null&&(n.callback=l),l=si(e,n,i),l!==null&&(os(l,e,i,s),Yn(l,e,i))}};function wc(e,l,s,i,n,u,d){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(i,u,d):l.prototype&&l.prototype.isPureReactComponent?!qt(s,i)||!qt(n,u):!0}function xc(e,l,s){var i=!1,n=Zs,u=l.contextType;return typeof u=="object"&&u!==null?u=Nl(u):(n=Ll(l)?ji:_l.current,i=l.contextTypes,u=(i=i!=null)?Xi(e,n):Zs),l=new l(s,u),e.memoizedState=l.state!==null&&l.state!==void 0?l.state:null,l.updater=na,e.stateNode=l,l._reactInternals=e,i&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=u),l}function yc(e,l,s,i){e=l.state,typeof l.componentWillReceiveProps=="function"&&l.componentWillReceiveProps(s,i),typeof l.UNSAFE_componentWillReceiveProps=="function"&&l.UNSAFE_componentWillReceiveProps(s,i),l.state!==e&&na.enqueueReplaceState(l,l.state,null)}function Oo(e,l,s,i){var n=e.stateNode;n.props=s,n.state=e.memoizedState,n.refs={},Lo(e);var u=l.contextType;typeof u=="object"&&u!==null?n.context=Nl(u):(u=Ll(l)?ji:_l.current,n.context=Xi(e,u)),n.state=e.memoizedState,u=l.getDerivedStateFromProps,typeof u=="function"&&(Ro(e,l,u,s),n.state=e.memoizedState),typeof l.getDerivedStateFromProps=="function"||typeof n.getSnapshotBeforeUpdate=="function"||typeof n.UNSAFE_componentWillMount!="function"&&typeof n.componentWillMount!="function"||(l=n.state,typeof n.componentWillMount=="function"&&n.componentWillMount(),typeof n.UNSAFE_componentWillMount=="function"&&n.UNSAFE_componentWillMount(),l!==n.state&&na.enqueueReplaceState(n,n.state,null),Xn(e,s,n,i),n.state=e.memoizedState),typeof n.componentDidMount=="function"&&(e.flags|=4194308)}function at(e,l){try{var s="",i=l;do s+=ge(i),i=i.return;while(i);var n=s}catch(u){n=`
Error generating stack: `+u.message+`
`+u.stack}return{value:e,source:l,stack:n,digest:null}}function No(e,l,s){return{value:e,source:null,stack:s??null,digest:l??null}}function Fo(e,l){try{console.error(l.value)}catch(s){setTimeout(function(){throw s})}}var Xg=typeof WeakMap=="function"?WeakMap:Map;function Ec(e,l,s){s=zs(-1,s),s.tag=3,s.payload={element:null};var i=l.value;return s.callback=function(){da||(da=!0,nu=i),Fo(e,l)},s}function kc(e,l,s){s=zs(-1,s),s.tag=3;var i=e.type.getDerivedStateFromError;if(typeof i=="function"){var n=l.value;s.payload=function(){return i(n)},s.callback=function(){Fo(e,l)}}var u=e.stateNode;return u!==null&&typeof u.componentDidCatch=="function"&&(s.callback=function(){Fo(e,l),typeof i!="function"&&(ti===null?ti=new Set([this]):ti.add(this));var d=l.stack;this.componentDidCatch(l.value,{componentStack:d!==null?d:""})}),s}function bc(e,l,s){var i=e.pingCache;if(i===null){i=e.pingCache=new Xg;var n=new Set;i.set(l,n)}else n=i.get(l),n===void 0&&(n=new Set,i.set(l,n));n.has(s)||(n.add(s),e=gf.bind(null,e,l,s),l.then(e,e))}function Cc(e){do{var l;if((l=e.tag===13)&&(l=e.memoizedState,l=l!==null?l.dehydrated!==null:!0),l)return e;e=e.return}while(e!==null);return null}function Lc(e,l,s,i,n){return(e.mode&1)===0?(e===l?e.flags|=65536:(e.flags|=128,s.flags|=131072,s.flags&=-52805,s.tag===1&&(s.alternate===null?s.tag=17:(l=zs(-1,1),l.tag=2,si(s,l,1))),s.lanes|=1),e):(e.flags|=65536,e.lanes=n,e)}var Zg=pe.ReactCurrentOwner,Il=!1;function El(e,l,s,i){l.child=e===null?Vr(l,null,s,i):st(l,e.child,s,i)}function Ic(e,l,s,i,n){s=s.render;var u=l.ref;return tt(l,n),i=qo(e,l,s,i,u,n),s=Bo(),e!==null&&!Il?(l.updateQueue=e.updateQueue,l.flags&=-2053,e.lanes&=~n,Us(e,l,n)):(Ye&&s&&jo(l),l.flags|=1,El(e,l,i,n),l.child)}function Gc(e,l,s,i,n){if(e===null){var u=s.type;return typeof u=="function"&&!du(u)&&u.defaultProps===void 0&&s.compare===null&&s.defaultProps===void 0?(l.tag=15,l.type=u,Pc(e,l,u,i,n)):(e=ja(s.type,null,i,l,l.mode,n),e.ref=l.ref,e.return=l,l.child=e)}if(u=e.child,(e.lanes&n)===0){var d=u.memoizedProps;if(s=s.compare,s=s!==null?s:qt,s(d,i)&&e.ref===l.ref)return Us(e,l,n)}return l.flags|=1,e=ui(u,i),e.ref=l.ref,e.return=l,l.child=e}function Pc(e,l,s,i,n){if(e!==null){var u=e.memoizedProps;if(qt(u,i)&&e.ref===l.ref)if(Il=!1,l.pendingProps=i=u,(e.lanes&n)!==0)(e.flags&131072)!==0&&(Il=!0);else return l.lanes=e.lanes,Us(e,l,n)}return Do(e,l,s,i,n)}function Jc(e,l,s){var i=l.pendingProps,n=i.children,u=e!==null?e.memoizedState:null;if(i.mode==="hidden")if((l.mode&1)===0)l.memoizedState={baseLanes:0,cachePool:null,transitions:null},$e(ut,Ml),Ml|=s;else{if((s&1073741824)===0)return e=u!==null?u.baseLanes|s:s,l.lanes=l.childLanes=1073741824,l.memoizedState={baseLanes:e,cachePool:null,transitions:null},l.updateQueue=null,$e(ut,Ml),Ml|=e,null;l.memoizedState={baseLanes:0,cachePool:null,transitions:null},i=u!==null?u.baseLanes:s,$e(ut,Ml),Ml|=i}else u!==null?(i=u.baseLanes|s,l.memoizedState=null):i=s,$e(ut,Ml),Ml|=i;return El(e,l,n,s),l.child}function zc(e,l){var s=l.ref;(e===null&&s!==null||e!==null&&e.ref!==s)&&(l.flags|=512,l.flags|=2097152)}function Do(e,l,s,i,n){var u=Ll(s)?ji:_l.current;return u=Xi(l,u),tt(l,n),s=qo(e,l,s,i,u,n),i=Bo(),e!==null&&!Il?(l.updateQueue=e.updateQueue,l.flags&=-2053,e.lanes&=~n,Us(e,l,n)):(Ye&&i&&jo(l),l.flags|=1,El(e,l,s,n),l.child)}function Uc(e,l,s,i,n){if(Ll(s)){var u=!0;Nn(l)}else u=!1;if(tt(l,n),l.stateNode===null)oa(e,l),xc(l,s,i),Oo(l,s,i,n),i=!0;else if(e===null){var d=l.stateNode,h=l.memoizedProps;d.props=h;var v=d.context,z=s.contextType;typeof z=="object"&&z!==null?z=Nl(z):(z=Ll(s)?ji:_l.current,z=Xi(l,z));var O=s.getDerivedStateFromProps,F=typeof O=="function"||typeof d.getSnapshotBeforeUpdate=="function";F||typeof d.UNSAFE_componentWillReceiveProps!="function"&&typeof d.componentWillReceiveProps!="function"||(h!==i||v!==z)&&yc(l,d,i,z),li=!1;var R=l.memoizedState;d.state=R,Xn(l,i,d,n),v=l.memoizedState,h!==i||R!==v||Cl.current||li?(typeof O=="function"&&(Ro(l,s,O,i),v=l.memoizedState),(h=li||wc(l,s,h,i,R,v,z))?(F||typeof d.UNSAFE_componentWillMount!="function"&&typeof d.componentWillMount!="function"||(typeof d.componentWillMount=="function"&&d.componentWillMount(),typeof d.UNSAFE_componentWillMount=="function"&&d.UNSAFE_componentWillMount()),typeof d.componentDidMount=="function"&&(l.flags|=4194308)):(typeof d.componentDidMount=="function"&&(l.flags|=4194308),l.memoizedProps=i,l.memoizedState=v),d.props=i,d.state=v,d.context=z,i=h):(typeof d.componentDidMount=="function"&&(l.flags|=4194308),i=!1)}else{d=l.stateNode,Qr(e,l),h=l.memoizedProps,z=l.type===l.elementType?h:ts(l.type,h),d.props=z,F=l.pendingProps,R=d.context,v=s.contextType,typeof v=="object"&&v!==null?v=Nl(v):(v=Ll(s)?ji:_l.current,v=Xi(l,v));var Z=s.getDerivedStateFromProps;(O=typeof Z=="function"||typeof d.getSnapshotBeforeUpdate=="function")||typeof d.UNSAFE_componentWillReceiveProps!="function"&&typeof d.componentWillReceiveProps!="function"||(h!==F||R!==v)&&yc(l,d,i,v),li=!1,R=l.memoizedState,d.state=R,Xn(l,i,d,n);var le=l.memoizedState;h!==F||R!==le||Cl.current||li?(typeof Z=="function"&&(Ro(l,s,Z,i),le=l.memoizedState),(z=li||wc(l,s,z,i,R,le,v)||!1)?(O||typeof d.UNSAFE_componentWillUpdate!="function"&&typeof d.componentWillUpdate!="function"||(typeof d.componentWillUpdate=="function"&&d.componentWillUpdate(i,le,v),typeof d.UNSAFE_componentWillUpdate=="function"&&d.UNSAFE_componentWillUpdate(i,le,v)),typeof d.componentDidUpdate=="function"&&(l.flags|=4),typeof d.getSnapshotBeforeUpdate=="function"&&(l.flags|=1024)):(typeof d.componentDidUpdate!="function"||h===e.memoizedProps&&R===e.memoizedState||(l.flags|=4),typeof d.getSnapshotBeforeUpdate!="function"||h===e.memoizedProps&&R===e.memoizedState||(l.flags|=1024),l.memoizedProps=i,l.memoizedState=le),d.props=i,d.state=le,d.context=v,i=z):(typeof d.componentDidUpdate!="function"||h===e.memoizedProps&&R===e.memoizedState||(l.flags|=4),typeof d.getSnapshotBeforeUpdate!="function"||h===e.memoizedProps&&R===e.memoizedState||(l.flags|=1024),i=!1)}return Wo(e,l,s,i,u,n)}function Wo(e,l,s,i,n,u){zc(e,l);var d=(l.flags&128)!==0;if(!i&&!d)return n&&Hr(l,s,!1),Us(e,l,u);i=l.stateNode,Zg.current=l;var h=d&&typeof s.getDerivedStateFromError!="function"?null:i.render();return l.flags|=1,e!==null&&d?(l.child=st(l,e.child,null,u),l.child=st(l,null,h,u)):El(e,l,h,u),l.memoizedState=i.state,n&&Hr(l,s,!0),l.child}function qc(e){var l=e.stateNode;l.pendingContext?Ar(e,l.pendingContext,l.pendingContext!==l.context):l.context&&Ar(e,l.context,!1),Io(e,l.containerInfo)}function Bc(e,l,s,i,n){return lt(),xo(n),l.flags|=256,El(e,l,s,i),l.child}var $o={dehydrated:null,treeContext:null,retryLane:0};function Vo(e){return{baseLanes:e,cachePool:null,transitions:null}}function Ac(e,l,s){var i=l.pendingProps,n=Xe.current,u=!1,d=(l.flags&128)!==0,h;if((h=d)||(h=e!==null&&e.memoizedState===null?!1:(n&2)!==0),h?(u=!0,l.flags&=-129):(e===null||e.memoizedState!==null)&&(n|=1),$e(Xe,n&1),e===null)return wo(l),e=l.memoizedState,e!==null&&(e=e.dehydrated,e!==null)?((l.mode&1)===0?l.lanes=1:e.data==="$!"?l.lanes=8:l.lanes=1073741824,null):(d=i.children,e=i.fallback,u?(i=l.mode,u=l.child,d={mode:"hidden",children:d},(i&1)===0&&u!==null?(u.childLanes=0,u.pendingProps=d):u=Sa(d,i,0,null),e=Li(e,i,s,null),u.return=l,e.return=l,u.sibling=e,l.child=u,l.child.memoizedState=Vo(s),l.memoizedState=$o,e):Ko(l,d));if(n=e.memoizedState,n!==null&&(h=n.dehydrated,h!==null))return ef(e,l,d,i,h,n,s);if(u){u=i.fallback,d=l.mode,n=e.child,h=n.sibling;var v={mode:"hidden",children:i.children};return(d&1)===0&&l.child!==n?(i=l.child,i.childLanes=0,i.pendingProps=v,l.deletions=null):(i=ui(n,v),i.subtreeFlags=n.subtreeFlags&14680064),h!==null?u=ui(h,u):(u=Li(u,d,s,null),u.flags|=2),u.return=l,i.return=l,i.sibling=u,l.child=i,i=u,u=l.child,d=e.child.memoizedState,d=d===null?Vo(s):{baseLanes:d.baseLanes|s,cachePool:null,transitions:d.transitions},u.memoizedState=d,u.childLanes=e.childLanes&~s,l.memoizedState=$o,i}return u=e.child,e=u.sibling,i=ui(u,{mode:"visible",children:i.children}),(l.mode&1)===0&&(i.lanes=s),i.return=l,i.sibling=null,e!==null&&(s=l.deletions,s===null?(l.deletions=[e],l.flags|=16):s.push(e)),l.child=i,l.memoizedState=null,i}function Ko(e,l){return l=Sa({mode:"visible",children:l},e.mode,0,null),l.return=e,e.child=l}function aa(e,l,s,i){return i!==null&&xo(i),st(l,e.child,null,s),e=Ko(l,l.pendingProps.children),e.flags|=2,l.memoizedState=null,e}function ef(e,l,s,i,n,u,d){if(s)return l.flags&256?(l.flags&=-257,i=No(Error(o(422))),aa(e,l,d,i)):l.memoizedState!==null?(l.child=e.child,l.flags|=128,null):(u=i.fallback,n=l.mode,i=Sa({mode:"visible",children:i.children},n,0,null),u=Li(u,n,d,null),u.flags|=2,i.return=l,u.return=l,i.sibling=u,l.child=i,(l.mode&1)!==0&&st(l,e.child,null,d),l.child.memoizedState=Vo(d),l.memoizedState=$o,u);if((l.mode&1)===0)return aa(e,l,d,null);if(n.data==="$!"){if(i=n.nextSibling&&n.nextSibling.dataset,i)var h=i.dgst;return i=h,u=Error(o(419)),i=No(u,i,void 0),aa(e,l,d,i)}if(h=(d&e.childLanes)!==0,Il||h){if(i=cl,i!==null){switch(d&-d){case 4:n=2;break;case 16:n=8;break;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:n=32;break;case 536870912:n=268435456;break;default:n=0}n=(n&(i.suspendedLanes|d))!==0?0:n,n!==0&&n!==u.retryLane&&(u.retryLane=n,Js(e,n),os(i,e,n,-1))}return pu(),i=No(Error(o(421))),aa(e,l,d,i)}return n.data==="$?"?(l.flags|=128,l.child=e.child,l=ff.bind(null,e),n._reactRetry=l,null):(e=u.treeContext,Al=Ys(n.nextSibling),Bl=l,Ye=!0,is=null,e!==null&&(Rl[Ol++]=Gs,Rl[Ol++]=Ps,Rl[Ol++]=Si,Gs=e.id,Ps=e.overflow,Si=l),l=Ko(l,i.children),l.flags|=4096,l)}function Mc(e,l,s){e.lanes|=l;var i=e.alternate;i!==null&&(i.lanes|=l),bo(e.return,l,s)}function Qo(e,l,s,i,n){var u=e.memoizedState;u===null?e.memoizedState={isBackwards:l,rendering:null,renderingStartTime:0,last:i,tail:s,tailMode:n}:(u.isBackwards=l,u.rendering=null,u.renderingStartTime=0,u.last=i,u.tail=s,u.tailMode=n)}function Hc(e,l,s){var i=l.pendingProps,n=i.revealOrder,u=i.tail;if(El(e,l,i.children,s),i=Xe.current,(i&2)!==0)i=i&1|2,l.flags|=128;else{if(e!==null&&(e.flags&128)!==0)e:for(e=l.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&Mc(e,s,l);else if(e.tag===19)Mc(e,s,l);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===l)break e;for(;e.sibling===null;){if(e.return===null||e.return===l)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}i&=1}if($e(Xe,i),(l.mode&1)===0)l.memoizedState=null;else switch(n){case"forwards":for(s=l.child,n=null;s!==null;)e=s.alternate,e!==null&&Zn(e)===null&&(n=s),s=s.sibling;s=n,s===null?(n=l.child,l.child=null):(n=s.sibling,s.sibling=null),Qo(l,!1,n,s,u);break;case"backwards":for(s=null,n=l.child,l.child=null;n!==null;){if(e=n.alternate,e!==null&&Zn(e)===null){l.child=n;break}e=n.sibling,n.sibling=s,s=n,n=e}Qo(l,!0,s,null,u);break;case"together":Qo(l,!1,null,null,void 0);break;default:l.memoizedState=null}return l.child}function oa(e,l){(l.mode&1)===0&&e!==null&&(e.alternate=null,l.alternate=null,l.flags|=2)}function Us(e,l,s){if(e!==null&&(l.dependencies=e.dependencies),Ei|=l.lanes,(s&l.childLanes)===0)return null;if(e!==null&&l.child!==e.child)throw Error(o(153));if(l.child!==null){for(e=l.child,s=ui(e,e.pendingProps),l.child=s,s.return=l;e.sibling!==null;)e=e.sibling,s=s.sibling=ui(e,e.pendingProps),s.return=l;s.sibling=null}return l.child}function lf(e,l,s){switch(l.tag){case 3:qc(l),lt();break;case 5:Zr(l);break;case 1:Ll(l.type)&&Nn(l);break;case 4:Io(l,l.stateNode.containerInfo);break;case 10:var i=l.type._context,n=l.memoizedProps.value;$e(Kn,i._currentValue),i._currentValue=n;break;case 13:if(i=l.memoizedState,i!==null)return i.dehydrated!==null?($e(Xe,Xe.current&1),l.flags|=128,null):(s&l.child.childLanes)!==0?Ac(e,l,s):($e(Xe,Xe.current&1),e=Us(e,l,s),e!==null?e.sibling:null);$e(Xe,Xe.current&1);break;case 19:if(i=(s&l.childLanes)!==0,(e.flags&128)!==0){if(i)return Hc(e,l,s);l.flags|=128}if(n=l.memoizedState,n!==null&&(n.rendering=null,n.tail=null,n.lastEffect=null),$e(Xe,Xe.current),i)break;return null;case 22:case 23:return l.lanes=0,Jc(e,l,s)}return Us(e,l,s)}var Tc,Yo,Rc,Oc;Tc=function(e,l){for(var s=l.child;s!==null;){if(s.tag===5||s.tag===6)e.appendChild(s.stateNode);else if(s.tag!==4&&s.child!==null){s.child.return=s,s=s.child;continue}if(s===l)break;for(;s.sibling===null;){if(s.return===null||s.return===l)return;s=s.return}s.sibling.return=s.return,s=s.sibling}},Yo=function(){},Rc=function(e,l,s,i){var n=e.memoizedProps;if(n!==i){e=l.stateNode,xi(ds.current);var u=null;switch(s){case"input":n=ll(e,n),i=ll(e,i),u=[];break;case"select":n=V({},n,{value:void 0}),i=V({},i,{value:void 0}),u=[];break;case"textarea":n=St(e,n),i=St(e,i),u=[];break;default:typeof n.onClick!="function"&&typeof i.onClick=="function"&&(e.onclick=Tn)}qi(s,i);var d;s=null;for(z in n)if(!i.hasOwnProperty(z)&&n.hasOwnProperty(z)&&n[z]!=null)if(z==="style"){var h=n[z];for(d in h)h.hasOwnProperty(d)&&(s||(s={}),s[d]="")}else z!=="dangerouslySetInnerHTML"&&z!=="children"&&z!=="suppressContentEditableWarning"&&z!=="suppressHydrationWarning"&&z!=="autoFocus"&&(c.hasOwnProperty(z)?u||(u=[]):(u=u||[]).push(z,null));for(z in i){var v=i[z];if(h=n!=null?n[z]:void 0,i.hasOwnProperty(z)&&v!==h&&(v!=null||h!=null))if(z==="style")if(h){for(d in h)!h.hasOwnProperty(d)||v&&v.hasOwnProperty(d)||(s||(s={}),s[d]="");for(d in v)v.hasOwnProperty(d)&&h[d]!==v[d]&&(s||(s={}),s[d]=v[d])}else s||(u||(u=[]),u.push(z,s)),s=v;else z==="dangerouslySetInnerHTML"?(v=v?v.__html:void 0,h=h?h.__html:void 0,v!=null&&h!==v&&(u=u||[]).push(z,v)):z==="children"?typeof v!="string"&&typeof v!="number"||(u=u||[]).push(z,""+v):z!=="suppressContentEditableWarning"&&z!=="suppressHydrationWarning"&&(c.hasOwnProperty(z)?(v!=null&&z==="onScroll"&&Ke("scroll",e),u||h===v||(u=[])):(u=u||[]).push(z,v))}s&&(u=u||[]).push("style",s);var z=u;(l.updateQueue=z)&&(l.flags|=4)}},Oc=function(e,l,s,i){s!==i&&(l.flags|=4)};function Qt(e,l){if(!Ye)switch(e.tailMode){case"hidden":l=e.tail;for(var s=null;l!==null;)l.alternate!==null&&(s=l),l=l.sibling;s===null?e.tail=null:s.sibling=null;break;case"collapsed":s=e.tail;for(var i=null;s!==null;)s.alternate!==null&&(i=s),s=s.sibling;i===null?l||e.tail===null?e.tail=null:e.tail.sibling=null:i.sibling=null}}function Sl(e){var l=e.alternate!==null&&e.alternate.child===e.child,s=0,i=0;if(l)for(var n=e.child;n!==null;)s|=n.lanes|n.childLanes,i|=n.subtreeFlags&14680064,i|=n.flags&14680064,n.return=e,n=n.sibling;else for(n=e.child;n!==null;)s|=n.lanes|n.childLanes,i|=n.subtreeFlags,i|=n.flags,n.return=e,n=n.sibling;return e.subtreeFlags|=i,e.childLanes=s,l}function sf(e,l,s){var i=l.pendingProps;switch(So(l),l.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return Sl(l),null;case 1:return Ll(l.type)&&On(),Sl(l),null;case 3:return i=l.stateNode,nt(),Qe(Cl),Qe(_l),Jo(),i.pendingContext&&(i.context=i.pendingContext,i.pendingContext=null),(e===null||e.child===null)&&($n(l)?l.flags|=4:e===null||e.memoizedState.isDehydrated&&(l.flags&256)===0||(l.flags|=1024,is!==null&&(uu(is),is=null))),Yo(e,l),Sl(l),null;case 5:Go(l);var n=xi(Dt.current);if(s=l.type,e!==null&&l.stateNode!=null)Rc(e,l,s,i,n),e.ref!==l.ref&&(l.flags|=512,l.flags|=2097152);else{if(!i){if(l.stateNode===null)throw Error(o(166));return Sl(l),null}if(e=xi(ds.current),$n(l)){i=l.stateNode,s=l.type;var u=l.memoizedProps;switch(i[ps]=l,i[Tt]=u,e=(l.mode&1)!==0,s){case"dialog":Ke("cancel",i),Ke("close",i);break;case"iframe":case"object":case"embed":Ke("load",i);break;case"video":case"audio":for(n=0;n<At.length;n++)Ke(At[n],i);break;case"source":Ke("error",i);break;case"img":case"image":case"link":Ke("error",i),Ke("load",i);break;case"details":Ke("toggle",i);break;case"input":ys(i,u),Ke("invalid",i);break;case"select":i._wrapperState={wasMultiple:!!u.multiple},Ke("invalid",i);break;case"textarea":vn(i,u),Ke("invalid",i)}qi(s,u),n=null;for(var d in u)if(u.hasOwnProperty(d)){var h=u[d];d==="children"?typeof h=="string"?i.textContent!==h&&(u.suppressHydrationWarning!==!0&&Hn(i.textContent,h,e),n=["children",h]):typeof h=="number"&&i.textContent!==""+h&&(u.suppressHydrationWarning!==!0&&Hn(i.textContent,h,e),n=["children",""+h]):c.hasOwnProperty(d)&&h!=null&&d==="onScroll"&&Ke("scroll",i)}switch(s){case"input":se(i),Ji(i,u,!0);break;case"textarea":se(i),rs(i);break;case"select":case"option":break;default:typeof u.onClick=="function"&&(i.onclick=Tn)}i=n,l.updateQueue=i,i!==null&&(l.flags|=4)}else{d=n.nodeType===9?n:n.ownerDocument,e==="http://www.w3.org/1999/xhtml"&&(e=Ms(s)),e==="http://www.w3.org/1999/xhtml"?s==="script"?(e=d.createElement("div"),e.innerHTML="<script><\/script>",e=e.removeChild(e.firstChild)):typeof i.is=="string"?e=d.createElement(s,{is:i.is}):(e=d.createElement(s),s==="select"&&(d=e,i.multiple?d.multiple=!0:i.size&&(d.size=i.size))):e=d.createElementNS(e,s),e[ps]=l,e[Tt]=i,Tc(e,l,!1,!1),l.stateNode=e;e:{switch(d=Bi(s,i),s){case"dialog":Ke("cancel",e),Ke("close",e),n=i;break;case"iframe":case"object":case"embed":Ke("load",e),n=i;break;case"video":case"audio":for(n=0;n<At.length;n++)Ke(At[n],e);n=i;break;case"source":Ke("error",e),n=i;break;case"img":case"image":case"link":Ke("error",e),Ke("load",e),n=i;break;case"details":Ke("toggle",e),n=i;break;case"input":ys(e,i),n=ll(e,i),Ke("invalid",e);break;case"option":n=i;break;case"select":e._wrapperState={wasMultiple:!!i.multiple},n=V({},i,{value:void 0}),Ke("invalid",e);break;case"textarea":vn(e,i),n=St(e,i),Ke("invalid",e);break;default:n=i}qi(s,n),h=n;for(u in h)if(h.hasOwnProperty(u)){var v=h[u];u==="style"?xn(e,v):u==="dangerouslySetInnerHTML"?(v=v?v.__html:void 0,v!=null&&Tl(e,v)):u==="children"?typeof v=="string"?(s!=="textarea"||v!=="")&&xl(e,v):typeof v=="number"&&xl(e,""+v):u!=="suppressContentEditableWarning"&&u!=="suppressHydrationWarning"&&u!=="autoFocus"&&(c.hasOwnProperty(u)?v!=null&&u==="onScroll"&&Ke("scroll",e):v!=null&&X(e,u,v,d))}switch(s){case"input":se(e),Ji(e,i,!1);break;case"textarea":se(e),rs(e);break;case"option":i.value!=null&&e.setAttribute("value",""+qe(i.value));break;case"select":e.multiple=!!i.multiple,u=i.value,u!=null?As(e,!!i.multiple,u,!1):i.defaultValue!=null&&As(e,!!i.multiple,i.defaultValue,!0);break;default:typeof n.onClick=="function"&&(e.onclick=Tn)}switch(s){case"button":case"input":case"select":case"textarea":i=!!i.autoFocus;break e;case"img":i=!0;break e;default:i=!1}}i&&(l.flags|=4)}l.ref!==null&&(l.flags|=512,l.flags|=2097152)}return Sl(l),null;case 6:if(e&&l.stateNode!=null)Oc(e,l,e.memoizedProps,i);else{if(typeof i!="string"&&l.stateNode===null)throw Error(o(166));if(s=xi(Dt.current),xi(ds.current),$n(l)){if(i=l.stateNode,s=l.memoizedProps,i[ps]=l,(u=i.nodeValue!==s)&&(e=Bl,e!==null))switch(e.tag){case 3:Hn(i.nodeValue,s,(e.mode&1)!==0);break;case 5:e.memoizedProps.suppressHydrationWarning!==!0&&Hn(i.nodeValue,s,(e.mode&1)!==0)}u&&(l.flags|=4)}else i=(s.nodeType===9?s:s.ownerDocument).createTextNode(i),i[ps]=l,l.stateNode=i}return Sl(l),null;case 13:if(Qe(Xe),i=l.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(Ye&&Al!==null&&(l.mode&1)!==0&&(l.flags&128)===0)Dr(),lt(),l.flags|=98560,u=!1;else if(u=$n(l),i!==null&&i.dehydrated!==null){if(e===null){if(!u)throw Error(o(318));if(u=l.memoizedState,u=u!==null?u.dehydrated:null,!u)throw Error(o(317));u[ps]=l}else lt(),(l.flags&128)===0&&(l.memoizedState=null),l.flags|=4;Sl(l),u=!1}else is!==null&&(uu(is),is=null),u=!0;if(!u)return l.flags&65536?l:null}return(l.flags&128)!==0?(l.lanes=s,l):(i=i!==null,i!==(e!==null&&e.memoizedState!==null)&&i&&(l.child.flags|=8192,(l.mode&1)!==0&&(e===null||(Xe.current&1)!==0?ul===0&&(ul=3):pu())),l.updateQueue!==null&&(l.flags|=4),Sl(l),null);case 4:return nt(),Yo(e,l),e===null&&Mt(l.stateNode.containerInfo),Sl(l),null;case 10:return ko(l.type._context),Sl(l),null;case 17:return Ll(l.type)&&On(),Sl(l),null;case 19:if(Qe(Xe),u=l.memoizedState,u===null)return Sl(l),null;if(i=(l.flags&128)!==0,d=u.rendering,d===null)if(i)Qt(u,!1);else{if(ul!==0||e!==null&&(e.flags&128)!==0)for(e=l.child;e!==null;){if(d=Zn(e),d!==null){for(l.flags|=128,Qt(u,!1),i=d.updateQueue,i!==null&&(l.updateQueue=i,l.flags|=4),l.subtreeFlags=0,i=s,s=l.child;s!==null;)u=s,e=i,u.flags&=14680066,d=u.alternate,d===null?(u.childLanes=0,u.lanes=e,u.child=null,u.subtreeFlags=0,u.memoizedProps=null,u.memoizedState=null,u.updateQueue=null,u.dependencies=null,u.stateNode=null):(u.childLanes=d.childLanes,u.lanes=d.lanes,u.child=d.child,u.subtreeFlags=0,u.deletions=null,u.memoizedProps=d.memoizedProps,u.memoizedState=d.memoizedState,u.updateQueue=d.updateQueue,u.type=d.type,e=d.dependencies,u.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),s=s.sibling;return $e(Xe,Xe.current&1|2),l.child}e=e.sibling}u.tail!==null&&Be()>rt&&(l.flags|=128,i=!0,Qt(u,!1),l.lanes=4194304)}else{if(!i)if(e=Zn(d),e!==null){if(l.flags|=128,i=!0,s=e.updateQueue,s!==null&&(l.updateQueue=s,l.flags|=4),Qt(u,!0),u.tail===null&&u.tailMode==="hidden"&&!d.alternate&&!Ye)return Sl(l),null}else 2*Be()-u.renderingStartTime>rt&&s!==1073741824&&(l.flags|=128,i=!0,Qt(u,!1),l.lanes=4194304);u.isBackwards?(d.sibling=l.child,l.child=d):(s=u.last,s!==null?s.sibling=d:l.child=d,u.last=d)}return u.tail!==null?(l=u.tail,u.rendering=l,u.tail=l.sibling,u.renderingStartTime=Be(),l.sibling=null,s=Xe.current,$e(Xe,i?s&1|2:s&1),l):(Sl(l),null);case 22:case 23:return cu(),i=l.memoizedState!==null,e!==null&&e.memoizedState!==null!==i&&(l.flags|=8192),i&&(l.mode&1)!==0?(Ml&1073741824)!==0&&(Sl(l),l.subtreeFlags&6&&(l.flags|=8192)):Sl(l),null;case 24:return null;case 25:return null}throw Error(o(156,l.tag))}function tf(e,l){switch(So(l),l.tag){case 1:return Ll(l.type)&&On(),e=l.flags,e&65536?(l.flags=e&-65537|128,l):null;case 3:return nt(),Qe(Cl),Qe(_l),Jo(),e=l.flags,(e&65536)!==0&&(e&128)===0?(l.flags=e&-65537|128,l):null;case 5:return Go(l),null;case 13:if(Qe(Xe),e=l.memoizedState,e!==null&&e.dehydrated!==null){if(l.alternate===null)throw Error(o(340));lt()}return e=l.flags,e&65536?(l.flags=e&-65537|128,l):null;case 19:return Qe(Xe),null;case 4:return nt(),null;case 10:return ko(l.type._context),null;case 22:case 23:return cu(),null;case 24:return null;default:return null}}var ua=!1,vl=!1,nf=typeof WeakSet=="function"?WeakSet:Set,ee=null;function ot(e,l){var s=e.ref;if(s!==null)if(typeof s=="function")try{s(null)}catch(i){el(e,l,i)}else s.current=null}function Xo(e,l,s){try{s()}catch(i){el(e,l,i)}}var Nc=!1;function af(e,l){if(ro=Ln,e=wr(),lo(e)){if("selectionStart"in e)var s={start:e.selectionStart,end:e.selectionEnd};else e:{s=(s=e.ownerDocument)&&s.defaultView||window;var i=s.getSelection&&s.getSelection();if(i&&i.rangeCount!==0){s=i.anchorNode;var n=i.anchorOffset,u=i.focusNode;i=i.focusOffset;try{s.nodeType,u.nodeType}catch{s=null;break e}var d=0,h=-1,v=-1,z=0,O=0,F=e,R=null;l:for(;;){for(var Z;F!==s||n!==0&&F.nodeType!==3||(h=d+n),F!==u||i!==0&&F.nodeType!==3||(v=d+i),F.nodeType===3&&(d+=F.nodeValue.length),(Z=F.firstChild)!==null;)R=F,F=Z;for(;;){if(F===e)break l;if(R===s&&++z===n&&(h=d),R===u&&++O===i&&(v=d),(Z=F.nextSibling)!==null)break;F=R,R=F.parentNode}F=Z}s=h===-1||v===-1?null:{start:h,end:v}}else s=null}s=s||{start:0,end:0}}else s=null;for(co={focusedElem:e,selectionRange:s},Ln=!1,ee=l;ee!==null;)if(l=ee,e=l.child,(l.subtreeFlags&1028)!==0&&e!==null)e.return=l,ee=e;else for(;ee!==null;){l=ee;try{var le=l.alternate;if((l.flags&1024)!==0)switch(l.tag){case 0:case 11:case 15:break;case 1:if(le!==null){var ie=le.memoizedProps,il=le.memoizedState,I=l.stateNode,x=I.getSnapshotBeforeUpdate(l.elementType===l.type?ie:ts(l.type,ie),il);I.__reactInternalSnapshotBeforeUpdate=x}break;case 3:var P=l.stateNode.containerInfo;P.nodeType===1?P.textContent="":P.nodeType===9&&P.documentElement&&P.removeChild(P.documentElement);break;case 5:case 6:case 4:case 17:break;default:throw Error(o(163))}}catch(W){el(l,l.return,W)}if(e=l.sibling,e!==null){e.return=l.return,ee=e;break}ee=l.return}return le=Nc,Nc=!1,le}function Yt(e,l,s){var i=l.updateQueue;if(i=i!==null?i.lastEffect:null,i!==null){var n=i=i.next;do{if((n.tag&e)===e){var u=n.destroy;n.destroy=void 0,u!==void 0&&Xo(l,s,u)}n=n.next}while(n!==i)}}function ra(e,l){if(l=l.updateQueue,l=l!==null?l.lastEffect:null,l!==null){var s=l=l.next;do{if((s.tag&e)===e){var i=s.create;s.destroy=i()}s=s.next}while(s!==l)}}function Zo(e){var l=e.ref;if(l!==null){var s=e.stateNode;switch(e.tag){case 5:e=s;break;default:e=s}typeof l=="function"?l(e):l.current=e}}function Fc(e){var l=e.alternate;l!==null&&(e.alternate=null,Fc(l)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(l=e.stateNode,l!==null&&(delete l[ps],delete l[Tt],delete l[mo],delete l[Rg],delete l[Og])),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}function Dc(e){return e.tag===5||e.tag===3||e.tag===4}function Wc(e){e:for(;;){for(;e.sibling===null;){if(e.return===null||Dc(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.flags&2||e.child===null||e.tag===4)continue e;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function eu(e,l,s){var i=e.tag;if(i===5||i===6)e=e.stateNode,l?s.nodeType===8?s.parentNode.insertBefore(e,l):s.insertBefore(e,l):(s.nodeType===8?(l=s.parentNode,l.insertBefore(e,s)):(l=s,l.appendChild(e)),s=s._reactRootContainer,s!=null||l.onclick!==null||(l.onclick=Tn));else if(i!==4&&(e=e.child,e!==null))for(eu(e,l,s),e=e.sibling;e!==null;)eu(e,l,s),e=e.sibling}function lu(e,l,s){var i=e.tag;if(i===5||i===6)e=e.stateNode,l?s.insertBefore(e,l):s.appendChild(e);else if(i!==4&&(e=e.child,e!==null))for(lu(e,l,s),e=e.sibling;e!==null;)lu(e,l,s),e=e.sibling}var dl=null,ns=!1;function ii(e,l,s){for(s=s.child;s!==null;)$c(e,l,s),s=s.sibling}function $c(e,l,s){if(al&&typeof al.onCommitFiberUnmount=="function")try{al.onCommitFiberUnmount(Os,s)}catch{}switch(s.tag){case 5:vl||ot(s,l);case 6:var i=dl,n=ns;dl=null,ii(e,l,s),dl=i,ns=n,dl!==null&&(ns?(e=dl,s=s.stateNode,e.nodeType===8?e.parentNode.removeChild(s):e.removeChild(s)):dl.removeChild(s.stateNode));break;case 18:dl!==null&&(ns?(e=dl,s=s.stateNode,e.nodeType===8?fo(e.parentNode,s):e.nodeType===1&&fo(e,s),It(e)):fo(dl,s.stateNode));break;case 4:i=dl,n=ns,dl=s.stateNode.containerInfo,ns=!0,ii(e,l,s),dl=i,ns=n;break;case 0:case 11:case 14:case 15:if(!vl&&(i=s.updateQueue,i!==null&&(i=i.lastEffect,i!==null))){n=i=i.next;do{var u=n,d=u.destroy;u=u.tag,d!==void 0&&((u&2)!==0||(u&4)!==0)&&Xo(s,l,d),n=n.next}while(n!==i)}ii(e,l,s);break;case 1:if(!vl&&(ot(s,l),i=s.stateNode,typeof i.componentWillUnmount=="function"))try{i.props=s.memoizedProps,i.state=s.memoizedState,i.componentWillUnmount()}catch(h){el(s,l,h)}ii(e,l,s);break;case 21:ii(e,l,s);break;case 22:s.mode&1?(vl=(i=vl)||s.memoizedState!==null,ii(e,l,s),vl=i):ii(e,l,s);break;default:ii(e,l,s)}}function Vc(e){var l=e.updateQueue;if(l!==null){e.updateQueue=null;var s=e.stateNode;s===null&&(s=e.stateNode=new nf),l.forEach(function(i){var n=mf.bind(null,e,i);s.has(i)||(s.add(i),i.then(n,n))})}}function as(e,l){var s=l.deletions;if(s!==null)for(var i=0;i<s.length;i++){var n=s[i];try{var u=e,d=l,h=d;e:for(;h!==null;){switch(h.tag){case 5:dl=h.stateNode,ns=!1;break e;case 3:dl=h.stateNode.containerInfo,ns=!0;break e;case 4:dl=h.stateNode.containerInfo,ns=!0;break e}h=h.return}if(dl===null)throw Error(o(160));$c(u,d,n),dl=null,ns=!1;var v=n.alternate;v!==null&&(v.return=null),n.return=null}catch(z){el(n,l,z)}}if(l.subtreeFlags&12854)for(l=l.child;l!==null;)Kc(l,e),l=l.sibling}function Kc(e,l){var s=e.alternate,i=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:if(as(l,e),fs(e),i&4){try{Yt(3,e,e.return),ra(3,e)}catch(ie){el(e,e.return,ie)}try{Yt(5,e,e.return)}catch(ie){el(e,e.return,ie)}}break;case 1:as(l,e),fs(e),i&512&&s!==null&&ot(s,s.return);break;case 5:if(as(l,e),fs(e),i&512&&s!==null&&ot(s,s.return),e.flags&32){var n=e.stateNode;try{xl(n,"")}catch(ie){el(e,e.return,ie)}}if(i&4&&(n=e.stateNode,n!=null)){var u=e.memoizedProps,d=s!==null?s.memoizedProps:u,h=e.type,v=e.updateQueue;if(e.updateQueue=null,v!==null)try{h==="input"&&u.type==="radio"&&u.name!=null&&Es(n,u),Bi(h,d);var z=Bi(h,u);for(d=0;d<v.length;d+=2){var O=v[d],F=v[d+1];O==="style"?xn(n,F):O==="dangerouslySetInnerHTML"?Tl(n,F):O==="children"?xl(n,F):X(n,O,F,z)}switch(h){case"input":zl(n,u);break;case"textarea":wn(n,u);break;case"select":var R=n._wrapperState.wasMultiple;n._wrapperState.wasMultiple=!!u.multiple;var Z=u.value;Z!=null?As(n,!!u.multiple,Z,!1):R!==!!u.multiple&&(u.defaultValue!=null?As(n,!!u.multiple,u.defaultValue,!0):As(n,!!u.multiple,u.multiple?[]:"",!1))}n[Tt]=u}catch(ie){el(e,e.return,ie)}}break;case 6:if(as(l,e),fs(e),i&4){if(e.stateNode===null)throw Error(o(162));n=e.stateNode,u=e.memoizedProps;try{n.nodeValue=u}catch(ie){el(e,e.return,ie)}}break;case 3:if(as(l,e),fs(e),i&4&&s!==null&&s.memoizedState.isDehydrated)try{It(l.containerInfo)}catch(ie){el(e,e.return,ie)}break;case 4:as(l,e),fs(e);break;case 13:as(l,e),fs(e),n=e.child,n.flags&8192&&(u=n.memoizedState!==null,n.stateNode.isHidden=u,!u||n.alternate!==null&&n.alternate.memoizedState!==null||(tu=Be())),i&4&&Vc(e);break;case 22:if(O=s!==null&&s.memoizedState!==null,e.mode&1?(vl=(z=vl)||O,as(l,e),vl=z):as(l,e),fs(e),i&8192){if(z=e.memoizedState!==null,(e.stateNode.isHidden=z)&&!O&&(e.mode&1)!==0)for(ee=e,O=e.child;O!==null;){for(F=ee=O;ee!==null;){switch(R=ee,Z=R.child,R.tag){case 0:case 11:case 14:case 15:Yt(4,R,R.return);break;case 1:ot(R,R.return);var le=R.stateNode;if(typeof le.componentWillUnmount=="function"){i=R,s=R.return;try{l=i,le.props=l.memoizedProps,le.state=l.memoizedState,le.componentWillUnmount()}catch(ie){el(i,s,ie)}}break;case 5:ot(R,R.return);break;case 22:if(R.memoizedState!==null){Xc(F);continue}}Z!==null?(Z.return=R,ee=Z):Xc(F)}O=O.sibling}e:for(O=null,F=e;;){if(F.tag===5){if(O===null){O=F;try{n=F.stateNode,z?(u=n.style,typeof u.setProperty=="function"?u.setProperty("display","none","important"):u.display="none"):(h=F.stateNode,v=F.memoizedProps.style,d=v!=null&&v.hasOwnProperty("display")?v.display:null,h.style.display=Ui("display",d))}catch(ie){el(e,e.return,ie)}}}else if(F.tag===6){if(O===null)try{F.stateNode.nodeValue=z?"":F.memoizedProps}catch(ie){el(e,e.return,ie)}}else if((F.tag!==22&&F.tag!==23||F.memoizedState===null||F===e)&&F.child!==null){F.child.return=F,F=F.child;continue}if(F===e)break e;for(;F.sibling===null;){if(F.return===null||F.return===e)break e;O===F&&(O=null),F=F.return}O===F&&(O=null),F.sibling.return=F.return,F=F.sibling}}break;case 19:as(l,e),fs(e),i&4&&Vc(e);break;case 21:break;default:as(l,e),fs(e)}}function fs(e){var l=e.flags;if(l&2){try{e:{for(var s=e.return;s!==null;){if(Dc(s)){var i=s;break e}s=s.return}throw Error(o(160))}switch(i.tag){case 5:var n=i.stateNode;i.flags&32&&(xl(n,""),i.flags&=-33);var u=Wc(e);lu(e,u,n);break;case 3:case 4:var d=i.stateNode.containerInfo,h=Wc(e);eu(e,h,d);break;default:throw Error(o(161))}}catch(v){el(e,e.return,v)}e.flags&=-3}l&4096&&(e.flags&=-4097)}function of(e,l,s){ee=e,Qc(e)}function Qc(e,l,s){for(var i=(e.mode&1)!==0;ee!==null;){var n=ee,u=n.child;if(n.tag===22&&i){var d=n.memoizedState!==null||ua;if(!d){var h=n.alternate,v=h!==null&&h.memoizedState!==null||vl;h=ua;var z=vl;if(ua=d,(vl=v)&&!z)for(ee=n;ee!==null;)d=ee,v=d.child,d.tag===22&&d.memoizedState!==null?Zc(n):v!==null?(v.return=d,ee=v):Zc(n);for(;u!==null;)ee=u,Qc(u),u=u.sibling;ee=n,ua=h,vl=z}Yc(e)}else(n.subtreeFlags&8772)!==0&&u!==null?(u.return=n,ee=u):Yc(e)}}function Yc(e){for(;ee!==null;){var l=ee;if((l.flags&8772)!==0){var s=l.alternate;try{if((l.flags&8772)!==0)switch(l.tag){case 0:case 11:case 15:vl||ra(5,l);break;case 1:var i=l.stateNode;if(l.flags&4&&!vl)if(s===null)i.componentDidMount();else{var n=l.elementType===l.type?s.memoizedProps:ts(l.type,s.memoizedProps);i.componentDidUpdate(n,s.memoizedState,i.__reactInternalSnapshotBeforeUpdate)}var u=l.updateQueue;u!==null&&Xr(l,u,i);break;case 3:var d=l.updateQueue;if(d!==null){if(s=null,l.child!==null)switch(l.child.tag){case 5:s=l.child.stateNode;break;case 1:s=l.child.stateNode}Xr(l,d,s)}break;case 5:var h=l.stateNode;if(s===null&&l.flags&4){s=h;var v=l.memoizedProps;switch(l.type){case"button":case"input":case"select":case"textarea":v.autoFocus&&s.focus();break;case"img":v.src&&(s.src=v.src)}}break;case 6:break;case 4:break;case 12:break;case 13:if(l.memoizedState===null){var z=l.alternate;if(z!==null){var O=z.memoizedState;if(O!==null){var F=O.dehydrated;F!==null&&It(F)}}}break;case 19:case 17:case 21:case 22:case 23:case 25:break;default:throw Error(o(163))}vl||l.flags&512&&Zo(l)}catch(R){el(l,l.return,R)}}if(l===e){ee=null;break}if(s=l.sibling,s!==null){s.return=l.return,ee=s;break}ee=l.return}}function Xc(e){for(;ee!==null;){var l=ee;if(l===e){ee=null;break}var s=l.sibling;if(s!==null){s.return=l.return,ee=s;break}ee=l.return}}function Zc(e){for(;ee!==null;){var l=ee;try{switch(l.tag){case 0:case 11:case 15:var s=l.return;try{ra(4,l)}catch(v){el(l,s,v)}break;case 1:var i=l.stateNode;if(typeof i.componentDidMount=="function"){var n=l.return;try{i.componentDidMount()}catch(v){el(l,n,v)}}var u=l.return;try{Zo(l)}catch(v){el(l,u,v)}break;case 5:var d=l.return;try{Zo(l)}catch(v){el(l,d,v)}}}catch(v){el(l,l.return,v)}if(l===e){ee=null;break}var h=l.sibling;if(h!==null){h.return=l.return,ee=h;break}ee=l.return}}var uf=Math.ceil,ca=pe.ReactCurrentDispatcher,su=pe.ReactCurrentOwner,Dl=pe.ReactCurrentBatchConfig,He=0,cl=null,tl=null,gl=0,Ml=0,ut=Xs(0),ul=0,Xt=null,Ei=0,pa=0,iu=0,Zt=null,Gl=null,tu=0,rt=1/0,qs=null,da=!1,nu=null,ti=null,ga=!1,ni=null,fa=0,en=0,au=null,ma=-1,ha=0;function kl(){return(He&6)!==0?Be():ma!==-1?ma:ma=Be()}function ai(e){return(e.mode&1)===0?1:(He&2)!==0&&gl!==0?gl&-gl:Fg.transition!==null?(ha===0&&(ha=kn()),ha):(e=De,e!==0||(e=window.event,e=e===void 0?16:lr(e.type)),e)}function os(e,l,s,i){if(50<en)throw en=0,au=null,Error(o(185));Et(e,s,i),((He&2)===0||e!==cl)&&(e===cl&&((He&2)===0&&(pa|=s),ul===4&&oi(e,gl)),Pl(e,i),s===1&&He===0&&(l.mode&1)===0&&(rt=Be()+500,Fn&&ei()))}function Pl(e,l){var s=e.callbackNode;Cs(e,l);var i=Fs(e,e===cl?gl:0);if(i===0)s!==null&&sl(s),e.callbackNode=null,e.callbackPriority=0;else if(l=i&-i,e.callbackPriority!==l){if(s!=null&&sl(s),l===1)e.tag===0?Ng(lp.bind(null,e)):Tr(lp.bind(null,e)),Hg(function(){(He&6)===0&&ei()}),s=null;else{switch($u(i)){case 1:s=bs;break;case 4:s=es;break;case 16:s=ls;break;case 536870912:s=Ul;break;default:s=ls}s=rp(s,ep.bind(null,e))}e.callbackPriority=l,e.callbackNode=s}}function ep(e,l){if(ma=-1,ha=0,(He&6)!==0)throw Error(o(327));var s=e.callbackNode;if(ct()&&e.callbackNode!==s)return null;var i=Fs(e,e===cl?gl:0);if(i===0)return null;if((i&30)!==0||(i&e.expiredLanes)!==0||l)l=_a(e,i);else{l=i;var n=He;He|=2;var u=ip();(cl!==e||gl!==l)&&(qs=null,rt=Be()+500,bi(e,l));do try{pf();break}catch(h){sp(e,h)}while(!0);Eo(),ca.current=u,He=n,tl!==null?l=0:(cl=null,gl=0,l=ul)}if(l!==0){if(l===2&&(n=Oi(e),n!==0&&(i=n,l=ou(e,n))),l===1)throw s=Xt,bi(e,0),oi(e,i),Pl(e,Be()),s;if(l===6)oi(e,i);else{if(n=e.current.alternate,(i&30)===0&&!rf(n)&&(l=_a(e,i),l===2&&(u=Oi(e),u!==0&&(i=u,l=ou(e,u))),l===1))throw s=Xt,bi(e,0),oi(e,i),Pl(e,Be()),s;switch(e.finishedWork=n,e.finishedLanes=i,l){case 0:case 1:throw Error(o(345));case 2:Ci(e,Gl,qs);break;case 3:if(oi(e,i),(i&130023424)===i&&(l=tu+500-Be(),10<l)){if(Fs(e,0)!==0)break;if(n=e.suspendedLanes,(n&i)!==i){kl(),e.pingedLanes|=e.suspendedLanes&n;break}e.timeoutHandle=go(Ci.bind(null,e,Gl,qs),l);break}Ci(e,Gl,qs);break;case 4:if(oi(e,i),(i&4194240)===i)break;for(l=e.eventTimes,n=-1;0<i;){var d=31-ml(i);u=1<<d,d=l[d],d>n&&(n=d),i&=~u}if(i=n,i=Be()-i,i=(120>i?120:480>i?480:1080>i?1080:1920>i?1920:3e3>i?3e3:4320>i?4320:1960*uf(i/1960))-i,10<i){e.timeoutHandle=go(Ci.bind(null,e,Gl,qs),i);break}Ci(e,Gl,qs);break;case 5:Ci(e,Gl,qs);break;default:throw Error(o(329))}}}return Pl(e,Be()),e.callbackNode===s?ep.bind(null,e):null}function ou(e,l){var s=Zt;return e.current.memoizedState.isDehydrated&&(bi(e,l).flags|=256),e=_a(e,l),e!==2&&(l=Gl,Gl=s,l!==null&&uu(l)),e}function uu(e){Gl===null?Gl=e:Gl.push.apply(Gl,e)}function rf(e){for(var l=e;;){if(l.flags&16384){var s=l.updateQueue;if(s!==null&&(s=s.stores,s!==null))for(var i=0;i<s.length;i++){var n=s[i],u=n.getSnapshot;n=n.value;try{if(!ss(u(),n))return!1}catch{return!1}}}if(s=l.child,l.subtreeFlags&16384&&s!==null)s.return=l,l=s;else{if(l===e)break;for(;l.sibling===null;){if(l.return===null||l.return===e)return!0;l=l.return}l.sibling.return=l.return,l=l.sibling}}return!0}function oi(e,l){for(l&=~iu,l&=~pa,e.suspendedLanes|=l,e.pingedLanes&=~l,e=e.expirationTimes;0<l;){var s=31-ml(l),i=1<<s;e[s]=-1,l&=~i}}function lp(e){if((He&6)!==0)throw Error(o(327));ct();var l=Fs(e,0);if((l&1)===0)return Pl(e,Be()),null;var s=_a(e,l);if(e.tag!==0&&s===2){var i=Oi(e);i!==0&&(l=i,s=ou(e,i))}if(s===1)throw s=Xt,bi(e,0),oi(e,l),Pl(e,Be()),s;if(s===6)throw Error(o(345));return e.finishedWork=e.current.alternate,e.finishedLanes=l,Ci(e,Gl,qs),Pl(e,Be()),null}function ru(e,l){var s=He;He|=1;try{return e(l)}finally{He=s,He===0&&(rt=Be()+500,Fn&&ei())}}function ki(e){ni!==null&&ni.tag===0&&(He&6)===0&&ct();var l=He;He|=1;var s=Dl.transition,i=De;try{if(Dl.transition=null,De=1,e)return e()}finally{De=i,Dl.transition=s,He=l,(He&6)===0&&ei()}}function cu(){Ml=ut.current,Qe(ut)}function bi(e,l){e.finishedWork=null,e.finishedLanes=0;var s=e.timeoutHandle;if(s!==-1&&(e.timeoutHandle=-1,Mg(s)),tl!==null)for(s=tl.return;s!==null;){var i=s;switch(So(i),i.tag){case 1:i=i.type.childContextTypes,i!=null&&On();break;case 3:nt(),Qe(Cl),Qe(_l),Jo();break;case 5:Go(i);break;case 4:nt();break;case 13:Qe(Xe);break;case 19:Qe(Xe);break;case 10:ko(i.type._context);break;case 22:case 23:cu()}s=s.return}if(cl=e,tl=e=ui(e.current,null),gl=Ml=l,ul=0,Xt=null,iu=pa=Ei=0,Gl=Zt=null,wi!==null){for(l=0;l<wi.length;l++)if(s=wi[l],i=s.interleaved,i!==null){s.interleaved=null;var n=i.next,u=s.pending;if(u!==null){var d=u.next;u.next=n,i.next=d}s.pending=i}wi=null}return e}function sp(e,l){do{var s=tl;try{if(Eo(),ea.current=ta,la){for(var i=Ze.memoizedState;i!==null;){var n=i.queue;n!==null&&(n.pending=null),i=i.next}la=!1}if(yi=0,rl=ol=Ze=null,Wt=!1,$t=0,su.current=null,s===null||s.return===null){ul=1,Xt=l,tl=null;break}e:{var u=e,d=s.return,h=s,v=l;if(l=gl,h.flags|=32768,v!==null&&typeof v=="object"&&typeof v.then=="function"){var z=v,O=h,F=O.tag;if((O.mode&1)===0&&(F===0||F===11||F===15)){var R=O.alternate;R?(O.updateQueue=R.updateQueue,O.memoizedState=R.memoizedState,O.lanes=R.lanes):(O.updateQueue=null,O.memoizedState=null)}var Z=Cc(d);if(Z!==null){Z.flags&=-257,Lc(Z,d,h,u,l),Z.mode&1&&bc(u,z,l),l=Z,v=z;var le=l.updateQueue;if(le===null){var ie=new Set;ie.add(v),l.updateQueue=ie}else le.add(v);break e}else{if((l&1)===0){bc(u,z,l),pu();break e}v=Error(o(426))}}else if(Ye&&h.mode&1){var il=Cc(d);if(il!==null){(il.flags&65536)===0&&(il.flags|=256),Lc(il,d,h,u,l),xo(at(v,h));break e}}u=v=at(v,h),ul!==4&&(ul=2),Zt===null?Zt=[u]:Zt.push(u),u=d;do{switch(u.tag){case 3:u.flags|=65536,l&=-l,u.lanes|=l;var I=Ec(u,v,l);Yr(u,I);break e;case 1:h=v;var x=u.type,P=u.stateNode;if((u.flags&128)===0&&(typeof x.getDerivedStateFromError=="function"||P!==null&&typeof P.componentDidCatch=="function"&&(ti===null||!ti.has(P)))){u.flags|=65536,l&=-l,u.lanes|=l;var W=kc(u,h,l);Yr(u,W);break e}}u=u.return}while(u!==null)}np(s)}catch(te){l=te,tl===s&&s!==null&&(tl=s=s.return);continue}break}while(!0)}function ip(){var e=ca.current;return ca.current=ta,e===null?ta:e}function pu(){(ul===0||ul===3||ul===2)&&(ul=4),cl===null||(Ei&268435455)===0&&(pa&268435455)===0||oi(cl,gl)}function _a(e,l){var s=He;He|=2;var i=ip();(cl!==e||gl!==l)&&(qs=null,bi(e,l));do try{cf();break}catch(n){sp(e,n)}while(!0);if(Eo(),He=s,ca.current=i,tl!==null)throw Error(o(261));return cl=null,gl=0,ul}function cf(){for(;tl!==null;)tp(tl)}function pf(){for(;tl!==null&&!Ve();)tp(tl)}function tp(e){var l=up(e.alternate,e,Ml);e.memoizedProps=e.pendingProps,l===null?np(e):tl=l,su.current=null}function np(e){var l=e;do{var s=l.alternate;if(e=l.return,(l.flags&32768)===0){if(s=sf(s,l,Ml),s!==null){tl=s;return}}else{if(s=tf(s,l),s!==null){s.flags&=32767,tl=s;return}if(e!==null)e.flags|=32768,e.subtreeFlags=0,e.deletions=null;else{ul=6,tl=null;return}}if(l=l.sibling,l!==null){tl=l;return}tl=l=e}while(l!==null);ul===0&&(ul=5)}function Ci(e,l,s){var i=De,n=Dl.transition;try{Dl.transition=null,De=1,df(e,l,s,i)}finally{Dl.transition=n,De=i}return null}function df(e,l,s,i){do ct();while(ni!==null);if((He&6)!==0)throw Error(o(327));s=e.finishedWork;var n=e.finishedLanes;if(s===null)return null;if(e.finishedWork=null,e.finishedLanes=0,s===e.current)throw Error(o(177));e.callbackNode=null,e.callbackPriority=0;var u=s.lanes|s.childLanes;if(Dd(e,u),e===cl&&(tl=cl=null,gl=0),(s.subtreeFlags&2064)===0&&(s.flags&2064)===0||ga||(ga=!0,rp(ls,function(){return ct(),null})),u=(s.flags&15990)!==0,(s.subtreeFlags&15990)!==0||u){u=Dl.transition,Dl.transition=null;var d=De;De=1;var h=He;He|=4,su.current=null,af(e,s),Kc(s,e),Pg(co),Ln=!!ro,co=ro=null,e.current=s,of(s),Fe(),He=h,De=d,Dl.transition=u}else e.current=s;if(ga&&(ga=!1,ni=e,fa=n),u=e.pendingLanes,u===0&&(ti=null),Ti(s.stateNode),Pl(e,Be()),l!==null)for(i=e.onRecoverableError,s=0;s<l.length;s++)n=l[s],i(n.value,{componentStack:n.stack,digest:n.digest});if(da)throw da=!1,e=nu,nu=null,e;return(fa&1)!==0&&e.tag!==0&&ct(),u=e.pendingLanes,(u&1)!==0?e===au?en++:(en=0,au=e):en=0,ei(),null}function ct(){if(ni!==null){var e=$u(fa),l=Dl.transition,s=De;try{if(Dl.transition=null,De=16>e?16:e,ni===null)var i=!1;else{if(e=ni,ni=null,fa=0,(He&6)!==0)throw Error(o(331));var n=He;for(He|=4,ee=e.current;ee!==null;){var u=ee,d=u.child;if((ee.flags&16)!==0){var h=u.deletions;if(h!==null){for(var v=0;v<h.length;v++){var z=h[v];for(ee=z;ee!==null;){var O=ee;switch(O.tag){case 0:case 11:case 15:Yt(8,O,u)}var F=O.child;if(F!==null)F.return=O,ee=F;else for(;ee!==null;){O=ee;var R=O.sibling,Z=O.return;if(Fc(O),O===z){ee=null;break}if(R!==null){R.return=Z,ee=R;break}ee=Z}}}var le=u.alternate;if(le!==null){var ie=le.child;if(ie!==null){le.child=null;do{var il=ie.sibling;ie.sibling=null,ie=il}while(ie!==null)}}ee=u}}if((u.subtreeFlags&2064)!==0&&d!==null)d.return=u,ee=d;else e:for(;ee!==null;){if(u=ee,(u.flags&2048)!==0)switch(u.tag){case 0:case 11:case 15:Yt(9,u,u.return)}var I=u.sibling;if(I!==null){I.return=u.return,ee=I;break e}ee=u.return}}var x=e.current;for(ee=x;ee!==null;){d=ee;var P=d.child;if((d.subtreeFlags&2064)!==0&&P!==null)P.return=d,ee=P;else e:for(d=x;ee!==null;){if(h=ee,(h.flags&2048)!==0)try{switch(h.tag){case 0:case 11:case 15:ra(9,h)}}catch(te){el(h,h.return,te)}if(h===d){ee=null;break e}var W=h.sibling;if(W!==null){W.return=h.return,ee=W;break e}ee=h.return}}if(He=n,ei(),al&&typeof al.onPostCommitFiberRoot=="function")try{al.onPostCommitFiberRoot(Os,e)}catch{}i=!0}return i}finally{De=s,Dl.transition=l}}return!1}function ap(e,l,s){l=at(s,l),l=Ec(e,l,1),e=si(e,l,1),l=kl(),e!==null&&(Et(e,1,l),Pl(e,l))}function el(e,l,s){if(e.tag===3)ap(e,e,s);else for(;l!==null;){if(l.tag===3){ap(l,e,s);break}else if(l.tag===1){var i=l.stateNode;if(typeof l.type.getDerivedStateFromError=="function"||typeof i.componentDidCatch=="function"&&(ti===null||!ti.has(i))){e=at(s,e),e=kc(l,e,1),l=si(l,e,1),e=kl(),l!==null&&(Et(l,1,e),Pl(l,e));break}}l=l.return}}function gf(e,l,s){var i=e.pingCache;i!==null&&i.delete(l),l=kl(),e.pingedLanes|=e.suspendedLanes&s,cl===e&&(gl&s)===s&&(ul===4||ul===3&&(gl&130023424)===gl&&500>Be()-tu?bi(e,0):iu|=s),Pl(e,l)}function op(e,l){l===0&&((e.mode&1)===0?l=1:(l=bl,bl<<=1,(bl&130023424)===0&&(bl=4194304)));var s=kl();e=Js(e,l),e!==null&&(Et(e,l,s),Pl(e,s))}function ff(e){var l=e.memoizedState,s=0;l!==null&&(s=l.retryLane),op(e,s)}function mf(e,l){var s=0;switch(e.tag){case 13:var i=e.stateNode,n=e.memoizedState;n!==null&&(s=n.retryLane);break;case 19:i=e.stateNode;break;default:throw Error(o(314))}i!==null&&i.delete(l),op(e,s)}var up;up=function(e,l,s){if(e!==null)if(e.memoizedProps!==l.pendingProps||Cl.current)Il=!0;else{if((e.lanes&s)===0&&(l.flags&128)===0)return Il=!1,lf(e,l,s);Il=(e.flags&131072)!==0}else Il=!1,Ye&&(l.flags&1048576)!==0&&Rr(l,Wn,l.index);switch(l.lanes=0,l.tag){case 2:var i=l.type;oa(e,l),e=l.pendingProps;var n=Xi(l,_l.current);tt(l,s),n=qo(null,l,i,e,n,s);var u=Bo();return l.flags|=1,typeof n=="object"&&n!==null&&typeof n.render=="function"&&n.$$typeof===void 0?(l.tag=1,l.memoizedState=null,l.updateQueue=null,Ll(i)?(u=!0,Nn(l)):u=!1,l.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,Lo(l),n.updater=na,l.stateNode=n,n._reactInternals=l,Oo(l,i,e,s),l=Wo(null,l,i,!0,u,s)):(l.tag=0,Ye&&u&&jo(l),El(null,l,n,s),l=l.child),l;case 16:i=l.elementType;e:{switch(oa(e,l),e=l.pendingProps,n=i._init,i=n(i._payload),l.type=i,n=l.tag=_f(i),e=ts(i,e),n){case 0:l=Do(null,l,i,e,s);break e;case 1:l=Uc(null,l,i,e,s);break e;case 11:l=Ic(null,l,i,e,s);break e;case 14:l=Gc(null,l,i,ts(i.type,e),s);break e}throw Error(o(306,i,""))}return l;case 0:return i=l.type,n=l.pendingProps,n=l.elementType===i?n:ts(i,n),Do(e,l,i,n,s);case 1:return i=l.type,n=l.pendingProps,n=l.elementType===i?n:ts(i,n),Uc(e,l,i,n,s);case 3:e:{if(qc(l),e===null)throw Error(o(387));i=l.pendingProps,u=l.memoizedState,n=u.element,Qr(e,l),Xn(l,i,null,s);var d=l.memoizedState;if(i=d.element,u.isDehydrated)if(u={element:i,isDehydrated:!1,cache:d.cache,pendingSuspenseBoundaries:d.pendingSuspenseBoundaries,transitions:d.transitions},l.updateQueue.baseState=u,l.memoizedState=u,l.flags&256){n=at(Error(o(423)),l),l=Bc(e,l,i,s,n);break e}else if(i!==n){n=at(Error(o(424)),l),l=Bc(e,l,i,s,n);break e}else for(Al=Ys(l.stateNode.containerInfo.firstChild),Bl=l,Ye=!0,is=null,s=Vr(l,null,i,s),l.child=s;s;)s.flags=s.flags&-3|4096,s=s.sibling;else{if(lt(),i===n){l=Us(e,l,s);break e}El(e,l,i,s)}l=l.child}return l;case 5:return Zr(l),e===null&&wo(l),i=l.type,n=l.pendingProps,u=e!==null?e.memoizedProps:null,d=n.children,po(i,n)?d=null:u!==null&&po(i,u)&&(l.flags|=32),zc(e,l),El(e,l,d,s),l.child;case 6:return e===null&&wo(l),null;case 13:return Ac(e,l,s);case 4:return Io(l,l.stateNode.containerInfo),i=l.pendingProps,e===null?l.child=st(l,null,i,s):El(e,l,i,s),l.child;case 11:return i=l.type,n=l.pendingProps,n=l.elementType===i?n:ts(i,n),Ic(e,l,i,n,s);case 7:return El(e,l,l.pendingProps,s),l.child;case 8:return El(e,l,l.pendingProps.children,s),l.child;case 12:return El(e,l,l.pendingProps.children,s),l.child;case 10:e:{if(i=l.type._context,n=l.pendingProps,u=l.memoizedProps,d=n.value,$e(Kn,i._currentValue),i._currentValue=d,u!==null)if(ss(u.value,d)){if(u.children===n.children&&!Cl.current){l=Us(e,l,s);break e}}else for(u=l.child,u!==null&&(u.return=l);u!==null;){var h=u.dependencies;if(h!==null){d=u.child;for(var v=h.firstContext;v!==null;){if(v.context===i){if(u.tag===1){v=zs(-1,s&-s),v.tag=2;var z=u.updateQueue;if(z!==null){z=z.shared;var O=z.pending;O===null?v.next=v:(v.next=O.next,O.next=v),z.pending=v}}u.lanes|=s,v=u.alternate,v!==null&&(v.lanes|=s),bo(u.return,s,l),h.lanes|=s;break}v=v.next}}else if(u.tag===10)d=u.type===l.type?null:u.child;else if(u.tag===18){if(d=u.return,d===null)throw Error(o(341));d.lanes|=s,h=d.alternate,h!==null&&(h.lanes|=s),bo(d,s,l),d=u.sibling}else d=u.child;if(d!==null)d.return=u;else for(d=u;d!==null;){if(d===l){d=null;break}if(u=d.sibling,u!==null){u.return=d.return,d=u;break}d=d.return}u=d}El(e,l,n.children,s),l=l.child}return l;case 9:return n=l.type,i=l.pendingProps.children,tt(l,s),n=Nl(n),i=i(n),l.flags|=1,El(e,l,i,s),l.child;case 14:return i=l.type,n=ts(i,l.pendingProps),n=ts(i.type,n),Gc(e,l,i,n,s);case 15:return Pc(e,l,l.type,l.pendingProps,s);case 17:return i=l.type,n=l.pendingProps,n=l.elementType===i?n:ts(i,n),oa(e,l),l.tag=1,Ll(i)?(e=!0,Nn(l)):e=!1,tt(l,s),xc(l,i,n),Oo(l,i,n,s),Wo(null,l,i,!0,e,s);case 19:return Hc(e,l,s);case 22:return Jc(e,l,s)}throw Error(o(156,l.tag))};function rp(e,l){return Re(e,l)}function hf(e,l,s,i){this.tag=e,this.key=s,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=l,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=i,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function Wl(e,l,s,i){return new hf(e,l,s,i)}function du(e){return e=e.prototype,!(!e||!e.isReactComponent)}function _f(e){if(typeof e=="function")return du(e)?1:0;if(e!=null){if(e=e.$$typeof,e===we)return 11;if(e===Me)return 14}return 2}function ui(e,l){var s=e.alternate;return s===null?(s=Wl(e.tag,l,e.key,e.mode),s.elementType=e.elementType,s.type=e.type,s.stateNode=e.stateNode,s.alternate=e,e.alternate=s):(s.pendingProps=l,s.type=e.type,s.flags=0,s.subtreeFlags=0,s.deletions=null),s.flags=e.flags&14680064,s.childLanes=e.childLanes,s.lanes=e.lanes,s.child=e.child,s.memoizedProps=e.memoizedProps,s.memoizedState=e.memoizedState,s.updateQueue=e.updateQueue,l=e.dependencies,s.dependencies=l===null?null:{lanes:l.lanes,firstContext:l.firstContext},s.sibling=e.sibling,s.index=e.index,s.ref=e.ref,s}function ja(e,l,s,i,n,u){var d=2;if(i=e,typeof e=="function")du(e)&&(d=1);else if(typeof e=="string")d=5;else e:switch(e){case Le:return Li(s.children,n,u,l);case L:d=8,n|=8;break;case ke:return e=Wl(12,s,l,n|2),e.elementType=ke,e.lanes=u,e;case Pe:return e=Wl(13,s,l,n),e.elementType=Pe,e.lanes=u,e;case Je:return e=Wl(19,s,l,n),e.elementType=Je,e.lanes=u,e;case de:return Sa(s,n,u,l);default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case fe:d=10;break e;case Ne:d=9;break e;case we:d=11;break e;case Me:d=14;break e;case Oe:d=16,i=null;break e}throw Error(o(130,e==null?e:typeof e,""))}return l=Wl(d,s,l,n),l.elementType=e,l.type=i,l.lanes=u,l}function Li(e,l,s,i){return e=Wl(7,e,i,l),e.lanes=s,e}function Sa(e,l,s,i){return e=Wl(22,e,i,l),e.elementType=de,e.lanes=s,e.stateNode={isHidden:!1},e}function gu(e,l,s){return e=Wl(6,e,null,l),e.lanes=s,e}function fu(e,l,s){return l=Wl(4,e.children!==null?e.children:[],e.key,l),l.lanes=s,l.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},l}function jf(e,l,s,i,n){this.tag=l,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.pendingContext=this.context=null,this.callbackPriority=0,this.eventTimes=Ta(0),this.expirationTimes=Ta(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Ta(0),this.identifierPrefix=i,this.onRecoverableError=n,this.mutableSourceEagerHydrationData=null}function mu(e,l,s,i,n,u,d,h,v){return e=new jf(e,l,s,h,v),l===1?(l=1,u===!0&&(l|=8)):l=0,u=Wl(3,null,null,l),e.current=u,u.stateNode=e,u.memoizedState={element:i,isDehydrated:s,cache:null,transitions:null,pendingSuspenseBoundaries:null},Lo(u),e}function Sf(e,l,s){var i=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:ve,key:i==null?null:""+i,children:e,containerInfo:l,implementation:s}}function cp(e){if(!e)return Zs;e=e._reactInternals;e:{if(Y(e)!==e||e.tag!==1)throw Error(o(170));var l=e;do{switch(l.tag){case 3:l=l.stateNode.context;break e;case 1:if(Ll(l.type)){l=l.stateNode.__reactInternalMemoizedMergedChildContext;break e}}l=l.return}while(l!==null);throw Error(o(171))}if(e.tag===1){var s=e.type;if(Ll(s))return Mr(e,s,l)}return l}function pp(e,l,s,i,n,u,d,h,v){return e=mu(s,i,!0,e,n,u,d,h,v),e.context=cp(null),s=e.current,i=kl(),n=ai(s),u=zs(i,n),u.callback=l??null,si(s,u,n),e.current.lanes=n,Et(e,n,i),Pl(e,i),e}function va(e,l,s,i){var n=l.current,u=kl(),d=ai(n);return s=cp(s),l.context===null?l.context=s:l.pendingContext=s,l=zs(u,d),l.payload={element:e},i=i===void 0?null:i,i!==null&&(l.callback=i),e=si(n,l,d),e!==null&&(os(e,n,d,u),Yn(e,n,d)),d}function wa(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function dp(e,l){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var s=e.retryLane;e.retryLane=s!==0&&s<l?s:l}}function hu(e,l){dp(e,l),(e=e.alternate)&&dp(e,l)}function vf(){return null}var gp=typeof reportError=="function"?reportError:function(e){console.error(e)};function _u(e){this._internalRoot=e}xa.prototype.render=_u.prototype.render=function(e){var l=this._internalRoot;if(l===null)throw Error(o(409));va(e,l,null,null)},xa.prototype.unmount=_u.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var l=e.containerInfo;ki(function(){va(null,e,null,null)}),l[Ls]=null}};function xa(e){this._internalRoot=e}xa.prototype.unstable_scheduleHydration=function(e){if(e){var l=Qu();e={blockedOn:null,target:e,priority:l};for(var s=0;s<Vs.length&&l!==0&&l<Vs[s].priority;s++);Vs.splice(s,0,e),s===0&&Zu(e)}};function ju(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function ya(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function fp(){}function wf(e,l,s,i,n){if(n){if(typeof i=="function"){var u=i;i=function(){var z=wa(d);u.call(z)}}var d=pp(l,i,e,0,null,!1,!1,"",fp);return e._reactRootContainer=d,e[Ls]=d.current,Mt(e.nodeType===8?e.parentNode:e),ki(),d}for(;n=e.lastChild;)e.removeChild(n);if(typeof i=="function"){var h=i;i=function(){var z=wa(v);h.call(z)}}var v=mu(e,0,!1,null,null,!1,!1,"",fp);return e._reactRootContainer=v,e[Ls]=v.current,Mt(e.nodeType===8?e.parentNode:e),ki(function(){va(l,v,s,i)}),v}function Ea(e,l,s,i,n){var u=s._reactRootContainer;if(u){var d=u;if(typeof n=="function"){var h=n;n=function(){var v=wa(d);h.call(v)}}va(l,d,e,n)}else d=wf(s,l,e,n,i);return wa(d)}Vu=function(e){switch(e.tag){case 3:var l=e.stateNode;if(l.current.memoizedState.isDehydrated){var s=Ns(l.pendingLanes);s!==0&&(Ra(l,s|1),Pl(l,Be()),(He&6)===0&&(rt=Be()+500,ei()))}break;case 13:ki(function(){var i=Js(e,1);if(i!==null){var n=kl();os(i,e,1,n)}}),hu(e,1)}},Oa=function(e){if(e.tag===13){var l=Js(e,134217728);if(l!==null){var s=kl();os(l,e,134217728,s)}hu(e,134217728)}},Ku=function(e){if(e.tag===13){var l=ai(e),s=Js(e,l);if(s!==null){var i=kl();os(s,e,l,i)}hu(e,l)}},Qu=function(){return De},Yu=function(e,l){var s=De;try{return De=e,l()}finally{De=s}},Mi=function(e,l,s){switch(l){case"input":if(zl(e,s),l=s.name,s.type==="radio"&&l!=null){for(s=e;s.parentNode;)s=s.parentNode;for(s=s.querySelectorAll("input[name="+JSON.stringify(""+l)+'][type="radio"]'),l=0;l<s.length;l++){var i=s[l];if(i!==e&&i.form===e.form){var n=Rn(i);if(!n)throw Error(o(90));be(i),zl(i,n)}}}break;case"textarea":wn(e,s);break;case"select":l=s.value,l!=null&&As(e,!!s.multiple,l,!1)}},En=ru,xt=ki;var xf={usingClientEntryPoint:!1,Events:[Rt,Qi,Rn,yn,wt,ru]},ln={findFiberByHostInstance:_i,bundleType:0,version:"18.3.1",rendererPackageName:"react-dom"},yf={bundleType:ln.bundleType,version:ln.version,rendererPackageName:ln.rendererPackageName,rendererConfig:ln.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setErrorHandler:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:pe.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=re(e),e===null?null:e.stateNode},findFiberByHostInstance:ln.findFiberByHostInstance||vf,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null,reconcilerVersion:"18.3.1-next-f1338f8080-20240426"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var ka=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!ka.isDisabled&&ka.supportsFiber)try{Os=ka.inject(yf),al=ka}catch{}}return Jl.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=xf,Jl.createPortal=function(e,l){var s=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!ju(l))throw Error(o(200));return Sf(e,l,null,s)},Jl.createRoot=function(e,l){if(!ju(e))throw Error(o(299));var s=!1,i="",n=gp;return l!=null&&(l.unstable_strictMode===!0&&(s=!0),l.identifierPrefix!==void 0&&(i=l.identifierPrefix),l.onRecoverableError!==void 0&&(n=l.onRecoverableError)),l=mu(e,1,!1,null,null,s,!1,i,n),e[Ls]=l.current,Mt(e.nodeType===8?e.parentNode:e),new _u(l)},Jl.findDOMNode=function(e){if(e==null)return null;if(e.nodeType===1)return e;var l=e._reactInternals;if(l===void 0)throw typeof e.render=="function"?Error(o(188)):(e=Object.keys(e).join(","),Error(o(268,e)));return e=re(l),e=e===null?null:e.stateNode,e},Jl.flushSync=function(e){return ki(e)},Jl.hydrate=function(e,l,s){if(!ya(l))throw Error(o(200));return Ea(null,e,l,!0,s)},Jl.hydrateRoot=function(e,l,s){if(!ju(e))throw Error(o(405));var i=s!=null&&s.hydratedSources||null,n=!1,u="",d=gp;if(s!=null&&(s.unstable_strictMode===!0&&(n=!0),s.identifierPrefix!==void 0&&(u=s.identifierPrefix),s.onRecoverableError!==void 0&&(d=s.onRecoverableError)),l=pp(l,null,e,1,s??null,n,!1,u,d),e[Ls]=l.current,Mt(e),i)for(e=0;e<i.length;e++)s=i[e],n=s._getVersion,n=n(s._source),l.mutableSourceEagerHydrationData==null?l.mutableSourceEagerHydrationData=[s,n]:l.mutableSourceEagerHydrationData.push(s,n);return new xa(l)},Jl.render=function(e,l,s){if(!ya(l))throw Error(o(200));return Ea(null,e,l,!1,s)},Jl.unmountComponentAtNode=function(e){if(!ya(e))throw Error(o(40));return e._reactRootContainer?(ki(function(){Ea(null,null,e,!1,function(){e._reactRootContainer=null,e[Ls]=null})}),!0):!1},Jl.unstable_batchedUpdates=ru,Jl.unstable_renderSubtreeIntoContainer=function(e,l,s,i){if(!ya(s))throw Error(o(200));if(e==null||e._reactInternals===void 0)throw Error(o(38));return Ea(e,l,s,!1,i)},Jl.version="18.3.1-next-f1338f8080-20240426",Jl}var Xp;function Nd(){if(Xp)return bu.exports;Xp=1;function t(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(t)}catch(a){console.error(a)}}return t(),bu.exports=l_(),bu.exports}var s_=Nd();function i_(t){return C.createElement(fh,{flushSync:s_.flushSync,...t})}var Ia={},Zp;function t_(){if(Zp)return Ia;Zp=1;var t=Nd();return Ia.createRoot=t.createRoot,Ia.hydrateRoot=t.hydrateRoot,Ia}var n_=t_();/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const a_=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),o_=t=>t.replace(/^([A-Z])|[\s-_]+(\w)/g,(a,o,r)=>r?r.toUpperCase():o.toLowerCase()),ed=t=>{const a=o_(t);return a.charAt(0).toUpperCase()+a.slice(1)},Fd=(...t)=>t.filter((a,o,r)=>!!a&&a.trim()!==""&&r.indexOf(a)===o).join(" ").trim();/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const r_=C.forwardRef(({color:t="currentColor",size:a=24,strokeWidth:o=2,absoluteStrokeWidth:r,className:c="",children:p,iconNode:g,...f},m)=>C.createElement("svg",{ref:m,...u_,width:a,height:a,stroke:t,strokeWidth:r?Number(o)*24/Number(a):o,className:Fd("lucide",c),...f},[...g.map(([_,E])=>C.createElement(_,E)),...Array.isArray(p)?p:[p]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gi=(t,a)=>{const o=C.forwardRef(({className:r,...c},p)=>C.createElement(r_,{ref:p,iconNode:a,className:Fd(`lucide-${a_(ed(t))}`,`lucide-${t}`,r),...c}));return o.displayName=ed(t),o};/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const c_=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],ld=gi("check",c_);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p_=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],d_=gi("chevron-left",p_);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g_=[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}]],sd=gi("heart",g_);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f_=[["path",{d:"M5 12h14",key:"1ays0h"}]],m_=gi("minus",f_);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h_=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],__=gi("plus",h_);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j_=[["path",{d:"M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z",key:"hou9p0"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M16 10a4 4 0 0 1-8 0",key:"1ltviw"}]],id=gi("shopping-bag",j_);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S_=[["path",{d:"M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z",key:"r04s7s"}]],v_=gi("star",S_);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const w_=[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]],x_=gi("trash-2",w_),y_="data:image/svg+xml;base64,";function on(t){const[a,o]=C.useState(!1),r=()=>{o(!0)},{src:c,alt:p,style:g,className:f,...m}=t;return a?b.jsx("div",{className:`inline-block bg-gray-100 text-center align-middle ${f??""}`,style:g,children:b.jsx("div",{className:"flex items-center justify-center w-full h-full",children:b.jsx("img",{src:y_,alt:"Error loading image",...m,"data-original-url":c})})}):b.jsx("img",{src:c,alt:p,className:f,style:g,...m,onError:r})}const E_=`id,TITLE,DESCRIPTION,PRICE,CURRENCY_CODE,QUANTITY,TAGS,MATERIALS,IMAGE1,IMAGE2,IMAGE3,IMAGE4,IMAGE5,IMAGE6,IMAGE7,IMAGE8,IMAGE9,IMAGE10,condition,availability,root links,item_group_id,shape,length\r
...
`,td=["Square","Oval","Stiletto","Coffin","Almond"];function nd(t){const a=[];let o="",r=!1;for(let c=0;c<t.length;c++){const p=t[c];p==='"'?r&&t[c+1]==='"'?(o+='"',c++):r=!r:p===","&&!r?(a.push(o),o=""):o+=p}return a.push(o),a}function k_(t){const a=[];let o="",r=!1;for(let c=0;c<t.length;c++){const p=t[c];p==='"'?(r&&t[c+1]==='"'?(o+='"',c++):r=!r,o+=p):(p===`
`||p==="\r")&&!r?(p==="\r"&&t[c+1]===`
`&&c++,o.trim()&&a.push(o),o=""):o+=p}return o.trim()&&a.push(o),a}function b_(){const t=k_(E_),a=nd(t[0]).map(c=>c.trim()),o=(c,p)=>{var f;const g=a.indexOf(p);return g>=0?((f=c[g])==null?void 0:f.trim())??"":""},r=[];for(let c=1;c<t.length;c++){const p=nd(t[c]),g=o(p,"id");if(!g||o(p,"availability")==="out of stock")continue;const f=o(p,"item_group_id")||g,m=o(p,"TITLE"),_=parseFloat(o(p,"PRICE"))||0,E=o(p,"DESCRIPTION").replace(/\n/g," ").replace(/\s+/g," ").trim(),J=["IMAGE1","IMAGE2","IMAGE3","IMAGE4","IMAGE5","IMAGE6","IMAGE7","IMAGE8","IMAGE9","IMAGE10"].map(L=>(o(p,L)||"").trim()).filter(Boolean),U=J[0]||"",H=J.slice(1),A=o(p,"TAGS"),q=A?A.split(",").map(L=>L.trim()).filter(Boolean):[],D=o(p,"VARIATION 1 TYPE")||o(p,"VARIATION 2 TYPE"),K=o(p,"VARIATION 1 NAME")||o(p,"VARIATION 2 NAME"),X=o(p,"VARIATION 1 VALUES")||o(p,"VARIATION 2 VALUES");let pe=td;K==="Nail Shapes"&&X?pe=X.split(",").map(L=>L.trim()).filter(Boolean):(D||K)&&(pe=td);const ue=o(p,"shape"),ve=o(p,"length"),Le=ve.charAt(0).toUpperCase()+ve.slice(1).toLowerCase();r.push({id:g,groupId:f,name:m,price:_,description:E,image:U,extraImages:H,shapes:pe,tags:q,shape:ue,length:Le})}return r}const un={firstName:"",lastName:"",email:"",phone:"",address:"",instagram:"",city:"",postcode:"",nailSizes:"",notes:""},ad=new Set(["JUICEGELS-0301"]),C_="meta_shops",mt=b_(),L_=mt.filter((t,a,o)=>a===o.findIndex(r=>r.groupId===t.groupId));function I_(t){return t.map(a=>`${encodeURIComponent(a.product.id)}:${encodeURIComponent(String(a.quantity))}`).join(",")}function G_(t,a){if(t.length===0)return"/basket";const o=[`products=${I_(t)}`];return a!=null&&a.includeCoupon&&o.push(a.coupon?`coupon=${encodeURIComponent(a.coupon)}`:"coupon"),a!=null&&a.cartOrigin&&o.push(`cart_origin=${encodeURIComponent(a.cartOrigin)}`),`/basket?${o.join("&")}`}function P_(t,a){return t.split(",").map(o=>{const[r,c]=o.split(":"),p=decodeURIComponent(r??"").trim(),g=Math.max(1,Number(decodeURIComponent(c??"1"))),f=a.find(m=>m.id===p);return!f||Number.isNaN(g)?null:{product:f,shape:f.shape,length:f.length,quantity:g}}).filter(Boolean)}function J_(t,a){return t.split(",").map(o=>{const[r,c,p,g]=o.split("|"),f=decodeURIComponent(r??"").trim(),m=decodeURIComponent(c??"").trim(),_=decodeURIComponent(p??"Medium"),E=Math.max(1,Number(decodeURIComponent(g??"1"))),S=a.find(J=>J.id===f);return!S||!m||Number.isNaN(E)?null:{product:S,shape:m,length:_,quantity:E}}).filter(Boolean)}function pt(){const t=xs(),a=Bd(),o=Km(),r=C.useMemo(()=>new URLSearchParams(t.search),[t.search]),c=C.useMemo(()=>t.pathname.replace(/\/+$/,"")||"/",[t.pathname]),[p,g]=C.useState("home"),[f,m]=C.useState(null),[_,E]=C.useState(""),[S,J]=C.useState("Medium"),[U,H]=C.useState([]),[A,q]=C.useState(()=>{if(typeof window>"u")return[];try{return JSON.parse(localStorage.getItem("juicegels_cart")??"[]")}catch{return[]}}),[D,K]=C.useState(()=>{if(typeof window>"u")return un;try{return JSON.parse(localStorage.getItem("juicegels_form")??"null")??un}catch{return un}}),[X,pe]=C.useState({}),[ue,ve]=C.useState(0),[Le,L]=C.useState(null),[ke,fe]=C.useState(!1),Ne=k=>G_(k,{coupon:r.get("coupon"),includeCoupon:r.has("coupon")||k.length>0,cartOrigin:r.get("cart_origin")??C_});C.useEffect(()=>{const k=(()=>{if(!t.search.startsWith("?/"))return"";const[se]=t.search.slice(1).split("&");return se.startsWith("/")?se:`/${se}`})(),$=r.get("checkout")==="success"||r.has("session_id");if(c==="/confirmation"||c==="/checkout-success"||k==="/confirmation"||k==="/checkout-success"||c==="/"&&$){g("confirmation");return}if(c==="/basket"){const se=new URLSearchParams(t.search),be=se.get("products"),Ee=se.get("items");if(be!==null)q(P_(be,mt));else if(Ee){const ll=J_(Ee,mt);ll.length>0&&q(ll)}g("basket");return}if(c==="/"){g("home");return}if(c.startsWith("/product/")&&o.id){const se=mt.find(be=>be.id===o.id);if(se){if(Oe(se)){m(se),E(se.shape),J(se.length),ve(0),g("product");return}const be=new URLSearchParams(t.search),Ee=be.get("shape")??"",ll=be.get("length")??"",ys=de(se),Es=N(se),zl=ys.includes(Ee)?Ee:ys[0]??"",Ji=Es.includes(ll)?ll:Es[0]??"Medium";m(se),E(zl),J(Ji),ve(0),g("product");return}}g("home")},[t.search,c,o.id,mt,r]),C.useEffect(()=>{if(p!=="product"||!f||!_||!S)return;const k=new URLSearchParams(t.search),$=k.get("shape")??"",se=k.get("length")??"";$===_&&se===S||Q(f.id,_,S)},[p,f,_,S]);const we=A.reduce((k,$)=>k+$.product.price*$.quantity,0),Pe=A.reduce((k,$)=>k+$.quantity,0);C.useEffect(()=>{typeof window>"u"||localStorage.setItem("juicegels_cart",JSON.stringify(A))},[A]),C.useEffect(()=>{typeof window>"u"||localStorage.setItem("juicegels_form",JSON.stringify(D))},[D]);const Je=k=>H($=>$.includes(k)?$.filter(se=>se!==k):[...$,k]),Me=["Short","Medium","Long"],Oe=k=>ad.has(k.id),de=k=>{const $=k.shapes;return Array.isArray($)&&$.length>0?$:["Short Almond","Medium Almond","Long Almond"]},N=k=>{const $=k.lengths;return Array.isArray($)&&$.length>0?$:Me},Q=(k,$,se)=>{if(ad.has(k)){a(`/product/${k}`,{replace:!0});return}const be=new URLSearchParams;$&&be.set("shape",$),se&&be.set("length",se),a(`/product/${k}?${be.toString()}`,{replace:!0})},V=k=>{const $=de(k),se=N(k),be=Oe(k)?k.shape:$[0]??"",Ee=Oe(k)?k.length:se[0]??"Medium";if(m(k),E(be),J(Ee),ve(0),g("product"),Oe(k)){a(`/product/${k.id}`);return}a(`/product/${k.id}?shape=${encodeURIComponent(be)}&length=${encodeURIComponent(Ee)}`)},y=()=>{!f||!_||!S||q(k=>{const $=k.findIndex(be=>be.product.id===f.id&&be.shape===_&&be.length===S);let se;return $>=0?(se=[...k],se[$]={...se[$],quantity:se[$].quantity+1}):se=[...k,{product:f,shape:_,length:S,quantity:1}],a(Ne(se)),se})},B=(k,$,se)=>mt.find(be=>be.groupId===k&&be.shape===$&&be.length===se),ce=(k,$)=>{q(se=>{const be=[...se],Ee=be[k].quantity+$;let ll;return Ee<=0?ll=be.filter((ys,Es)=>Es!==k):(be[k]={...be[k],quantity:Ee},ll=be),a(Ne(ll)),ll})},me=k=>{q($=>{const se=$.filter((be,Ee)=>Ee!==k);return a(Ne(se)),se})},ge=(k,$)=>{K(se=>({...se,[k]:$})),X[k]&&pe(se=>({...se,[k]:""}))},he=()=>{const k={};return D.firstName.trim()||(k.firstName="Required"),D.lastName.trim()||(k.lastName="Required"),(!D.email.trim()||!/\S+@\S+\.\S+/.test(D.email))&&(k.email="Valid email required"),D.phone.trim()||(k.phone="Required"),D.address.trim()||(k.address="Required"),D.city.trim()||(k.city="Required"),D.instagram.trim()||(k.instagram="Required"),D.postcode.trim()||(k.postcode="Required"),pe(k),Object.keys(k).length===0},Ie=async k=>{if(k.preventDefault(),!he())return;if(A.length===0){L("Your basket is empty.");return}L(null),fe(!0);const $="https://juicegels-v2.onrender.com/create-checkout-session";try{const se=await fetch($,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({items:A.map(Ee=>({product:{id:Ee.product.id,name:Ee.product.name,price:Ee.product.price,description:Ee.product.description,image:Ee.product.image},shape:Ee.shape,length:Ee.length,quantity:Ee.quantity})),form:D,checkoutPath:"/confirmation"})}),be=await se.json();if(!se.ok||!be.url)throw new Error(be.error||"Failed to create checkout session.");window.location.href=be.url}catch(se){L(se instanceof Error?se.message:"Checkout failed."),fe(!1)}},qe=()=>{p==="preorder"?g("basket"):p==="basket"?g(f?"product":"home"):a("/home")};return b.jsxs("div",{style:{fontFamily:"'DM Sans', sans-serif",maxWidth:430,margin:"0 auto",minHeight:"100vh",background:"var(--background)"},children:[b.jsxs("header",{style:{background:"var(--card)",borderBottom:"1px solid var(--border)",position:"sticky",top:0,zIndex:50,padding:"12px 16px",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[p!=="home"?b.jsx("button",{onClick:qe,style:{color:"var(--primary)",background:"none",border:"none",cursor:"pointer",padding:4},"aria-label":"Back",children:b.jsx(d_,{size:22})}):b.jsx("div",{style:{width:30}}),b.jsx("h1",{style:{fontFamily:"'Playfair Display', serif",color:"var(--primary)",margin:0,letterSpacing:"0.04em",fontSize:22},children:"Juice Gels"}),b.jsxs("button",{onClick:()=>a(Ne(A)),style:{position:"relative",background:"none",border:"none",cursor:"pointer",padding:4},"aria-label":"Basket",children:[b.jsx(id,{size:22,style:{color:"var(--primary)"}}),Pe>0&&b.jsx("span",{style:{position:"absolute",top:-4,right:-4,background:"var(--primary)",color:"#fff",borderRadius:"50%",width:17,height:17,fontSize:10,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:700},children:Pe})]})]}),(p==="basket"||p==="preorder"||p==="confirmation")&&b.jsx("div",{style:{display:"flex",padding:"10px 20px",gap:6,alignItems:"center",background:"var(--card)",borderBottom:"1px solid var(--border)"},children:["Basket","Details","Done"].map((k,$)=>{const se=p==="basket"&&$===0||p==="preorder"&&$===1||p==="confirmation"&&$===2,be=p==="preorder"&&$===0||p==="confirmation"&&$<=1;return b.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6,flex:$<2?1:void 0},children:[b.jsxs("div",{style:{display:"flex",alignItems:"center",gap:5},children:[b.jsx("div",{style:{width:22,height:22,borderRadius:"50%",background:be?"var(--primary)":se?"var(--accent)":"var(--muted)",border:`2px solid ${se||be?"var(--primary)":"var(--border)"}`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0},children:be?b.jsx(ld,{size:11,color:"#fff"}):b.jsx("span",{style:{fontSize:10,color:se?"var(--foreground)":"var(--muted-foreground)",fontWeight:600},children:$+1})}),b.jsx("span",{style:{fontSize:11,color:se?"var(--foreground)":"var(--muted-foreground)",fontWeight:se?600:400},children:k})]}),$<2&&b.jsx("div",{style:{flex:1,height:1.5,background:be?"var(--primary)":"var(--border)",borderRadius:2}})]},k)})}),p==="home"&&b.jsxs("main",{children:[b.jsxs("div",{style:{background:"linear-gradient(160deg, #f9d5e0 0%, #fce4ea 60%, #fdf2f4 100%)",padding:"28px 20px 22px",textAlign:"center"},children:[b.jsx("p",{style:{color:"var(--muted-foreground)",margin:"0 0 5px",letterSpacing:"0.12em",fontSize:11,textTransform:"uppercase"},children:"Handmade Press-On Nails"}),b.jsx("h2",{style:{fontFamily:"'Playfair Display', serif",fontSize:30,color:"var(--foreground)",margin:"0 0 8px",lineHeight:1.2},children:"Nail the Look ✨"}),b.jsx("p",{style:{color:"var(--muted-foreground)",margin:"0 0 4px",fontSize:13,lineHeight:1.6},children:"Custom-fit gel press-ons · Send your nail sizes for a perfect fit"})]}),b.jsx("div",{style:{padding:"16px 14px",display:"grid",gridTemplateColumns:"1fr 1fr",gap:12},children:L_.map(k=>b.jsxs("button",{onClick:()=>V(k),style:{background:"var(--card)",border:"1px solid var(--border)",borderRadius:14,overflow:"hidden",textAlign:"left",cursor:"pointer",padding:0,position:"relative",display:"block",width:"100%"},children:[b.jsx("button",{onClick:$=>{$.stopPropagation(),Je(k.id)},style:{position:"absolute",top:7,right:7,background:"rgba(255,255,255,0.88)",border:"none",borderRadius:"50%",width:28,height:28,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",zIndex:2},"aria-label":"Wishlist",children:b.jsx(sd,{size:13,fill:U.includes(k.id)?"var(--primary)":"none",stroke:U.includes(k.id)?"var(--primary)":"var(--muted-foreground)"})}),b.jsx(on,{src:k.image,alt:k.name,style:{width:"100%",height:160,objectFit:"cover",display:"block",background:"var(--secondary)"}}),b.jsxs("div",{style:{padding:"8px 10px 10px"},children:[b.jsx("p",{style:{margin:"0 0 5px",fontSize:12,color:"var(--foreground)",lineHeight:1.3},children:k.name}),b.jsxs("span",{style:{color:"var(--primary)",fontWeight:600,fontSize:14},children:["£",k.price.toFixed(2)]})]})]},k.id))}),b.jsxs("div",{style:{margin:"4px 14px 32px",background:"var(--secondary)",borderRadius:14,padding:"16px 18px",textAlign:"center"},children:[b.jsx("p",{style:{fontFamily:"'Playfair Display', serif",color:"var(--foreground)",margin:"0 0 3px",fontSize:16},children:"Need your nail sizes?"}),b.jsx("p",{style:{color:"var(--muted-foreground)",margin:0,fontSize:12},children:"Pick up the Nail Sizing Guide — £4 deducted from your first set 🌸"})]})]}),p==="product"&&f&&b.jsxs("main",{children:[b.jsx(on,{src:[f.image,...f.extraImages][ue],alt:f.name,style:{width:"100%",height:320,objectFit:"cover",display:"block",background:"var(--secondary)"}}),f.extraImages.length>0&&b.jsx("div",{style:{display:"flex",gap:8,padding:"10px 16px 0",overflowX:"auto"},children:[f.image,...f.extraImages].map((k,$)=>b.jsx("button",{onClick:()=>ve($),style:{flexShrink:0,border:`2px solid ${ue===$?"var(--primary)":"var(--border)"}`,borderRadius:8,overflow:"hidden",padding:0,cursor:"pointer",background:"none"},children:b.jsx(on,{src:k,alt:"",style:{width:52,height:52,objectFit:"cover",display:"block"}})},$))}),b.jsxs("div",{style:{padding:"16px 20px 130px"},children:[b.jsx("h2",{style:{fontFamily:"'Playfair Display', serif",margin:"0 0 4px",fontSize:22,color:"var(--foreground)"},children:f.name}),b.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4,marginBottom:10},children:[[1,2,3,4,5].map(k=>b.jsx(v_,{size:12,fill:"var(--primary)",stroke:"none"},k)),b.jsx("span",{style:{fontSize:12,color:"var(--muted-foreground)",marginLeft:3},children:"Handmade · In stock"})]}),b.jsxs("span",{style:{fontSize:24,fontWeight:700,color:"var(--primary)"},children:["£",f.price.toFixed(2)]}),b.jsx("p",{style:{color:"var(--muted-foreground)",fontSize:13,lineHeight:1.7,margin:"12px 0 18px"},children:f.description}),Oe(f)?null:b.jsxs(b.Fragment,{children:[b.jsx("p",{style:{margin:"0 0 8px",fontSize:13,fontWeight:600,color:"var(--foreground)"},children:"Nail Shape"}),b.jsx("div",{style:{display:"flex",gap:7,flexWrap:"wrap",marginBottom:20},children:f.shapes.map(k=>b.jsx("button",{onClick:()=>{if(!f)return;const $=B(f.groupId,k,S);$&&(m($),E(k),J($.length))},style:{border:`1.5px solid ${_===k?"var(--primary)":"var(--border)"}`,background:_===k?"var(--primary)":"var(--card)",color:_===k?"#fff":"var(--foreground)",borderRadius:8,padding:"6px 14px",fontSize:12,cursor:"pointer",transition:"all 0.15s"},children:k},k))}),b.jsx("p",{style:{margin:"0 0 8px",fontSize:13,fontWeight:600,color:"var(--foreground)"},children:"Nail Length"}),b.jsx("div",{style:{display:"flex",gap:7,flexWrap:"wrap",marginBottom:20},children:["Short","Medium","Long"].map(k=>b.jsx("button",{onClick:()=>{if(!f)return;const $=B(f.groupId,_,k);$&&(m($),J(k),E($.shape))},style:{border:`1.5px solid ${S===k?"var(--primary)":"var(--border)"}`,background:S===k?"var(--primary)":"var(--card)",color:S===k?"#fff":"var(--foreground)",borderRadius:8,padding:"6px 14px",fontSize:12,cursor:"pointer",transition:"all 0.15s",textTransform:"capitalize"},children:k},k))})]}),Oe(f)?null:b.jsxs("div",{style:{background:"var(--muted)",borderRadius:10,padding:"10px 14px",fontSize:12,color:"var(--muted-foreground)",lineHeight:1.5},children:["🌸 Send your nail sizes after ordering via ",b.jsx("strong",{children:"@juicegels"})," on Instagram or through your order notes."]})]}),b.jsxs("div",{style:{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:430,padding:"14px 18px",background:"var(--card)",borderTop:"1px solid var(--border)",display:"flex",gap:10,boxSizing:"border-box"},children:[b.jsx("button",{onClick:()=>Je(f.id),style:{border:"1.5px solid var(--border)",background:"var(--card)",borderRadius:12,width:46,height:46,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0},children:b.jsx(sd,{size:17,fill:U.includes(f.id)?"var(--primary)":"none",stroke:U.includes(f.id)?"var(--primary)":"var(--muted-foreground)"})}),b.jsx("button",{onClick:y,disabled:!_||!S,style:{flex:1,background:_&&S?"var(--primary)":"var(--muted)",color:_&&S?"#fff":"var(--muted-foreground)",border:"none",borderRadius:12,height:46,fontWeight:600,fontSize:14,cursor:_&&S?"pointer":"not-allowed",transition:"all 0.15s"},children:_&&S?"Add to Basket":"Select shape and length"})]})]}),p==="basket"&&b.jsxs("main",{style:{padding:"16px 16px 100px"},children:[b.jsx("h2",{style:{fontFamily:"'Playfair Display', serif",fontSize:20,color:"var(--foreground)",margin:"0 0 14px"},children:"Your Basket"}),A.length===0?b.jsxs("div",{style:{textAlign:"center",padding:"48px 20px"},children:[b.jsx(id,{size:40,style:{color:"var(--muted-foreground)",marginBottom:12}}),b.jsx("p",{style:{color:"var(--muted-foreground)",fontSize:14},children:"Your basket is empty"}),b.jsx("button",{onClick:()=>a("/"),style:{marginTop:16,background:"var(--primary)",color:"#fff",border:"none",borderRadius:10,padding:"10px 24px",fontSize:14,fontWeight:600,cursor:"pointer"},children:"Browse Sets"})]}):b.jsxs(b.Fragment,{children:[b.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10,marginBottom:16},children:A.map((k,$)=>b.jsxs("div",{style:{background:"var(--card)",border:"1px solid var(--border)",borderRadius:14,padding:"12px",display:"flex",gap:12,alignItems:"center"},children:[b.jsx(on,{src:k.product.image,alt:k.product.name,style:{width:64,height:64,borderRadius:10,objectFit:"cover",flexShrink:0,background:"var(--secondary)"}}),b.jsxs("div",{style:{flex:1,minWidth:0},children:[b.jsx("p",{style:{margin:"0 0 2px",fontSize:13,fontWeight:500,color:"var(--foreground)",lineHeight:1.3},children:k.product.name}),b.jsxs("p",{style:{margin:"0 0 6px",fontSize:11,color:"var(--muted-foreground)"},children:["Shape: ",k.shape]}),b.jsxs("p",{style:{margin:"0 0 6px",fontSize:11,color:"var(--muted-foreground)"},children:["Length: ",k.length]}),b.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[b.jsxs("div",{style:{display:"flex",alignItems:"center",gap:1},children:[b.jsx("button",{onClick:()=>ce($,-1),style:{width:26,height:26,borderRadius:6,border:"1px solid var(--border)",background:"var(--muted)",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"},children:b.jsx(m_,{size:12})}),b.jsx("span",{style:{minWidth:28,textAlign:"center",fontSize:13,fontWeight:600},children:k.quantity}),b.jsx("button",{onClick:()=>ce($,1),style:{width:26,height:26,borderRadius:6,border:"1px solid var(--border)",background:"var(--muted)",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"},children:b.jsx(__,{size:12})})]}),b.jsxs("span",{style:{color:"var(--primary)",fontWeight:700,fontSize:14},children:["£",(k.product.price*k.quantity).toFixed(2)]})]})]}),b.jsx("button",{onClick:()=>me($),style:{background:"none",border:"none",cursor:"pointer",padding:4,flexShrink:0},children:b.jsx(x_,{size:15,style:{color:"var(--muted-foreground)"}})})]},`${k.product.id}-${k.shape}`))}),b.jsxs("div",{style:{background:"var(--secondary)",borderRadius:14,padding:"14px 16px",marginBottom:14},children:[b.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:13,marginBottom:6},children:[b.jsxs("span",{style:{color:"var(--muted-foreground)"},children:["Subtotal (",Pe," item",Pe!==1?"s":"",")"]}),b.jsxs("span",{children:["£",we.toFixed(2)]})]}),b.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:13,marginBottom:8},children:[b.jsx("span",{style:{color:"var(--muted-foreground)"},children:"Delivery"}),b.jsx("span",{style:{color:"var(--primary)"},children:"Free"})]}),b.jsxs("div",{style:{borderTop:"1px solid var(--border)",paddingTop:8,display:"flex",justifyContent:"space-between",fontWeight:700,fontSize:15},children:[b.jsx("span",{children:"Total"}),b.jsxs("span",{children:["£",we.toFixed(2)]})]})]}),b.jsxs("div",{style:{background:"var(--muted)",borderRadius:10,padding:"10px 14px",fontSize:12,color:"var(--muted-foreground)",lineHeight:1.5,marginBottom:4},children:["💅 Remember to send your nail sizes after ordering via ",b.jsx("strong",{children:"@juicegels"})," on Instagram or in your order notes."]})]})]}),A.length>0&&p==="basket"&&b.jsxs("div",{style:{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:430,padding:"14px 18px",background:"var(--card)",borderTop:"1px solid var(--border)",display:"flex",gap:10,boxSizing:"border-box"},children:[b.jsx("button",{onClick:()=>a("/"),style:{border:"1.5px solid var(--border)",background:"var(--card)",borderRadius:12,height:46,padding:"0 16px",fontSize:13,fontWeight:500,cursor:"pointer",flexShrink:0},children:"+ Add more"}),b.jsxs("button",{onClick:()=>{K(un),pe({}),g("preorder")},style:{flex:1,background:"var(--primary)",color:"#fff",border:"none",borderRadius:12,height:46,fontWeight:600,fontSize:14,cursor:"pointer"},children:["Pre-order · £",we.toFixed(2)]})]}),p==="preorder"&&b.jsxs("main",{style:{padding:"18px 18px 48px"},children:[b.jsx("h2",{style:{fontFamily:"'Playfair Display', serif",fontSize:20,color:"var(--foreground)",margin:"0 0 4px"},children:"Your Details"}),b.jsxs("p",{style:{color:"var(--muted-foreground)",fontSize:12,margin:"0 0 18px"},children:[Pe," item",Pe!==1?"s":""," · £",we.toFixed(2)," total"]}),b.jsxs("form",{onSubmit:Ie,noValidate:!0,style:{display:"flex",flexDirection:"column",gap:13},children:[b.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10},children:[b.jsx(hs,{label:"First name",error:X.firstName,children:b.jsx("input",{type:"text",placeholder:"Sophie",value:D.firstName,onChange:k=>ge("firstName",k.target.value),style:_s(!!X.firstName)})}),b.jsx(hs,{label:"Last name",error:X.lastName,children:b.jsx("input",{type:"text",placeholder:"Wright",value:D.lastName,onChange:k=>ge("lastName",k.target.value),style:_s(!!X.lastName)})})]}),b.jsx(hs,{label:"Email address",error:X.email,children:b.jsx("input",{type:"email",placeholder:"sophie@example.com",value:D.email,onChange:k=>ge("email",k.target.value),style:_s(!!X.email)})}),b.jsx(hs,{label:"Phone number",error:X.phone,children:b.jsx("input",{type:"tel",placeholder:"+44 7700 900000",value:D.phone,onChange:k=>ge("phone",k.target.value),style:_s(!!X.phone)})}),b.jsx(hs,{label:"Delivery address",error:X.address,children:b.jsx("input",{type:"text",placeholder:"12 Petal Lane",value:D.address,onChange:k=>ge("address",k.target.value),style:_s(!!X.address)})}),b.jsx(hs,{label:"Instagram username",error:X.instagram,children:b.jsx("input",{type:"text",placeholder:"@juicegels",value:D.instagram,onChange:k=>ge("instagram",k.target.value),style:_s(!!X.instagram)})}),b.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10},children:[b.jsx(hs,{label:"City",error:X.city,children:b.jsx("input",{type:"text",placeholder:"London",value:D.city,onChange:k=>ge("city",k.target.value),style:_s(!!X.city)})}),b.jsx(hs,{label:"Postcode",error:X.postcode,children:b.jsx("input",{type:"text",placeholder:"SW1A 1AA",value:D.postcode,onChange:k=>ge("postcode",k.target.value),style:_s(!!X.postcode)})})]}),b.jsxs(hs,{label:"Your nail sizes (e.g. R: 3,5,4,6,4 · L: 3,5,4,6,4)",children:[b.jsx("input",{type:"text",placeholder:"Right: 3,5,4,6,4  Left: 3,5,4,6,4",value:D.nailSizes,onChange:k=>ge("nailSizes",k.target.value),style:_s(!1)}),b.jsx("span",{style:{fontSize:11,color:"var(--muted-foreground)",lineHeight:1.4},children:"Not sure? Order the Nail Sizing Guide first — or send your sizes via @juicegels on Instagram after ordering."})]}),b.jsx(hs,{label:"Additional notes (optional)",children:b.jsx("textarea",{placeholder:"Any special requests, colour preferences, or custom details...",value:D.notes,onChange:k=>ge("notes",k.target.value),rows:3,style:{..._s(!1),resize:"none"}})}),b.jsxs("div",{style:{background:"var(--secondary)",borderRadius:13,padding:"13px 15px",fontSize:13,lineHeight:1.7,color:"var(--foreground)"},children:[b.jsx("strong",{style:{display:"block",marginBottom:6},children:"Order Summary"}),A.map((k,$)=>b.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:12,color:"var(--muted-foreground)"},children:[b.jsxs("span",{children:[k.product.name," (",k.shape,") ×",k.quantity]}),b.jsxs("span",{children:["£",(k.product.price*k.quantity).toFixed(2)]})]},$)),b.jsxs("div",{style:{borderTop:"1px solid var(--border)",marginTop:8,paddingTop:8,display:"flex",justifyContent:"space-between",fontWeight:700},children:[b.jsx("span",{children:"Total"}),b.jsxs("span",{children:["£",we.toFixed(2)]})]})]}),b.jsx("button",{type:"submit",disabled:ke,style:{background:ke?"var(--border)":"var(--primary)",color:"#fff",border:"none",borderRadius:12,height:48,fontWeight:600,fontSize:14,cursor:ke?"not-allowed":"pointer",letterSpacing:"0.02em"},children:ke?"Redirecting to Stripe...":"Confirm Pre-order 🌸"}),Le&&b.jsx("p",{style:{color:"var(--destructive)",fontSize:12,marginTop:10},children:Le})]})]}),p==="confirmation"&&b.jsxs("main",{style:{padding:"44px 22px",textAlign:"center"},children:[b.jsx("div",{style:{width:68,height:68,borderRadius:"50%",background:"var(--secondary)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 18px"},children:b.jsx(ld,{size:30,style:{color:"var(--primary)"}})}),b.jsx("h2",{style:{fontFamily:"'Playfair Display', serif",fontSize:24,color:"var(--foreground)",margin:"0 0 8px"},children:"Order Placed!"}),b.jsxs("p",{style:{color:"var(--muted-foreground)",fontSize:13,lineHeight:1.7,margin:"0 0 6px"},children:["Thank you, ",b.jsx("strong",{children:D.firstName}),"! Your pre-order of ",Pe," item",Pe!==1?"s":""," is confirmed."]}),b.jsxs("p",{style:{color:"var(--muted-foreground)",fontSize:12,margin:"0 0 24px",lineHeight:1.5},children:["A confirmation will be sent to ",b.jsx("strong",{children:D.email}),".",b.jsx("br",{}),!D.nailSizes&&b.jsxs("span",{style:{color:"var(--primary)"},children:["📏 Don't forget to DM your nail sizes to ",b.jsx("strong",{children:"@juicegels"})," on Instagram!"]})]}),b.jsxs("div",{style:{background:"var(--secondary)",borderRadius:13,padding:"14px",textAlign:"left",marginBottom:14},children:[b.jsx("p",{style:{margin:"0 0 8px",fontWeight:600,fontSize:13},children:"Items ordered"}),A.map((k,$)=>b.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:6},children:[b.jsx(on,{src:k.product.image,alt:k.product.name,style:{width:40,height:40,borderRadius:7,objectFit:"cover",background:"var(--muted)"}}),b.jsxs("div",{children:[b.jsx("p",{style:{margin:0,fontSize:12,fontWeight:500,color:"var(--foreground)"},children:k.product.name}),b.jsxs("p",{style:{margin:0,fontSize:11,color:"var(--muted-foreground)"},children:[k.shape," · ×",k.quantity," · £",(k.product.price*k.quantity).toFixed(2)]})]})]},$))]}),b.jsxs("div",{style:{background:"var(--card)",border:"1px solid var(--border)",borderRadius:13,padding:"14px",textAlign:"left",marginBottom:24},children:[b.jsx("p",{style:{margin:"0 0 5px",fontWeight:600,fontSize:13},children:"Delivering to"}),b.jsxs("p",{style:{margin:0,fontSize:12,color:"var(--muted-foreground)",lineHeight:1.6},children:[D.firstName," ",D.lastName,b.jsx("br",{}),D.address,b.jsx("br",{}),D.city,", ",D.postcode]})]}),b.jsx("button",{onClick:()=>{a("/"),q([]),K(un)},style:{background:"var(--primary)",color:"#fff",border:"none",borderRadius:12,height:46,width:"100%",fontWeight:600,fontSize:14,cursor:"pointer"},children:"Continue Shopping"})]})]})}function hs({label:t,error:a,children:o}){return b.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:4},children:[b.jsx("label",{style:{fontSize:11,fontWeight:600,color:"var(--foreground)",letterSpacing:"0.03em",textTransform:"uppercase"},children:t}),o,a&&b.jsx("span",{style:{fontSize:11,color:"var(--destructive)"},children:a})]})}function _s(t){return{background:"var(--input-background)",border:`1.5px solid ${t?"var(--destructive)":"var(--border)"}`,borderRadius:9,padding:"10px 13px",fontSize:14,color:"var(--foreground)",outline:"none",width:"100%",boxSizing:"border-box"}}const z_=Rh([{path:"/",element:b.jsx(pt,{})},{path:"/home",element:b.jsx(pt,{})},{path:"/basket",element:b.jsx(pt,{})},{path:"/product/:id",element:b.jsx(pt,{})},{path:"/confirmation",element:b.jsx(pt,{})},{path:"*",element:b.jsx(pt,{})}]);n_.createRoot(document.getElementById("root")).render(b.jsx(i_,{router:z_}));
